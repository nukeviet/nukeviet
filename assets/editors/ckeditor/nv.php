...
function nv_aleditor($textareaname, $width = '100%', $height = '450px', $val = '', $customtoolbar = '', $path = '', $currentpath = '')
{
    ...
    if (!defined('CKEDITOR')) {
        ...
        $return .= '<script src="' . NV_STATIC_URL . NV_EDITORSDIR . '/ckeditor/ckeditor.js?t=' . $global_config['timestamp'] . '"></script>';
        $return .= '<script>CKEDITOR.timestamp=CKEDITOR.timestamp+' . $global_config['timestamp'] . ';</script>';
    ...
    $replaces[] = 'codeSnippet_languages:{apache: "Apache", bash: "Bash", css: "CSS", html: "HTML", ini: "INI", js: "JavaScript", json: "JSON", nginx: "Nginx", php: "PHP", sql: "SQL", xhtml: "XHTML", xml: "XML"}';
