...
<html dir="ltr" mozdisallowselectionprint moznomarginboxes>
  <head>
    ...
    <title>PDF.js viewer</title>
		<link rel="stylesheet" href="{PDF_JS_DIR}viewer.css"/>
		<script src="{PDF_JS_DIR}compatibility.js"></script>
		<!-- This snippet is used in production (included from viewer.html) -->
		<link rel="resource" type="application/l10n" href="{PDF_JS_DIR}locale/locale.properties"/>
		<script src="{PDF_JS_DIR}l10n.js"></script>
