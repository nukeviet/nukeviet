...
<div class="block clearfix">
    ...
    <table class="rows" style="margin-top:2px">
        <tr>
            <!-- BEGIN: order_note -->
            <td valign="top">
                <span style="font-style:italic;">{LANG.cart_note} : {DATA.order_note}</span>
            </td>
            <!-- END: order_note -->
            <!-- BEGIN: price3 -->
            <td align="right" valign="top">
                {LANG.cart_total}: <strong id="total">{order_total}</strong>
                {unit}
            </td>
            <!-- END: price3 -->
        </tr>
    ...
    <div style="margin-top:4px">
		<!-- BEGIN: payment -->
	        <div style="padding:5px; border:1px solid #F7F7F7; text-align:center; margin-bottom:2px">
	            <!-- BEGIN: paymentloop --><span style="padding:5px; border:1px solid #F7F7F7; text-align:center; margin-right:2px; display:inline-block"><a title="{DATA_PAYMENT.name}" href="{DATA_PAYMENT.url}"><img src="{DATA_PAYMENT.images_button}" alt="{DATA_PAYMENT.name}" /></a>
	                <br/>
	                {DATA_PAYMENT.name}
	            </span>
	            <!-- END: paymentloop -->
