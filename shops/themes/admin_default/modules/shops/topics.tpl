  ...
  <form action="" method="post"><input name="save" type="hidden" value="1" />
    <table summary="{DATA.caption}" class="tab1">
        ...
        <tr>
            ...
            <td>
            	<input style="width:50%" name="title" type="text" value="{DATA.title}" maxlength="255" />
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td align="right">
            	<strong>{LANG.topic_sub}: </strong> <br />
            	{LANG.topic_sub_note}
            </td>
            <td>
            	<textarea style="width:50%; height:50px" name="keywords">{DATA.keywords}</textarea> 
            </td>
        </tr>
    </table>
    <br>
    <center><input name="submit" type="submit" value="{LANG.prounit_save}" /></center>
  </form>
  <script type="text/javascript">
