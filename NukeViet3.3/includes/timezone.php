...
if ( $global_config['site_timezone'] == "byCountry" )
{
    $global_config['site_timezone'] = $countries[$client_info['country']][2];
}

if ( empty( $global_config['site_timezone'] ) and defined( 'NV_CLIENT_TIMEZONE_NAME' ) )
{
    $global_config['site_timezone'] = NV_CLIENT_TIMEZONE_NAME;
}

if ( ! empty( $global_config['site_timezone'] ) and $global_config['site_timezone'] != "byCountry" )
{
    $ok = false;
