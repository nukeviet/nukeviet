    ...
    function nv_style_type($style, $list_cats, $block_config)
    {
        ...
        foreach ($list_cats as $cat)
        {
            if (empty($cat['parentid']))
            {
                ...
                $cat['note'] = (!empty($cat['note'])) ? $cat['note'] : $cat['title'];
            ...
            if (empty($cat['parentid']))
            {
                ...
                if (!empty($cat['subcats']))
                {
                    ...
                    foreach ($list_cats as $subcat)
                    {
                        ...
                        {
                            $subcat['note'] = (!empty($subcat['note'])) ? $subcat['note'] : $subcat['title'];
        ...
        while ($row = $db->sql_fetchrow($result))
        {
            ...
            if (nv_set_allow($row['who_view'], $row['groups_view']))
            {
                $list_cats[$row['id']] = array('id' => $row['id'], 'parentid' => $row['parentid'], //
                    ...
                    'title' => $row['title'], //
                    'link' => $row['link'], //
                    'note' => (!empty($row['note'])) ? $row['note'] : $row['title'], //
        ...
        else
        {
            ...
            foreach ($list as $catid)
            {
                ...
                if (!empty($list_cats[$catid]['subcats']))
                {
                    ...
                    $tree['note'] = (!empty($tree['note'])) ? $tree['note'] : $tree['title'];
