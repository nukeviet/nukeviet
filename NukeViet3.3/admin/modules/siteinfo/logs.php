...
// Search data
$data_search = array("q" => $lang_module['filter_enterkey'], //
    "from" => "", //
    "to" => "", //
    "lang" => "", //
    "module" => "", //
...
if ($nv_Request->isset_request('filter', 'get') and $nv_Request->isset_request('checksess', 'get'))
{
    ...
    $data_search = array("q" => filter_text_input('q', 'get', ''), //
...
$opposite_order = array("NO" => "ASC", //
    "DESC" => "ASC", //
    "ASC" => "DESC"  //
);
$lang_order_1 = array("NO" => $lang_module['filter_lang_asc'], //
    "DESC" => $lang_module['filter_lang_asc'], //
    "ASC" => $lang_module['filter_lang_desc']  //
);
$lang_order_2 = array("lang" => strtolower($lang_module['log_lang']), //
...
foreach ($order as $key => $check)
{
    ...
    $order[$key]['data'] = array("class" => "order" . strtolower($order[$key]['order']), //
...
{
    $array_user[] = array("key" => $user['userid'], //
        "title" => $user['username'], //
