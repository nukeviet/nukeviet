...
namespace NukeViet\NukeVietElasticSearch;
use Elasticsearch;
...
class Functions
{
	...
	{
	    $hosts = array( $elas_host . ':' . $elas_port );
	    $this->_client = Elasticsearch\ClientBuilder::create( )->setHosts( $hosts )->setRetries( 0 )->build();
