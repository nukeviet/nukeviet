...
class Diagnostic
{
     ...
     * @return
     */
    public function __construct($_pattern = array())
    {
        if (isset($_pattern['PageRank'])) {
            $this->$pattern['PageRank'] = $_pattern['PageRank'];
        }
        if (isset($_pattern['AlexaRank'])) {
            $this->$pattern['AlexaRank'] = $_pattern['AlexaRank'];
        }
        if (isset($_pattern['GoogleBackLink'])) {
            $this->$pattern['GoogleBackLink'] = $_pattern['GoogleBackLink'];
        }
        if (isset($_pattern['GoogleIndexed'])) {
            $this->$pattern['GoogleIndexed'] = $_pattern['GoogleIndexed'];
        }
        if (isset($_pattern['BingBackLink'])) {
            $this->$pattern['BingBackLink'] = $_pattern['BingBackLink'];
        }
        if (isset($_pattern['BingIndexed'])) {
            $this->$pattern['BingIndexed'] = $_pattern['BingIndexed'];
        }
