...
class Zalo
{
    public const ERROR_OA_ID_EMPTY = 'oa_id_empty';
    public const ERROR_REDIRECT_URI_EMPTY = 'redirect_uri_empty';
    public const ERROR_APP_ID_EMPTY = 'app_id_empty';
    public const ERROR_APP_SECKEY_EMPTY = 'app_seckey_empty';
    public const ERROR_REFRESH_TOKEN_EMPTY = 'refresh_token_empty';
    public const ERROR_NOT_RESPONSE = 'not_response';
    public const ERROR_OA_ID_INCORRECT = 'oa_id_incorrect';
    public const ERROR_REFRESH_TOKEN_EXP = 'refresh_token_expired';

    public const PERMISSION_URL = 'https://oauth.zaloapp.com/v4/permission?';
    public const OA_PERMISSION_URL = 'https://oauth.zaloapp.com/v4/oa/permission?';
    public const OA_GET_ACCESSTOKEN_URL = 'https://oauth.zaloapp.com/v4/oa/access_token';
    public const OA_GET_OAINFO_URL = 'https://openapi.zalo.me/v2.0/oa/getoa';
    public const OA_GET_FOLLOWERS_URL = 'https://openapi.zalo.me/v2.0/oa/getfollowers?';
    public const OA_GET_FOLLOWER_PROFILE_URL = 'https://openapi.zalo.me/v2.0/oa/getprofile?';
    public const OA_UPDATE_FOLLOWERINFO_URL = 'https://openapi.zalo.me/v2.0/oa/updatefollowerinfo';
    public const OA_TAGFOLLOWER_URL = 'https://openapi.zalo.me/v2.0/oa/tag/tagfollower';
    public const OA_RMFOLLOWERFROMTAG_URL = 'https://openapi.zalo.me/v2.0/oa/tag/rmfollowerfromtag';
    public const OA_GETTAGSOFOA_URL = 'https://openapi.zalo.me/v2.0/oa/tag/gettagsofoa';
    public const OA_RMTAG_URL = 'https://openapi.zalo.me/v2.0/oa/tag/rmtag';
    public const CONVERSATION_URL = 'https://openapi.zalo.me/v2.0/oa/conversation?';
    public const LISTRECENTCHAT_URL = 'https://openapi.zalo.me/v2.0/oa/listrecentchat?';
    public const QUOTA_MESSAGE_URL = 'https://openapi.zalo.me/v2.0/oa/quota/message';
    public const MESSAGE_SEND_URL = 'https://openapi.zalo.me/v2.0/oa/message';
    public const UPLOAD_URL = 'https://openapi.zalo.me/v2.0/oa/upload/';
    public const VIDEOUPLOAD_URL = 'https://openapi.zalo.me/v2.0/article/upload_video/preparevideo';
    public const VIDEOUPLOAD_VERIFY_URL = 'https://openapi.zalo.me/v2.0/article/upload_video/verify';
    public const ARTICLE_CREATE_URL = 'https://openapi.zalo.me/v2.0/article/create';
    public const ARTICLE_GETID_URL = 'https://openapi.zalo.me/v2.0/article/verify';
    public const ARTICLE_REMOVE_URL = 'https://openapi.zalo.me/v2.0/article/remove';
    public const ARTICLE_VIDEO_UPDATE_URL = 'https://openapi.zalo.me/v2.0/article/video/update';
    public const ARTICLE_UPDATE_URL = 'https://openapi.zalo.me/v2.0/article/update';
    public const ARTICLE_GETDETAIL_URL = 'https://openapi.zalo.me/v2.0/article/getdetail';
    public const ARTICLE_GETLIST_URL = 'https://openapi.zalo.me/v2.0/article/getslice?';
    public const GET_ACCESSTOKEN_URL = 'https://oauth.zaloapp.com/v4/access_token';
    public const GET_USERINO_URL = 'https://graph.zalo.me/v2.0/me?';
