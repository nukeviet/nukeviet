...
class UsersUserAddCest
{
    ...
    private const PROFILES = [
        ['last' => 'Nguyễn', 'first' => 'Văn An',   'slug' => 'nguyen_van_an'],
        ['last' => 'Trần',   'first' => 'Thị Bình',  'slug' => 'tran_thi_binh'],
        ['last' => 'Lê',     'first' => 'Văn Cường', 'slug' => 'le_van_cuong'],
        ['last' => 'Phạm',   'first' => 'Thị Dung',  'slug' => 'pham_thi_dung'],
        ['last' => 'Hoàng',  'first' => 'Minh Đức',  'slug' => 'hoang_minh_duc'],
        ['last' => 'Vũ',     'first' => 'Thị Hà',    'slug' => 'vu_thi_ha'],
        ['last' => 'Đặng',   'first' => 'Văn Hùng',  'slug' => 'dang_van_hung'],
        ['last' => 'Bùi',    'first' => 'Thị Lan',   'slug' => 'bui_thi_lan'],
        ['last' => 'Đỗ',     'first' => 'Quang Minh','slug' => 'do_quang_minh'],
        ['last' => 'Hồ',     'first' => 'Thị Ngọc',  'slug' => 'ho_thi_ngoc'],
    ];
