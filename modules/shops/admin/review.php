...
{
	$view['link_product'] = NV_BASE_SITEURL . 'index.php?' . NV_LANG_VARIABLE . '=' . NV_LANG_DATA . '&amp;' . NV_NAME_VARIABLE . '=' . $module_name . '&amp;' . NV_OP_VARIABLE . '=' . $global_array_cat[$view['listcatid']]['alias'] . '/' . $view['alias'] . '-' . $view['product_id'] . $global_config['rewrite_exturl'];
