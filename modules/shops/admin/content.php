...
{
	$form = 'cat_form_' . $global_array_shops_cat[$rowcontent['listcatid']]['form'] . '.tpl';
	if( nv_is_file( NV_BASE_SITEURL . NV_ASSETS_DIR . '/' . $module_name . '/files_tpl/' . $form, NV_ASSETS_DIR . '/' . $module_name ) )
	{
