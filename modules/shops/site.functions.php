...
// Groups
$sql = 'SELECT groupid, parentid, cateid, lev, ' . NV_LANG_DATA . '_title AS title, ' . NV_LANG_DATA . '_alias AS alias, viewgroup, numsubgroup, subgroupid, ' . NV_LANG_DATA . '_description AS description, inhome, in_order, ' . NV_LANG_DATA . '_keywords AS keywords, numpro FROM ' . $db_config['prefix'] . '_' . $module_data . '_group ORDER BY sort ASC';
