...
if( $allowed )
{
        ...
        // Fetch Limit
        $db->sqlreset()
          ->select( " id, " . NV_LANG_DATA . "_title, " . NV_LANG_DATA . "_alias, homeimgfile, homeimgthumb, addtime, product_code, product_price, product_discounts, money_unit, showprice, " . NV_LANG_DATA . "_hometext " )
