...
$contents['rows']['title'] = array(
	$lang_module['title'],
	$row['title']
);
$contents['rows']['blang'] = array(
	$lang_module['blang'],
	( ! empty( $row['blang'] )) ? $language_array[$row['blang']]['name'] : $lang_module['blang_all']
);
$contents['rows']['form'] = array(
	$lang_module['form'],
	$row['form']
);
$contents['rows']['size'] = array(
	$lang_module['size'],
	$row['width'] . ' x ' . $row['height'] . 'px'
);
$contents['rows']['is_act'] = array(
	$lang_module['is_act'],
	$row['act'] ? $lang_global['yes'] : $lang_global['no']
);

if( ! empty( $row['description'] ) )
	$contents['rows']['description'] = array(
		$lang_module['description'],
		$row['description']
	);

$contents['edit'] = array(
	NV_BASE_ADMINURL . "index.php?" . NV_NAME_VARIABLE . "=" . $module_name . "&amp;" . NV_OP_VARIABLE . "=edit_plan&amp;id=" . $id,
	$lang_global['edit']
);
$contents['add'] = array(
	NV_BASE_ADMINURL . "index.php?" . NV_NAME_VARIABLE . "=" . $module_name . "&amp;" . NV_OP_VARIABLE . "=add_banner&amp;pid=" . $id,
