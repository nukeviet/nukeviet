...
$contents['rows'][] = array(
	$lang_module['email'],
	nv_EncodeEmail( $row['email'] )
);
$contents['rows'][] = array(
	$lang_module['reg_time'],
	nv_date( "d/m/Y H:i", $row['reg_time'] )
);
...
$contents['edit'] = array(
	NV_BASE_ADMINURL . "index.php?" . NV_NAME_VARIABLE . "=" . $module_name . "&amp;" . NV_OP_VARIABLE . "=edit_client&amp;id=" . $id,
	$lang_global['edit']
);
$contents['add'] = array(
	NV_BASE_ADMINURL . "index.php?" . NV_NAME_VARIABLE . "=" . $module_name . "&amp;" . NV_OP_VARIABLE . "=add_banner&amp;clid=" . $id,
