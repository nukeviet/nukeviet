...
if( defined( 'NV_IS_BANNER_CLIENT' ) )
{
	...
	if( $nv_Request->isset_request( 'confirm', 'post' ) )
	{
		...
		else
		{
			...
			$sql = "INSERT INTO `" . NV_BANNERS_ROWS_GLOBALTABLE . "` (`id`, `title`, `pid`, `clid`, `file_name`, `file_ext`, `file_mime`, `width`, `height`, `file_alt`, `click_url`, `add_time`, `publ_time`, `exp_time`, `hits_total`, `act`, `weight`) VALUES 
