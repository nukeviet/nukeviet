...
$contents['rows']['login'] = array(
	$lang_module['login'],
	$banner_client_info['login']
);
$contents['rows']['email'] = array(
	$lang_global['email'],
	nv_EncodeEmail( $banner_client_info['email'] )
);
$contents['rows']['full_name'] = array(
	$lang_global['full_name'],
	$banner_client_info['full_name']
);
$contents['rows']['reg_time'] = array(
	$lang_module['reg_time'],
	nv_date( "d/m/Y H:i", $banner_client_info['reg_time'] )
);
...
if( ! empty( $banner_client_info['website'] ) and nv_is_url( $banner_client_info['website'] ) )
{
	$contents['rows']['website'] = array(
		$lang_module['website'],
		"<a href=\"" . $banner_client_info['website'] . "\" target=\"_blank\">" . $banner_client_info['website'] . "</a>"
	);
}
...
{
	$contents['rows']['last_login'] = array(
		$lang_global['last_login'],
		nv_date( "d/m/Y H:i", $banner_client_info['last_login'] ) . " (" . $lang_module['ip'] . ": " . $banner_client_info['last_ip'] . ")"
	);
}

$manament = array();
$manament['current_login'] = array(
	$lang_global['current_login'],
	nv_date( "d/m/Y H:i", $banner_client_info['current_login'] ) . " (" . $lang_module['ip'] . ": " . $banner_client_info['current_ip'] . ")"
);
