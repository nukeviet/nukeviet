...
// Cache dung tai tat ca cac giao dien
...
if( ! empty( $abouts ) )
{
	...
	if( ! empty( $alias ) and isset( $abouts[$alias] ) )
	{
		...
		$nv_vertical_menu[] = array(
			$abouts[$alias]['title'],
			NV_BASE_SITEURL . "index.php?" . NV_LANG_VARIABLE . "=" . NV_LANG_DATA . "&amp;" . NV_NAME_VARIABLE . "=" . $module_name . "&amp;" . NV_OP_VARIABLE . "=" . $abouts[$alias]['alias'],
			1
		);
		unset( $abouts[$alias] );
	}
	else
	{
		...
		$nv_vertical_menu[] = array(
			$about['title'],
			NV_BASE_SITEURL . "index.php?" . NV_LANG_VARIABLE . "=" . NV_LANG_DATA . "&amp;" . NV_NAME_VARIABLE . "=" . $module_name . "&amp;" . NV_OP_VARIABLE . "=" . $about['alias'],
			1
		);
	}
	...
	if( ! empty( $abouts ) )
	{
		foreach( $abouts as $about )
		{
			...
			$ab_links[] = array(
				"title" => $about['title'],
				"link" => NV_BASE_SITEURL . "index.php?" . NV_LANG_VARIABLE . "=" . NV_LANG_DATA . "&amp;" . NV_NAME_VARIABLE . "=" . $module_name . "&amp;" . NV_OP_VARIABLE . "=" . $about['alias']
			);
		}
	}
}
