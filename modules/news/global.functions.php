...
function nv_link_edit_page( $id )
{
	...
	$link = "<a class=\"btn btn-primary\" href=\"" . NV_BASE_ADMINURL . "index.php?" . NV_LANG_VARIABLE . "=" . NV_LANG_DATA . "&amp;" . NV_NAME_VARIABLE . "=" . $module_name . "&amp;" . NV_OP_VARIABLE . "=content&amp;id=" . $id . "\"><em class=\"fa fa-edit fa-lg margin-right\"></em>" . $lang_global['edit'] . "</a>";
	return $link;
}
...
{
	global $lang_global, $module_name;
	$link = "<a class=\"btn btn-danger\" href=\"javascript:void(0);\" onclick=\"nv_del_content(" . $id . ", '" . md5( $id . session_id() ) . "','" . NV_BASE_ADMINURL . "', " . $detail . ")\"><em class=\"fa fa-trash-o fa-lg margin-right\"></em>" . $lang_global['delete'] . "</a>";
	return $link;
}
