...
$lang_module['setting_history'] = 'Lưu thông tin lịch sử chỉnh sửa bài viết';
...
$lang_module['no_history'] = 'Chưa có lịch sửa thay đổi phiên bản.';
$lang_module['stt'] = 'STT';
$lang_module['title_new'] = 'Tên bài viết';
$lang_module['user_change'] = 'Người sửa đổi';
$lang_module['time_history'] = 'Thời gian lịch sử';
$lang_module['info_backup'] = 'Thông tin khôi phục';
$lang_module['action_form'] = 'Tác vụ';
$lang_module['restored'] = 'Đã khôi phục';
$lang_module['version'] = 'Phiên bản';
$lang_module['version_old'] = 'Phiên bản cũ';
$lang_module['version_active'] = 'Phiên bản đang hoạt động';
$lang_module['restore'] = 'Khôi phục';
$lang_module['title_history_modal'] = 'Lịch sử thay đổi phiên bản';
$lang_module['title_close'] = 'Đóng';
$lang_module['title_wait_backup'] = 'Đang khôi phục bài viết';
$lang_module['title_success_backup'] = 'Đã khôi phục bài viết thành công';
$lang_module['title_action_history'] = 'Lịch sử';
$lang_module['config_restore_history'] = 'Bạn có muốn khôi phục phiên bản bài viết này không?';
