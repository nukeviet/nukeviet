...
$lang_module['error_select_date'] = "Erreur: vous n'avez pas sélectionné de type d'heure de recherche";
$lang_module['error_to_date'] = "Erreur: L'heure à ce jour est inférieure à l'heure à partir de la date";
...
$lang_module['no_history'] = 'Aucun calendrier de révision pour le moment.';
$lang_module['stt'] = 'STT';
$lang_module['title_new'] = 'Nom du message' ;
$lang_module['user_change'] = 'Modificateur';
$lang_module['time_history'] = 'Heure de l\'historique';
$lang_module['info_backup'] = 'Restaurer les informations';
$lang_module['action_form'] = 'Action';
$lang_module['restored'] = 'Restauré';
$lang_module['version'] = 'Version';
$lang_module['version_old'] = 'Ancienne version';
$lang_module['version_active'] = 'Version active';
$lang_module['restore'] = 'Restaurer';
$lang_module['title_history_modal'] = 'Historique des changements de version';
$lang_module['title_close'] = 'Fermer';
$lang_module['title_wait_backup'] = 'Articles restaurés' ;
$lang_module['title_success_backup'] = 'Messages restaurés avec succès';
$lang_module['title_action_history'] = 'Historique';
