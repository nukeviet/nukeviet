...
elseif( defined( 'NV_IS_USER' ) )
{
	...
	foreach( $array_catpage as $array_row_i )
	{
		...
		{
			$array_link_content[] = "<em class=\"fa fa-edit\">&nbsp;</em> <a href=\"" . $base_url . "&amp;contentid=" . $id . "&amp;checkss=" . md5( $id . $client_info['session_id'] . $global_config['sitekey'] ) . "\">" . $lang_global['edit'] . "</a>";
		}

		if( $array_row_i['is_del_content'] )
		{
			$array_link_content[] = "<em class=\"fa fa-trash-o\">&nbsp;</em> <a onclick=\"return confirm(nv_is_del_confirm[0]);\" href=\"" . $base_url . "&amp;contentid=" . $id . "&amp;delcontent=1&amp;checkss=" . md5( $id . $client_info['session_id'] . $global_config['sitekey'] ) . "\">" . $lang_global['delete'] . "</a>";
		}
