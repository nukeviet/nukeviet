...
if ( $module_config[$m_values['module_name']]['use_elas'] == 1 )  {

    $nukeVietElasticSearh = new NukeViet\NukeVietElasticSearch\Functions( $module_config[$m_values['module_name']]['elas_host'], $module_config[$m_values['module_name']]['elas_port'], $module_config[$m_values['module_name']]['elas_index'] );
