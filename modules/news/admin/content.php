...
if ($rowcontent['id'] > 0) {
    ...
    $body_contents['voicedata'] = !empty($body_contents['voicedata']) ? json_decode($body_contents['voicedata'], true) : [];
        ...
        if ($rowcontent['id'] == 0 or $copy) {
            ...
            if ($rowcontent['id'] > 0) {
                ...
                $stmt = $db->prepare('INSERT INTO ' . NV_PREFIXLANG . '_' . $module_data . '_detail (
                    id, titlesite, description, bodyhtml, voicedata, keywords, sourcetext, files, imgposition, layout_func,
