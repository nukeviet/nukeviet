...
if (file_exists(NV_ROOTDIR . '/themes/' . $module_info['template'] . '/modules/' . $module_info['module_theme'] . '/block_add_topic.tpl')) {
    $block_theme = $module_info['template'];
} else {
    $block_theme = 'default';
}
$xtpl = new XTemplate('block_add_topic.tpl', NV_ROOTDIR . '/themes/' . $block_theme . '/modules/' . $module_file);
