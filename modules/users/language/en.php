...
$lang_module['account_active_info'] = 'Hi %1$s,<br /><br />Your account at website %2$s waitting to activate. To activate, please click link follow:<br /><br />URL: <a href="%3$s">%3$s</a><br /><br />Account information:<br /><br />Username: %4$s<br />Email: %5$s<br /><br />Activate expired on %6$s<br /><br />This is email automatic sending from website %2$s.<br /><br />Site administrator';
...
$lang_module['adduser_register_info_with_password'] = 'Hi %1$s,<br />Your account at website %2$s activated. Your login information:<br />URL: <a href="%3$s">%3$s</a><br />Username: %4$s<br />Password: %5$s<br /><br />This is email automatic sending from website %2$s.<br />Site administrator';
...
$lang_module['adduser_register_openid_info_with_password'] = 'Hi %1$s,<br /><br />Your account at website %2$s activated.<br />To log into your account please visit the page: <a href="%3$s">%3$s</a> and press the button: Sign in with %4$s.<br />You can also log in using the usual method with the following information:<br />Username: %5$s<br />Password: %6$s<br /><br />This is email automatic sending from website %2$s.<br /><br />Site administrator';
$lang_module['adduser_register_info1'] = 'Hello %1$s,<br /><br /> Your account at website %2$s has been created. Here are the logins: <br /><br />URL: <a href="%3$s">%3$s</a><br /> Username: %4$s<br /> < Password: %5$s<br />%6$s<br />This is an automated message sent to Your email box from %2$s. website. If you do not understand the content of this letter, simply delete it. <br /> <br /> Site Admin';
$lang_module['adduser_register_info2'] = 'Hello %1$s,<br /><br /> Your account at website %2$s has been updated. Here are the login information: <br /><br />URL: <a href="%3$s">%3$s</a><br /> Username: %4$s';
$lang_module['adduser_register_info3'] = '<br /> Password: %1$s';
$lang_module['adduser_register_info4'] = '<br />%1$s<br />This is an automated message sent to your email from %2$s. If you do not understand the content of this letter, simply delete it. <br /> <br /> Site Admin';
...
$lang_module['pass_reset_request_info1'] = 'Hello %1$s,<br /><br />The %2$s website administration informs: For security reasons, you need to change your account password as soon as possible. To change your password, you need to first visit the Manage Personal Account page (%3$s), select the Account Settings button, then the Password button, and follow the instructions.<br /><br />Site Admin';
$lang_module['pass_reset_request_info2'] = 'Hello %1$s,<br /><br />The %2$s website administration informs: For security reasons, we recommend that you change your account password. To change your password, you need to first visit the Manage Personal Account page (%3$s), select the Account Settings button, then the Password button, and follow the instructions.<br /><br />Site Admin';
...
$lang_module['admin_adduser_register_info'] = 'Hi %1$s,<br /><br />Your account at website %2$s activated. Your login information:<br /><br />URL: <a href="%3$s">%3$s</a><br />Username: %4$s<br /><br />This is email automatic sending from website %2$s.<br />Site administrator';
...
$lang_module['remove_2step_verifykey_content'] = 'Hello %1$s,<br /><br />We have received a request to turn off 2-step verification for your account at the %2$s website. If you sent this request yourself, please use the Verification Code below to proceed:<br /><br />Verification Code: %3$s<br /><br />This is email automatic sending from website %2$s.<br />Site administrator';
$lang_module['remove_2step_subject'] = '2-Step Verification is turned off';
$lang_module['remove_2step_content'] = 'Hello %1$s,<br /><br />At your request, we have turned off 2-Step Verification for your account at the %2$s website.<br /><br />This is email automatic sending from website %2$s.<br />Site administrator';
