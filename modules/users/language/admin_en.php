...
$lang_module['adduser_register_info'] = 'Hi %1$s,<br />Your account at website %2$s activated. Your login information:<br />URL: <a href="%3$s">%3$s</a><br />Username: %4$s<br /><br />This is email automatic sending from website %2$s.<br />Site administrator';
...
$lang_module['openid_processing_connect'] = 'Guest connects a third-party account to an existing account';
$lang_module['openid_processing_create'] = 'Guest creates a new account to connect it to a third party account';
$lang_module['openid_processing_auto'] = 'The system automatically creates a new account to connect it to a third-party account';
...
$lang_module['error_not_groups'] = 'There are no groups to be established. <a href="%s">Click here</a> to create a group';
