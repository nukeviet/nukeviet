...
$lang_module['edit_password_note2'] = 'Note: Changing the password does not log the user out of existing sessions. If you want to force logout, select the &quot;Force logout&quot; option above';
...
$lang_module['adduser_register_info'] = 'Hi %1$s,<br />Your account at website %2$s activated. Your login information:<br />URL: <a href="%3$s">%3$s</a><br />Account: %4$s<br />This is email automatic sending from website %2$s.<br />Site administrator';
...
$lang_module['force_logout'] = 'Force logout';
$lang_module['force_logout1'] = 'Log out of all user area login sessions';
