...
$lang_module['openid_confirm_info'] = 'OpenID của bạn chưa được đăng ký trên website này, nhưng email %s đã được sử dụng.<br />Nếu tài khoản sử dụng email này là của bạn, hãy xác nhận bằng cách khai báo mật khẩu đăng nhập.<br />Nếu mật khẩu được khẳng định, kể từ lần đăng nhập sau bạn sẽ không phải thực hiện thao tác này';
...
$lang_module['edit_email_warning'] = 'Để thay đổi email, bạn cần khai báo lại mật khẩu và nhập mã xác minh được gửi đến email mới.';
...
$lang_module['safe_activate'] = 'Bặt chế độ an toàn';
...
$lang_module['safe_activate_info'] = 'Chế độ an toàn sẽ giúp cho bạn tránh được những thay đổi thông tin tài khoản. Khi bạn kích hoạt chế độ an toàn, hệ thống sẽ gửi đến email của bạn một mã xác minh. Mã xác minh này cũng được dùng để tắt chế độ an toàn. Nó có hiệu lực trong khoảng thời gian giữa hai lần bật - tắt. Sau khi bạn tắt chế độ an toàn, mã xác minh này sẽ vô giá trị.';
$lang_module['safe_deactivate_info'] = 'Để tắt chế độ an toàn bạn cần khai báo mã xác minh và mật khẩu. Mã xác minh đã được gửi đến email của bạn khi bạn bật chế độ an toàn.';
