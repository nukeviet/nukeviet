...
$lang_module['lostpass_title'] = 'Nếu bạn quên Mật khẩu tài khoản';
...
$lang_module['na'] = 'N/A';
$lang_module['account'] = 'Tên tài khoản';
...
$lang_module['avatar_error_data'] = 'Lỗi: Dữ liệu không đầy đủ. Vui lòng thửz lại lần nữa!';
$lang_module['avatar_error_save'] = 'Lỗi: Hệ thống không thực hiện được yêu cầu. Vui lòng thử lại lần nữa!';
...
$lang_module['logout_ok'] = 'Bạn đã đăng xuất thành công khỏi tài khoản thành viên. Hy vọng bạn sẽ sớm trở lại!';
...
$lang_module['lostpass_info'] = 'Bạn đã quên mật khẩu tài khoản?';
...
$lang_module['account_active_mess'] = 'Tài khoản của bạn đã được tạo và đang đợi kích hoạt.<br />Chúng tôi đã gửi đến e-mail của bạn các thông tin cần thiết.<br />Hãy làm theo hướng dẫn để kích hoạt tài khoản. Nếu bạn không tìm thấy thư trong hộp thư đến, vui lòng kiểm tra thư mục spam';
...
$lang_module['openid_note4'] = 'Tạo tài khoản mới';
$lang_module['openid_note5'] = 'Gán vào tài khoản đã có';
...
$lang_module['change_name_info'] = 'Chú ý: Đây là lần duy nhất bạn có quyền thay đổi tên tài khoản. Chức năng này sẽ bị tắt kể từ lần đăng nhập sau. Hãy click <a href="%s">vào đây</a> để thay đổi';
...
$lang_module['error_update_users_info'] = 'Rất tiếc là hệ thống không thể cập nhật thông tin thành viên của bạn. Vui lòng liên hệ với quản trị site để được hướng dẫn.';
...
$lang_module['listusers_sort_by_username'] = 'tên tài khoản';
...
$lang_module['edit_login'] = 'Tên tài khoản';
$lang_module['edit_email'] = 'Email';
$lang_module['edit_question'] = 'Câu hỏi bảo mật';
$lang_module['edit_password'] = 'Mật khẩu';
$lang_module['edit_login_warning'] = 'Để thay đổi tên tài khoản, bạn cần khai báo lại mật khẩu.';
...
$lang_module['edit_question_warning'] = 'Vui lòng hoàn thành các trường bên dưới để tạo câu hỏi và câu trả lời bảo mật mới (thay thế cho câu hỏi và câu trả lời bảo mật cũ).';
$lang_module['edit_password_warning'] = 'Để thay đổi mật khẩu, bạn cần khai báo lại mật khẩu cũ.';
$lang_module['newlogin'] = 'Tên tài khoản mới';
$lang_module['newemail'] = 'Email mới';
$lang_module['newquestion'] = 'Câu hỏi bảo mật mới';
$lang_module['currentlogin'] = 'Tên tài khoản hiện tại';
...
$lang_module['safe_deactivate_openidlogin'] = 'Rất tiếc là tài khoản tạm thời không hỗ trợ OpenID. Hãy đăng nhập bằng cách khai báo tên tài khoản và mật khẩu.';
$lang_module['safe_deactivate_openidreg'] = 'Email của OpenID mà bạn vừa khai báo đã được gắn với một tài khoản trên website này. Nhưng rất tiếc là tài khoản đó hiện không hỗ trợ OpenID. Nếu đây là tài khoản của bạn, vui lòng đăng nhập bằng cách khai báo tên tài khoản và mật khẩu.';
...
$lang_module['changelogin_notvalid'] = 'Tài khoản chưa có mật khẩu nên không thể thay đổi tên tài khoản. Hãy tạo mật khẩu sau đó quay lại trang này.';
