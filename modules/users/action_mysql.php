...
if ($module_data != 'users' or empty($_arr_table_module)) {
    ...
    if ($module_data == 'users') {
        $sql_create_module[] = "INSERT INTO " . $db_config['prefix'] . "_" . $module_data . "_groups (group_id, title, description, content, group_type, group_color, group_avatar, is_default, add_time, exp_time, weight, act, idsite, numbers, siteus) VALUES (1, 'Super admin', 'Super Admin', '', 0, '', '', 0, " . NV_CURRENTTIME . ", 0, 1, 1, 0, 1, 0)";
        $sql_create_module[] = "INSERT INTO " . $db_config['prefix'] . "_" . $module_data . "_groups (group_id, title, description, content, group_type, group_color, group_avatar, is_default, add_time, exp_time, weight, act, idsite, numbers, siteus) VALUES (2, 'General admin', 'General Admin', '', 0, '', '', 0, " . NV_CURRENTTIME . ", 0, 2, 1, 0, 0, 0)";
        $sql_create_module[] = "INSERT INTO " . $db_config['prefix'] . "_" . $module_data . "_groups (group_id, title, description, content, group_type, group_color, group_avatar, is_default, add_time, exp_time, weight, act, idsite, numbers, siteus) VALUES (3, 'Module admin', 'Module Admin', '', 0, '', '', 0, " . NV_CURRENTTIME . ", 0, 3, 1, 0, 0, 0)";
        $sql_create_module[] = "INSERT INTO " . $db_config['prefix'] . "_" . $module_data . "_groups (group_id, title, description, content, group_type, group_color, group_avatar, is_default, add_time, exp_time, weight, act, idsite, numbers, siteus) VALUES (4, 'Users', 'Users', '', 0, '', '', 0, " . NV_CURRENTTIME . ", 0, 4, 1, 0, 1, 0)";
        $sql_create_module[] = "INSERT INTO " . $db_config['prefix'] . "_" . $module_data . "_groups (group_id, title, description, content, group_type, group_color, group_avatar, is_default, add_time, exp_time, weight, act, idsite, numbers, siteus) VALUES (7, 'New Users', 'New Users', '', 0, '', '', 0, " . NV_CURRENTTIME . ", 0, 5, 1, 0, 0, 0)";
        $sql_create_module[] = "INSERT INTO " . $db_config['prefix'] . "_" . $module_data . "_groups (group_id, title, description, content, group_type, group_color, group_avatar, is_default, add_time, exp_time, weight, act, idsite, numbers, siteus) VALUES (5, 'Guest', 'Guest', '', 0, '', '', 0, " . NV_CURRENTTIME . ", 0, 6, 1, 0, 0, 0)";
        $sql_create_module[] = "INSERT INTO " . $db_config['prefix'] . "_" . $module_data . "_groups (group_id, title, description, content, group_type, group_color, group_avatar, is_default, add_time, exp_time, weight, act, idsite, numbers, siteus) VALUES (6, 'All', 'All', '', 0, '', '', 0, " . NV_CURRENTTIME . ", 0, 7, 1, 0, 0, 0)";
    }
    $sql_create_module[] = "INSERT INTO " . $db_config['prefix'] . "_" . $module_data . "_groups (group_id, title, description, content, group_type, group_color, group_avatar, is_default, add_time, exp_time, weight, act, idsite, numbers, siteus) VALUES (10, 'NukeViet-Fans', '" . $my_lang['groups']['NukeViet-Fans'] . "', '', 2, '', '', 1, " . NV_CURRENTTIME . ", 0, 8, 1, 0, 0, 0)";
    $sql_create_module[] = "INSERT INTO " . $db_config['prefix'] . "_" . $module_data . "_groups (group_id, title, description, content, group_type, group_color, group_avatar, is_default, add_time, exp_time, weight, act, idsite, numbers, siteus) VALUES (11, 'NukeViet-Admins', '" . $my_lang['groups']['NukeViet-Admins'] . "', '', 2, '', '', 0, " . NV_CURRENTTIME . ", 0, 9, 1, 0, 0, 0)";
    $sql_create_module[] = "INSERT INTO " . $db_config['prefix'] . "_" . $module_data . "_groups (group_id, title, description, content, group_type, group_color, group_avatar, is_default, add_time, exp_time, weight, act, idsite, numbers, siteus) VALUES (12, 'NukeViet-Programmers', '" . $my_lang['groups']['NukeViet-Programmers'] . "', '', 1, '', '', 0, " . NV_CURRENTTIME . ", 0, 10, 1, 0, 0, 0)";
} else {
...
if ($lang == 'vi') {
    $sql_create_module[] = "INSERT INTO " . $db_config['prefix'] . "_" . $module_data . "_question (title, lang, weight, add_time, edit_time) VALUES('Bạn thích môn thể thao nào nhất', '" . $lang . "', 1, 1274840238, 1274840238)";
    $sql_create_module[] = "INSERT INTO " . $db_config['prefix'] . "_" . $module_data . "_question (title, lang, weight, add_time, edit_time) VALUES('Món ăn mà bạn yêu thích', '" . $lang . "', 2, 1274840250, 1274840250)";
    $sql_create_module[] = "INSERT INTO " . $db_config['prefix'] . "_" . $module_data . "_question (title, lang, weight, add_time, edit_time) VALUES('Thần tượng điện ảnh của bạn', '" . $lang . "', 3, 1274840257, 1274840257)";
    $sql_create_module[] = "INSERT INTO " . $db_config['prefix'] . "_" . $module_data . "_question (title, lang, weight, add_time, edit_time) VALUES('Bạn thích nhạc sỹ nào nhất', '" . $lang . "', 4, 1274840264, 1274840264)";
    $sql_create_module[] = "INSERT INTO " . $db_config['prefix'] . "_" . $module_data . "_question (title, lang, weight, add_time, edit_time) VALUES('Quê ngoại của bạn ở đâu', '" . $lang . "', 5, 1274840270, 1274840270)";
    $sql_create_module[] = "INSERT INTO " . $db_config['prefix'] . "_" . $module_data . "_question (title, lang, weight, add_time, edit_time) VALUES('Tên cuốn sách &quot;gối đầu giường&quot;', '" . $lang . "', 6, 1274840278, 1274840278)";
    $sql_create_module[] = "INSERT INTO " . $db_config['prefix'] . "_" . $module_data . "_question (title, lang, weight, add_time, edit_time) VALUES('Ngày lễ mà bạn luôn mong đợi', '" . $lang . "', 7, 1274840285, 1274840285)";
