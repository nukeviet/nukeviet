...
if ($nv_Request->isset_request('submit', 'get')) {
    ...
    if (!$is_null) {
        ...
        $ordertitlea = array(
            "url" => ($ordertitle == "ASC") ? $base_url . "&amp;ordertitle=DESC" : $base_url . "&amp;ordertitle=ASC",
            "class" => ($ordertitle == "") ? "nooder" : strtolower($ordertitle)
        );
        
        $ordercodea = array(
            "url" => ($ordercode == "ASC") ? $base_url . "&amp;ordercode=DESC" : $base_url . "&amp;ordercode=ASC",
            "class" => ($ordercode == "") ? "nooder" : strtolower($ordercode)
        );
        
        $orderaddtimea = array(
            "url" => ($orderaddtime == "ASC") ? $base_url . "&amp;orderaddtime=DESC" : $base_url . "&amp;orderaddtime=ASC",
