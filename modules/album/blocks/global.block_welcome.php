...
if (!nv_function_exists('nv_block_welcome')) {
     ...
     * @return string
     */
    function nv_block_config_welcome($module, $data_block, $lang_block)
    {
     ...
     * @return array
     */
    function nv_block_config_welcome_submit($module, $lang_block)
    {
        global $nv_Request;
        $return = [];
        $return['error'] = [];
    ...
    function nv_block_welcome($block_config)
    {
        ...
        if (!empty($list)) {
            if (file_exists(NV_ROOTDIR . '/themes/' . $global_config['module_theme'] . '/modules/news/block_welcome.tpl')) {
                $block_theme = $global_config['module_theme'];
            } else {
                $block_theme = 'default';
            }
            $xtpl = new XTemplate('block_welcome.tpl', NV_ROOTDIR . '/themes/' . $block_theme . '/modules/news');
