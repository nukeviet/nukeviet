...
$lang_module['sendinfo2'] = 'Ce message est envoyé par la fonction "Contact" du site %1$s.<br />Coordonnées de l’expéditeur<br /><strong>Nom complet</strong>: %2$s<br /><strong>E-mail</strong>: %3$s<br /><strong>Télephone</strong>: %4$s<br /><strong>IP</strong>: %5$s<br /><strong>Destinataire</strong>: %6$s';
