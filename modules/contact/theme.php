        ...
        foreach ( $array_department as $dep )
        {
            ...
            if ( ! empty( $dep['phone'] ) )
            {
                ...
                foreach ( $nums as $k => $num )
                {
                    ...
                    if ( $k ) $xtpl->parse( 'main.dep.phone.item.comma' );
            ...
            if ( ! empty( $dep['email'] ) )
            {
                ...
                foreach ( $emails as $k => $email )
                {
                    ...
                    if ( $k ) $xtpl->parse( 'main.dep.email.item.comma' );
                        ...
                        if ( ! empty( $value ) )
                        {
                            if ( strtolower( $key ) == "yahoo" )
                            {
                                ...
                                foreach ( $ys as $k => $y )
                                {
                                    ...
                                    if ( $k ) $xtpl->parse( 'main.dep.yahoo.item.comma' );
                            ...
                            elseif ( strtolower( $key ) == "skype" )
                            {
                                ...
                                foreach ( $ss as $k => $s )
                                {
                                    ...
                                    if ( $k ) $xtpl->parse( 'main.dep.skype.item.comma' );
                            ...
                            elseif ( strtolower( $key ) == "viber" )
                            {
                                ...
                                foreach ( $ss as $k => $s )
                                {
                                    ...
                                    if ( $k ) $xtpl->parse( 'main.dep.viber.item.comma' );
                            ...
                            elseif ( strtolower( $key ) == "icq" )
                            {
                                ...
                                foreach ( $ss as $k => $s )
                                {
                                    ...
                                    if ( $k ) $xtpl->parse( 'main.dep.icq.item.comma' );
                            ...
                            elseif ( strtolower( $key ) == "whatsapp" )
                            {
                                ...
                                foreach ( $ss as $k => $s )
                                {
                                    ...
                                    if ( $k ) $xtpl->parse( 'main.dep.whatsapp.item.comma' );
