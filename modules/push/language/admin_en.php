...
$lang_module['main_title'] = 'Push-Notification';
$lang_module['configs'] = 'Configuration';
$lang_module['push_from_generaladmin'] = 'Push notifications sent from the system, user groups, or site administrators';
$lang_module['push_from_moduleadmin'] = 'Push notifications sent from you';
$lang_module['filter_by_criteria'] = 'Filter by criteria';
$lang_module['filter_all'] = 'All';
...
$lang_module['add_push'] = 'Create notification';
$lang_module['no_notifications'] = 'No notifications';
$lang_module['id'] = 'ID';
...
$lang_module['exp_time'] = 'Expired time';
$lang_module['from_group'] = 'Notification from user group';
$lang_module['from_admin'] = 'Notification from admin';
$lang_module['from_system'] = 'Notification from system';
...
$lang_module['to_group_all'] = 'To all group members';
$lang_module['view_more'] = 'View more';
$lang_module['unlimited'] = 'Unlimited';
$lang_module['push_link'] = 'Notification link';
$lang_module['push_add'] = 'Add push-notification';
$lang_module['push_edit'] = 'Edit push-notification';
...
$lang_module['expired'] = 'Expired';
$lang_module['delete_confirm'] = 'Do you really want to delete?';
$lang_module['push_active'] = 'Enable push-notifications';
$lang_module['push_default_exp'] = 'Default lifespan of push-notifications (in days)';
$lang_module['push_exp_del'] = 'Waiting time to delete expired push-notifications (in days)';
$lang_module['push_refresh_time'] = 'Waiting time to update new push-notification count (in seconds)';
$lang_module['push_max_characters'] = 'Number of characters of shortened push-notification';
