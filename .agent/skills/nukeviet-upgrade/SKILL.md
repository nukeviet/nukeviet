...
### Nâng cấp Module → `.agent/upgrade/module/`

| Lộ trình | File cần đọc (theo thứ tự) |
|---|---|
| 4.5.06 → 5.0.00 | `NV-4.5.06-len-5.0.00.md` |

### Nâng cấp Theme → `.agent/upgrade/theme/`
...
```
1. Tạo .agent/upgrade/module/NV-X.X.XX-len-X.X.XX.md
2. Tạo .agent/upgrade/theme/NV-X.X.XX-len-X.X.XX.md
3. Cập nhật bảng lộ trình trong file này (upgrade-guide.md)
4. Cập nhật bảng lộ trình trong .agent/ai-context.md
```
