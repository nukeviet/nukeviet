...
$lang_module['block_group_notice'] = "Lưu ý: <br />Nếu thay đổi một block thuộc 1 nhóm thì sẽ thay đổi toàn bộ các block khác thuộc nhóm đó. <br/>Nếu không muốn thay đổi các block khác cùng nhóm nhưng muốn tách các block ra thành nhóm mới hãy check vào nút Tách ra khỏi nhóm và tạo nhóm mới.";
