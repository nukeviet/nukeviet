...
$lang_module['block_group_notice'] = "Lưu ý: <br />Nếu thay đổi một block thuộc 1 nhóm thì sẽ thay đổi toàn bộ các block khác thuộc nhóm đó. <br/>Nếu không muốn thay đổi các block khác cùng nhóm thì hãy tách block ra thành nhóm mớibằng cách đánh dấu vào mục <i>Tách ra khỏi nhóm và tạo nhóm mới</i>.";
...
$lang_module['block_filename'] = "Chọn file";
$lang_module['block_default'] = "Mặc định";
$lang_module['block_exp_time'] = "Ngày hết hạn";
$lang_module['block_content'] = "Hoặc có nội dung sau";
...
$lang_module['block_error_title'] = "Bạn chưa khai báo tên block hoặc tên block trùng với một block hiện có !";
$lang_module['error_empty_title'] = "Bạn chưa khai báo tên của block";
$lang_module['error_invalid_url'] = "URL mà bạn đưa vào không đúng";
...
$lang_module['theme_created_activate_layout'] = "Lỗi: Bạn cần thiết lập layout cho giao diện này trước khi khích hoạt";
