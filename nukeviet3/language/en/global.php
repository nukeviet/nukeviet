...
$lang_global['admin_logout_question'] = "Are you sure to logout from administrator account ?";
...
$lang_global['nickname_empty'] = "Username has not been declared";
$lang_global['nicknamelong'] = "Username &ldquo;<strong>%1\$s</strong>&rdquo; too length. Limit &ldquo;<strong>%2\$d</strong>&rdquo; characters";
$lang_global['nicknameadjective'] = "Username &ldquo;<strong>%1\$s</strong>&rdquo; too short. Minimum &ldquo;<strong>%2\$d</strong>&rdquo; characters";
...
$lang_global['wednesday'] = "Wenesday";
...
$lang_global['directory_was_created'] = "Directory: %s has created successfully";
...
$lang_global['error_notice'] = "Notice";
...
$lang_global['error_sendmail_content'] = "The system has received some error messages. You please open the attached file for details.";
