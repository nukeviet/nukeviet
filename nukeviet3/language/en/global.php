...
$lang_global['nicknameincorrect'] = "Username &ldquo;<strong>%s</strong>&rdquo; is invalid. It only accept latin characters, numbers and underscore";
...
$lang_global['nicknamenospaces'] = "Username &ldquo;<strong>%s</strong>&rdquo; contains a space. Characters must be written together";
$lang_global['password_empty'] = "Password has not been declared";
$lang_global['passwordincorrect'] = "Password &ldquo;<strong>%s</strong>&rdquo; is invalid. It only accept latin characters, numbers and underscore";
...
$lang_global['passwordnospaces'] = "Password &ldquo;<strong>%s</strong>&rdquo; contains a space. The letter must be written together";
...
$lang_global['nickname'] = "User name";
...
$lang_global['non_existent_file'] = "Does not exist file or directory %s";
