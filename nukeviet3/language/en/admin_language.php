...
$lang_module['nv_lang_error_exit'] = "Error: The current language does not have to be read into the database, <br> <br> system will automatically switch to the configuration you need to read data in a language before other operations";
