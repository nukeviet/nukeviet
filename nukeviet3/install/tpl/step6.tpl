    ...
    <table cellspacing="0" summary="{LANG.website_info}">
        ...
        <tr>
            <th scope="row" class="spec">
                {LANG.sitename} <span class="highlight_red">*</span>
            </th>
            <td>
        ...
        <tr>
            <th scope="row" class="specalt">
                {LANG.admin_account} <span class="highlight_red">*</span>
            </th>
            <td class="alt">
                <input type="text" value="{DATA.nv_login}" name="nv_login" class="required" />
            </td>
            <td class="alt">{LANG.admin_account_note}</td>
        </tr>
        <tr>
            <th scope="row" class="spec">
                {LANG.admin_email} <span class="highlight_red">*</span>
            </th>
            <td>
                <input type="text" value="{DATA.nv_email}" name="nv_email" class="required email" />
            </td>
...
<ul class="control_t fr">
    <li>
        <span class="back_step"><a href="{BASE_SITEURL}index.php?{LANG_VARIABLE}={CURRENTLANG}&amp;step=5">{LANG.previous}</a></span>
    </li>
    <!-- BEGIN: nextstep -->
    <li>
        <span class="next_step"><a href="{BASE_SITEURL}index.php?{LANG_VARIABLE}={CURRENTLANG}&amp;step=7">{LANG.next_step}</a></span>
    </li>
    <!-- END: nextstep -->
</ul>
<script type="text/javascript">
