...
<table id="database_config" cellspacing="0" summary="{LANG.database}">
	...
	<tr>
		<th scope="col" abbr="" class="nobg" style="width: 150px;">&nbsp;</th>
		<th scope="col" abbr="{LANG.database_config}">{LANG.database_config}</th>
		<th scope="col" abbr="{LANG.note}">{LANG.note}</th>
	</tr>
	<tr>
		<th scope="row" abbr="" class="spec">{LANG.database_type} <span
	...
	<tr>
		<th scope="row" abbr="" class="specalt">{LANG.host_name} <span
			class="highlight_red">*</span></th>
	...
	<tr>
		<th scope="row" abbr="" class="spec">{LANG.db_username} <span
			class="highlight_red">*</span></th>
	...
	<tr>
		<th scope="row" abbr="" class="specalt">{LANG.db_pass}</th>
		<td class="alt"><input type="password" value="{DATADASE.dbpass}"
			name="dbpass" /></td>
		<td class="alt">{LANG.db_pass_note}</td>
	</tr>
	<tr>
		<th scope="row" abbr="" class="spec">{LANG.db_name}<span
			class="highlight_red">*</span></th>
	...
	<tr>
		<th scope="row" abbr="" class="specalt">{LANG.prefix} <span
			class="highlight_red">*</span></th>
...
<!-- BEGIN: errordata --> <span class="highlight_red"> {DATADASE.error}
</span> <!-- END: errordata --></form>
<ul class="control_t fr">
	<li><span class="back_step"><a
		href="{BASE_SITEURL}index.php?{LANG_VARIABLE}={CURRENTLANG}&amp;step=4">{LANG.previous}</a></span></li>
	<!-- BEGIN: nextstep -->
	<li><span class="next_step"><a
		href="{BASE_SITEURL}index.php?{LANG_VARIABLE}={CURRENTLANG}&amp;step=6">{LANG.next_step}</a></span></li>
	<!-- END: nextstep -->
