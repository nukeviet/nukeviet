...
function nv_create_table_news ( $catid )
{
    ...
    $result = $db->sql_query( "SHOW CREATE TABLE `" . $db_config['prefix'] . "_" . NV_LANG_DATA . "_news_rows`" );
    ...
    $sql = str_replace( $db_config['prefix'] . "_" . NV_LANG_DATA . "_news_rows", $db_config['prefix'] . "_" . NV_LANG_DATA . "_news_" . $catid, $sql );
    $db->sql_query( $sql );
}

$sql_create_table = array();

$sql_create_table[] = "TRUNCATE TABLE `" . $db_config['prefix'] . "_" . NV_LANG_DATA . "_modfuncs`";
$sql_create_table[] = "INSERT INTO `" . $db_config['prefix'] . "_" . NV_LANG_DATA . "_modfuncs` (`func_id`, `func_name`, `func_custom_name`, `in_module`, `show_func`, `in_submenu`, `subweight`, `layout`, `setting`) VALUES
...
$sql_create_table[] = "TRUNCATE TABLE `" . $db_config['prefix'] . "_" . NV_LANG_DATA . "_blocks`";
$sql_create_table[] = "INSERT INTO `" . $db_config['prefix'] . "_" . NV_LANG_DATA . "_blocks` (`bid`, `groupbl`, `title`, `link`, `type`, `file_path`, `theme`, `template`, `position`, `exp_time`, `active`, `groups_view`, `module`, `all_func`, `func_id`, `weight`) VALUES
...
$sql_create_table[] = "INSERT INTO `" . $db_config['prefix'] . "_" . NV_LANG_DATA . "_news_cat` VALUES
...
$sql_create_table[] = "INSERT INTO `" . $db_config['prefix'] . "_" . NV_LANG_DATA . "_news_rows` VALUES
...
$sql_create_table[] = "INSERT INTO `" . $db_config['prefix'] . "_" . NV_LANG_DATA . "_about` VALUES
...
$sql_create_table[] = "UPDATE `" . $db_config['prefix'] . "_config` SET `config_value` =  " . $db->dbescape_string( $disable_site_content ) . " WHERE `module` =  'global' AND `config_name` = 'disable_site_content' AND `lang`='" . NV_LANG_DATA . "'";
$sql_create_table[] = "UPDATE `" . $db_config['prefix'] . "_config` SET `config_value` =  " . $db->dbescape_string( $copyright ) . " WHERE `module` =  'news' AND `config_name` = 'copyright' AND `lang`='" . NV_LANG_DATA . "'";
?>