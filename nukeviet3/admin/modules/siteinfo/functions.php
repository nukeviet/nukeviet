...
$menu_top = array( "title" => $module_name, "module_file" => "", "custom_title" => $lang_global['mod_siteinfo']);
...
$allow_func = array( 'main', 'php_info_configuration', 'php_info_modules', 'php_info_environment', 'php_info_variables' );
