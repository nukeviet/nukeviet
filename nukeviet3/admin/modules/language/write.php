...
{
    global $module_name, $db, $language_array, $global_config, $include_lang, $lang_module, $file_lang_tran_no_comp, $array_lang_exit;
            ...
            if ( in_array( "vi", $array_lang_exit ) and in_array( "en", $array_lang_exit ) and $dirlang != "vi" and $dirlang != "en" )
            {
                ...
                while ( list( $lang_key, $lang_value_vi, $lang_value_en, $lang_value, $update_time ) = $db->sql_fetchrow( $result ) )
                {
                    if ( $lang_value != "" )
                    {
                        ...
                        $lang_value = str_replace( '"', '\"', $lang_value );
                        $lang_value = trim( str_replace( 'UNI0N', 'union', $lang_value ) );
                        ...
                        if ( $dirlang != "vi" )
                        {
                            ...
                            $lang_value_vi = str_replace( '"', '\"', $lang_value_vi );
                            $lang_value_vi = trim( str_replace( 'UNI0N', 'union', $lang_value_vi ) );
                        ...
                        if ( $dirlang != "en" )
                        {
                            ...
                            $lang_value_en = str_replace( '"', '\"', $lang_value_en );
                            $lang_value_en = trim( str_replace( 'UNI0N', 'union', $lang_value_en ) );
