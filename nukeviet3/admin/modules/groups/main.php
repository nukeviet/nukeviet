...
$contents = array();
$contents['caption'] = $lang_module['main'];
...
while ( $row = $db->sql_fetchrow( $result ) )
{
    $contents['row'][$row['group_id']]['title'] = array( 
        $row['title'], NV_BASE_ADMINURL . "index.php?" . NV_NAME_VARIABLE . "=" . $module_name . "&amp;group_id=" . $row['group_id'] 
    );
    ...
    $contents['row'][$row['group_id']]['actions'] = array( 
        $lang_global['edit'], NV_BASE_ADMINURL . "index.php?" . NV_NAME_VARIABLE . "=" . $module_name . "&amp;" . NV_OP_VARIABLE . "=edit&amp;group_id=" . $row['group_id'], $lang_global['delete'] 
    );
    ...
    if ( $group_id )
    {
        ...
        $contents['users_list'] = rawurlencode( NV_BASE_ADMINURL . "index.php?" . NV_NAME_VARIABLE . "=" . $module_name . "&" . NV_OP_VARIABLE . "=users&group_id=" . $group_id );
        ...
        $contents['add_user']['form_search']['input_submit']['onclick'] = "nv_group_search_users('" . rawurlencode( NV_BASE_ADMINURL . "index.php?" . NV_NAME_VARIABLE . "=" . $module_name . "&" . NV_OP_VARIABLE . "=search_users&group_id=" . $group_id ) . "');";
