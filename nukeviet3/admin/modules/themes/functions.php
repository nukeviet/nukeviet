...
$allow_func = array( 
    'main', 'blocks', 'setuplayout', 'activatetheme', 'deletetheme', 'change_layout', 'autoinstall', 'install_theme', 'install_check', 'package_theme', 'package_theme_module', 'front_add','front_del','front_outgroup','add', 'loadblocks', 'blocks_change_pos', 'blocks_change_pos2', 'blocks_change_func', 'blocks_change_order', 'blocks_del', 'blocks_del_group', 'blocks_list', 'sort_order' 
);
