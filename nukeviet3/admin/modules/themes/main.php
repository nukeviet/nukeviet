...
foreach ( $theme_list as $value ) {
	...
	$contents .= "<p style='font-weight:bold;font-size:13px'>" . $info [0]->name . " " . $lang_module ['theme_created_by'] . " <a href='" . $info [0]->website . "' title='" . $lang_module ['theme_created_website'] . "' style='color:#3B5998' target='_blank'>" . $info [0]->author . "</a></p>";
