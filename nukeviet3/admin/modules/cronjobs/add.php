...
if ( $nv_Request->get_int( 'save', 'post' ) == '1' )
{
	...
	else
	{
		...
		$sql = "INSERT INTO `" . NV_CRONJOBS_GLOBALTABLE . "` VALUES (
			NULL, " . $db->dbescape( $cron_name ) . ", " . $start_time . ", " . $interval . ", " . $db->dbescape( $run_file ) . ", 
			" . $db->dbescape( $run_func ) . ", " . $db->dbescape( $params ) . ", " . $del . ", 0, 1, 0, 0)";
		$db->sql_query( $sql );
