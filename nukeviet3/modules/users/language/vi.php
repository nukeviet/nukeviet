...
$lang_module['your_question'] = "Hoặc câu hỏi của bạn";
...
$lang_module['account_active_mess_error_mail'] = "Lỗi: Tài khoản của bạn đã được tạo, Nhưng hệ thống không gửi email để kích hoạt tài khoản. Vui lòng liên hệ với Quản trị Website để được hỗ trợ.";
...
$lang_module['lostpass_question_empty'] = "Câu hỏi dự phòng hoặc câu trả lời chưa được khai báo khi đăng ký tài khoản nên chúng tôi không thể cung cấp mật khẩu mới cho bạn. Hãy liên hệ với quản trị site để biết thêm chi tiết";
...
$lang_module['lostactivelink_question_empty'] = "Câu hỏi dự phòng hoặc câu trả lời chưa được khai báo khi đăng ký tài khoản nên chúng tôi không đủ cơ sở để cung cấp link kích hoạt mới cho bạn. Hãy liên hệ với quản trị site để biết thêm chi tiết";
...
$lang_module['change_question_pagetitle'] = "Thay đổi câu hỏi-câu trả lời dự phòng";
$lang_module['change_question_ok'] = "Câu hỏi-câu trả lời dự phòng đã được thay đổi";
$lang_module['changequestion_info'] = "Những chức năng chính của câu hỏi - câu trả lời dự phòng";
...
$lang_module['changequestion_step1'] = "Để thay đổi câu hỏi - câu trả lời dự phòng, bạn cần khai báo mật khẩu";
$lang_module['changequestion_step2'] = "Bạn có thể thay câu hỏi - câu trả lời dự phòng mới";
...
$lang_module['question2'] = "Câu hỏi dự phòng";
$lang_module['user_info'] = "Thông tin thành viên";
...
$lang_module['question_empty_note'] = "Chú ý: Bạn chưa khai báo câu hỏi-câu trả lời dự phòng nên sẽ không thể phục hồi tài khoản khi quên thông tin đăng nhập. Hãy click <a href=\"%s\">vào đây</a> để khai báo";
