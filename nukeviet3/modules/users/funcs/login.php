...
function openidLogin_Res1 ( $attribs )
{
    ...
    if ( $option == 3 )
    {
        ...
        if ( $nv_Request->isset_request( 'nv_login', 'post' ) )
        {
            ...
            $array_login = array( 
                "nv_login" => $nv_username, "nv_password" => $nv_password, 'login_info' => "<span style=\"color:#fb490b;\">" . $error . "</span>" 
            );
        }
        else
        {
            $array_login = array( 
                "nv_login" => '', "nv_password" => '', 'login_info' => $lang_module['openid_note1'] 
            );
        }
...
{
    $array_login = array( 
        "nv_login" => '', "nv_password" => '', "nv_redirect" => '' 
    );
}
