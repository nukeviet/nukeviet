...
function result_weblinks_theme ( $m_info, $keyword, $xtpl, $limit, $pages, $per_pages )
{
    ...
    $sql_search1 = "SELECT id,title,description FROM `" . NV_PREFIXLANG . "_" . $module_data . "_rows` 
	WHERE title LIKE '%" . $dbkeyword . "%' OR description LIKE '%" . $dbkeyword . "%'";
    
    $sql_search2 = "SELECT id,title,description FROM `" . NV_PREFIXLANG . "_" . $module_data . "_rows` 
	WHERE title LIKE '%" . $dbkeyword . "%' OR description LIKE '%" . $dbkeyword . "%' LIMIT 0," . $limit;
    //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    $URLLink = NV_BASE_SITEURL . "?" . NV_LANG_VARIABLE . "=" . NV_LANG_DATA . "&amp;" . NV_NAME_VARIABLE . "=" . $module_name . '&op=visitlink&id=';
    ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    if ( ! empty( $xtpl ) )
    {
