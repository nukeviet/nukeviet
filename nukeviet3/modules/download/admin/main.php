...
if ( $nv_Request->isset_request( 'add', 'get' ) or $nv_Request->isset_request( 'edit', 'get' ) )
{
    ...
    else
    {
        ...
        else
        {
            ...
            $array['fileupload'] = $array['linkdirect'] = $array['groups_comment'] = array();
            $array['filesize'] = $array['who_comment'] = 0;
...
$xtpl->assign( 'ADD_NEW_FILE', NV_BASE_ADMINURL . "index.php?" . NV_NAME_VARIABLE . "=" . $module_name . "&amp;add=1" );
