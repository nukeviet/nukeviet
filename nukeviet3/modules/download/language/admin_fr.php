...
$lang_module['config_queuefolder'] = "Répertoire contenant les fichiers à approuver";
$lang_module['config_whouploadfile'] = "Qui peut transférer";
$lang_module['config_whoaddfile'] = "Qui peut ajouter les fichiers";
$lang_module['groups_upload'] = "Cocher aux grouppes autorisés pour les sélectionner";
...
$lang_module['error_cat5'] = "Impossible d'enregister les données par un raison inconnu !";
$lang_module['addcat_titlebox'] = "Ajouter Catégorie";
$lang_module['category_cat_name'] = "Nom de Catégorie";
...
$lang_module['cat_save'] = "Sauvegarder";
$lang_module['download_catmanager'] = "Gestion de Catégories";
$lang_module['category_cat_sub'] = "Sous-catégorie";
$lang_module['category_cat_active'] = "Acitive";
$lang_module['category_cat_feature'] = "Fonctionalité";
...
$lang_module['file_error_fileupload'] = "Sélectioner un fichier pour transférer ou donner le lien direct!";
$lang_module['file_error_author_url'] = "Erreur: Site de l'auteur invalide!";
$lang_module['file_error1'] = "Impossible d'entregistrer les données par un raison inconnu!";
...
$lang_module['file_author_email'] = "Email de l'auteur";
...
$lang_module['file_addfile'] = "Ajouter Fichier";
$lang_module['download_filequeue'] = "Fichiers à approuver";
$lang_module['file_title_exists'] = "Erreur: ce noma été utilisé. Choisissez un autre nom";
...
$lang_module['report_check_error'] = "Le système a trouvé le lien cassé. Cliquez OK pour corriger ou ANNULER";
$lang_module['report_check_error2'] = "Erreur: Fichier inexistant. Cliquez OK pour supprimer le rapport ou ANNULER";
$lang_module['report_delete'] = "Supprimer Rapport d'erreur";
$lang_module['file_gourl'] = "Accès";
...
$lang_module['comment_st0'] = "Commentaires à approuver";
...
$lang_module['comment_empty0'] = "Aucune commentaire en attente d'approbation";
$lang_module['comment_empty2'] = "Aucun commentaire suspens";
$lang_module['comment_status0'] = "À approuver";
$lang_module['comment_status1'] = "Actif";
...
$lang_module['comment_edit'] = "Éditer commentaire";
...
$lang_module['file_who_autocomment'] = "Qui peut commenter sans approbation";
$lang_module['download_comment'] = "Gestion de commentaires";
$lang_module['download_report'] = "Rapport d'erreur";
$lang_module['download_filemanager'] = "Gestion de fichiers";
$lang_module['download_editfile'] = "Modifier Fichier";
$lang_module['editcat_cat'] = "Éditer Sujet";
$lang_module['add_file_items'] = "Ajouter le fichier";
$lang_module['add_file_items_note'] = "Si cefichier a plusieurs parties";
$lang_module['add_linkdirect_items'] = "Ajouter Source externe";
