...
$contents['upload'] = array( 
    sprintf( $lang_module['upload'], $contents['file_allowed_ext'] ), 'banner' 
);
...
$contents['publ_date'] = array( 
    $lang_module['publ_date'], 'publ_date', $publ_date, 10, NV_BASE_SITEURL . "images/calendar.jpg", 18, 17, "popCalendar.show(this, 'publ_date', 'dd.mm.yyyy', false);" 
);
$contents['exp_date'] = array( 
    $lang_module['exp_date'], 'exp_date', $exp_date, 10, NV_BASE_SITEURL . "images/calendar.jpg", 18, 17, "popCalendar.show(this, 'exp_date', 'dd.mm.yyyy', false);" 
);
