...
if ( $nv_Request->get_int( 'save', 'post' ) == '1' )
{
	...
	else
	{
		if ( isset( $_FILES['banner'] ) and is_uploaded_file( $_FILES['banner']['tmp_name'] ) )
		{
			...
			$upload_info = $upload->save_file( $_FILES['banner'], NV_UPLOADS_REAL_DIR . '/' . $module_name, false );
...
$contents['file_name'] = array( $lang_module['file_name'], NV_BASE_SITEURL . $file_name, "rel=\"shadowbox;height=" . $height . ";width=" . $width . "\"", NV_BASE_SITEURL . "images/ico_" . $file_ext . ".gif", $lang_global['show_picture'] );
