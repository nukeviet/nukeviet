...
if (defined ( 'NV_IS_BANNER_CLIENT' )) {
	$xtpl = new XTemplate ( "stats.tpl", NV_ROOTDIR . "/themes/" . $module_info ['template'] . "/modules/" . $module_name );
	...
	$query = "SELECT `id`,`title` FROM `" . NV_BANNERS_ROWS_GLOBALTABLE . "` WHERE clid=" . $banner_client_info ['id'] . " ORDER BY `id` ASC";
