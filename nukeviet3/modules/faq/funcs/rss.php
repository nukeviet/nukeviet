...
if ( ! empty( $list_cats ) )
{
    ...
    if ( $catid > 0 )
    {
        ...
        $channel_link = NV_MY_DOMAIN . NV_BASE_SITEURL . "?" . NV_LANG_VARIABLE . "=" . NV_LANG_DATA . "&amp;" . NV_NAME_VARIABLE . "=" . $module_name . "&amp;cat=" . $list_cats[$catid]['alias'];
    }
    else
    {
...
<link>' . NV_MY_DOMAIN . NV_BASE_SITEURL . '</link>
    ...
    {
        $rsslink = NV_MY_DOMAIN . NV_BASE_SITEURL . "?" . NV_LANG_VARIABLE . "=" . NV_LANG_DATA . "&amp;" . NV_NAME_VARIABLE . "=" . $module_name . "&amp;" . NV_OP_VARIABLE . "=" . $list_cats[$cid]['alias'] . "#faq" . $id;
        $content .= '
	<item>
	<title>' . $title . '</title>
	<link>' . $rsslink . '</link>
