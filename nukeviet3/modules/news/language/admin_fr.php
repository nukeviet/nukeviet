...
$lang_module['setting_setcomm'] = "Commentaires autorisés pour un nouveau article";
/*
	 vietnam:	  Thảo luận mặc định khi tạo bài viết mới
	 english:	  Set default comment
*/

$lang_module['setting_auto_postcomm'] = "Publier les commentaires sans censurer";
/*
...
$lang_module['content_keywords_note'] = "Pour les générer automatiquement, copiez le contenu de l'article dans le champs ci-dessous et cliquez";
/*
...
$lang_module['comment_delete_unsuccess'] = "Erreur de la suppression";
/*
...
$lang_module['comment_enable'] = "Publier";
/*
	 vietnam:	  Bật
	 english:	  Enable
*/

$lang_module['comment_disable'] = "Dépublier";
/*
	 vietnam:	  Tắt
	 english:	  Desable
*/
