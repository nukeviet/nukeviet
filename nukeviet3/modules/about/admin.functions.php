...
$allow_func = array( 'main', 'list', 'content', 'change_status', 'change_weight', 'del' );
...
function nv_show_list()
{
    ...
    if ( $num > 0 )
    {
        ...
        while ( $row = $db->sql_fetchrow( $result ) )
        {
            ...
            $array = array( $lang_module['aabout6'], $lang_module['aabout5'] );
            ...
            $contents .= "<td><span class=\"edit_icon\"><a href=\"" . NV_BASE_ADMINURL . "index.php?" . NV_NAME_VARIABLE . "=" . $module_name . "&" . NV_OP_VARIABLE . "=content&amp;id=" . $row['id'] . "\">" . $lang_global['edit'] .
                "</a></span>\n";
