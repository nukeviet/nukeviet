                    ...
                    <td valign="top" width="200" bgcolor="#EAEAEA">
                    	<div class="filetype">
                            <select name="imgtype" id="imgtype">
                                <option value="file">{LANG.type_file}</option>
                                <option value="image">{LANG.type_image}</option>
                                <option value="flash">{LANG.type_flash}</option>
                            </select>
                        </div>
                    	<div name="imgfolder" id="imgfolder" size="25" 
                        style="width:200px;height:320px;overflow:auto;cursor:pointer; background:#FFFFFF; margin:1px">&nbsp;</div>
                        <!-- BEGIN: error -->
                        <div class="error">
                            {error}
                        </div>
...
$(function(){
	...
	$("#imglist").html("<span style='color:red'><img src='{NV_BASE_SITEURL}images/load.gif'/> please wait...</span>");
...
<div id="renamefolder" title="{LANG.renamefolder}">{LANG.rename_newname}<input type="text" name="foldername"/></div>
<div id="createfolder" title="{LANG.createfolder}">{LANG.rename_newname}<input type="text" name="createfoldername"/></div>
<script type="text/javascript">
