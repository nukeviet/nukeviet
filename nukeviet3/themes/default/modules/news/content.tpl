...
<div class="news"><label><strong>{LANG.alias}: </strong></label> <input style="width: 330px;" name="alias" id="idalias" value="{DATA.alias}" maxlength="255" type="text">&nbsp;&nbsp; <img src="/NukeViet3Official/images/refresh.png" widht="16" style="cursor: pointer; vertical-align: middle;" onclick="get_alias();" alt="" height="16"></div>
...
<div class="news"><label><strong>{LANG.content_topic}</strong></label> <select name="topicid">
	<!-- BEGIN: topic -->
	<option value="{DATATOPIC.value}"{DATATOPIC.selected}>{DATATOPIC.title}</option>
	<!-- END: topic -->
</select></div>

<div class="news"><label><strong>{LANG.content_homeimg}</strong></label> <input name="homeimgfile" id="homeimg" value="{DATA.homeimgfile}" type="text"></div>

<div class="news"><label><strong>{LANG.content_homeimgalt}</strong></label> <input maxlength="255" value="{DATA.homeimgalt}" name="homeimgalt" type="text"></div>

<div class="news"><label><strong>{LANG.imgposition}</strong></label> <select name="imgposition">
	<!-- BEGIN: imgposition -->
...
<br />
<div style="width: 500px; text-align: center;"><input type="hidden" name="contentid" value="{DATA.id}" /><input type="hidden" name="checkss" value="{CHECKSS}" /> <!-- BEGIN: save_temp --> <input type="submit" value="{LANG.save_temp}" name="status0"> <!-- END: save_temp --> <!-- BEGIN: postcontent --> <input type="submit" value="{LANG.save_content}" name="status1"><!-- END: postcontent --></div>
