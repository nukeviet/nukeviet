...
# ------------------------------------------------------------------------------
#
# File Time Stamp   : Thu Jul 26 12:08:01 2007 UTC.
...
# =======
#
# When we started this database a couple of years ago we were amazed to find that
# almost 2 billion IP addresses in the IPV4 space had been assigned. Today, that
# figure is just over 3 billion. The database has grown from about 2MB unzipped
# to over 5. That's a lot of new assigned IP space for just a few years!
#
# What this database is
# =====================
#
# This Database is operated and maintained by Webnet77 and updated every 24
# hours. It represents over 3 billion IPV4 numbers in use on the internet
...
#
# Nov 2006     - Added country code for �LAND ISLANDS - AX - ALA
