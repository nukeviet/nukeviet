...
if ( $nv_Request->isset_request( 'nv_login,nv_password', 'post' ) )
{
	...
	$check_login = nv_check_valid_login( $nv_username, NV_ANICKMAX, NV_ANICKMIN );
...
$xtpl->assign( 'JS', NV_BASE_SITEURL . "js/admin_login.js" );
$xtpl->assign( 'SITELANG', NV_LANG_INTERFACE );
$xtpl->assign( 'NV_BASE_SITEURL', NV_BASE_SITEURL );
$xtpl->assign( 'NV_BASE_ADMINURL', NV_BASE_ADMINURL );
$xtpl->assign( 'CHECK_SC', ( $global_config['gfx_chk'] == 1 ) ? 1 : 0 );
$xtpl->assign( 'NICKMIN', NV_ANICKMIN );
$xtpl->assign( 'NICKMAX', NV_ANICKMAX );
...
$xtpl->assign( 'LOGIN_ERROR_ACCOUNT', addslashes( sprintf( $lang_global['login_error_account'], NV_ANICKMIN, NV_ANICKMAX ) ) );
$xtpl->assign( 'LOGIN_ERROR_PASSWORD', addslashes( sprintf( $lang_global['login_error_password'], NV_APASSMIN, NV_APASSMAX ) ) );
