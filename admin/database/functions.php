...
{
    global $db, $db_config, $module_name, $nv_Lang;
    ...
    $contents['captions']['tables_info'] = sprintf($nv_Lang->getModule('tables_info'), $db->dbname);
    ...
    $contents['third'] = sprintf($nv_Lang->getModule('third'), $db_tables_count, $db_size, $db_totalfree);
...
{
    global $db, $db_config, $module_name, $page_title, $nv_Request, $nv_Lang;
    ...
    $contents['table']['row']['caption'] = sprintf($nv_Lang->getModule('table_row_caption'), $tablename);
    ...
    $page_title = sprintf($nv_Lang->getModule('nv_show_tab'), $tablename);
