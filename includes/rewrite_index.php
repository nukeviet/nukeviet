...
// Rewrite if no config in .htaccess or web.config

// Rewrite with no lang variable
if( $global_config['rewrite_optional'] )
{
	// Rewrite module page
	$rewrite["#\"(" . NV_BASE_SITEURL . ")index.php\?" . NV_LANG_VARIABLE . "=([a-z-]+)\&[amp;]*" . NV_NAME_VARIABLE . "=page\&[amp;]*" . NV_OP_VARIABLE . "=([a-zA-Z0-9-/]+)" . preg_quote( $global_config['rewrite_exturl'], '#' ) . "\"#"] = "\"\\1index.php/\\3" . $global_config['rewrite_exturl'] . "\"";
	...
	if( $global_config['rewrite_op_mod'] != '' )
	{
		...
		// Module
		$rewrite["#\"(" . NV_BASE_SITEURL . ")index.php\?" . NV_LANG_VARIABLE . "=([a-z-]+)\&[amp;]*" . NV_NAME_VARIABLE . "=" . $global_config['rewrite_op_mod'] . "\&[amp;]*" . NV_OP_VARIABLE . "=([a-zA-Z0-9-/]+)" . preg_quote( $global_config['rewrite_exturl'], '#' ) . "\"#"] = "\"\\1index.php/\\3" . $global_config['rewrite_exturl'] . "\"";
	...
	$rewrite["#\"(" . NV_BASE_SITEURL . ")index.php\?" . NV_LANG_VARIABLE . "=([a-z-]+)\&[amp;]*" . NV_NAME_VARIABLE . "=([a-zA-Z0-9-]+)\&[amp;]*" . NV_OP_VARIABLE . "=([a-zA-Z0-9-/]+)" . preg_quote( $global_config['rewrite_exturl'], '#' ) . "\"#"] = "\"\\1index.php/\\3/\\4" . $global_config['rewrite_exturl'] . "\"";
...
else
{
	...
	// Rewrite module has funcs url
	$rewrite["#\"(" . NV_BASE_SITEURL . ")index.php\?" . NV_LANG_VARIABLE . "=([a-z-]+)\&[amp;]*" . NV_NAME_VARIABLE . "=([a-zA-Z0-9-]+)\&[amp;]*" . NV_OP_VARIABLE . "=([a-zA-Z0-9-/]+)" . preg_quote( $global_config['rewrite_exturl'], '#' ) . "\"#"] = "\"\\1index.php/\\2/\\3/\\4" . $global_config['rewrite_exturl'] . "\"";
