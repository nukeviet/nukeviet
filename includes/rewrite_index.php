...
{
	// Rewrite module page
	$rewrite["#(\"" . NV_BASE_SITEURL . ")index.php\?" . NV_LANG_VARIABLE . "=([a-z-]+)\&[amp;]*" . NV_NAME_VARIABLE . "=page\&[amp;]*" . NV_OP_VARIABLE . "=([a-zA-Z0-9-/]+)" . $global_config['rewrite_exturl'] . "\"#"] = "\\1index.php/\\3" . $global_config['rewrite_exturl'] . "\"";
	
	// Rewrite to remove module name on url
	if( $global_config['rewrite_op_mod'] != '' )
	{
		// Search
		$rewrite["#(\"" . NV_BASE_SITEURL . ")index.php\?" . NV_LANG_VARIABLE . "=([a-z-]+)\&[amp;]*" . NV_NAME_VARIABLE . "=" . $global_config['rewrite_op_mod'] . "\&[amp;]*q\=([^\"]+)\"#"] = "\\1index.php/search/q=\\3\"";
...
{
	// Rewrite search url
	$rewrite["#(\"" . NV_BASE_SITEURL . ")index.php\?" . NV_LANG_VARIABLE . "=([a-z-]+)\&[amp;]*" . NV_NAME_VARIABLE . "=search\&[amp;]*q\=([^\"]+)\"#"] = "\\1index.php/\\2/search/q=\\3\"";
