...
if( $global_config['rewrite_optional'] )
{
	...
	// Rewrite search url
	$rewrite["#(\"" . NV_BASE_SITEURL . ")index.php\?" . NV_LANG_VARIABLE . "=([a-z-]+)\&[amp;]*" . NV_NAME_VARIABLE . "=search\&[amp;]*q\=([^\"]+)\"#"] = "\\1search/q=\\3\"";
...
{
	// Rewrite search url
	$rewrite["#(\"" . NV_BASE_SITEURL . ")index.php\?" . NV_LANG_VARIABLE . "=([a-z-]+)\&[amp;]*" . NV_NAME_VARIABLE . "=search\&[amp;]*q\=([^\"]+)\"#"] = "\\1\\2/search/q=\\3\"";
