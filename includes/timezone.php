...
$site_timezone = ($global_config['site_timezone'] == 'byCountry' and !empty($countries[$client_info['country']][2])) ? $countries[$client_info['country']][2] : $global_config['site_timezone'];
