...
function nv_change_buffer($buffer)
{
    ...
    if (defined('NV_SYSTEM') and !empty($global_config['googleAnalyticsID']) and (defined('GOOGLE_ANALYTICS_SYSTEM') or preg_match('/^UA-\d{4,}-\d+$/', $global_config['googleAnalyticsID']))) {
