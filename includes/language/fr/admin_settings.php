...
$lang_module['dont_use'] = 'Ne pas utiliser';
$lang_module['default'] = 'Défaut';
$lang_module['bycountry'] = 'Par pays';
$lang_module['removeall'] = 'Enlever tout';
$lang_module['url'] = 'URL';
$lang_module['countries'] = 'Des pays';
$lang_module['cdn_notes'] = '<ul><li>L\'URL doit commencer par <code>http://</code>, <code>https://</code> ou <code>//</code></li><li><strong>Par défaut</strong>: à utiliser pour tous les pays, à l\'exception de ceux répertoriés sur d\'autres CDN</li><li><strong>Par pays</strong>: disponible uniquement dans le pays listés</li><li>S\'il y a plusieurs CDN, le CDN qui remplit les conditions en premier sera utilisé</li></ul>';
