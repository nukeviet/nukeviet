...
$lang_module['headers'] = 'Configurer les en-têtes HTTP';
...
$lang_module['captcha_type_recaptcha_note1'] = '. Veuillez contacter le support si vous avez besoin d\'une clé de site ou si reCaptcha ne fonctionne pas';
$lang_module['select_all_as'] = 'Sélectionner pour tous les modules';
...
$lang_module['pp_desc3'] = 'Permissions-Policy est renommé Feature-Policy (FP). Les configurations ici s\'appliqueront également à l\'en-tête Feature-Policy. FP ne prend pas en charge les caractères génériques, donc les lignes de configuration génériques seront ignorées dans l\'en-tête FP';
$lang_module['pp_act'] = 'PP actif';
$lang_module['pp_note'] = 'Dans le formulaire ci-dessous, saisissez chaque valeur sur une seule ligne. Les valeurs possibles sont <code>*</code>, <code>self</code>, <code>()</code>, le nom de domaine complet https://example.com ou le formulaire générique https:// *.exemple.com. S\'il y a une valeur de * alors tout le contenu sera remplacé par * correspondant à tout autoriser à cette directive, ensuite s\'il y a () alors tout le contenu sera remplacé par () correspondant à refuser l\'accès à cette directive. Laisser vide signifie que la directive n\'apparaît pas dans l\'en-tête HTTP, auquel cas le navigateur décidera de la valeur par défaut';
