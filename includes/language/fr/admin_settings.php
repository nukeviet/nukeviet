...
$lang_module['run_file_info'] = 'Fichier d\'exécution est un des fichiers dans le répertoire “<strong>includes/cronjobs/</strong>”';
$lang_module['run_func'] = 'Accès à la fonction';
$lang_module['run_func_info'] = 'Fonction doit être commencée par “<strong>cron_</strong>”';
$lang_module['params'] = 'Paramètre';
$lang_module['params_info'] = 'Séparer par la virgule';
$lang_module['interval'] = 'Répêter la tâche après';
$lang_module['interval_info'] = 'Si vous entrez “<strong>0</strong>”, la tâche est faite une seule fois';
...
$lang_module['static_url_note'] = 'Laissez ce champ vide ou renseignez l\'URL d\'un hébergeur statique dont le domaine n\'est pas l\'un des domaines ou sous-domaines du site. L\'URL doit commencer par http://, https:// ou //';
...
$lang_module['cors_site_allowed_variables_note'] = '<ul class="list-unstyled"><li>- Entrez la valeur dans le format de chaîne de requête URL (par exemple, key1=value1, key1=value1&key2=value2, key1=value1&key2...). Saisissez une valeur par ligne.</li><li>- Seuls les noms de variables (key1, key2...) sont acceptés qui contiennent les caractères [a-zA-Z0-9] et le trait de soulignement.</li><li>- Seules les valeurs variables (valeur1, valeur2...) sont acceptées qui sont vides ou contiennent les caractères [a-zA-Z0-9], tiret , trait de soulignement, point ou @. Une valeur de variable vide sera interprétée comme n\'importe quelle valeur.</li></ul>';
...
$lang_module['deny_access_note'] = '<ul><li>Entrez une valeur par ligne</li><li>Accepte les valeurs qui sont des constantes (lettres majuscules et entre {...}), des expressions régulières (entre [...]) ou des chemins à partir de la racine du site</li></ul>';
...
$lang_module['comma_separated'] = 'Séparé par des espaces; Accepte les expressions régulières entre [...]';
...
$lang_module['compress_types_note'] = '<ul><li>Entrez une valeur par ligne</li><li>Valeur listée par le modèle: [nom du type de compression]: [chemin vers le fichier de bibliothèque DLL](par exemple gzip: %Windir%\system32\inetsrv\gzip.dll)</li></ul>';
...
$lang_module['mime_types_note'] = '<ul><li>Entrez une valeur par ligne</li><li>Valeur listée par le modèle: [mime-type]: [extension 1] [extension 2].. .</li></ul>';
$lang_module['cache_control'] = 'En-tête HTTP Cache-Control';
$lang_module['expires'] = 'En-tête HTTP Expires';
$lang_module['expires_note'] = 'Valeur listée par le modèle: [number][unit]; Les unités comprennent: y(année), M(mois), w(semaine), d(jour) , h(heure), m(minute), s(seconde)';
...
$lang_module['access_control_allow_origin_note'] = 'Vous pouvez le laisser vide, sélectionner »Tous», ou entrer une liste de noms de domaine séparés par des espaces. Si vous déclarez cette ligne et appliquez les suggestions, assurez-vous de désactiver l\'option »Ajouter un en-tête Access-Control-Allow-Origin» dans la zone Paramètres de sécurité => Paramètres intersites';
...
$lang_module['mime_list_note'] = 'Saisissez uniquement les types mime répertoriés dans la zone «Types de fichiers utilisés sur le site», séparés par des espaces';
$lang_module['any_origin'] = 'Tous';
$lang_module['charset_types'] = 'Ajoutez des informations sur le jeu de caractères au champ d\'en-tête de réponse «Content-Type»';
...
$lang_module['cdn_notes'] = '<ul><li>L\'URL doit commencer par http://, https:// ou //</li><li>Si <strong>Par défaut</strong> est sélectionné, ce CDN sera utilisé pour tous les pays, à l\'exception des pays où un CDN personnalisé est spécifié ou des pays marqués "Ne pas utiliser CDN" (affiché sur la page <strong>CDN par pays</strong>)</li></ul>';
...
$lang_module['config_key_note'] = 'Seules les clés correspondant au modèle [a-zA-Z][a-zA-Z0-9_]{0,29} sont acceptées.';
$lang_module['custom_configs_note'] = 'La configuration personnalisée est sortie sous la forme: $global_config[\'custom_configs\'][\'Clé de configuration\'] = \'Valeur de configuration\'';
$lang_module['addconfig'] = 'Ajouter ligne';
$lang_module['passshow_button'] = 'Intégration du bouton «Afficher/masquer le mot de passe»';
...
$lang_module['dkim_included'] = '';
$lang_module['csp_form-action'] = 'Chỉ thị form-action chỉ định các địa chỉ có thể được sử dụng để gửi .';
