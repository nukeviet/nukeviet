...
$lang_module['dont_use'] = 'Không sử dụng';
$lang_module['default'] = 'Sử dụng mặc định';
$lang_module['bycountry'] = 'Theo quốc gia';
$lang_module['removeall'] = 'Bỏ tất cả';
$lang_module['url'] = 'URL';
$lang_module['countries'] = 'Quốc gia';
$lang_module['cdn_notes'] = '<ul><li>URL cần bắt đầu bằng <code>http://</code>, <code>https://</code> hay <code>//</code></li><li><strong>Sử dụng mặc định</strong>: Sử dụng cho mọi quốc gia, ngoại trừ các quốc gia được liệt kê ở các CDN khác</li><li><strong>Theo quốc gia</strong>: Chỉ sử dụng ở các quốc gia được liệt kê</li><li>Nếu có nhiều CDN, CDN đáp ứng các điều kiện trước sẽ được sử dụng</li></ul>';
