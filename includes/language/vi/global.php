...
$lang_global['block_delete_confirm'] = 'Chú ý: Khi xóa block này hệ thống sẽ xóa cả nhóm block tại tất cả các vị trí khác. Bạn chắc chắn thực hiện thao tác này? Nếu chỉ muốn xóa một mình nó, bạn nên tách nhóm block trước khi xóa.';
$lang_global['block_outgroup_confirm'] = 'Nếu block này đang nằm trong nhóm có từ 2 block trở lên, thao tác này sẽ dẫn đến việc loại bỏ block ra khỏi nhóm hiện tại và tạo cho nó một nhóm mới. Bạn chắc chắn thực hiện thao tác này?';
