...
$lang_global['username_empty'] = 'Tên tài khoản chưa được khai báo';
$lang_global['usernamelong'] = 'Tên tài khoản quá dài. Chỉ chấp nhận tên không nhiều hơn %1$d ký tự';
$lang_global['usernameadjective'] = 'Tên tài khoản quá ngắn. Nó phải có ít nhất %1$d ký tự';
$lang_global['unick_type_1'] = 'Tên tài khoản chỉ được sử dụng chữ số';
$lang_global['unick_type_2'] = 'Tên tài khoản chỉ được sử dụng chữ số và chữ cái';
$lang_global['unick_type_3'] = 'Tên tài khoản chỉ được sử dụng chữ số, chữ cái, và các ký tự sau nằm giữa: gạch ngang, gạch dưới, cách trống';
$lang_global['unick_type_4'] = 'Tên tài khoản chỉ được sử dụng Unicode, không có các ký tự đặc biệt';
$lang_global['username_rule_limit'] = 'Tên tài khoản không hợp lệ: %1$s và có từ %2$d đến %3$d ký tự';
$lang_global['username_rule_nolimit'] = 'Tên tài khoản phải từ %1$d đến %2$d ký tự';
...
$lang_global['userlogin_blocked'] = 'Bạn đã đăng nhập thất bại %s lần nên hệ thống tạm khóa công cụ đăng nhập cho đến %s';
...
$lang_global['username'] = 'Tên tài khoản';
$lang_global['username_email'] = 'Tên tài khoản hoặc email';
...
$lang_global['chromeframe'] = 'Bạn đang sử dụng một trình duyệt <strong>lỗi thời</strong>. Vui lòng <a href="http://browsehappy.com/">nâng cấp trình duyệt của bạn</a> hoặc <a href="http://www.google.com/chromeframe/?redirect=true">kích hoạt Google Chrome Frame</a> để cải thiện trải nghiệm của bạn.';
$lang_global['sun'] = 'CN';
$lang_global['mon'] = 'T2';
$lang_global['tue'] = 'T3';
$lang_global['wed'] = 'T4';
