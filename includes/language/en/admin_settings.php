...
$lang_module['csp_source_hosts'] = 'List of accepted source hosts (Enter one value per line)';
...
$lang_module['access_control_allow_origin_note'] = 'If you don\'t select &raquo;All&raquo; enter a space-separated list of domains';
...
$lang_module['dont_use'] = 'Don\'t use';
$lang_module['default'] = 'Default';
$lang_module['bycountry'] = 'By countries';
$lang_module['removeall'] = 'Remove all';
$lang_module['url'] = 'URL';
$lang_module['countries'] = 'Countries';
$lang_module['cdn_notes'] = '<ul><li>URL should start with <code>http://</code>, <code>https://</code> or <code>//</code></li><li><strong>Default</strong>: Use for all countries, except those listed on other CDNs</li><li><strong >By country</strong>: Only available in the countries listed</li><li>If there are multiple CDNs, the CDN that meets the conditions first will be used</li></ul>';
