...
$lang_global['passwordadjective'] = 'Password &ldquo;<strong>%1$s</strong>&rdquo; too short. Minimum &ldquo;<strong>%2$d</strong>&rdquo; characters';
...
$lang_global['logininfo'] = 'Please log into your account so you can use all tools the site';
$lang_global['adminlogininfo']  = 'Please use a valide username and password to login to the Control Panel';
