...
function nv_create_table_sys($lang)
{
    ...
    $sql_create_table[] = "INSERT INTO " . $db_config['prefix'] . "_" . $lang . "_modules (
		...
		('about', 'page', 'about', 'about', 'page', 'About', '', 1533200400, 1, 1, '', '', '', '', '0', 1, 1, '', 1, 0),
 		('news', 'news', 'news', 'news', 'news', 'News', '', 1533200400, 1, 1, '', '', '', '', '0', 2, 1, '', 1, 0),
		('users', 'users', 'users', 'users', 'users', 'Users', 'Users', 1533200400, 1, 1, '', '', '', '', '0', 3, 1, '', 0, 0),
		('contact', 'contact', 'contact', 'contact', 'contact', 'Contact', '', 1533200400, 1, 1, '', '', '', '', '0', 4, 1, '', 0, 0),
		('statistics', 'statistics', 'statistics', 'statistics', 'statistics', 'Statistics', '', 1533200400, 1, 0, '', '', '', '', '0', 5, 1, '', 0, 0),
		('voting', 'voting', 'voting', 'voting', 'voting', 'Voting', '', 1533200400, 1, 1, '', '', '', '', '0', 6, 1, '', 1, 0),
		('banners', 'banners', 'banners', 'banners', 'banners', 'Banners', '', 1533200400, 1, 1, '', '', '', '', '0', 7, 1, '', 0, 0),
		('seek', 'seek', 'seek', 'seek', 'seek', 'Search', '', 1533200400, 1, 0, '', '', '', '', '0', 8, 1, '', 0, 0),
		('menu', 'menu', 'menu', 'menu', 'menu', 'Menu Site', '', 1533200400, 0, 1, '', '', '', '', '0', 9, 1, '', 0, 0),
		('feeds', 'feeds', 'feeds', 'feeds', 'feeds', 'Rss Feeds', '', 1533200400, 1, 1, '', '', '', '', '0', 10, 1, '', 0, 0),
		('page', 'page', 'page', 'page', 'page', 'Page', '', 1533200400, 1, 1, '', '', '', '', '0', 11, 1, '', 1, 0),
		('comment', 'comment', 'comment', 'comment', 'comment', 'Comment', '', 1533200400, 1, 1, '', '', '', '', '0', 12, 1, '', 0, 0),
 		('siteterms', 'page', 'siteterms', 'siteterms', 'page', 'Siteterms', '', 1533200400, 1, 1, '', '', '', '', '0', 13, 1, '', 1, 0),
 		('freecontent', 'freecontent', 'freecontent', 'freecontent', 'freecontent', 'Free Content', '', 1533200400, 0, 1, '', '', '', '', '0', 14, 1, '', 0, 0),
 		('two-step-verification', 'two-step-verification', 'two_step_verification', 'two-step-verification', 'two_step_verification', 'Two-Step Verification', '', 1533200400, 1, 0, '', '', '', '', '0', 15, 1, '', 0, 0)";
