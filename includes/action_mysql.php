...
function nv_create_table_sys( $lang )
{
	...
	$sql_create_table[] = "CREATE TABLE " . $db_config['prefix'] . "_" . $lang . "_modthemes (
 	...
 	$sql_create_table[] = "INSERT INTO " . $db_config['prefix'] . "_" . $lang . "_modules (title, module_file, module_data, custom_title, admin_title, set_time, main_file, admin_file, theme, mobile, description, keywords, groups_view, weight, act, admins, rss, gid) VALUES
		('about', 'page', 'about', 'About', '', 1276333182, 1, 1, '', '', '', '', '0', 1, 1, '', 0, 0),
		('news', 'news', 'news', 'News', '', 1270400000, 1, 1, '', '', '', '', '0', 2, 1, '', 1, 0),
		('users', 'users', 'users', 'Users', 'Users', 1274080277, 1, 1, '', '', '', '', '0', 3, 1, '', 0, 0),
		('contact', 'contact', 'contact', 'Contact', '', 1275351337, 1, 1, '', '', '', '', '0', 4, 1, '', 0, 0),
		('statistics', 'statistics', 'statistics', 'Statistics', '', 1276520928, 1, 0, '', '', '', '', '0', 5, 1, '', 0, 0),
		('voting', 'voting', 'voting', 'Voting', '', 1275315261, 1, 1, '', '', '', '', '0', 6, 1, '', 1, 0),
		('banners', 'banners', 'banners', 'Banners', '', 1270400000, 1, 1, '', '', '', '', '0', 7, 1, '', 0, 0),
		('seek', 'seek', 'seek', 'Search', '', 1273474173, 1, 0, '', '', '', '', '0', 8, 1, '', 0, 0),
		('menu', 'menu', 'menu', 'Menu Site', '', 1295287334, 0, 1, '', '', '', '', '0', 9, 1, '', 0, 0),
		('feeds', 'feeds', 'feeds', 'Rss Feeds', '', 1279366705, 1, 1, '', '', '', '', '0', 10, 1, '', 0, 0),
		('page', 'page', 'page', 'Page', '', 1279366705, 1, 1, '', '', '', '', '0', 11, 1, '', 0, 0),
