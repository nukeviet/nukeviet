...
$lang_module['extNote2'] = 'Ứng dụng chưa được cài đặt. Hãy click để tải về';
$lang_module['extNote2_link'] = 'Các ứng dụng mới';
$lang_module['extNote3'] = '<a title="Hãy Click để tải mới" href="%s">Phiên bản không xác định</a>';
$lang_module['extNote4'] = '<a title="Hãy Click để tải về" href="%s">Cần cập nhật phiên bản mới</a>';
