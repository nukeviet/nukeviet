...
$lang_module['nv_data_note'] = 'Để thêm mới ngôn ngữ dữ liệu, bạn cần kích hoạt chức năng đa ngôn ngữ, tạo trước ngôn ngữ giao diện, xuất ra file và cấu hình cho phép hiển thị trong admin';
