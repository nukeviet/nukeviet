...
$lang_module['update_semiautomatic'] = 'Đây là gói cập nhật đòi hỏi bạn phải di chuyển các file trước khi có thể nâng cấp CSDL. Hãy di chuyển toàn bộ files và folders trong <strong>install/update/</strong> ra ngoài thư mục gốc của website (thư mục chứa index.php, CJzip.php, robots.php...). Sau khi thực hiện thành công nhấp vào "<strong>Bước kế tiếp</strong>" để tiếp tục công việc';
...
$lang_module['update_file_info_win'] = 'Cảnh báo: Trên nền window việc di chuyển các file có thể sẽ không thực hiện được, chúng tôi khuyến khích bạn thực hiện di chuyển thủ công các files và folders trong <strong>install/update/</strong> ra ngoài thư mục gốc của website (thư mục chứa index.php, CJzip.php, robots.php...).';
...
$lang_module['update_ftp_nosupport'] = 'Cảnh báo: Hosting không hỗ trợ FTP, chúng tôi khuyến cáo bạn thực hiện di chuyển thủ công các files và folders trong <strong>install/update/</strong> ra ngoài thư mục gốc của website (thư mục chứa index.php, CJzip.php, robots.php...).';
...
$lang_module['update_move_redo_manual'] = 'Hoặc bạn nên di chuyển thủ công các files và folders trong <strong>install/update/</strong> ra ngoài thư mục gốc của website (thư mục chứa index.php, CJzip.php, robots.php...).';
