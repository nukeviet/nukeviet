...
$lang_module['closed_ssl'] = 'Kích hoạt chế độ sử dụng SSL';
$lang_module['note_ssl'] = 'Bạn có chấc chắn site bạn hỗ trợ https không, nếu không hỗ trợ sẽ không truy cập được site sau khi lưu?';
