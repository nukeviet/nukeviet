...
$sql_create_table[] = "CREATE TABLE " . NV_USERS_GLOBALTABLE . "_reg (
	...
	question VARCHAR2(255 CHAR) DEFAULT '' NOT NULL ENABLE,
	answer VARCHAR2(255 CHAR) DEFAULT '' NOT NULL ENABLE,
	checknum VARCHAR2(50 CHAR) DEFAULT '' NOT NULL ENABLE,
	users_info CLOB NOT NULL ENABLE,
	primary key (userid),
...
$sql_create_table[] = "CREATE TABLE " . NV_USERS_GLOBALTABLE . "_field (
	...
	field_choices CLOB NOT NULL ENABLE,
...
$sql_create_table[] = "CREATE OR REPLACE TRIGGER TNV_USERS_EDITABLE
	BEFORE INSERT OR UPDATE ON nv3_users_field
	FOR EACH ROW
	DECLARE
...
$sql_create_table[] = "CREATE TABLE " . $db_config['prefix'] . "_banners_rows (
	...
	file_alt VARCHAR2(255 CHAR) DEFAULT '' NOT NULL ENABLE,
	imageforswf VARCHAR2(255 CHAR) DEFAULT '' NOT NULL ENABLE,
	click_url VARCHAR2(255 CHAR) DEFAULT '' NOT NULL ENABLE,
