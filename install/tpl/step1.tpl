...
<div id="thanks">
    ...
    <div class="list-member">
        ...
        <div class="list-member-other-version">
            ...
            <div class="version">
                <h5>{LANG.thanks_other_version} 4.6.02</h5>
                    <a target="_blank" href="https://github.com/vinades">VINADES.,JSC (15 commits)</a>
                <h5>{LANG.thanks_other_version} 4.6.01</h5>
                    <a target="_blank" href="https://github.com/vinades">VINADES.,JSC (30 commits)</a>
                <h5>{LANG.thanks_other_version} 4.6.00</h5>
                    <a target="_blank" href="https://github.com/vinades">VINADES.,JSC (26 commits)</a>
                <h5>{LANG.thanks_other_version} 4.5.09</h5>
                    <a target="_blank" href="https://github.com/vinades">VINADES.,JSC (50 commits)</a>
                ...
                <h5>{LANG.thanks_other_version} 4.5.04</h5>
                    <a target="_blank" href="https://github.com/vinades">VINADES.,JSC (38 commits)</a>,
                    <a target="_blank" href="https://github.com/hoaquynhtim99">hoaquynhtim99 (2 commits)</a>
