...
<div id="thanks">
    ...
    <div class="list-member">
        ...
        <div class="list-member-other-version">
            ...
            <div class="version">
                <h5>{LANG.thanks_other_version} 4.4.08</h5>
                    <a target="_blank" href="https://github.com/vinades">VINADES.,JSC (35 commits)</a>,
                ...
                <h5>{LANG.thanks_other_version} 4.4.06</h5>
                    <a target="_blank" href="https://github.com/vinades">VINADES.,JSC (42 commits)</a>,
