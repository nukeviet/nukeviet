...
$sth->execute( array(11, 'rss', 'rss', 'Rss', 'news', 1, 0, 1, '') );
$sth->execute( array(12, 'savefile', 'savefile', 'Savefile', 'news', 0, 0, 0, '') );
$sth->execute( array(13, 'search', 'search', 'Search', 'news', 1, 0, 6, '') );
...
$sth->execute( array(11, 'body-right', 'modern') );
...
$sth->execute( array(1, 'default', 'news', 'global.block_category.php', 'Menu', '', 'no_title', '[LEFT]', 0, 1, '0', 0, 1, 'a:1:{s:12:"title_length";i:25;}') );
$sth->execute( array(2, 'default', 'statistics', 'global.counter.php', 'Thống kê truy cập', '', 'primary', '[LEFT]', 0, 1, '0', 1, 2, '') );
...
$sth->execute( array(5, 'default', 'users', 'global.login.php', 'Đăng nhập thành viên', '', 'primary', '[RIGHT]', 0, 1, '0', 1, 2, '') );
$sth->execute( array(6, 'default', 'voting', 'global.voting_random.php', 'Thăm dò ý kiến', '', 'primary', '[RIGHT]', 0, 1, '0', 1, 3, '') );
$sth->execute( array(7, 'default', 'news', 'module.block_newscenter.php', 'Tin mới nhất', '', 'no_title', '[TOP]', 0, 1, '0', 0, 1, '') );
$sth->execute( array(8, 'default', 'banners', 'global.banners.php', 'Quảng cáo giữa trang', '', 'no_title', '[TOP]', 0, 1, '0', 1, 2, 'a:1:{s:12:"idplanbanner";i:1;}') );
$sth->execute( array(9, 'modern', 'news', 'module.block_newscenter.php', 'Tin mới nhất', '', 'no_title', '[HEADER]', 0, 1, '0', 0, 1, '') );
$sth->execute( array(10, 'modern', 'about', 'global.about.php', 'Giới thiệu', '', 'no_title_html', '[RIGHT]', 0, 1, '0', 1, 1, '') );
$sth->execute( array(11, 'modern', 'users', 'global.login.php', 'Đăng nhập', '', '', '[RIGHT]', 0, 1, '0', 1, 2, '') );
$sth->execute( array(12, 'modern', 'voting', 'global.voting_random.php', 'Thăm dò ý kiến', '', '', '[RIGHT]', 0, 1, '0', 1, 3, '') );
...
$sth->execute( array(1, 5, 1) );
$sth->execute( array(1, 6, 1) );
$sth->execute( array(1, 7, 1) );
$sth->execute( array(1, 13, 1) );
$sth->execute( array(1, 15, 1) );
$sth->execute( array(1, 16, 1) );
$sth->execute( array(2, 2, 1) );
$sth->execute( array(2, 36, 1) );
$sth->execute( array(2, 39, 1) );
$sth->execute( array(2, 42, 1) );
$sth->execute( array(2, 43, 1) );
$sth->execute( array(2, 27, 1) );
$sth->execute( array(2, 5, 2) );
$sth->execute( array(2, 6, 2) );
$sth->execute( array(2, 7, 2) );
$sth->execute( array(2, 13, 2) );
$sth->execute( array(2, 15, 2) );
$sth->execute( array(2, 16, 2) );
$sth->execute( array(2, 47, 1) );
$sth->execute( array(2, 46, 1) );
$sth->execute( array(2, 28, 1) );
$sth->execute( array(2, 29, 1) );
$sth->execute( array(2, 30, 1) );
$sth->execute( array(2, 31, 1) );
$sth->execute( array(2, 32, 1) );
$sth->execute( array(2, 33, 1) );
$sth->execute( array(2, 34, 1) );
$sth->execute( array(2, 17, 1) );
$sth->execute( array(2, 25, 1) );
$sth->execute( array(2, 24, 1) );
$sth->execute( array(2, 23, 1) );
$sth->execute( array(2, 22, 1) );
$sth->execute( array(2, 21, 1) );
$sth->execute( array(2, 20, 1) );
$sth->execute( array(2, 19, 1) );
$sth->execute( array(2, 18, 1) );
$sth->execute( array(2, 26, 1) );
$sth->execute( array(3, 2, 2) );
$sth->execute( array(3, 36, 2) );
$sth->execute( array(3, 39, 2) );
$sth->execute( array(3, 42, 2) );
$sth->execute( array(3, 43, 2) );
$sth->execute( array(3, 27, 2) );
$sth->execute( array(3, 5, 3) );
$sth->execute( array(3, 6, 3) );
$sth->execute( array(3, 7, 3) );
$sth->execute( array(3, 13, 3) );
$sth->execute( array(3, 15, 3) );
$sth->execute( array(3, 16, 3) );
$sth->execute( array(3, 47, 2) );
$sth->execute( array(3, 46, 2) );
$sth->execute( array(3, 28, 2) );
$sth->execute( array(3, 29, 2) );
$sth->execute( array(3, 30, 2) );
$sth->execute( array(3, 31, 2) );
$sth->execute( array(3, 32, 2) );
$sth->execute( array(3, 33, 2) );
$sth->execute( array(3, 34, 2) );
$sth->execute( array(3, 17, 2) );
$sth->execute( array(3, 25, 2) );
$sth->execute( array(3, 24, 2) );
$sth->execute( array(3, 23, 2) );
$sth->execute( array(3, 22, 2) );
$sth->execute( array(3, 21, 2) );
$sth->execute( array(3, 20, 2) );
$sth->execute( array(3, 19, 2) );
$sth->execute( array(3, 18, 2) );
$sth->execute( array(3, 26, 2) );
$sth->execute( array(4, 2, 1) );
$sth->execute( array(4, 36, 1) );
$sth->execute( array(4, 39, 1) );
$sth->execute( array(4, 42, 1) );
$sth->execute( array(4, 43, 1) );
$sth->execute( array(4, 27, 1) );
$sth->execute( array(4, 5, 1) );
$sth->execute( array(4, 6, 1) );
$sth->execute( array(4, 7, 1) );
$sth->execute( array(4, 13, 1) );
$sth->execute( array(4, 15, 1) );
$sth->execute( array(4, 16, 1) );
$sth->execute( array(4, 47, 1) );
$sth->execute( array(4, 46, 1) );
$sth->execute( array(4, 28, 1) );
$sth->execute( array(4, 29, 1) );
$sth->execute( array(4, 30, 1) );
$sth->execute( array(4, 31, 1) );
$sth->execute( array(4, 32, 1) );
$sth->execute( array(4, 33, 1) );
$sth->execute( array(4, 34, 1) );
$sth->execute( array(4, 17, 1) );
$sth->execute( array(4, 25, 1) );
$sth->execute( array(4, 24, 1) );
$sth->execute( array(4, 23, 1) );
$sth->execute( array(4, 22, 1) );
$sth->execute( array(4, 21, 1) );
$sth->execute( array(4, 20, 1) );
$sth->execute( array(4, 19, 1) );
$sth->execute( array(4, 18, 1) );
$sth->execute( array(4, 26, 1) );
$sth->execute( array(5, 2, 2) );
$sth->execute( array(5, 36, 2) );
$sth->execute( array(5, 39, 2) );
$sth->execute( array(5, 42, 2) );
$sth->execute( array(5, 43, 2) );
$sth->execute( array(5, 27, 2) );
$sth->execute( array(5, 5, 2) );
$sth->execute( array(5, 6, 2) );
$sth->execute( array(5, 7, 2) );
$sth->execute( array(5, 13, 2) );
$sth->execute( array(5, 15, 2) );
$sth->execute( array(5, 16, 2) );
$sth->execute( array(5, 47, 2) );
$sth->execute( array(5, 46, 2) );
$sth->execute( array(5, 28, 2) );
$sth->execute( array(5, 29, 2) );
$sth->execute( array(5, 30, 2) );
$sth->execute( array(5, 31, 2) );
$sth->execute( array(5, 32, 2) );
$sth->execute( array(5, 33, 2) );
$sth->execute( array(5, 34, 2) );
$sth->execute( array(5, 17, 2) );
$sth->execute( array(5, 25, 2) );
$sth->execute( array(5, 24, 2) );
$sth->execute( array(5, 23, 2) );
$sth->execute( array(5, 22, 2) );
$sth->execute( array(5, 21, 2) );
$sth->execute( array(5, 20, 2) );
$sth->execute( array(5, 19, 2) );
$sth->execute( array(5, 18, 2) );
$sth->execute( array(5, 26, 2) );
$sth->execute( array(6, 2, 3) );
$sth->execute( array(6, 36, 3) );
$sth->execute( array(6, 39, 3) );
$sth->execute( array(6, 42, 3) );
$sth->execute( array(6, 43, 3) );
$sth->execute( array(6, 27, 3) );
$sth->execute( array(6, 5, 3) );
$sth->execute( array(6, 6, 3) );
$sth->execute( array(6, 7, 3) );
$sth->execute( array(6, 13, 3) );
$sth->execute( array(6, 15, 3) );
$sth->execute( array(6, 16, 3) );
$sth->execute( array(6, 47, 3) );
$sth->execute( array(6, 46, 3) );
$sth->execute( array(6, 28, 3) );
$sth->execute( array(6, 29, 3) );
$sth->execute( array(6, 30, 3) );
$sth->execute( array(6, 31, 3) );
$sth->execute( array(6, 32, 3) );
$sth->execute( array(6, 33, 3) );
$sth->execute( array(6, 34, 3) );
$sth->execute( array(6, 17, 3) );
$sth->execute( array(6, 25, 3) );
$sth->execute( array(6, 24, 3) );
$sth->execute( array(6, 23, 3) );
$sth->execute( array(6, 22, 3) );
$sth->execute( array(6, 21, 3) );
$sth->execute( array(6, 20, 3) );
$sth->execute( array(6, 19, 3) );
$sth->execute( array(6, 18, 3) );
$sth->execute( array(6, 26, 3) );
$sth->execute( array(7, 7, 1) );
$sth->execute( array(8, 2, 1) );
$sth->execute( array(8, 36, 1) );
$sth->execute( array(8, 39, 1) );
$sth->execute( array(8, 42, 1) );
$sth->execute( array(8, 43, 1) );
$sth->execute( array(8, 27, 1) );
$sth->execute( array(8, 5, 1) );
$sth->execute( array(8, 6, 1) );
$sth->execute( array(8, 7, 2) );
$sth->execute( array(8, 13, 1) );
$sth->execute( array(8, 15, 1) );
$sth->execute( array(8, 16, 1) );
$sth->execute( array(8, 47, 1) );
$sth->execute( array(8, 46, 1) );
$sth->execute( array(8, 28, 1) );
$sth->execute( array(8, 29, 1) );
$sth->execute( array(8, 30, 1) );
$sth->execute( array(8, 31, 1) );
$sth->execute( array(8, 32, 1) );
$sth->execute( array(8, 33, 1) );
$sth->execute( array(8, 34, 1) );
$sth->execute( array(8, 17, 1) );
$sth->execute( array(8, 25, 1) );
$sth->execute( array(8, 24, 1) );
$sth->execute( array(8, 23, 1) );
$sth->execute( array(8, 22, 1) );
$sth->execute( array(8, 21, 1) );
$sth->execute( array(8, 20, 1) );
$sth->execute( array(8, 19, 1) );
$sth->execute( array(8, 18, 1) );
$sth->execute( array(8, 26, 1) );
$sth->execute( array(9, 7, 1) );
$sth->execute( array(10, 2, 1) );
$sth->execute( array(10, 36, 1) );
$sth->execute( array(10, 39, 1) );
$sth->execute( array(10, 42, 1) );
$sth->execute( array(10, 43, 1) );
$sth->execute( array(10, 27, 1) );
$sth->execute( array(10, 5, 1) );
$sth->execute( array(10, 6, 1) );
$sth->execute( array(10, 7, 1) );
$sth->execute( array(10, 13, 1) );
$sth->execute( array(10, 15, 1) );
$sth->execute( array(10, 16, 1) );
$sth->execute( array(10, 47, 1) );
$sth->execute( array(10, 46, 1) );
$sth->execute( array(10, 28, 1) );
$sth->execute( array(10, 29, 1) );
$sth->execute( array(10, 30, 1) );
$sth->execute( array(10, 31, 1) );
$sth->execute( array(10, 32, 1) );
$sth->execute( array(10, 33, 1) );
$sth->execute( array(10, 34, 1) );
$sth->execute( array(10, 17, 1) );
$sth->execute( array(10, 25, 1) );
$sth->execute( array(10, 24, 1) );
$sth->execute( array(10, 23, 1) );
$sth->execute( array(10, 22, 1) );
$sth->execute( array(10, 21, 1) );
$sth->execute( array(10, 20, 1) );
$sth->execute( array(10, 19, 1) );
$sth->execute( array(10, 18, 1) );
$sth->execute( array(10, 26, 1) );
$sth->execute( array(11, 2, 2) );
$sth->execute( array(11, 36, 2) );
$sth->execute( array(11, 39, 2) );
$sth->execute( array(11, 42, 2) );
$sth->execute( array(11, 43, 2) );
$sth->execute( array(11, 27, 2) );
$sth->execute( array(11, 5, 2) );
$sth->execute( array(11, 6, 2) );
$sth->execute( array(11, 7, 2) );
$sth->execute( array(11, 13, 2) );
$sth->execute( array(11, 15, 2) );
$sth->execute( array(11, 16, 2) );
$sth->execute( array(11, 47, 2) );
$sth->execute( array(11, 46, 2) );
$sth->execute( array(11, 28, 2) );
$sth->execute( array(11, 29, 2) );
$sth->execute( array(11, 30, 2) );
$sth->execute( array(11, 31, 2) );
$sth->execute( array(11, 32, 2) );
$sth->execute( array(11, 33, 2) );
$sth->execute( array(11, 34, 2) );
$sth->execute( array(11, 17, 2) );
$sth->execute( array(11, 25, 2) );
$sth->execute( array(11, 24, 2) );
$sth->execute( array(11, 23, 2) );
$sth->execute( array(11, 22, 2) );
$sth->execute( array(11, 21, 2) );
$sth->execute( array(11, 20, 2) );
$sth->execute( array(11, 19, 2) );
$sth->execute( array(11, 18, 2) );
$sth->execute( array(11, 26, 2) );
$sth->execute( array(12, 2, 3) );
$sth->execute( array(12, 36, 3) );
$sth->execute( array(12, 39, 3) );
$sth->execute( array(12, 42, 3) );
$sth->execute( array(12, 43, 3) );
$sth->execute( array(12, 27, 3) );
$sth->execute( array(12, 5, 3) );
$sth->execute( array(12, 6, 3) );
$sth->execute( array(12, 7, 3) );
$sth->execute( array(12, 13, 3) );
$sth->execute( array(12, 15, 3) );
$sth->execute( array(12, 16, 3) );
$sth->execute( array(12, 47, 3) );
$sth->execute( array(12, 46, 3) );
$sth->execute( array(12, 28, 3) );
$sth->execute( array(12, 29, 3) );
$sth->execute( array(12, 30, 3) );
$sth->execute( array(12, 31, 3) );
$sth->execute( array(12, 32, 3) );
$sth->execute( array(12, 33, 3) );
$sth->execute( array(12, 34, 3) );
$sth->execute( array(12, 17, 3) );
$sth->execute( array(12, 25, 3) );
$sth->execute( array(12, 24, 3) );
$sth->execute( array(12, 23, 3) );
$sth->execute( array(12, 22, 3) );
$sth->execute( array(12, 21, 3) );
$sth->execute( array(12, 20, 3) );
$sth->execute( array(12, 19, 3) );
$sth->execute( array(12, 18, 3) );
$sth->execute( array(12, 26, 3) );
$sth->execute( array(13, 2, 4) );
$sth->execute( array(13, 36, 4) );
$sth->execute( array(13, 39, 4) );
$sth->execute( array(13, 42, 4) );
$sth->execute( array(13, 43, 4) );
$sth->execute( array(13, 27, 4) );
$sth->execute( array(13, 5, 4) );
$sth->execute( array(13, 6, 4) );
$sth->execute( array(13, 7, 4) );
$sth->execute( array(13, 13, 4) );
$sth->execute( array(13, 15, 4) );
$sth->execute( array(13, 16, 4) );
$sth->execute( array(13, 47, 4) );
$sth->execute( array(13, 46, 4) );
$sth->execute( array(13, 28, 4) );
$sth->execute( array(13, 29, 4) );
$sth->execute( array(13, 30, 4) );
$sth->execute( array(13, 31, 4) );
$sth->execute( array(13, 32, 4) );
$sth->execute( array(13, 33, 4) );
$sth->execute( array(13, 34, 4) );
$sth->execute( array(13, 17, 4) );
$sth->execute( array(13, 25, 4) );
$sth->execute( array(13, 24, 4) );
$sth->execute( array(13, 23, 4) );
$sth->execute( array(13, 22, 4) );
$sth->execute( array(13, 21, 4) );
$sth->execute( array(13, 20, 4) );
$sth->execute( array(13, 19, 4) );
$sth->execute( array(13, 18, 4) );
$sth->execute( array(13, 26, 4) );
$sth->execute( array(14, 5, 5) );
$sth->execute( array(14, 6, 5) );
$sth->execute( array(14, 7, 5) );
$sth->execute( array(14, 13, 5) );
$sth->execute( array(14, 15, 5) );
$sth->execute( array(14, 16, 5) );
$sth->execute( array(15, 2, 1) );
$sth->execute( array(15, 36, 1) );
$sth->execute( array(15, 39, 1) );
$sth->execute( array(15, 42, 1) );
$sth->execute( array(15, 43, 1) );
$sth->execute( array(15, 27, 1) );
$sth->execute( array(15, 5, 1) );
$sth->execute( array(15, 6, 1) );
$sth->execute( array(15, 7, 1) );
$sth->execute( array(15, 13, 1) );
$sth->execute( array(15, 15, 1) );
$sth->execute( array(15, 16, 1) );
$sth->execute( array(15, 47, 1) );
$sth->execute( array(15, 46, 1) );
$sth->execute( array(15, 28, 1) );
$sth->execute( array(15, 29, 1) );
$sth->execute( array(15, 30, 1) );
$sth->execute( array(15, 31, 1) );
$sth->execute( array(15, 32, 1) );
$sth->execute( array(15, 33, 1) );
$sth->execute( array(15, 34, 1) );
$sth->execute( array(15, 17, 1) );
$sth->execute( array(15, 25, 1) );
$sth->execute( array(15, 24, 1) );
$sth->execute( array(15, 23, 1) );
$sth->execute( array(15, 22, 1) );
$sth->execute( array(15, 21, 1) );
$sth->execute( array(15, 20, 1) );
$sth->execute( array(15, 19, 1) );
$sth->execute( array(15, 18, 1) );
$sth->execute( array(15, 26, 1) );
$sth->execute( array(16, 2, 1) );
$sth->execute( array(16, 36, 1) );
$sth->execute( array(16, 39, 1) );
$sth->execute( array(16, 42, 1) );
$sth->execute( array(16, 43, 1) );
$sth->execute( array(16, 27, 1) );
$sth->execute( array(16, 5, 1) );
$sth->execute( array(16, 6, 1) );
$sth->execute( array(16, 7, 1) );
$sth->execute( array(16, 13, 1) );
$sth->execute( array(16, 15, 1) );
$sth->execute( array(16, 16, 1) );
$sth->execute( array(16, 47, 1) );
$sth->execute( array(16, 46, 1) );
$sth->execute( array(16, 33, 1) );
$sth->execute( array(16, 32, 1) );
$sth->execute( array(16, 30, 1) );
$sth->execute( array(16, 29, 1) );
$sth->execute( array(16, 31, 1) );
$sth->execute( array(16, 28, 1) );
$sth->execute( array(16, 34, 1) );
$sth->execute( array(16, 24, 1) );
$sth->execute( array(16, 20, 1) );
$sth->execute( array(16, 21, 1) );
$sth->execute( array(16, 26, 1) );
$sth->execute( array(16, 23, 1) );
$sth->execute( array(16, 18, 1) );
$sth->execute( array(16, 25, 1) );
$sth->execute( array(16, 17, 1) );
$sth->execute( array(16, 22, 1) );
$sth->execute( array(16, 19, 1) );
$sth->execute( array(17, 2, 1) );
$sth->execute( array(17, 36, 1) );
$sth->execute( array(17, 39, 1) );
$sth->execute( array(17, 42, 1) );
$sth->execute( array(17, 43, 1) );
$sth->execute( array(17, 27, 1) );
$sth->execute( array(17, 5, 1) );
$sth->execute( array(17, 6, 1) );
$sth->execute( array(17, 7, 1) );
$sth->execute( array(17, 13, 1) );
$sth->execute( array(17, 15, 1) );
$sth->execute( array(17, 16, 1) );
$sth->execute( array(17, 47, 1) );
$sth->execute( array(17, 46, 1) );
$sth->execute( array(17, 33, 1) );
$sth->execute( array(17, 32, 1) );
$sth->execute( array(17, 30, 1) );
$sth->execute( array(17, 29, 1) );
$sth->execute( array(17, 31, 1) );
$sth->execute( array(17, 28, 1) );
$sth->execute( array(17, 34, 1) );
$sth->execute( array(17, 24, 1) );
$sth->execute( array(17, 20, 1) );
$sth->execute( array(17, 21, 1) );
$sth->execute( array(17, 26, 1) );
$sth->execute( array(17, 23, 1) );
$sth->execute( array(17, 18, 1) );
$sth->execute( array(17, 25, 1) );
$sth->execute( array(17, 17, 1) );
$sth->execute( array(17, 22, 1) );
$sth->execute( array(17, 19, 1) );
$sth->execute( array(18, 2, 1) );
$sth->execute( array(18, 36, 1) );
$sth->execute( array(18, 39, 1) );
$sth->execute( array(18, 42, 1) );
$sth->execute( array(18, 43, 1) );
$sth->execute( array(18, 27, 1) );
$sth->execute( array(18, 5, 1) );
$sth->execute( array(18, 6, 1) );
$sth->execute( array(18, 7, 1) );
$sth->execute( array(18, 13, 1) );
$sth->execute( array(18, 15, 1) );
$sth->execute( array(18, 16, 1) );
$sth->execute( array(18, 47, 1) );
$sth->execute( array(18, 46, 1) );
$sth->execute( array(18, 33, 1) );
$sth->execute( array(18, 32, 1) );
$sth->execute( array(18, 30, 1) );
$sth->execute( array(18, 29, 1) );
$sth->execute( array(18, 31, 1) );
$sth->execute( array(18, 28, 1) );
$sth->execute( array(18, 34, 1) );
$sth->execute( array(18, 24, 1) );
$sth->execute( array(18, 20, 1) );
$sth->execute( array(18, 21, 1) );
$sth->execute( array(18, 26, 1) );
$sth->execute( array(18, 23, 1) );
$sth->execute( array(18, 18, 1) );
$sth->execute( array(18, 25, 1) );
$sth->execute( array(18, 17, 1) );
$sth->execute( array(18, 22, 1) );
$sth->execute( array(18, 19, 1) );
$sth->execute( array(19, 2, 1) );
$sth->execute( array(19, 36, 1) );
$sth->execute( array(19, 39, 1) );
$sth->execute( array(19, 42, 1) );
$sth->execute( array(19, 43, 1) );
$sth->execute( array(19, 27, 1) );
$sth->execute( array(19, 5, 1) );
$sth->execute( array(19, 6, 1) );
$sth->execute( array(19, 7, 1) );
$sth->execute( array(19, 13, 1) );
$sth->execute( array(19, 15, 1) );
$sth->execute( array(19, 16, 1) );
$sth->execute( array(19, 47, 1) );
$sth->execute( array(19, 46, 1) );
$sth->execute( array(19, 33, 1) );
$sth->execute( array(19, 32, 1) );
$sth->execute( array(19, 30, 1) );
$sth->execute( array(19, 29, 1) );
$sth->execute( array(19, 31, 1) );
$sth->execute( array(19, 28, 1) );
$sth->execute( array(19, 34, 1) );
$sth->execute( array(19, 24, 1) );
$sth->execute( array(19, 20, 1) );
$sth->execute( array(19, 21, 1) );
$sth->execute( array(19, 26, 1) );
$sth->execute( array(19, 23, 1) );
$sth->execute( array(19, 18, 1) );
$sth->execute( array(19, 25, 1) );
$sth->execute( array(19, 17, 1) );
$sth->execute( array(19, 22, 1) );
$sth->execute( array(19, 19, 1) );
$sth->execute( array(19, 48, 1) );
$sth->execute( array(2, 48, 1) );
$sth->execute( array(3, 48, 2) );
$sth->execute( array(17, 48, 1) );
$sth->execute( array(4, 48, 1) );
$sth->execute( array(5, 48, 2) );
$sth->execute( array(6, 48, 3) );
$sth->execute( array(8, 48, 1) );
$sth->execute( array(18, 48, 1) );
$sth->execute( array(16, 48, 1) );
$sth->execute( array(10, 48, 1) );
$sth->execute( array(11, 48, 2) );
$sth->execute( array(12, 48, 3) );
$sth->execute( array(13, 48, 4) );
$sth->execute( array(15, 48, 1) );

$sth->execute( array(20, 2, 1) );
$sth->execute( array(20, 36, 1) );
$sth->execute( array(20, 39, 1) );
$sth->execute( array(20, 42, 1) );
$sth->execute( array(20, 43, 1) );
$sth->execute( array(20, 27, 1) );
$sth->execute( array(20, 5, 1) );
$sth->execute( array(20, 6, 1) );
$sth->execute( array(20, 7, 1) );
$sth->execute( array(20, 13, 1) );
$sth->execute( array(20, 15, 1) );
$sth->execute( array(20, 16, 1) );
$sth->execute( array(20, 47, 1) );
$sth->execute( array(20, 46, 1) );
$sth->execute( array(20, 33, 1) );
$sth->execute( array(20, 32, 1) );
$sth->execute( array(20, 30, 1) );
$sth->execute( array(20, 29, 1) );
$sth->execute( array(20, 31, 1) );
$sth->execute( array(20, 28, 1) );
$sth->execute( array(20, 34, 1) );
$sth->execute( array(20, 48, 1) );
$sth->execute( array(20, 24, 1) );
$sth->execute( array(20, 20, 1) );
$sth->execute( array(20, 21, 1) );
$sth->execute( array(20, 26, 1) );
$sth->execute( array(20, 23, 1) );
$sth->execute( array(20, 18, 1) );
$sth->execute( array(20, 25, 1) );
...
$sth->execute( array(12, 35, 3) );
$sth->execute( array(13, 35, 4) );
$sth->execute( array(15, 35, 1) );
$sth->execute( array(18, 35, 1) );
$sth->execute( array(17, 35, 1) );
$sth->execute( array(19, 35, 1) );
$sth->execute( array(2, 35, 1) );
$sth->execute( array(3, 35, 2) );
$sth->execute( array(4, 35, 1) );
$sth->execute( array(5, 35, 2) );
$sth->execute( array(6, 35, 3) );
$sth->execute( array(8, 35, 1) );
$sth->execute( array(20, 35, 1) );
$sth->execute( array(16, 50, 1) );
$sth->execute( array(10, 50, 1) );
$sth->execute( array(11, 50, 2) );
$sth->execute( array(12, 50, 3) );
$sth->execute( array(13, 50, 4) );
$sth->execute( array(15, 50, 1) );
$sth->execute( array(18, 50, 1) );
$sth->execute( array(17, 50, 1) );
$sth->execute( array(19, 50, 1) );
$sth->execute( array(2, 50, 1) );
$sth->execute( array(3, 50, 2) );
$sth->execute( array(4, 50, 1) );
$sth->execute( array(5, 50, 2) );
$sth->execute( array(6, 50, 3) );
$sth->execute( array(8, 50, 1) );
$sth->execute( array(20, 50, 1) );
$sth->execute( array(19, 52, 1) );
$sth->execute( array(2, 52, 1) );
$sth->execute( array(3, 52, 2) );
$sth->execute( array(17, 52, 1) );
$sth->execute( array(4, 52, 1) );
$sth->execute( array(5, 52, 2) );
$sth->execute( array(6, 52, 3) );
$sth->execute( array(8, 52, 1) );
$sth->execute( array(20, 52, 1) );
$sth->execute( array(18, 52, 1) );
$sth->execute( array(16, 52, 1) );
$sth->execute( array(10, 52, 1) );
$sth->execute( array(11, 52, 2) );
$sth->execute( array(12, 52, 3) );
$sth->execute( array(13, 52, 4) );
$sth->execute( array(15, 52, 1) );
$sth->execute( array(16, 11, 1) );
$sth->execute( array(16, 51, 1) );
$sth->execute( array(10, 11, 1) );
$sth->execute( array(10, 51, 1) );
$sth->execute( array(15, 11, 1) );
$sth->execute( array(15, 51, 1) );
$sth->execute( array(11, 11, 2) );
$sth->execute( array(11, 51, 2) );
$sth->execute( array(12, 11, 3) );
$sth->execute( array(12, 51, 3) );
$sth->execute( array(13, 11, 4) );
$sth->execute( array(13, 51, 4) );
$sth->execute( array(18, 11, 1) );
$sth->execute( array(18, 51, 1) );
$sth->execute( array(17, 11, 1) );
$sth->execute( array(17, 51, 1) );
$sth->execute( array(2, 11, 1) );
$sth->execute( array(2, 51, 1) );
$sth->execute( array(3, 11, 2) );
$sth->execute( array(3, 51, 2) );
$sth->execute( array(4, 11, 1) );
$sth->execute( array(4, 51, 1) );
$sth->execute( array(5, 11, 2) );
$sth->execute( array(5, 51, 2) );
$sth->execute( array(6, 11, 3) );
$sth->execute( array(6, 51, 3) );
...
{
	$db->query( "INSERT INTO " . $db_config['prefix'] . "_" . $lang_data . "_news_cat VALUES (1, 0, 'Tin tức', '', 'Tin-tuc', '', '', 0, 1, 1, 0, 'viewcat_main_right', 3, '8,12,9', 1, 4, '2', '', '', 1274986690, 1274986690, 0, '')" );
	$db->query( "INSERT INTO " . $db_config['prefix'] . "_" . $lang_data . "_news_cat VALUES (2, 0, 'Sản phẩm', '', 'San-pham', '', '', 0, 2, 5, 0, 'viewcat_page_new', 0, '', 1, 4, '2', '', '', 1274986705, 1274986705, 0, '')" );
	$db->query( "INSERT INTO " . $db_config['prefix'] . "_" . $lang_data . "_news_cat VALUES (8, 1, 'Thông cáo báo chí', '', 'thong-cao-bao-chi', '', '', 0, 1, 2, 1, 'viewcat_page_new', 0, '', 1, 4, '2', '', '', 1274987105, 1274987244, 0, '')" );
	$db->query( "INSERT INTO " . $db_config['prefix'] . "_" . $lang_data . "_news_cat VALUES (9, 1, 'Tin công nghệ', '', 'Tin-cong-nghe', '', '', 0, 3, 4, 1, 'viewcat_page_new', 0, '', 1, 4, '2', '', '', 1274987212, 1274987212, 0, '')" );
	$db->query( "INSERT INTO " . $db_config['prefix'] . "_" . $lang_data . "_news_cat VALUES (10, 0, 'Đối tác', '', 'Doi-tac', '', '', 0, 3, 9, 0, 'viewcat_main_right', 0, '', 1, 4, '2', '', '', 1274987460, 1274987460, 0, '')" );
	$db->query( "INSERT INTO " . $db_config['prefix'] . "_" . $lang_data . "_news_cat VALUES (11, 0, 'Tuyển dụng', '', 'Tuyen-dung', '', '', 0, 4, 12, 0, 'viewcat_page_new', 0, '', 1, 4, '2', '', '', 1274987538, 1274987538, 0, '')" );
	$db->query( "INSERT INTO " . $db_config['prefix'] . "_" . $lang_data . "_news_cat VALUES (12, 1, 'Bản tin nội bộ', '', 'Ban-tin-noi-bo', '', '', 0, 2, 3, 1, 'viewcat_page_new', 0, '', 1, 4, '2', '', '', 1274987902, 1274987902, 0, '')" );

	$db->query( "INSERT INTO " . $db_config['prefix'] . "_" . $lang_data . "_news_rows VALUES (1, 1, '1,8,12', 0, 1, 'Quỳnh Nhi', 1, 1274989177, 1275318126, 1, 1274989140, 0, 2, 'Ra mắt công ty mã nguồn mở đầu tiên tại Việt Nam', 'Ra-mat-cong-ty-ma-nguon-mo-dau-tien-tai-Viet-Nam', 'Mã nguồn mở NukeViet vốn đã quá quen thuộc với cộng đồng CNTT Việt Nam trong mấy năm qua. Tuy chưa hoạt động chính thức, nhưng chỉ trong khoảng 5 năm gần đây, mã nguồn mở NukeViet đã được dùng phổ biến ở Việt Nam, áp dụng ở hầu hết các lĩnh vực, từ tin tức đến thương mại điện tử, từ các website cá nhân cho tới những hệ thống website doanh nghiệp.', 'nangly.jpg', 'Thành lập VINADES.,JSC', 1, 1, 2, 1, 1, 0, 0, 0)" );
	$db->query( "INSERT INTO " . $db_config['prefix'] . "_" . $lang_data . "_news_rows VALUES (2, 1, '1,8,12', 1, 1, 'laser', 2, 1274989787, 1275318114, 1, 1274989740, 0, 2, 'Công bố dự án NukeViet 3.0 sau 1 tháng ra mắt VINADES.,JSC', 'Cong-bo-du-an-NukeViet-3-0-sau-1-thang-ra-mat-VINADES-JSC', 'NukeViet 3.0 - Một nền tảng được xây dựng hoàn toàn mới với những công nghệ web tiên tiến nhất hiện nay hứa hẹn sẽ làm một cuộc cách mạng về mã nguồn mở ở Việt Nam. Món quà này là lời cảm ơn chân thành nhất mà VINADES.,JSC muốn gửi tới cộng đồng sau một tháng chính thức ra mắt.', 'nukeviet3.jpg', 'NukeViet 3.0', 1, 1, 2, 1, 1, 0, 0, 0)" );
	$db->query( "INSERT INTO " . $db_config['prefix'] . "_" . $lang_data . "_news_rows VALUES (5, 2, '2', 1, 1, '', 5, 1274993307, 1275318039, 1, 1274993280, 0, 2, 'Giới thiệu về mã nguồn mở NukeViet', 'Gioi-thieu-ve-ma-nguon-mo-NukeViet', 'Chắc hẳn đây không phải lần đầu tiên bạn nghe nói đến mã nguồn mở. Và nếu bạn là người mê lướt web thì hẳn bạn từng nhìn thấy đâu đó cái tên NukeViet. NukeViet, phát âm là Nu-Ke-Việt, chính là phần mềm dùng để xây dựng các Website mà bạn ngày ngày online để truy cập đấy.', 'screenshot.jpg', '', 1, 0, 2, 1, 1, 0, 0, 0)" );
	$db->query( "INSERT INTO " . $db_config['prefix'] . "_" . $lang_data . "_news_rows VALUES (6, 10, '1,8,10', 0, 1, '', 2, 1274994722, 1275318001, 1, 1274994720, 0, 2, 'Thư mời hợp tác liên kết quảng cáo và cung cấp hosting thử nghiệm', 'Thu-moi-hop-tac', 'Hiện tại VINADES.,JSC đang tiến hành phát triển bộ mã nguồn NukeViet phiên bản 3.0 – một thế hệ CMS hoàn toàn mới với nhiều tính năng ưu việt, được đầu tư bài bản với kinh phí lớn. Với thiện chí hợp tác cùng phát triển VINADES.,JSC xin trân trọng gửi lời mời hợp tác đến Quý đối tác là các công ty cung cấp tên miền - hosting, các doanh nghiệp quan tâm và mong muốn hợp tác cùng VINADES để cùng thực hiện chung các hoạt động kinh doanh nhằm gia tăng giá trị, quảng bá thương hiệu chung cho cả hai bên.', 'hoptac.jpg', '', 1, 1, 2, 1, 1, 0, 0, 0)" );
	$db->query( "INSERT INTO " . $db_config['prefix'] . "_" . $lang_data . "_news_rows VALUES (7, 11, '11', 0, 1, '', 2, 1307197282, 1307197381, 1, 1307197260, 0, 2, 'Tuyển dụng lập trình viên, chuyên viên đồ họa phát triển NukeViet', 'Tuyen-dung-lap-trinh-vien-chuyen-vien-do-hoa-phat-trien-NukeViet', 'Bạn đam mê nguồn mở? Bạn có năng khiếu lập trình PHP & MySQL? Bạn là chuyên gia đồ họa, HTML, CSS? Chúng tôi sẽ giúp bạn hiện thực hóa ước mơ của mình với một mức lương đảm bảo. Hãy gia nhập VINADES.,JSC để xây dựng mã nguồn mở hàng đầu cho Việt Nam.', 'nukeviet-job.jpg', '', 1, 1, 2, 1, 1, 0, 0, 0)" );
	$db->query( "INSERT INTO " . $db_config['prefix'] . "_" . $lang_data . "_news_rows VALUES (8, 9, '9', 0, 1, 'laser', 3, 1310067949, 1310068009, 1, 1310067949, 0, 2, 'Webnhanh.vn - website dịch vụ chuyên nghiệp cho NukeViet chính thức ra mắt', 'Webnhanhvn-website-dich-vu-chuyen-nghiep-cho-NukeViet-chinh-thuc-ra-mat', 'Sau một thời gian đi vào hoạt động, Webnhanh.vn đã nhận được nhiều ủng hộ cùng sự quan tâm, góp ý của cộng đồng và khách hàng. Để đáp ứng mong mỏi của cộng đồng về một dịch vụ web chuyên nghiệp với mức giá tối thiểu, Webnhanh.vn đã thực hiện chiến dịch siêu khuyến mại Giảm giá tất cả các gói web dựng sẵn, module, block và giao diện (theme). Mức giảm giá cao nhất tới 90% giá so với trước tháng 7 năm 2011.', 'webnhanh-vn.jpg', '', 1, 1, 2, 1, 1, 0, 0, 0)" );
	$db->query( "INSERT INTO " . $db_config['prefix'] . "_" . $lang_data . "_news_rows VALUES (9, 2, '2', 0, 1, 'Phạm Thế Quang Huy', 4, 1322685396, 1322686088, 1, 1322685396, 0, 2, 'NukeViet - Công cụ mã nguồn mở cho cộng đồng thiết kế website Việt Nam', 'NukeViet-Cong-cu-ma-nguon-mo-cho-cong-dong-thiet-ke-website-Viet-Nam', '(Dân trí) - Là một trong những hệ quản trị nội dung nổi tiếng hàng đầu tại Việt Nam, NukeViet đã được áp dụng rộng rãi trong việc xây dựng nhiều trang báo điện tử và các cổng thông tin điện tử nổi tiếng tại Việt Nam. Mới đây nhất, NukeViet đã vượt qua vòng sơ khảo để tranh tài tại vòng chung khảo của Giải Thưởng Nhân Tài Đất Việt 2011', 'product_box.jpg', 'Sản phẩm dự thi Nhân tài Đất Việt 2011&#x3A; Mã nguồn mở NukeViet', 1, 1, 2, 1, 1, 0, 0, 0)" );
	$db->query( "INSERT INTO " . $db_config['prefix'] . "_" . $lang_data . "_news_rows VALUES (10, 1, '1,9', 0, 1, '', 4, 1322685920, 1322686042, 1, 1322685920, 0, 2, 'Mã nguồn mở NukeViet giành giải ba Nhân tài đất Việt 2011', 'Ma-nguon-mo-NukeViet-gianh-giai-ba-Nhan-tai-dat-Viet-2011', 'Không có giải nhất và giải nhì, sản phẩm Mã nguồn mở NukeViet của VINADES.,JSC là một trong ba sản phẩm đã đoạt giải ba Nhân tài đất Việt 2011 - Lĩnh vực Công nghệ thông tin (Sản phẩm đã ứng dụng rộng rãi).', 'nukeviet-nhantaidatviet2011.jpg', 'Mã nguồn mở NukeViet giành giải ba Nhân tài đất Việt 2011', 1, 1, 2, 1, 1, 0, 0, 0)" );

	// news_bodyhtml
	$sth = $db->prepare( "INSERT INTO " . $db_config['prefix'] . "_" . $lang_data . "_news_bodyhtml_1 VALUES (1, :bodyhtml, 'http://hanoimoi.com.vn/newsdetail/Cong_nghe/309750/ra-mat-cong-ty-ma-nguon-mo-dau-tien-tai-viet-nam.htm', 1, 0, 1, 1, 1, 0)" );
	...
	$db->query( "INSERT INTO " . $db_config['prefix'] . "_" . $lang_data . "_news_block_cat (bid, adddefault, numbers,title, alias, image, description, weight, keywords, add_time, edit_time) VALUES (1, 0, 4,'Tin tiêu điểm', 'Tin-tieu-diem', '', 'Tin tiêu điểm', 1, '', 1279945710, 1279956943)" );
	$db->query( "INSERT INTO " . $db_config['prefix'] . "_" . $lang_data . "_news_block_cat (bid, adddefault, numbers,title, alias, image, description, weight, keywords, add_time, edit_time) VALUES (2, 1, 4, 'Tin mới nhất', 'Tin-moi-nhat', '', 'Tin mới nhất', 2, '', 1279945725, 1279956445)" );

	$db->query( 'INSERT INTO ' . $db_config['prefix'] . '_' . $lang_data . '_news_block VALUES (1, 5, 3)' );
	$db->query( 'INSERT INTO ' . $db_config['prefix'] . '_' . $lang_data . '_news_block VALUES (1, 2, 2)' );
	$db->query( 'INSERT INTO ' . $db_config['prefix'] . '_' . $lang_data . '_news_block VALUES (1, 1, 1)' );
	$db->query( 'INSERT INTO ' . $db_config['prefix'] . '_' . $lang_data . '_news_block VALUES (2, 6, 4)' );
	$db->query( 'INSERT INTO ' . $db_config['prefix'] . '_' . $lang_data . '_news_block VALUES (2, 5, 3)' );
	$db->query( 'INSERT INTO ' . $db_config['prefix'] . '_' . $lang_data . '_news_block VALUES (2, 2, 2)' );
	$db->query( 'INSERT INTO ' . $db_config['prefix'] . '_' . $lang_data . '_news_block VALUES (2, 1, 1)' );

	$sth = $db->prepare( 'INSERT INTO ' . $db_config['prefix'] . '_' . $lang_data . '_news_tags (tid, numnews, alias, image, description, keywords) VALUES (?, ?, ?, ?, ?, ?)' );
	$sth->execute( array(1, 2, 'nguồn-mở', '', '', 'nguồn mở') );
	$sth->execute( array(2, 1, 'quen-thuộc', '', '', 'quen thuộc') );
	$sth->execute( array(3, 2, 'cộng-đồng', '', '', 'cộng đồng') );
	$sth->execute( array(4, 2, 'việt-nam', '', '', 'việt nam') );
	$sth->execute( array(5, 1, 'hoạt-động', '', '', 'hoạt động') );
	$sth->execute( array(6, 1, 'tin-tức', '', '', 'tin tức') );
	$sth->execute( array(7, 1, 'thương-mại-điện', '', '', 'thương mại điện') );
	$sth->execute( array(8, 1, 'điện-tử', '', '', 'điện tử') );
	$sth->execute( array(9, 3, 'nukeviet', '', '', 'nukeviet') );
	$sth->execute( array(10, 1, 'nền-tảng', '', '', 'nền tảng') );
	$sth->execute( array(11, 1, 'xây-dựng', '', '', 'xây dựng') );
	$sth->execute( array(12, 2, 'quản-trị', '', '', 'quản trị') );
	$sth->execute( array(13, 2, 'nội-dung', '', '', 'nội dung') );
	$sth->execute( array(14, 2, 'sử-dụng', '', '', 'sử dụng') );
	$sth->execute( array(15, 2, 'khả-năng', '', '', 'khả năng') );
	$sth->execute( array(16, 2, 'tích-hợp', '', '', 'tích hợp') );
	$sth->execute( array(17, 2, 'ứng-dụng', '', '', 'ứng dụng') );
	$sth->execute( array(18, 1, 'vinades', '', '', 'vinades') );
	$sth->execute( array(19, 1, 'lập-trình-viên', '', '', 'lập trình viên') );
	$sth->execute( array(20, 1, 'chuyên-viên-đồ-họa', '', '', 'chuyên viên đồ họa') );
	$sth->execute( array(21, 1, 'php', '', '', 'php') );
	$sth->execute( array(22, 1, 'mysql', '', '', 'mysql') );
	$sth->execute( array(23, 1, 'khai-trương', '', '', 'khai trương') );
	$sth->execute( array(24, 1, 'khuyến-mại', '', '', 'khuyến mại') );
	$sth->execute( array(25, 1, 'giảm-giá', '', '', 'giảm giá') );
	$sth->execute( array(26, 1, 'siêu-khuyến-mại', '', '', 'siêu khuyến mại') );
	$sth->execute( array(27, 1, 'webnhanh', '', '', 'webnhanh') );
	$sth->execute( array(28, 1, 'thiết-kế-website', '', '', 'thiết kế website') );
	$sth->execute( array(29, 1, 'giao-diện-web', '', '', 'giao diện web') );
	$sth->execute( array(30, 1, 'thiết-kế-web', '', '', 'thiết kế web') );
	$sth->execute( array(31, 2, 'nhân-tài-đất-việt-2011', '', '', 'nhân tài đất việt 2011') );
	$sth->execute( array(32, 2, 'mã-nguồn-mở', '', '', 'mã nguồn mở') );

	$sth = $db->prepare( "INSERT INTO " . $db_config['prefix'] . "_" . $lang_data . "_news_tags_id (id, tid, keyword) VALUES (?, ?, ?)" );
	$sth->execute( array(1, 1, 'nguồn mở') );
	$sth->execute( array(1, 2, 'quen thuộc') );
	$sth->execute( array(1, 3, 'cộng đồng') );
	$sth->execute( array(1, 4, 'việt nam') );
	$sth->execute( array(1, 5, 'hoạt động') );
	$sth->execute( array(1, 6, 'tin tức') );
	$sth->execute( array(1, 7, 'thương mại điện') );
	$sth->execute( array(1, 8, 'điện tử') );
	$sth->execute( array(1, 9, 'nukeviet') );
	$sth->execute( array(2, 10, 'nền tảng') );
	$sth->execute( array(2, 11, 'xây dựng') );
	$sth->execute( array(2, 1, 'nguồn mở') );
	$sth->execute( array(2, 4, 'việt nam') );
	$sth->execute( array(2, 3, 'cộng đồng') );
	$sth->execute( array(5, 12, 'quản trị') );
	$sth->execute( array(5, 13, 'nội dung') );
	$sth->execute( array(5, 14, 'sử dụng') );
	$sth->execute( array(5, 15, 'khả năng') );
	$sth->execute( array(5, 16, 'tích hợp') );
	$sth->execute( array(5, 17, 'ứng dụng') );
	$sth->execute( array(7, 18, 'vinades') );
	$sth->execute( array(7, 9, 'nukeviet') );
	$sth->execute( array(7, 19, 'lập trình viên') );
	$sth->execute( array(7, 20, 'chuyên viên đồ họa') );
	$sth->execute( array(7, 21, 'php') );
	$sth->execute( array(7, 22, 'mysql') );
	$sth->execute( array(8, 23, 'khai trương') );
	$sth->execute( array(8, 24, 'khuyến mại') );
	$sth->execute( array(8, 25, 'giảm giá') );
	$sth->execute( array(8, 26, 'siêu khuyến mại') );
	$sth->execute( array(8, 27, 'webnhanh') );
	$sth->execute( array(8, 28, 'thiết kế website') );
	$sth->execute( array(8, 29, 'giao diện web') );
	$sth->execute( array(8, 30, 'thiết kế web') );
	$sth->execute( array(9, 31, 'Nhân tài Đất Việt 2011') );
	$sth->execute( array(9, 32, 'mã nguồn mở') );
	$sth->execute( array(10, 31, 'Nhân tài đất Việt 2011') );
	$sth->execute( array(10, 32, 'mã nguồn mở') );
...
if( $result->fetchColumn() )
{
	$sth = $db->prepare( "INSERT INTO " . $db_config['prefix'] . "_" . $lang_data . "_about (id, title, alias, image, imagealt, description, bodytext, keywords, socialbutton, activecomm, facebookappid, layout_func, gid, weight, admin_id, add_time, edit_time, status) VALUES (1, 'Giới thiệu về NukeViet 3.0', 'Gioi-thieu-ve-NukeViet-3-0', '', '', '', :bodytext, '', 0, 0, '', '', 0, 1, 1, 1275320174, 1275320174, 1)" );
