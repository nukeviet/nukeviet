...
$sth->execute( array(17, 'active', 'active', 'Kích hoạt', 'users', 1, 0, 5, '') );
$sth->execute( array(18, 'changepass', 'changepass', 'Đổi mật khẩu', 'users', 1, 1, 9, '') );
$sth->execute( array(19, 'editinfo', 'editinfo', 'Sửa thông tin', 'users', 1, 1, 7, '') );
$sth->execute( array(20, 'login', 'login', 'Đăng nhập', 'users', 1, 1, 2, '') );
$sth->execute( array(21, 'logout', 'logout', 'Thoát', 'users', 1, 1, 14, '') );
$sth->execute( array(22, 'lostactivelink', 'lostactivelink', 'Lostactivelink', 'users', 1, 0, 6, '') );
$sth->execute( array(23, 'lostpass', 'lostpass', 'Quên mật khẩu', 'users', 1, 1, 4, '') );
$sth->execute( array(24, 'main', 'main', 'Main', 'users', 1, 0, 1, '') );
$sth->execute( array(25, 'openid', 'openid', 'Openid', 'users', 1, 1, 13, '') );
$sth->execute( array(26, 'register', 'register', 'Đăng ký', 'users', 1, 1, 3, '') );
...
$sth->execute( array(48, 'regroups', 'regroups', 'Nhóm thành viên', 'users', 1, 0, 8, '') );
$sth->execute( array(50, 'memberlist', 'memberlist', 'Danh sách thành viên', 'users', 1, 1, 10, '') );
...
$sth->execute( array(63, 'changequestion', 'changequestion', 'Thay đổi câu hỏi bảo mật', 'users', 1, 1, 12, '') );
...
$sth->execute( array(35, 'left-body', 'default') );
...
$sth->execute( array('default', 'voting', 'global.voting_random.php', 'Thăm dò ý kiến', '', 'primary', '[RIGHT]', 0, '1', '6', 1, 2, '') );
