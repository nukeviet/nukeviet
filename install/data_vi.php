...
{
	$db->query( "INSERT INTO " . $db_config['prefix'] . "_" . $lang_data . "_news_cat VALUES (1, 0, 'Tin tức', '', 'Tin-tuc', '', '', 0, 1, 1, 0, 'viewcat_main_right', 3, '8,12,9', 1, 4, '', '', 1274986690, 1274986690, 0, '')" );
	$db->query( "INSERT INTO " . $db_config['prefix'] . "_" . $lang_data . "_news_cat VALUES (2, 0, 'Sản phẩm', '', 'San-pham', '', '', 0, 2, 5, 0, 'viewcat_page_new', 0, '', 1, 4, '', '', 1274986705, 1274986705, 0, '')" );
	$db->query( "INSERT INTO " . $db_config['prefix'] . "_" . $lang_data . "_news_cat VALUES (8, 1, 'Thông cáo báo chí', '', 'thong-cao-bao-chi', '', '', 0, 1, 2, 1, 'viewcat_page_new', 0, '', 1, 4, '', '', 1274987105, 1274987244, 0, '')" );
	$db->query( "INSERT INTO " . $db_config['prefix'] . "_" . $lang_data . "_news_cat VALUES (9, 1, 'Tin công nghệ', '', 'Tin-cong-nghe', '', '', 0, 3, 4, 1, 'viewcat_page_new', 0, '', 1, 4, '', '', 1274987212, 1274987212, 0, '')" );
	$db->query( "INSERT INTO " . $db_config['prefix'] . "_" . $lang_data . "_news_cat VALUES (10, 0, 'Đối tác', '', 'Doi-tac', '', '', 0, 3, 9, 0, 'viewcat_main_right', 0, '', 1, 4, '', '', 1274987460, 1274987460, 0, '')" );
	$db->query( "INSERT INTO " . $db_config['prefix'] . "_" . $lang_data . "_news_cat VALUES (11, 0, 'Tuyển dụng', '', 'Tuyen-dung', '', '', 0, 4, 12, 0, 'viewcat_page_new', 0, '', 1, 4, '', '', 1274987538, 1274987538, 0, '')" );
	$db->query( "INSERT INTO " . $db_config['prefix'] . "_" . $lang_data . "_news_cat VALUES (12, 1, 'Bản tin nội bộ', '', 'Ban-tin-noi-bo', '', '', 0, 2, 3, 1, 'viewcat_page_new', 0, '', 1, 4, '', '', 1274987902, 1274987902, 0, '')" );
