...
$sql_create_table[] = 'INSERT INTO ' . NV_CONFIG_GLOBALTABLE . ' (lang, module, config_name, config_value) VALUES (\'sys\', \'site\', \'nv_csp\', \'{"default-src":{"self":1},"script-src":{"self":1,"unsafe-inline":1,"unsafe-eval":1,"hosts":["*.google.com","*.google-analytics.com","*.googletagmanager.com","*.gstatic.com","*.facebook.com","*.facebook.net","*.twitter.com","*.zalo.me","*.zaloapp.com","*.tawk.to","*.cloudflareinsights.com"]},"style-src":{"self":1,"data":1,"unsafe-inline":1,"hosts":["*.google.com","*.googleapis.com","*.tawk.to"]},"img-src":{"self":1,"data":1,"hosts":["*.twitter.com","*.google.com","*.googleapis.com","*.gstatic.com","*.facebook.com","tawk.link","*.tawk.to","static.nukeviet.vn"]},"font-src":{"self":1,"data":1,"hosts":["*.googleapis.com","*.gstatic.com","*.tawk.to"]},"connect-src":{"self":1,"hosts":["*.zalo.me","*.tawk.to","wss:\/\/*.tawk.to"]},"media-src":{"self":1,"hosts":["*.tawk.to"]},"frame-src":{"self":1,"hosts":["*.google.com","*.youtube.com","*.facebook.com","*.facebook.net","*.twitter.com","*.zalo.me"]},"form-action":{"self":1,"hosts":["*.google.com"]}}\')';
