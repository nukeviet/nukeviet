...
$sql_create_table[] = "INSERT INTO " . NV_GROUPS_GLOBALTABLE . " (group_id, title, description, content, add_time, exp_time, publics, weight, act, idsite, numbers, siteus) VALUES (1, 'Super admin', 'Super Admin', '', " . NV_CURRENTTIME . ", 0, 0, 1, 1, 0, 1, 0)";
$sql_create_table[] = "INSERT INTO " . NV_GROUPS_GLOBALTABLE . " (group_id, title, description, content, add_time, exp_time, publics, weight, act, idsite, numbers, siteus) VALUES (2, 'General admin', 'General Admin', '', " . NV_CURRENTTIME . ", 0, 0, 2, 1, 0, 0, 0)";
$sql_create_table[] = "INSERT INTO " . NV_GROUPS_GLOBALTABLE . " (group_id, title, description, content, add_time, exp_time, publics, weight, act, idsite, numbers, siteus) VALUES (3, 'Module admin', 'Module Admin', '', " . NV_CURRENTTIME . ", 0, 0, 3, 1, 0, 0, 0)";
$sql_create_table[] = "INSERT INTO " . NV_GROUPS_GLOBALTABLE . " (group_id, title, description, content, add_time, exp_time, publics, weight, act, idsite, numbers, siteus) VALUES (4, 'Users', 'Users', '', " . NV_CURRENTTIME . ", 0, 0, 4, 1, 0, 1, 0)";
$sql_create_table[] = "INSERT INTO " . NV_GROUPS_GLOBALTABLE . " (group_id, title, description, content, add_time, exp_time, publics, weight, act, idsite, numbers, siteus) VALUES (5, 'Guest', 'Guest', '', " . NV_CURRENTTIME . ", 0, 0, 5, 1, 0, 0, 0)";
$sql_create_table[] = "INSERT INTO " . NV_GROUPS_GLOBALTABLE . " (group_id, title, description, content, add_time, exp_time, publics, weight, act, idsite, numbers, siteus) VALUES (6, 'All', 'All', '', " . NV_CURRENTTIME . ", 0, 0, 6, 1, 0, 0, 0)";
...
$sql_create_table[] = "INSERT INTO " . NV_CONFIG_GLOBALTABLE . " (lang, module, config_name, config_value) VALUES ('sys', 'global', 'allowuserpublic', '1')";
...
$sql_create_table[] = "INSERT INTO " . NV_CONFIG_GLOBALTABLE . " (lang, module, config_name, config_value) VALUES ('sys', 'global', 'openid_servers', '')";
$sql_create_table[] = "INSERT INTO " . NV_CONFIG_GLOBALTABLE . " (lang, module, config_name, config_value) VALUES ('sys', 'global', 'timestamp', '1')";
$sql_create_table[] = "INSERT INTO " . NV_CONFIG_GLOBALTABLE . " (lang, module, config_name, config_value) VALUES ('sys', 'global', 'openid_processing', '0')";
...
$sql_create_table[] = "INSERT INTO " . NV_CONFIG_GLOBALTABLE . " (lang, module, config_name, config_value) VALUES ('sys', 'global', 'auto_login_after_reg', '1')";
...
$sql_create_table[] = "INSERT INTO " . $db_config['prefix'] . "_setup_extensions (id, type, title, is_sys, virtual, basename, table_prefix, version, addtime, author, note) VALUES (0, 'module', 'siteterms', 0, 0, 'page', 'siteterms', '4.0.21 1436199600', " . NV_CURRENTTIME . ", 'VINADES (contact@vinades.vn)', '')";
...
$sql_create_table[] = "INSERT INTO " . $db_config['prefix'] . "_setup_extensions (id, type, title, is_sys, virtual, basename, table_prefix, version, addtime, author, note) VALUES (312, 'module', 'freecontent', 0, 0, 'freecontent', 'freecontent', '4.0.21 1436199600', " . NV_CURRENTTIME . ", 'VINADES (contact@vinades.vn)', '')";
$sql_create_table[] = "INSERT INTO " . $db_config['prefix'] . "_setup_extensions (id, type, title, is_sys, virtual, basename, table_prefix, version, addtime, author, note) VALUES (307, 'theme', 'default', 0, 0, 'default', 'default', '4.0.21 1436199600', " . NV_CURRENTTIME . ", 'VINADES (contact@vinades.vn)', '')";
$sql_create_table[] = "INSERT INTO " . $db_config['prefix'] . "_setup_extensions (id, type, title, is_sys, virtual, basename, table_prefix, version, addtime, author, note) VALUES (311, 'theme', 'mobile_default', 0, 0, 'mobile_default', 'mobile_default', '4.0.21 1436199600', " . NV_CURRENTTIME . ", 'VINADES (contact@vinades.vn)', '')";
