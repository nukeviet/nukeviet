...
$sql_create_table[] = "INSERT INTO " . $db_config['prefix'] . "_setup_modules (title, is_sysmod, virtual, module_file, module_data, mod_version, addtime, author, note) VALUES ('search', 1, 0, 'search', 'search', '4.0.00 1393416212', " . NV_CURRENTTIME . ", 'VINADES (contact@vinades.vn)', '')";
...
$sql_create_table[] = "INSERT INTO " . $db_config['prefix'] . "_setup_modules (title, is_sysmod, virtual, module_file, module_data, mod_version, addtime, author, note) VALUES ('weblinks', 0, 1, 'weblinks', 'weblinks', '4.0.00 1393416212', " . NV_CURRENTTIME . ", 'VINADES (contact@vinades.vn)', '')";
...
$sql_create_table[] = "INSERT INTO " . $db_config['prefix'] . "_setup_modules (title, is_sysmod, virtual, module_file, module_data, mod_version, addtime, author, note) VALUES ('faq', 0, 1, 'faq', 'faq', '4.0.00 1393416212', " . NV_CURRENTTIME . ", 'VINADES (contact@vinades.vn)', '')";
...
$sql_create_table[] = "INSERT INTO " . $db_config['prefix'] . "_setup_modules (title, is_sysmod, virtual, module_file, module_data, mod_version, addtime, author, note) VALUES ('rss', 1, 0, 'rss', 'rss', '4.0.00 1393416212', " . NV_CURRENTTIME . ", 'VINADES (contact@vinades.vn)', '')";
