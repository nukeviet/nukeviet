...
$sth->execute( array('search', 'search', 'search', 'Recherche', '', 1273474173, 1, 0, '', 'mobile_nukeviet', '', '', '0', 0, 8, 1, 1, '', 0, 0) );
...
{
	$db->query( "INSERT INTO " . $db_config['prefix'] . "_" . $lang_data . "_news_cat VALUES (1, 0, 'News', '', 'News', '', '', 0, 1, 1, 0, 'viewcat_page_new', 3, '5,6,7', 1, 3, '', '', 1280644983, 1280927178, 0, '') ");
	$db->query( "INSERT INTO " . $db_config['prefix'] . "_" . $lang_data . "_news_cat VALUES (2, 0, 'Produits', '', 'Produits', '', '', 0, 2, 5, 0, 'viewcat_page_new', 0, '', 1, 3, '', '', 1280644996, 1280644996, 0, '') ");
	$db->query( "INSERT INTO " . $db_config['prefix'] . "_" . $lang_data . "_news_cat VALUES (3, 0, 'Partenaires', '', 'Partenaires', '', '', 0, 3, 6, 0, 'viewcat_page_new', 0, '', 1, 3, '', '', 1280645023, 1280645023, 0, '') ");
	$db->query( "INSERT INTO " . $db_config['prefix'] . "_" . $lang_data . "_news_cat VALUES (4, 0, 'Recrutement', '', 'Recruitement', '', '', 0, 4, 7, 0, 'viewcat_page_new', 0, '', 1, 3, '', '', 1280649352, 1280649900, 0, '') ");
	$db->query( "INSERT INTO " . $db_config['prefix'] . "_" . $lang_data . "_news_cat VALUES (5, 1, 'News Interne', '', 'News-Interne', '', '', 0, 1, 2, 1, 'viewcat_page_new', 0, '', 1, 3, '', '', 1280927318, 1280927318, 0, '') ");
	$db->query( "INSERT INTO " . $db_config['prefix'] . "_" . $lang_data . "_news_cat VALUES (6, 1, 'Nouvelles Technologies', '', 'Nouvelles-Technologies', '', '', 0, 2, 3, 1, 'viewcat_page_new', 0, '', 1, 3, '', '', 1280927364, 1280927364, 0, '') ");
	$db->query( "INSERT INTO " . $db_config['prefix'] . "_" . $lang_data . "_news_cat VALUES (7, 1, 'Espace presse', '', 'Espace-presse', '', '', 0, 3, 4, 1, 'viewcat_page_new', 0, '', 1, 3, '', '', 1280928740, 1280928740, 0, '') ");
