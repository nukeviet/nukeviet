...
function nv_create_table_news( $catid )
{
	...
	$show = $db->query( 'SHOW CREATE TABLE `' . $db_config['prefix'] . '_fr_news_rows`' )->fetchColumn( 1 );
...
('about', 'page', 'about', 'À propos', '', 1276333182, 1, 1, '', 'mobile_nukeviet', '', '', '0', 1, 1, 1, 1, '', 0, 0),
('news', 'news', 'news', 'News', '', 1270400000, 1, 1, '', 'mobile_nukeviet', '', '', '0', 1, 2, 1, 1, '', 1, 0),
('users', 'users', 'users', 'Compte d&#039;utilisateur', '', 1274080277, 1, 1, '', 'mobile_nukeviet', '', '', '0', 1, 3, 1, 1, '', 0, 0),
('contact', 'contact', 'contact', 'Contact', '', 1275351337, 1, 1, '', 'mobile_nukeviet', '', '', '0', 1, 4, 1, 1, '', 0, 0),
('statistics', 'statistics', 'statistics', 'Statistiques', '', 1276520928, 1, 0, '', 'mobile_nukeviet', '', 'online, statistics', '0', 1, 5, 1, 1, '', 0, 0),
('voting', 'voting', 'voting', 'Sondage', '', 1275315261, 1, 1, '', 'mobile_nukeviet', '', '', '0', 0, 6, 1, 1, '', 1, 0),
('banners', 'banners', 'banners', 'Publicité', '', 1270400000, 1, 1, '', 'mobile_nukeviet', '', '', '0', 0, 7, 1, 1, '', 0, 0),
('search', 'search', 'search', 'Recherche', '', 1273474173, 1, 0, '', 'mobile_nukeviet', '', '', '0', 0, 8, 1, 1, '', 0, 0),
('menu', 'menu', 'menu', 'Menu Site', '', 1295287334, 0, 1, '', 'mobile_nukeviet', '', '', '0', 0, 9, 1, 1, '', 0, 0),
('rss', 'rss', 'rss', 'Rss', '', 1279366705, 1, 1, '', 'mobile_nukeviet', '', '', '0', 0, 10, 1, 1, '', 0, 0),
('page', 'page', 'page', 'Page', '', 1279366705, 1, 1, '', 'mobile_nukeviet', '', '', '0', 0, 11, 1, 1, '', 0, 0)";

$sql_create_table[] = 'TRUNCATE TABLE `' . $db_config['prefix'] . '_' . $lang_data . '_modfuncs`';
$sql_create_table[] = "INSERT INTO `" . $db_config['prefix'] . "_" . $lang_data . "_modfuncs` (`func_id`, `func_name`, `alias`, `func_custom_name`, `in_module`, `show_func`, `in_submenu`, `subweight`, `setting`) VALUES
(1, 'Sitemap', 'Sitemap', 'Sitemap', 'about', 0, 0, 0, ''),
(2, 'main', 'main', 'Main', 'about', 1, 0, 1, ''),
(3, 'Sitemap', 'Sitemap', 'Sitemap', 'news', 0, 0, 0, ''),
(4, 'comment', 'comment', 'Comment', 'news', 0, 0, 0, ''),
(5, 'content', 'content', 'Content', 'news', 1, 0, 1, ''),
(6, 'detail', 'detail', 'Detail', 'news', 1, 0, 2, ''),
(7, 'main', 'main', 'Main', 'news', 1, 0, 3, ''),
(8, 'postcomment', 'postcomment', 'Postcomment', 'news', 0, 0, 0, ''),
(9, 'print', 'print', 'Print', 'news', 0, 0, 0, ''),
(10, 'rating', 'rating', 'Rating', 'news', 0, 0, 0, ''),
(11, 'rss', 'feed', 'Rss', 'news', 0, 0, 0, ''),
(12, 'savefile', 'savefile', 'Savefile', 'news', 0, 0, 0, ''),
(13, 'search', 'search', 'Search', 'news', 1, 0, 4, ''),
(14, 'sendmail', 'sendmail', 'Sendmail', 'news', 0, 0, 0, ''),
(15, 'topic', 'topic', 'Topic', 'news', 1, 0, 5, ''),
(16, 'viewcat', 'viewcat', 'Viewcat', 'news', 1, 0, 6, ''),
(17, 'active', 'active', 'Active', 'users', 1, 0, 8, ''),
(18, 'changepass', 'changepass', 'Changer le mot de passe', 'users', 1, 1, 6, ''),
(19, 'editinfo', 'editinfo', 'Editinfo', 'users', 1, 0, 10, ''),
(20, 'login', 'login', 'Se connecter', 'users', 1, 1, 2, ''),
(21, 'logout', 'logout', 'Logout', 'users', 1, 1, 3, ''),
(22, 'lostactivelink', 'lostactivelink', 'Lostactivelink', 'users', 1, 0, 9, ''),
(23, 'lostpass', 'lostpass', 'Mot de passe oublié?', 'users', 1, 1, 5, ''),
(24, 'main', 'main', 'Main', 'users', 1, 0, 1, ''),
(25, 'openid', 'openid', 'Openid', 'users', 1, 1, 7, ''),
(26, 'register', 'register', 'S&#039;inscrire', 'users', 1, 1, 4, ''),
(27, 'main', 'main', 'Main', 'contact', 1, 0, 1, ''),
(28, 'allbots', 'allbots', 'Par Moteur de recherche', 'statistics', 1, 1, 6, ''),
(29, 'allbrowsers', 'allbrowsers', 'Par Navigateur', 'statistics', 1, 1, 4, ''),
(30, 'allcountries', 'allcountries', 'Par Pays', 'statistics', 1, 1, 3, ''),
(31, 'allos', 'allos', 'Par Système d&#039;exploitation', 'statistics', 1, 1, 5, ''),
(32, 'allreferers', 'allreferers', 'Par Site', 'statistics', 1, 1, 2, ''),
(33, 'main', 'main', 'Main', 'statistics', 1, 0, 1, ''),
(34, 'referer', 'referer', 'referer', 'statistics', 1, 0, 7, ''),
...
(45, 'adv', 'adv', 'Adv', 'search', 0, 0, 0, ''),
(46, 'main', 'main', 'Main', 'search', 1, 0, 1, ''),
(47, 'main', 'main', 'Main', 'rss', 1, 0, 1, ''),
(48, 'regroups', 'regroups', 'Regroups', 'users', 1, 0, 11, ''),
(50, 'memberlist', 'memberlist', 'Liste des membres', 'users', 1, 1, 12, ''),
(51, 'groups', 'groups', 'Groups', 'news', 1, 0, 7, ''),
...
$sql_create_table[] = "UPDATE `" . $db_config['prefix'] . "_config` SET `config_value` = " . $db->quote( $site_description ) . " WHERE `module` = 'global' AND `config_name` = 'site_description' AND `lang`='fr'";
$sql_create_table[] = "UPDATE `" . $db_config['prefix'] . "_config` SET `config_value` = " . $db->quote( $disable_site_content ) . " WHERE `module` = 'global' AND `config_name` = 'disable_site_content' AND `lang`='fr'";
...
if( $result->rowCount() )
{
	$sql_create_table[] = "INSERT INTO `" . $db_config['prefix'] . "_" . $lang_data . "_news_cat` VALUES
		...
		(2, 0, 'Produits', '', 'Produits', '', '', 0, 2, 5, 0, 'viewcat_page_new', 0, '', 1, 3, '', '', 1280644996, 1280644996, 0, ''),
		(3, 0, 'Partenaires', '', 'Partenaires', '', '', 0, 3, 6, 0, 'viewcat_page_new', 0, '', 1, 3, '', '', 1280645023, 1280645023, 0, ''),
		(4, 0, 'Recrutement', '', 'Recruitement', '', '', 0, 4, 7, 0, 'viewcat_page_new', 0, '', 1, 3, '', '', 1280649352, 1280649900, 0, ''),
		(5, 1, 'News Interne', '', 'News-Interne', '', '', 0, 1, 2, 1, 'viewcat_page_new', 0, '', 1, 3, '', '', 1280927318, 1280927318, 0, ''),
		(6, 1, 'Nouvelles Technologies', '', 'Nouvelles-Technologies', '', '', 0, 2, 3, 1, 'viewcat_page_new', 0, '', 1, 3, '', '', 1280927364, 1280927364, 0, ''),
		(7, 1, 'Espace presse', '', 'Espace-presse', '', '', 0, 3, 4, 1, 'viewcat_page_new', 0, '', 1, 3, '', '', 1280928740, 1280928740, 0, '')";
	...
	$sql_create_table[] = "INSERT INTO `" . $db_config['prefix'] . "_" . $lang_data . "_news_tags` (`tid`, `numnews`, `alias`, `image`, `description`, `keywords`) VALUES
		(1, 0, 'nukeviet', '', '', 'Nukeviet')";

	$sql_create_table[] = "INSERT INTO `" . $db_config['prefix'] . "_" . $lang_data . "_news_tags_id` (`id`, `tid`, `keyword`) VALUES
		(1, 1, 'Nukeviet'),
		(2, 1, 'NukeViet')";

	$sql_create_table[] = "UPDATE `" . $db_config['prefix'] . "_config` SET `config_value` = " . $db->quote( $copyright ) . " WHERE `module` = 'news' AND `config_name` = 'copyright' AND `lang`='fr'";
