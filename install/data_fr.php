...
$sql_create_table[] = "INSERT INTO `" . $db_config['prefix'] . "_" . $lang_data . "_blocks_groups` (`bid`, `theme`, `module`, `file_name`, `title`, `link`, `template`, `position`, `class`, `exp_time`, `active`, `groups_view`, `all_func`, `weight`, `config`) VALUES
