...
NVU.ShowLoad = function(m){
	$('#nv-loading').html('<img src="' + nv_siteroot + 'images/load_bar.gif" alt=""/><br />' + update_task_load + ' <strong>' + m + '</strong><br />' + update_task_load_message + '.');
	$('#nv-loading').show();
}
...
NVMF.Start = function(){
	NVMF.IsStart = 1;
	$('#nv-message').html('<img src="' + nv_siteroot + 'images/load_bar.gif" alt="Loading..."/><br />' + update_load_waiting);
