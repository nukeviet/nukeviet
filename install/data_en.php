...
('statistics', 'statistics', 'statistics', 'Statistics', '', 1276520928, 1, 0, '', 'mobile_nukeviet', '', 'online, statistics', '0', 1, 5, 1, 1, '', 0, 0),
('voting', 'voting', 'voting', 'Voting', '', 1275315261, 1, 1, '', 'mobile_nukeviet', '', '', '0', 0, 6, 1, 1, '', 1, 0),
('banners', 'banners', 'banners', 'Banners', '', 1270400000, 1, 1, '', 'mobile_nukeviet', '', '', '0', 0, 7, 1, 1, '', 0, 0),
('search', 'search', 'search', 'Search', '', 1273474173, 1, 0, '', 'mobile_nukeviet', '', '', '0', 0, 8, 1, 1, '', 0, 0),
...
(18, 'changepass', 'changepass', 'Changepass', 'users', 1, 1, 6, ''),
...
(23, 'lostpass', 'lostpass', 'Lostpass', 'users', 1, 1, 5, ''),
(24, 'main', 'main', 'Main', 'users', 1, 0, 1, ''),
(25, 'openid', 'openid', 'Openid', 'users', 1, 1, 7, ''),
(26, 'register', 'register', 'Register', 'users', 1, 1, 4, ''),
(27, 'main', 'main', 'Main', 'contact', 1, 0, 1, ''),
(28, 'allbots', 'allbots', 'Allbots', 'statistics', 1, 1, 6, ''),
(29, 'allbrowsers', 'allbrowsers', 'Allbrowsers', 'statistics', 1, 1, 4, ''),
(30, 'allcountries', 'allcountries', 'Allcountries', 'statistics', 1, 1, 3, ''),
(31, 'allos', 'allos', 'Allos', 'statistics', 1, 1, 5, ''),
(32, 'allreferers', 'allreferers', 'Allreferers', 'statistics', 1, 1, 2, ''),
...
(50, 'memberlist', 'memberlist', 'Member List', 'users', 1, 1, 12, ''),
...
if( $db->sql_numrows( $result ) )
{
	$sql_create_table[] = "INSERT INTO `" . $db_config['prefix'] . "_" . $lang_data . "_news_cat` VALUES
		...
		(2, 1, 'Careers at NukeViet', '', 'Careers-at-NukeViet', '', '', 0, 1, 6, 1, 'viewcat_page_new', 0, '', 1, 3, '', '', 1277690086, 1277690259, 0, ''),
		(3, 1, 'Partners', '', 'Partners', '', '', 0, 2, 7, 1, 'viewcat_page_new', 0, '', 1, 3, '', '', 1277690142, 1277690291, 0, ''),
		(4, 0, 'NukeViet news', '', 'NukeViet-news', '', '', 0, 1, 1, 0, 'viewcat_page_new', 3, '5,6,7', 1, 3, '', '', 1277690451, 1277690451, 0, ''),
		(5, 4, 'Security issues', '', 'Security-issues', '', '', 0, 1, 2, 1, 'viewcat_page_new', 0, '', 1, 3, '', '', 1277690497, 1277690564, 0, ''),
		(6, 4, 'Release notes', '', 'Release-notes', '', '', 0, 2, 3, 1, 'viewcat_page_new', 0, '', 1, 3, '', '', 1277690588, 1277690588, 0, ''),
		(7, 4, 'Development team talk', '', 'Development-team-talk', '', '', 0, 3, 4, 1, 'viewcat_page_new', 0, '', 1, 3, '', '', 1277690652, 1277690652, 0, ''),
		(8, 0, 'NukeViet community', '', 'NukeViet-community', '', '', 0, 3, 8, 0, 'viewcat_page_new', 3, '9,10,11', 1, 3, '', '', 1277690748, 1277690748, 0, ''),
		(9, 8, 'Activities', '', 'Activities', '', '', 0, 1, 9, 1, 'viewcat_page_new', 0, '', 1, 3, '', '', 1277690765, 1277690765, 0, ''),
		(10, 8, 'Events', '', 'Events', '', '', 0, 2, 10, 1, 'viewcat_page_new', 0, '', 1, 3, '', '', 1277690783, 1277690783, 0, ''),
		(11, 8, 'Faces of week &#x3A;D', '', 'Faces-of-week-D', '', '', 0, 3, 11, 1, 'viewcat_page_new', 0, '', 1, 3, '', '', 1277690821, 1277690821, 0, ''),
		(12, 0, 'Lastest technologies', '', 'Lastest-technologies', '', '', 0, 4, 12, 0, 'viewcat_page_new', 2, '13,14', 1, 3, '', '', 1277690888, 1277690888, 0, ''),
		(13, 12, 'World wide web', '', 'World-wide-web', '', '', 0, 1, 13, 1, 'viewcat_page_new', 0, '', 1, 3, '', '', 1277690934, 1277690934, 0, ''),
		(14, 12, 'Around internet', '', 'Around-internet', '', '', 0, 2, 14, 1, 'viewcat_page_new', 0, '', 1, 3, '', '', 1277690982, 1277690982, 0, '')";
