...
$sth->execute( array('about', 'page', 'about', 'About', '', 1276333182, 1, 1, '', 'mobile_nukeviet', '', '', '0', 1, 1, '', 0, 0) );
$sth->execute( array('news', 'news', 'news', 'News', '', 1270400000, 1, 1, '', 'mobile_nukeviet', '', '', '0', 2, 1, '', 1, 0) );
$sth->execute( array('users', 'users', 'users', 'Users', '', 1274080277, 1, 1, '', 'mobile_nukeviet', '', '', '0', 3, 1, '', 0, 0) );
$sth->execute( array('contact', 'contact', 'contact', 'Contact', '', 1275351337, 1, 1, '', 'mobile_nukeviet', '', '', '0', 4, 1, '', 0, 0) );
$sth->execute( array('statistics', 'statistics', 'statistics', 'Statistics', '', 1276520928, 1, 0, '', 'mobile_nukeviet', '', 'online, statistics', '0', 5, 1, '', 0, 0) );
$sth->execute( array('voting', 'voting', 'voting', 'Voting', '', 1275315261, 1, 1, '', 'mobile_nukeviet', '', '', '0', 6, 1, '', 1, 0) );
$sth->execute( array('banners', 'banners', 'banners', 'Banners', '', 1270400000, 1, 1, '', 'mobile_nukeviet', '', '', '0', 7, 1, '', 0, 0) );
$sth->execute( array('seek', 'seek', 'seek', 'Search', '', 1273474173, 1, 0, '', 'mobile_nukeviet', '', '', '0', 8, 1, '', 0, 0) );
...
$sth->execute( array(2, 'default', 'statistics', 'global.counter.php', 'Counter', '', '', '[LEFT]', 0, 1, '0', 1, 2, '') );
$sth->execute( array(3, 'default', 'banners', 'global.banners.php', 'Left Banner', '', '', '[LEFT]', 0, 1, '0', 1, 3, 'a:1:{s:12:"idplanbanner";i:2;}') );
$sth->execute( array(4, 'default', 'about', 'global.about.php', 'About', '', 'orange', '[RIGHT]', 0, 1, '0', 1, 1, '') );
$sth->execute( array(5, 'default', 'users', 'global.login.php', 'Login site', '', '', '[RIGHT]', 0, 1, '0', 1, 2, '') );
$sth->execute( array(6, 'default', 'voting', 'global.voting_random.php', 'Voting', '', '', '[RIGHT]', 0, 1, '0', 1, 3, '') );
$sth->execute( array(7, 'default', 'news', 'module.block_headline.php', 'headline', '', 'no_title', '[TOP]', 0, 1, '0', 0, 1, '') );
$sth->execute( array(8, 'default', 'banners', 'global.banners.php', 'Center Banner', '', 'no_title', '[TOP]', 0, 1, '0', 1, 2, 'a:1:{s:12:"idplanbanner";i:1;}') );
$sth->execute( array(9, 'modern', 'news', 'module.block_newscenter.php', 'News Center', '', 'no_title', '[HEADER]', 0, 1, '0', 0, 1, '') );
$sth->execute( array(10, 'modern', 'about', 'global.about.php', 'About', '', 'no_title_html', '[RIGHT]', 0, 1, '0', 1, 1, '') );
$sth->execute( array(11, 'modern', 'users', 'global.login.php', 'Login site', '', '', '[RIGHT]', 0, 1, '0', 1, 2, '') );
$sth->execute( array(12, 'modern', 'voting', 'global.voting_random.php', 'Voting', '', '', '[RIGHT]', 0, 1, '0', 1, 3, '') );
$sth->execute( array(13, 'modern', 'statistics', 'global.counter.php', 'Counter', '', '', '[RIGHT]', 0, 1, '0', 1, 4, '') );
$sth->execute( array(14, 'modern', 'news', 'module.block_newsright.php', 'News Right', '', 'no_title', '[RIGHT]', 0, 1, '0', 0, 5, '') );
$sth->execute( array(15, 'modern', 'banners', 'global.banners.php', 'Top banner', '', 'no_title', '[TOPADV]', 0, 1, '0', 1, 1, 'a:1:{s:12:"idplanbanner";i:1;}') );
...
{
	$db->query( "INSERT INTO " . $db_config['prefix'] . "_" . $lang_data . "_news_cat VALUES (1, 0, 'Co-operate', '', 'Co-operate', '', '', 0, 2, 5, 0, 'viewcat_page_new', 2, '2,3', 1, 3, '2', '', '', 1277689708, 1277689708, 0, '') ");
	$db->query( "INSERT INTO " . $db_config['prefix'] . "_" . $lang_data . "_news_cat VALUES (2, 1, 'Careers at NukeViet', '', 'Careers-at-NukeViet', '', '', 0, 1, 6, 1, 'viewcat_page_new', 0, '', 1, 3, '2', '', '', 1277690086, 1277690259, 0, '') ");
	$db->query( "INSERT INTO " . $db_config['prefix'] . "_" . $lang_data . "_news_cat VALUES (3, 1, 'Partners', '', 'Partners', '', '', 0, 2, 7, 1, 'viewcat_page_new', 0, '', 1, 3, '2', '', '', 1277690142, 1277690291, 0, '') ");
	$db->query( "INSERT INTO " . $db_config['prefix'] . "_" . $lang_data . "_news_cat VALUES (4, 0, 'NukeViet news', '', 'NukeViet-news', '', '', 0, 1, 1, 0, 'viewcat_page_new', 3, '5,6,7', 1, 3, '2', '', '', 1277690451, 1277690451, 0, '') ");
	$db->query( "INSERT INTO " . $db_config['prefix'] . "_" . $lang_data . "_news_cat VALUES (5, 4, 'Security issues', '', 'Security-issues', '', '', 0, 1, 2, 1, 'viewcat_page_new', 0, '', 1, 3, '2', '', '', 1277690497, 1277690564, 0, '') ");
	$db->query( "INSERT INTO " . $db_config['prefix'] . "_" . $lang_data . "_news_cat VALUES (6, 4, 'Release notes', '', 'Release-notes', '', '', 0, 2, 3, 1, 'viewcat_page_new', 0, '', 1, 3, '2', '', '', 1277690588, 1277690588, 0, '') ");
	$db->query( "INSERT INTO " . $db_config['prefix'] . "_" . $lang_data . "_news_cat VALUES (7, 4, 'Development team talk', '', 'Development-team-talk', '', '', 0, 3, 4, 1, 'viewcat_page_new', 0, '', 1, 3, '2', '', '', 1277690652, 1277690652, 0, '') ");
	$db->query( "INSERT INTO " . $db_config['prefix'] . "_" . $lang_data . "_news_cat VALUES (8, 0, 'NukeViet community', '', 'NukeViet-community', '', '', 0, 3, 8, 0, 'viewcat_page_new', 3, '9,10,11', 1, 3, '2', '', '', 1277690748, 1277690748, 0, '') ");
	$db->query( "INSERT INTO " . $db_config['prefix'] . "_" . $lang_data . "_news_cat VALUES (9, 8, 'Activities', '', 'Activities', '', '', 0, 1, 9, 1, 'viewcat_page_new', 0, '', 1, 3, '2', '', '', 1277690765, 1277690765, 0, '') ");
	$db->query( "INSERT INTO " . $db_config['prefix'] . "_" . $lang_data . "_news_cat VALUES (10, 8, 'Events', '', 'Events', '', '', 0, 2, 10, 1, 'viewcat_page_new', 0, '', 1, 3, '2', '', '', 1277690783, 1277690783, 0, '') ");
	$db->query( "INSERT INTO " . $db_config['prefix'] . "_" . $lang_data . "_news_cat VALUES (11, 8, 'Faces of week &#x3A;D', '', 'Faces-of-week-D', '', '', 0, 3, 11, 1, 'viewcat_page_new', 0, '', 1, 3, '2', '', '', 1277690821, 1277690821, 0, '') ");
	$db->query( "INSERT INTO " . $db_config['prefix'] . "_" . $lang_data . "_news_cat VALUES (12, 0, 'Lastest technologies', '', 'Lastest-technologies', '', '', 0, 4, 12, 0, 'viewcat_page_new', 2, '13,14', 1, 3, '2', '', '', 1277690888, 1277690888, 0, '') ");
	$db->query( "INSERT INTO " . $db_config['prefix'] . "_" . $lang_data . "_news_cat VALUES (13, 12, 'World wide web', '', 'World-wide-web', '', '', 0, 1, 13, 1, 'viewcat_page_new', 0, '', 1, 3, '2', '', '', 1277690934, 1277690934, 0, '') ");
	$db->query( "INSERT INTO " . $db_config['prefix'] . "_" . $lang_data . "_news_cat VALUES (14, 12, 'Around internet', '', 'Around-internet', '', '', 0, 2, 14, 1, 'viewcat_page_new', 0, '', 1, 3, '2', '', '', 1277690982, 1277690982, 0, '') ");

	$db->query ("INSERT INTO " . $db_config['prefix'] . "_" . $lang_data . "_news_rows VALUES (1, 1, '1,7,8', 0, 8, 'VINADES', 0, 1277689959, 1277690410, 1, 1277689920, 0, 2, 'Invite to co-operate announcement', 'Invite-to-co-operate-announcement', 'VINADES.,JSC was founded in order to professionalize NukeViet opensource development and release. We also using NukeViet in our bussiness projects to make it continue developing. Include Advertisment, provide hosting services for NukeViet CMS development.', 'hoptac.jpg', '', 1, 1, 2, 1, 2, 0, 0, 0) ");
	...
	$db->query ("INSERT INTO " . $db_config['prefix'] . "_" . $lang_data . "_news_rows VALUES (4, 4, '4', 0, 1, 'VOVNews&#x002F;VNA', 0, 1292959020, 1292959513, 1, 1292959020, 0, 2, 'First open-source company starts operation', 'First-open-source-company-starts-operation', 'The Vietnam Open Source Development Joint Stock Company (VINADES.,JSC), the first firm operating in the field of open source in the country, made its debut on February 25.', 'nangly.jpg', '', 1, 1, 2, 1, 1, 0, 0, 0) ");
	$db->query ("INSERT INTO " . $db_config['prefix'] . "_" . $lang_data . "_news_rows VALUES (5, 4, '4', 0, 1, '', 0, 1292959490, 1292959664, 1, 1292959440, 0, 2, 'NukeViet 3.0 - New CMS for News site', 'NukeViet-30-New-CMS-for-News-site', 'NukeViet 3.0 is a professional system: VINADES.,JSC founded to maintain and improve NukeViet 3.0 features. VINADES.,JSC co-operated with many professional hosting providers to test compatibility issues.', 'nukeviet3.jpg', '', 1, 1, 2, 1, 1, 0, 0, 0) ");
...
if( $result->fetchColumn() )
{
	$sth = $db->prepare( "INSERT INTO " . $db_config['prefix'] . "_" . $lang_data . "_voting VALUES (:vid, :question, '', 1, 1, 0, '0', 1275318563, 0, 1)" );
