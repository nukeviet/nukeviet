...
* @Language English
* @Createdate Jun 29, 2010, 08:24:00 AM
*/
...
$lang_module['update_site_title_update'] = 'Upgrade NukeViet';
$lang_module['update_site_title_upgrade'] = 'Updated NukeViet';
$lang_module['update_step_1'] = 'Info';
$lang_module['update_step_2'] = 'Update';
$lang_module['update_step_3'] = 'Complete';
$lang_module['update_step_title_1'] = 'Version information';
$lang_module['update_step_title_2'] = 'Update';
$lang_module['update_step_title_3'] = 'Complete upgrade';
$lang_module['update_info_backage'] = 'Update package infor';
$lang_module['update_value'] = 'Value';
$lang_module['update_release_date'] = 'Release';
$lang_module['update_author'] = 'Author';
$lang_module['update_to_version'] = 'Upgrade to version';
$lang_module['update_to_version_support'] = 'Supported versions';
...
$lang_module['update_version_current'] = 'Version information is used';
$lang_module['update_version_current_name'] = 'The version number';
$lang_module['update_ability'] = 'The ability to upgrade';
$lang_module['update_ability_0'] = 'You can not upgrade due to incompatible versions';
$lang_module['update_ability_1'] = 'Can be upgraded';
...
$lang_module['update_all_work'] = 'All the work';
...
$lang_module['update_mod_list'] = 'The module currently in use';
...
$lang_module['update_goadmin'] = 'Go to site administrator';
$lang_module['update_manual'] = 'This is the update package requires you to manually perform all operations. Detailed instructions below, please read carefully and follow the steps in the guide. After successful implementation, click the';
...
$lang_module['update_empty_work'] = 'There is no work';
$lang_module['update_data_work'] = 'Work with database';
$lang_module['update_file_work'] = 'Work with system files';
$lang_module['update_substep3_error_file'] = 'Error: The files and folders in <strong>install/update/</strong> has not been moved out, continue move all the files, folders and click on the link below.';
$lang_module['update_substep3_moved'] = 'Moved out';
$lang_module['update_info_list_prosess'] = 'Below is a list of job will execute, click <strong>Next step</strong>to continue';
$lang_module['update_task'] = 'Waiting';
...
$lang_module['update_task_error_message'] = 'The process can not continue due to failure to <strong>"%s"</strong>. Try to close your browser then do the whole job. Access the <a href="http://nukeviet.vn/phpbb/" title="NukeViet forum">forum</a>and report this error message for assistance.';
...
$lang_module['update_task_do1_error'] = 'The work';
...
$lang_module['update_nav_confirm'] = 'The work is done, turn off the browser page or can lead to errors.';
...
$lang_module['update_file_info'] = 'Info';
...
$lang_module['update_file_backup_error'] = 'Backup system is not self-yourself backup';
...
$lang_module['update_step5_info_error'] = 'The system can not find any instructions, click "<strong />next step" to continue.';
...
$lang_module['update_log_start'] = 'Upgrades start';
