...
$lang_module['errorsave'] = "Lỗi hệ thống không cập nhật được nội dung, bạn hãy kiểm tra lại tên sản phẩm có thể bị trùng";
...
$lang_module['setting_setcomm'] = "Ai có quyền được thảo luận";
...
$lang_module['setting_money_all'] = "Đơn vị tiền tệ sử dụng";
$lang_module['setting_active_auto_check_order'] = "Tự động duyệt đơn hàng khi người mua gửi ";
$lang_module['setting_active_order'] = "Bật chức năng đặt hàng ngoài trang hiển thị";
...
$lang_module['error_product_price'] = "Lỗi: giá sản phẩm không được âm hoặc bằng 0";
...
$lang_module['content_keywords_note'] = "Để tạo tự động, hãy copy toàn bộ nội dung sản phẩm vào ô trống dưới đây và bấm";
...
$lang_module['content_publ_date'] = "Thời gian cập nhật";
...
$lang_module['content_sourceid'] = "Hãng sản xuất";
...
$lang_module['activecomm'] = "Kích hoạt chức năng bình luận cho sản phẩm";
...
$lang_module['topic_del'] = "Xóa khỏi nhóm sản phẩm này";
