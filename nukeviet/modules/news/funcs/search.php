...
$per_pages = 20;
if ($key == '')
    $key = isset($_SESSION["keyword"]) ? $_SESSION["keyword"] : '';
$array_cat_search = array();
foreach ($global_array_cat as $arr_cat_i)
{
    $array_cat_search[$arr_cat_i['catid']] = array('catid' => $arr_cat_i['catid'], 'title' => $arr_cat_i['title'], 'select' => ($arr_cat_i['catid'] == $catid) ? "selected" : "");
}
