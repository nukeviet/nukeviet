...
$sql_create_table[] = "INSERT INTO `" . $db_config['prefix'] . "_" . $lang_data . "_modules` (`title`, `module_file`, `module_data`, `custom_title`, `admin_title`, `set_time`, `main_file`, `admin_file`, `theme`, `mobile`, `keywords`, `groups_view`, `in_menu`, `weight`, `submenu`, `act`, `admins`, `rss`) VALUES
...
('tags', 'tags', 'tags', 'Tags',  '',1324787574, 1, 0, '', 'mobile_nukeviet', '', '0', 0, 11, 1, 1, '', 0),
...
if( $db->sql_numrows( $result ) )
{
	$sql_create_table[] = "INSERT INTO `" . $db_config['prefix'] . "_" . $lang_data . "_news_cat` VALUES
		(1, 0, 'Tin tức', '', 'Tin-tuc', '', '', '', 1, 1, 0, 'viewcat_main_right', 3, '8,12,9', 1, 4, '', '', 1274986690, 1274986690, 0, ''), 
		...
		(10, 0, 'Đối tác', '', 'Doi-tac', '', '', '', 3, 9, 0, 'viewcat_main_right', 0, '', 1, 4, '', '', 1274987460, 1274987460, 0, ''), 
	...
	$sql_create_table[] = "INSERT INTO `" . $db_config['prefix'] . "_" . $lang_data . "_tags` VALUES
		...
		(57, 'nukeviet', 1),
		(58, 'lập trình viên', 1),
		(59, 'chuyên viên đồ họa', 1),
		(60, 'php', 1),
		(61, 'mysql', 1),
		(62, 'khai trương', 1),
		(63, 'khuyến mại', 1),
		(64, 'giảm giá', 1),
		(65, 'siêu khuyến mại', 1),
		(66, 'webnhanh', 1),
		(67, 'thiết kế website', 1),
		(68, 'giao diện web', 1),
		(69, 'thiết kế web', 1),
		(70, 'Nhân tài Đất Việt 2011', 2),
		(71, 'mã nguồn mở', 2)";

	$sql_create_table[] = "INSERT INTO `" . $db_config['prefix'] . "_" . $lang_data . "_tags_con_1` VALUES
		('news', 1, 'Tin-tuc/Ra-mat-cong-ty-ma-nguon-mo-dau-tien-tai-Viet-Nam-1', 'Ra mắt công ty mã nguồn mở đầu tiên tại Việt Nam', 'Mã nguồn mở NukeViet vốn đã quá quen thuộc với cộng đồng CNTT Việt Nam trong mấy năm qua. Tuy chưa hoạt động chính thức, nhưng chỉ trong khoảng 5 năm gần đây, mã nguồn mở NukeViet đã được dùng phổ biến ở Việt Nam, áp dụng ở hầu hết các lĩnh vực, từ tin tức đến thương mại điện tử, từ các website cá nhân cho tới những hệ thống website doanh nghiệp.', 'files/news/thumb/nangly.jpg', 1274989140),
		('news', 2, 'Tin-tuc/Cong-bo-du-an-NukeViet-3-0-sau-1-thang-ra-mat-VINADES-JSC-2', 'Công bố dự án NukeViet 3.0 sau 1 tháng ra mắt VINADES.,JSC', 'NukeViet 3.0 - Một nền tảng được xây dựng hoàn toàn mới với những công nghệ web tiên tiến nhất hiện nay hứa hẹn sẽ làm một cuộc cách mạng về mã nguồn mở ở Việt Nam. Món quà này là lời cảm ơn chân thành nhất mà VINADES.,JSC muốn gửi tới cộng đồng sau một tháng chính thức ra mắt.', 'files/news/thumb/nukeviet3.jpg', 1274989740),
		('news', 5, 'San-pham/Gioi-thieu-ve-ma-nguon-mo-NukeViet-5', 'Giới thiệu về mã nguồn mở NukeViet', 'Chắc hẳn đây không phải lần đầu tiên bạn nghe nói đến mã nguồn mở. Và nếu bạn là người mê lướt web thì hẳn bạn từng nhìn thấy đâu đó cái tên NukeViet. NukeViet, phát âm là Nu-Ke-Việt, chính là phần mềm dùng để xây dựng các Website mà bạn ngày ngày online để truy cập đấy.', 'files/news/thumb/screenshot.jpg', 1274993280),
		('news', 6, 'Doi-tac/Thu-moi-hop-tac-6', 'Thư mời hợp tác liên kết quảng cáo và cung cấp hosting thử nghiệm', 'Hiện tại VINADES.,JSC đang tiến hành phát triển bộ mã nguồn NukeViet phiên bản 3.0 – một thế hệ CMS hoàn toàn mới với nhiều tính năng ưu việt, được đầu tư bài bản với kinh phí lớn. Với thiện chí hợp tác cùng phát triển VINADES.,JSC xin trân trọng gửi lời mời hợp tác đến Quý đối tác là các công ty cung cấp tên miền - hosting, các doanh nghiệp quan tâm và mong muốn hợp tác cùng VINADES để cùng thực hiện chung các hoạt động kinh doanh nhằm gia tăng giá trị, quảng bá thương hiệu chung cho cả hai bên.', 'files/news/thumb/hoptac.jpg', 1274994720),
		('news', 7, 'Tuyen-dung/Tuyen-dung-lap-trinh-vien-chuyen-vien-do-hoa-phat-trien-NukeViet-7', 'Tuyển dụng lập trình viên, chuyên viên đồ họa phát triển NukeViet', 'Bạn đam mê nguồn mở? Bạn có năng khiếu lập trình PHP & MySQL? Bạn là chuyên gia đồ họa, HTML, CSS? Chúng tôi sẽ giúp bạn hiện thực hóa ước mơ của mình với một mức lương đảm bảo. Hãy gia nhập VINADES.,JSC để xây dựng mã nguồn mở hàng đầu cho Việt Nam.', 'files/news/thumb/nukeviet-job.jpg',1307197260),
		('news', 8, 'Tin-cong-nghe/Webnhanhvn-website-dich-vu-chuyen-nghiep-cho-NukeViet-chinh-thuc-ra-mat-8', 'Webnhanh.vn - website dịch vụ chuyên nghiệp cho NukeViet chính thức ra mắt', 'Sau một thời gian đi vào hoạt động, Webnhanh.vn đã nhận được nhiều ủng hộ cùng sự quan tâm, góp ý của cộng đồng và khách hàng. Để đáp ứng mong mỏi của cộng đồng về một dịch vụ web chuyên nghiệp với mức giá tối thiểu, Webnhanh.vn đã thực hiện chiến dịch siêu khuyến mại Giảm giá tất cả các gói web dựng sẵn, module, block và giao diện (theme). Mức giảm giá cao nhất tới 90% giá so với trước tháng 7 năm 2011.', 'files/news/thumb/webnhanh-vn.jpg', 1310067949),
		('news', 9, 'San-pham/NukeViet-Cong-cu-ma-nguon-mo-cho-cong-dong-thiet-ke-website-Viet-Nam-9', 'NukeViet - Công cụ mã nguồn mở cho cộng đồng thiết kế website Việt Nam', '(Dân trí) - Là một trong những hệ quản trị nội dung nổi tiếng hàng đầu tại Việt Nam, NukeViet đã được áp dụng rộng rãi trong việc xây dựng nhiều trang báo điện tử và các cổng thông tin điện tử nổi tiếng tại Việt Nam. Mới đây nhất, NukeViet đã vượt qua vòng sơ khảo để tranh tài tại vòng chung khảo của Giải Thưởng Nhân Tài Đất Việt 2011', 'files/news/thumb/product_box.jpg', 1322685396),
		('news', 10, 'Tin-tuc/Ma-nguon-mo-NukeViet-gianh-giai-ba-Nhan-tai-dat-Viet-2011-10', 'Mã nguồn mở NukeViet giành giải ba Nhân tài đất Việt 2011', 'Không có giải nhất và giải nhì, sản phẩm Mã nguồn mở NukeViet của VINADES.,JSC là một trong ba sản phẩm đã đoạt giải ba Nhân tài đất Việt 2011 - Lĩnh vực Công nghệ thông tin (Sản phẩm đã ứng dụng rộng rãi).', 'files/news/thumb/nukeviet-nhantaidatviet2011.jpg', 1322685920)";

	$sql_create_table[] = "INSERT INTO `" . $db_config['prefix'] . "_" . $lang_data . "_tags_kid_1` (`tid`, `module`, `sid`) VALUES
	(1, 'news', 1),
	(1, 'news', 2),
	(2, 'news', 1),
	(3, 'news', 1),
