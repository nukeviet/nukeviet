    ...
    } elseif ( $i == "modUpd" or $i == "modUpdRef" or $i == "modNewUpd" or $i == "modNewUpdRef" )
    {
        ...
        while ( list( $module_file, $mod_version, $author ) = $db->sql_fetchrow( $result ) )
        {
            ...
            if ( isset( $onlineModules[$module_file] ) )
            {
                ...
                if ( isset( $onlineModules[$module_file]['pubtime'], $onlineModules[$module_file]['version'], $onlineModules[$module_file]['author'] ) //
                    and $onlineModules[$module_file]['version'] == $v //
                    and ( $onlineModules[$module_file]['pubtime'] != $p or $onlineModules[$module_file]['author'] != $author ) )
                {
