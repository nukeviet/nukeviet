...
-- Thời gian đã tạo: Th7 26, 2022 lúc 11:43 AM
...
--
-- Cơ sở dữ liệu: `nukeviet_phung`
--

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `phung_authors`
--

DROP TABLE IF EXISTS `phung_authors`;
CREATE TABLE IF NOT EXISTS `phung_authors` (
...
--
-- Đang đổ dữ liệu cho bảng `phung_authors`
--

INSERT INTO `phung_authors` (`admin_id`, `editor`, `lev`, `files_level`, `position`, `main_module`, `admin_theme`, `addtime`, `edittime`, `is_suspend`, `susp_reason`, `pre_check_num`, `pre_last_login`, `pre_last_ip`, `pre_last_agent`, `check_num`, `last_login`, `last_ip`, `last_agent`) VALUES
(1, 'ckeditor', 1, 'adobe,archives,audio,documents,flash,images,real,video|1|1|1', 'Administrator', 'siteinfo', '', 0, 0, 0, '', '', 0, '', '', 'a4521ea7efec02480111fba6cf629b11', 1658830355, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/103.0.0.0 Safari/537.36');

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `phung_authors_api_credential`
--

DROP TABLE IF EXISTS `phung_authors_api_credential`;
CREATE TABLE IF NOT EXISTS `phung_authors_api_credential` (
  `admin_id` int(11) UNSIGNED NOT NULL,
...
--
-- Cấu trúc bảng cho bảng `phung_authors_api_role`
--

DROP TABLE IF EXISTS `phung_authors_api_role`;
CREATE TABLE IF NOT EXISTS `phung_authors_api_role` (
...
--
-- Cấu trúc bảng cho bảng `phung_authors_config`
--

DROP TABLE IF EXISTS `phung_authors_config`;
CREATE TABLE IF NOT EXISTS `phung_authors_config` (
...
--
-- Cấu trúc bảng cho bảng `phung_authors_module`
--

DROP TABLE IF EXISTS `phung_authors_module`;
CREATE TABLE IF NOT EXISTS `phung_authors_module` (
...
--
-- Đang đổ dữ liệu cho bảng `phung_authors_module`
--

INSERT INTO `phung_authors_module` (`mid`, `module`, `lang_key`, `weight`, `act_1`, `act_2`, `act_3`, `checksum`) VALUES
(1, 'siteinfo', 'mod_siteinfo', 1, 1, 1, 1, '87d666c73812012c2bb705d40ec7ee60'),
(2, 'authors', 'mod_authors', 2, 1, 1, 1, '4da9e914a744921846b3c5a303ad8938'),
(3, 'settings', 'mod_settings', 3, 1, 1, 0, '7163e31e834ddf7ff71896fbbeaa2da6'),
(4, 'database', 'mod_database', 4, 1, 0, 0, 'd82d81dfaeb89fa11706cbb41bbf4e8a'),
(5, 'webtools', 'mod_webtools', 5, 1, 1, 0, '8033085a46ccef4292971a67dad7f0c9'),
(6, 'seotools', 'mod_seotools', 6, 1, 1, 0, '81298cba34a364d22616f1e3d3cc2a01'),
(7, 'language', 'mod_language', 7, 1, 1, 0, '853cf3f07ebf39e3fc2456c62412945d'),
(8, 'modules', 'mod_modules', 8, 1, 1, 0, 'c1d8efcf1b0dffd648d839cf715e1c50'),
(9, 'themes', 'mod_themes', 9, 1, 1, 0, 'a68f4d78ce1692935a53626af8654733'),
(10, 'extensions', 'mod_extensions', 10, 1, 0, 0, '3cd9a1e57306ce0ce57dc9f1a86e3026'),
(11, 'upload', 'mod_upload', 11, 1, 1, 1, '2dcf61cd0c07bd13037709016994ea60'),
(12, 'zalo', 'mod_zalo', 12, 1, 0, 0, '514a63839209f574b00c3a1c9362547b');

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `phung_authors_oauth`
--

DROP TABLE IF EXISTS `phung_authors_oauth`;
CREATE TABLE IF NOT EXISTS `phung_authors_oauth` (
  `id` mediumint(8) UNSIGNED NOT NULL AUTO_INCREMENT,
...
--
-- Cấu trúc bảng cho bảng `phung_banners_click`
--

DROP TABLE IF EXISTS `phung_banners_click`;
CREATE TABLE IF NOT EXISTS `phung_banners_click` (
...
--
-- Cấu trúc bảng cho bảng `phung_banners_plans`
--

DROP TABLE IF EXISTS `phung_banners_plans`;
CREATE TABLE IF NOT EXISTS `phung_banners_plans` (
...
--
-- Đang đổ dữ liệu cho bảng `phung_banners_plans`
--

INSERT INTO `phung_banners_plans` (`id`, `blang`, `title`, `description`, `form`, `width`, `height`, `act`, `require_image`, `uploadtype`, `uploadgroup`, `exp_time`) VALUES
...
--
-- Cấu trúc bảng cho bảng `phung_banners_rows`
--

DROP TABLE IF EXISTS `phung_banners_rows`;
CREATE TABLE IF NOT EXISTS `phung_banners_rows` (
  `id` mediumint(8) UNSIGNED NOT NULL AUTO_INCREMENT,
...
--
-- Đang đổ dữ liệu cho bảng `phung_banners_rows`
--

INSERT INTO `phung_banners_rows` (`id`, `title`, `pid`, `clid`, `file_name`, `file_ext`, `file_mime`, `width`, `height`, `file_alt`, `imageforswf`, `click_url`, `target`, `bannerhtml`, `add_time`, `publ_time`, `exp_time`, `hits_total`, `act`, `weight`) VALUES
(1, 'Mid-page advertisement', 1, 1, 'webnhanh.jpg', 'png', 'image/jpeg', 575, 72, '', '', 'http://webnhanh.vn', '_blank', '', 1658830073, 1658830073, 0, 0, 1, 1),
(2, 'Left-column advertisement', 2, 1, 'vinades.jpg', 'jpg', 'image/jpeg', 212, 400, '', '', 'http://vinades.vn', '_blank', '', 1658830073, 1658830073, 0, 0, 1, 2);

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `phung_config`
--

DROP TABLE IF EXISTS `phung_config`;
CREATE TABLE IF NOT EXISTS `phung_config` (
...
--
-- Đang đổ dữ liệu cho bảng `phung_config`
--

INSERT INTO `phung_config` (`lang`, `module`, `config_name`, `config_value`) VALUES
...
('sys', 'global', 'timestamp', '1658830073'),
...
('vi', 'global', 'cronjobs_next_time', '1658836076'),
...
('sys', 'site', 'site_email', 'wampserver@wampserver.invalid'),
('sys', 'global', 'error_set_logs', '1'),
('sys', 'global', 'error_send_email', 'wampserver@wampserver.invalid'),
('sys', 'global', 'site_lang', 'vi'),
('sys', 'global', 'my_domains', 'localhost'),
('sys', 'global', 'cookie_prefix', 'nv4'),
('sys', 'global', 'session_prefix', 'nv4s_v2cns3'),
...
('sys', 'global', 'ftp_user_pass', 'kp01jFgv5DC3rxjbkdpe7g,,'),
('sys', 'global', 'ftp_path', '/'),
...
--
-- Cấu trúc bảng cho bảng `phung_cookies`
--

DROP TABLE IF EXISTS `phung_cookies`;
CREATE TABLE IF NOT EXISTS `phung_cookies` (
...
--
-- Cấu trúc bảng cho bảng `phung_counter`
--

DROP TABLE IF EXISTS `phung_counter`;
CREATE TABLE IF NOT EXISTS `phung_counter` (
...
--
-- Đang đổ dữ liệu cho bảng `phung_counter`
--

INSERT INTO `phung_counter` (`c_type`, `c_val`, `last_update`, `c_count`, `vi_count`) VALUES
('c_time', 'start', 0, 0, 0),
('c_time', 'last', 0, 1658834655, 0),
('total', 'hits', 1658834655, 3, 3),
('year', '2022', 1658834655, 3, 3),
('year', '2023', 0, 0, 0),
('year', '2024', 0, 0, 0),
('year', '2025', 0, 0, 0),
('year', '2026', 0, 0, 0),
...
('dayofweek', 'Tuesday', 1658834655, 3, 3),
...
('hour', '15', 0, 0, 0),
('hour', '16', 0, 0, 0),
('hour', '17', 1658832569, 2, 2),
('hour', '18', 1658834655, 1, 1),
('hour', '19', 0, 0, 0),
('hour', '20', 0, 0, 0),
('hour', '21', 0, 0, 0),
('hour', '22', 0, 0, 0),
...
('country', 'ZM', 0, 0, 0),
('country', 'ZW', 0, 0, 0),
('country', 'ZZ', 1658834655, 3, 3),
('country', 'unkown', 0, 0, 0);

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `phung_cronjobs`
--

DROP TABLE IF EXISTS `phung_cronjobs`;
CREATE TABLE IF NOT EXISTS `phung_cronjobs` (
  `id` mediumint(8) UNSIGNED NOT NULL AUTO_INCREMENT,
...
--
-- Đang đổ dữ liệu cho bảng `phung_cronjobs`
--

INSERT INTO `phung_cronjobs` (`id`, `start_time`, `inter_val`, `inter_val_type`, `run_file`, `run_func`, `params`, `del`, `is_sys`, `act`, `last_time`, `last_result`, `vi_cron_name`) VALUES
(1, 1658830073, 5, 0, 'online_expired_del.php', 'cron_online_expired_del', '', 0, 1, 1, 1658835776, 1, 'Xóa các dòng ghi trạng thái online đã cũ trong CSDL'),
(2, 1658830073, 1440, 0, 'dump_autobackup.php', 'cron_dump_autobackup', '', 0, 1, 1, 1658830333, 1, 'Tự động lưu CSDL'),
(3, 1658830073, 60, 0, 'temp_download_destroy.php', 'cron_auto_del_temp_download', '', 0, 1, 1, 1658835053, 1, 'Xóa các file tạm trong thư mục tmp'),
(4, 1658830073, 30, 0, 'ip_logs_destroy.php', 'cron_del_ip_logs', '', 0, 1, 1, 1658835053, 1, 'Xóa IP log files, Xóa các file nhật ký truy cập'),
(5, 1658830073, 1440, 0, 'error_log_destroy.php', 'cron_auto_del_error_log', '', 0, 1, 1, 1658830333, 1, 'Xóa các file error_log quá hạn'),
(6, 1658830073, 360, 0, 'error_log_sendmail.php', 'cron_auto_sendmail_error_log', '', 0, 1, 0, 0, 0, 'Gửi email các thông báo lỗi cho admin'),
(7, 1658830073, 60, 0, 'ref_expired_del.php', 'cron_ref_expired_del', '', 0, 1, 1, 1658835053, 1, 'Xóa các referer quá hạn'),
(8, 1658830073, 60, 0, 'check_version.php', 'cron_auto_check_version', '', 0, 1, 1, 1658835053, 1, 'Kiểm tra phiên bản NukeViet'),
(9, 1658830073, 1440, 0, 'notification_autodel.php', 'cron_notification_autodel', '', 0, 1, 1, 1658830333, 1, 'Xóa thông báo cũ');

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `phung_extension_files`
--

DROP TABLE IF EXISTS `phung_extension_files`;
CREATE TABLE IF NOT EXISTS `phung_extension_files` (
...
--
-- Cấu trúc bảng cho bảng `phung_ips`
--

DROP TABLE IF EXISTS `phung_ips`;
CREATE TABLE IF NOT EXISTS `phung_ips` (
...
--
-- Đang đổ dữ liệu cho bảng `phung_ips`
--

INSERT INTO `phung_ips` (`id`, `type`, `ip`, `mask`, `area`, `begintime`, `endtime`, `notice`) VALUES
(1, 1, '::1', 0, 1, 1658830297, 0, '');

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `phung_language`
--

DROP TABLE IF EXISTS `phung_language`;
CREATE TABLE IF NOT EXISTS `phung_language` (
  `id` mediumint(8) UNSIGNED NOT NULL AUTO_INCREMENT,
...
--
-- Cấu trúc bảng cho bảng `phung_language_file`
--

DROP TABLE IF EXISTS `phung_language_file`;
CREATE TABLE IF NOT EXISTS `phung_language_file` (
  `idfile` mediumint(8) UNSIGNED NOT NULL AUTO_INCREMENT,
  `module` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
...
--
-- Cấu trúc bảng cho bảng `phung_logs`
--

DROP TABLE IF EXISTS `phung_logs`;
CREATE TABLE IF NOT EXISTS `phung_logs` (
...
--
-- Đang đổ dữ liệu cho bảng `phung_logs`
--

INSERT INTO `phung_logs` (`id`, `lang`, `module_name`, `name_key`, `note_action`, `link_acess`, `userid`, `log_time`) VALUES
(1, 'vi', 'login', '[admin] Đăng nhập', ' Client IP:::1', '', 0, 1658830355);

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `phung_notification`
--

DROP TABLE IF EXISTS `phung_notification`;
CREATE TABLE IF NOT EXISTS `phung_notification` (
  `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT,
...
--
-- Cấu trúc bảng cho bảng `phung_plugin`
--

DROP TABLE IF EXISTS `phung_plugin`;
CREATE TABLE IF NOT EXISTS `phung_plugin` (
...
--
-- Đang đổ dữ liệu cho bảng `phung_plugin`
--

INSERT INTO `phung_plugin` (`pid`, `plugin_file`, `plugin_area`, `weight`) VALUES
(1, 'qrcode.php', 1, 1),
...
--
-- Cấu trúc bảng cho bảng `phung_sessions`
--

DROP TABLE IF EXISTS `phung_sessions`;
CREATE TABLE IF NOT EXISTS `phung_sessions` (
...
--
-- Đang đổ dữ liệu cho bảng `phung_sessions`
--

INSERT INTO `phung_sessions` (`session_id`, `userid`, `username`, `onl_time`) VALUES
('v0f5nqrk92ogflngav0j69k00k', 1, 'admin', 1658835797);

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `phung_setup_extensions`
--

DROP TABLE IF EXISTS `phung_setup_extensions`;
CREATE TABLE IF NOT EXISTS `phung_setup_extensions` (
...
--
-- Đang đổ dữ liệu cho bảng `phung_setup_extensions`
--

INSERT INTO `phung_setup_extensions` (`id`, `type`, `title`, `is_sys`, `is_virtual`, `basename`, `table_prefix`, `version`, `addtime`, `author`, `note`) VALUES
(0, 'module', 'about', 0, 0, 'page', 'about', '4.5.02 1655715600', 1658830073, 'VINADES <contact@vinades.vn>', ''),
(0, 'module', 'siteterms', 0, 0, 'page', 'siteterms', '4.5.02 1655715600', 1658830073, 'VINADES <contact@vinades.vn>', ''),
(19, 'module', 'banners', 1, 0, 'banners', 'banners', '4.5.02 1655715600', 1658830073, 'VINADES <contact@vinades.vn>', ''),
(20, 'module', 'contact', 0, 1, 'contact', 'contact', '4.5.02 1655715600', 1658830073, 'VINADES <contact@vinades.vn>', ''),
(1, 'module', 'news', 0, 1, 'news', 'news', '4.5.02 1655715600', 1658830073, 'VINADES <contact@vinades.vn>', ''),
(21, 'module', 'voting', 0, 0, 'voting', 'voting', '4.5.02 1655715600', 1658830073, 'VINADES <contact@vinades.vn>', ''),
(284, 'module', 'seek', 1, 0, 'seek', 'seek', '4.5.02 1655715600', 1658830073, 'VINADES <contact@vinades.vn>', ''),
(24, 'module', 'users', 1, 1, 'users', 'users', '4.5.02 1655715600', 1658830073, 'VINADES <contact@vinades.vn>', ''),
(27, 'module', 'statistics', 0, 0, 'statistics', 'statistics', '4.5.02 1655715600', 1658830073, 'VINADES <contact@vinades.vn>', ''),
(29, 'module', 'menu', 0, 0, 'menu', 'menu', '4.5.02 1655715600', 1658830073, 'VINADES <contact@vinades.vn>', ''),
(283, 'module', 'feeds', 1, 0, 'feeds', 'feeds', '4.5.02 1655715600', 1658830073, 'VINADES <contact@vinades.vn>', ''),
(282, 'module', 'page', 1, 1, 'page', 'page', '4.5.02 1655715600', 1658830073, 'VINADES <contact@vinades.vn>', ''),
(281, 'module', 'comment', 1, 0, 'comment', 'comment', '4.5.02 1655715600', 1658830073, 'VINADES <contact@vinades.vn>', ''),
(312, 'module', 'freecontent', 0, 1, 'freecontent', 'freecontent', '4.5.02 1655715600', 1658830073, 'VINADES <contact@vinades.vn>', ''),
(327, 'module', 'two-step-verification', 1, 0, 'two-step-verification', 'two_step_verification', '4.5.02 1655715600', 1658830073, 'VINADES <contact@vinades.vn>', ''),
(307, 'theme', 'default', 0, 0, 'default', 'default', '4.5.02 1655715600', 1658830073, 'VINADES <contact@vinades.vn>', ''),
(311, 'theme', 'mobile_default', 0, 0, 'mobile_default', 'mobile_default', '4.5.02 1655715600', 1658830073, 'VINADES <contact@vinades.vn>', '');

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `phung_setup_language`
--

DROP TABLE IF EXISTS `phung_setup_language`;
CREATE TABLE IF NOT EXISTS `phung_setup_language` (
...
--
-- Đang đổ dữ liệu cho bảng `phung_setup_language`
--

INSERT INTO `phung_setup_language` (`lang`, `setup`, `weight`) VALUES
('vi', 1, 1);

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `phung_upload_dir`
--

DROP TABLE IF EXISTS `phung_upload_dir`;
CREATE TABLE IF NOT EXISTS `phung_upload_dir` (
...
--
-- Đang đổ dữ liệu cho bảng `phung_upload_dir`
--

INSERT INTO `phung_upload_dir` (`did`, `dirname`, `time`, `thumb_type`, `thumb_width`, `thumb_height`, `thumb_quality`) VALUES
(0, '', 0, 3, 100, 150, 90),
(1, 'uploads', 0, 0, 0, 0, 0),
...
--
-- Cấu trúc bảng cho bảng `phung_upload_file`
--

DROP TABLE IF EXISTS `phung_upload_file`;
CREATE TABLE IF NOT EXISTS `phung_upload_file` (
...
--
-- Cấu trúc bảng cho bảng `phung_users`
--

DROP TABLE IF EXISTS `phung_users`;
CREATE TABLE IF NOT EXISTS `phung_users` (
...
--
-- Đang đổ dữ liệu cho bảng `phung_users`
--

INSERT INTO `phung_users` (`userid`, `group_id`, `username`, `md5username`, `password`, `email`, `first_name`, `last_name`, `gender`, `photo`, `birthday`, `sig`, `regdate`, `question`, `answer`, `passlostkey`, `view_mail`, `remember`, `in_groups`, `active`, `active2step`, `secretkey`, `checknum`, `last_login`, `last_ip`, `last_agent`, `last_openid`, `last_update`, `idsite`, `safemode`, `safekey`, `email_verification_time`, `active_obj`) VALUES
(1, 1, 'admin', '21232f297a57a5a743894a0e4a801fc3', '{SSHA512}73yvJtWlelu9ZMrGEdwkj+9GzOk+5ngjRfgQthUT03Uyg/TOKNmGYrm6xIZC71NKKXoFxTQDBVPxfP8C/sEz7GYxYzM=', 'phungct2012@gmail.com', 'admin', '', '', '', 0, '', 1658830297, 'Tôi là ai', 'Dương Thị Phụng', '', 0, 1, '1,4', 1, 0, '', '', 1658830297, '', '', '', 0, 0, 0, '', -3, 'SYSTEM');

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `phung_users_backupcodes`
--

DROP TABLE IF EXISTS `phung_users_backupcodes`;
CREATE TABLE IF NOT EXISTS `phung_users_backupcodes` (
  `userid` mediumint(8) UNSIGNED NOT NULL AUTO_INCREMENT,
...
--
-- Cấu trúc bảng cho bảng `phung_users_config`
--

DROP TABLE IF EXISTS `phung_users_config`;
CREATE TABLE IF NOT EXISTS `phung_users_config` (
...
--
-- Đang đổ dữ liệu cho bảng `phung_users_config`
--

INSERT INTO `phung_users_config` (`config`, `content`, `edit_time`) VALUES
...
--
-- Cấu trúc bảng cho bảng `phung_users_edit`
--

DROP TABLE IF EXISTS `phung_users_edit`;
CREATE TABLE IF NOT EXISTS `phung_users_edit` (
  `userid` mediumint(8) UNSIGNED NOT NULL,
...
--
-- Cấu trúc bảng cho bảng `phung_users_field`
--

DROP TABLE IF EXISTS `phung_users_field`;
CREATE TABLE IF NOT EXISTS `phung_users_field` (
...
--
-- Đang đổ dữ liệu cho bảng `phung_users_field`
--

INSERT INTO `phung_users_field` (`fid`, `field`, `weight`, `field_type`, `field_choices`, `sql_choices`, `match_type`, `match_regex`, `func_callback`, `min_length`, `max_length`, `required`, `show_register`, `user_editable`, `show_profile`, `class`, `language`, `default_value`, `is_system`) VALUES
...
--
-- Cấu trúc bảng cho bảng `phung_users_groups`
--

DROP TABLE IF EXISTS `phung_users_groups`;
CREATE TABLE IF NOT EXISTS `phung_users_groups` (
...
--
-- Đang đổ dữ liệu cho bảng `phung_users_groups`
--

INSERT INTO `phung_users_groups` (`group_id`, `alias`, `email`, `group_type`, `group_color`, `group_avatar`, `require_2step_admin`, `require_2step_site`, `is_default`, `add_time`, `exp_time`, `weight`, `act`, `idsite`, `numbers`, `siteus`, `config`) VALUES
(1, 'Super-Admin', '', 0, '', '', 0, 0, 0, 1658830073, 0, 1, 1, 0, 1, 0, 'a:7:{s:17:\"access_groups_add\";i:1;s:17:\"access_groups_del\";i:1;s:12:\"access_addus\";i:0;s:14:\"access_waiting\";i:0;s:13:\"access_editus\";i:0;s:12:\"access_delus\";i:0;s:13:\"access_passus\";i:0;}'),
(2, 'General-Admin', '', 0, '', '', 0, 0, 0, 1658830073, 0, 2, 1, 0, 0, 0, 'a:7:{s:17:\"access_groups_add\";i:1;s:17:\"access_groups_del\";i:1;s:12:\"access_addus\";i:0;s:14:\"access_waiting\";i:0;s:13:\"access_editus\";i:0;s:12:\"access_delus\";i:0;s:13:\"access_passus\";i:0;}'),
(3, 'Module-Admin', '', 0, '', '', 0, 0, 0, 1658830073, 0, 3, 1, 0, 0, 0, 'a:7:{s:17:\"access_groups_add\";i:1;s:17:\"access_groups_del\";i:1;s:12:\"access_addus\";i:0;s:14:\"access_waiting\";i:0;s:13:\"access_editus\";i:0;s:12:\"access_delus\";i:0;s:13:\"access_passus\";i:0;}'),
(4, 'Users', '', 0, '', '', 0, 0, 0, 1658830073, 0, 4, 1, 0, 1, 0, 'a:7:{s:17:\"access_groups_add\";i:1;s:17:\"access_groups_del\";i:1;s:12:\"access_addus\";i:0;s:14:\"access_waiting\";i:0;s:13:\"access_editus\";i:0;s:12:\"access_delus\";i:0;s:13:\"access_passus\";i:0;}'),
(7, 'New-Users', '', 0, '', '', 0, 0, 0, 1658830073, 0, 5, 1, 0, 0, 0, 'a:7:{s:17:\"access_groups_add\";i:1;s:17:\"access_groups_del\";i:1;s:12:\"access_addus\";i:0;s:14:\"access_waiting\";i:0;s:13:\"access_editus\";i:0;s:12:\"access_delus\";i:0;s:13:\"access_passus\";i:0;}'),
(5, 'Guest', '', 0, '', '', 0, 0, 0, 1658830073, 0, 6, 1, 0, 0, 0, 'a:7:{s:17:\"access_groups_add\";i:1;s:17:\"access_groups_del\";i:1;s:12:\"access_addus\";i:0;s:14:\"access_waiting\";i:0;s:13:\"access_editus\";i:0;s:12:\"access_delus\";i:0;s:13:\"access_passus\";i:0;}'),
(6, 'All', '', 0, '', '', 0, 0, 0, 1658830073, 0, 7, 1, 0, 0, 0, 'a:7:{s:17:\"access_groups_add\";i:1;s:17:\"access_groups_del\";i:1;s:12:\"access_addus\";i:0;s:14:\"access_waiting\";i:0;s:13:\"access_editus\";i:0;s:12:\"access_delus\";i:0;s:13:\"access_passus\";i:0;}'),
(10, 'NukeViet-Fans', '', 2, '', '', 0, 0, 1, 1658830073, 0, 8, 1, 0, 0, 0, 'a:7:{s:17:\"access_groups_add\";i:1;s:17:\"access_groups_del\";i:1;s:12:\"access_addus\";i:0;s:14:\"access_waiting\";i:0;s:13:\"access_editus\";i:0;s:12:\"access_delus\";i:0;s:13:\"access_passus\";i:0;}'),
(11, 'NukeViet-Admins', '', 2, '', '', 0, 0, 0, 1658830073, 0, 9, 1, 0, 0, 0, 'a:7:{s:17:\"access_groups_add\";i:1;s:17:\"access_groups_del\";i:1;s:12:\"access_addus\";i:0;s:14:\"access_waiting\";i:0;s:13:\"access_editus\";i:0;s:12:\"access_delus\";i:0;s:13:\"access_passus\";i:0;}'),
(12, 'NukeViet-Programmers', '', 1, '', '', 0, 0, 0, 1658830073, 0, 10, 1, 0, 0, 0, 'a:7:{s:17:\"access_groups_add\";i:1;s:17:\"access_groups_del\";i:1;s:12:\"access_addus\";i:0;s:14:\"access_waiting\";i:0;s:13:\"access_editus\";i:0;s:12:\"access_delus\";i:0;s:13:\"access_passus\";i:0;}');

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `phung_users_groups_detail`
--

DROP TABLE IF EXISTS `phung_users_groups_detail`;
CREATE TABLE IF NOT EXISTS `phung_users_groups_detail` (
  `group_id` smallint(5) UNSIGNED NOT NULL DEFAULT '0',
...
--
-- Đang đổ dữ liệu cho bảng `phung_users_groups_detail`
--

INSERT INTO `phung_users_groups_detail` (`group_id`, `lang`, `title`, `description`, `content`) VALUES
(1, 'vi', 'Super Admin', '', ''),
(2, 'vi', 'General Admin', '', ''),
(3, 'vi', 'Module Admin', '', ''),
(4, 'vi', 'Users', '', ''),
...
--
-- Cấu trúc bảng cho bảng `phung_users_groups_users`
--

DROP TABLE IF EXISTS `phung_users_groups_users`;
CREATE TABLE IF NOT EXISTS `phung_users_groups_users` (
  `group_id` smallint(5) UNSIGNED NOT NULL DEFAULT '0',
  `userid` mediumint(8) UNSIGNED NOT NULL DEFAULT '0',
...
--
-- Đang đổ dữ liệu cho bảng `phung_users_groups_users`
--

INSERT INTO `phung_users_groups_users` (`group_id`, `userid`, `is_leader`, `approved`, `data`, `time_requested`, `time_approved`) VALUES
(1, 1, 1, 1, '0', 1658830297, 1658830297);

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `phung_users_info`
--

DROP TABLE IF EXISTS `phung_users_info`;
CREATE TABLE IF NOT EXISTS `phung_users_info` (
  `userid` mediumint(8) UNSIGNED NOT NULL,
  PRIMARY KEY (`userid`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Đang đổ dữ liệu cho bảng `phung_users_info`
--

INSERT INTO `phung_users_info` (`userid`) VALUES
(1);

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `phung_users_openid`
--

DROP TABLE IF EXISTS `phung_users_openid`;
CREATE TABLE IF NOT EXISTS `phung_users_openid` (
  `userid` mediumint(8) UNSIGNED NOT NULL DEFAULT '0',
...
--
-- Cấu trúc bảng cho bảng `phung_users_question`
--

DROP TABLE IF EXISTS `phung_users_question`;
CREATE TABLE IF NOT EXISTS `phung_users_question` (
...
--
-- Đang đổ dữ liệu cho bảng `phung_users_question`
--

INSERT INTO `phung_users_question` (`qid`, `title`, `lang`, `weight`, `add_time`, `edit_time`) VALUES
...
--
-- Cấu trúc bảng cho bảng `phung_users_reg`
--

DROP TABLE IF EXISTS `phung_users_reg`;
CREATE TABLE IF NOT EXISTS `phung_users_reg` (
  `userid` mediumint(8) UNSIGNED NOT NULL AUTO_INCREMENT,
  `username` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `md5username` char(32) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `password` varchar(150) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
--
-- Cấu trúc bảng cho bảng `phung_vi_about`
--

DROP TABLE IF EXISTS `phung_vi_about`;
CREATE TABLE IF NOT EXISTS `phung_vi_about` (
  `id` mediumint(8) UNSIGNED NOT NULL AUTO_INCREMENT,
  `title` varchar(250) COLLATE utf8mb4_unicode_ci NOT NULL,
...
--
-- Đang đổ dữ liệu cho bảng `phung_vi_about_config`
--

INSERT INTO `phung_vi_about_config` (`config_name`, `config_value`) VALUES
('viewtype', '0'),
('facebookapi', ''),
('per_page', '20'),
('news_first', '0'),
...
--
-- Cấu trúc bảng cho bảng `phung_vi_blocks_groups`
--

DROP TABLE IF EXISTS `phung_vi_blocks_groups`;
CREATE TABLE IF NOT EXISTS `phung_vi_blocks_groups` (
...
--
-- Đang đổ dữ liệu cho bảng `phung_vi_blocks_groups`
--

INSERT INTO `phung_vi_blocks_groups` (`bid`, `theme`, `module`, `file_name`, `title`, `link`, `template`, `position`, `exp_time`, `active`, `act`, `groups_view`, `all_func`, `weight`, `config`) VALUES
...
(11, 'default', 'theme', 'global.copyright.php', 'Copyright', '', 'no_title', '[FOOTER_SITE]', 0, '1', 1, '6', 1, 1, 'a:5:{s:12:\"copyright_by\";s:0:\"\";s:13:\"copyright_url\";s:0:\"\";s:9:\"design_by\";s:12:\"VINADES.,JSC\";s:10:\"design_url\";s:18:\"http://vinades.vn/\";s:13:\"siteterms_url\";s:54:\"/nukeviet-phung/index.php?language=vi&amp;nv=siteterms\";}'),
...
(28, 'mobile_default', 'theme', 'global.copyright.php', 'Copyright', '', 'no_title', '[FOOTER_SITE]', 0, '1', 1, '6', 1, 1, 'a:5:{s:12:\"copyright_by\";s:0:\"\";s:13:\"copyright_url\";s:0:\"\";s:9:\"design_by\";s:12:\"VINADES.,JSC\";s:10:\"design_url\";s:18:\"http://vinades.vn/\";s:13:\"siteterms_url\";s:54:\"/nukeviet-phung/index.php?language=vi&amp;nv=siteterms\";}'),
...
--
-- Cấu trúc bảng cho bảng `phung_vi_blocks_weight`
--

DROP TABLE IF EXISTS `phung_vi_blocks_weight`;
CREATE TABLE IF NOT EXISTS `phung_vi_blocks_weight` (
  `bid` mediumint(8) NOT NULL DEFAULT '0',
...
--
-- Đang đổ dữ liệu cho bảng `phung_vi_blocks_weight`
--

INSERT INTO `phung_vi_blocks_weight` (`bid`, `func_id`, `weight`) VALUES
(1, 4, 1),
(2, 4, 2),
(3, 4, 1),
(3, 5, 1),
...
--
-- Cấu trúc bảng cho bảng `phung_vi_comment`
--

DROP TABLE IF EXISTS `phung_vi_comment`;
CREATE TABLE IF NOT EXISTS `phung_vi_comment` (
...
--
-- Cấu trúc bảng cho bảng `phung_vi_contact_department`
--

DROP TABLE IF EXISTS `phung_vi_contact_department`;
CREATE TABLE IF NOT EXISTS `phung_vi_contact_department` (
  `id` smallint(5) UNSIGNED NOT NULL AUTO_INCREMENT,
...
--
-- Đang đổ dữ liệu cho bảng `phung_vi_contact_department`
--

INSERT INTO `phung_vi_contact_department` (`id`, `full_name`, `alias`, `image`, `phone`, `fax`, `email`, `address`, `note`, `others`, `cats`, `admins`, `act`, `weight`, `is_default`) VALUES
...
--
-- Cấu trúc bảng cho bảng `phung_vi_contact_reply`
--

DROP TABLE IF EXISTS `phung_vi_contact_reply`;
CREATE TABLE IF NOT EXISTS `phung_vi_contact_reply` (
...
--
-- Cấu trúc bảng cho bảng `phung_vi_contact_send`
--

DROP TABLE IF EXISTS `phung_vi_contact_send`;
CREATE TABLE IF NOT EXISTS `phung_vi_contact_send` (
  `id` mediumint(8) UNSIGNED NOT NULL AUTO_INCREMENT,
...
--
-- Cấu trúc bảng cho bảng `phung_vi_contact_supporter`
--

DROP TABLE IF EXISTS `phung_vi_contact_supporter`;
CREATE TABLE IF NOT EXISTS `phung_vi_contact_supporter` (
  `id` smallint(5) UNSIGNED NOT NULL AUTO_INCREMENT,
...
--
-- Cấu trúc bảng cho bảng `phung_vi_freecontent_blocks`
--

DROP TABLE IF EXISTS `phung_vi_freecontent_blocks`;
CREATE TABLE IF NOT EXISTS `phung_vi_freecontent_blocks` (
  `bid` mediumint(8) UNSIGNED NOT NULL AUTO_INCREMENT,
...
--
-- Đang đổ dữ liệu cho bảng `phung_vi_freecontent_blocks`
--

INSERT INTO `phung_vi_freecontent_blocks` (`bid`, `title`, `description`) VALUES
(1, 'Sản phẩm', 'Sản phẩm của công ty cổ phần phát triển nguồn mở Việt Nam - VINADES.,JSC');

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `phung_vi_freecontent_rows`
--

DROP TABLE IF EXISTS `phung_vi_freecontent_rows`;
CREATE TABLE IF NOT EXISTS `phung_vi_freecontent_rows` (
  `id` mediumint(8) UNSIGNED NOT NULL AUTO_INCREMENT,
...
--
-- Đang đổ dữ liệu cho bảng `phung_vi_freecontent_rows`
--

INSERT INTO `phung_vi_freecontent_rows` (`id`, `bid`, `title`, `description`, `link`, `target`, `image`, `start_time`, `end_time`, `status`) VALUES
(1, 1, 'Hệ quản trị nội dung NukeViet', '<ul>\n	<li>Giải thưởng Nhân tài đất Việt 2011, 10.000+ website đang sử dụng</li>\n	<li>Được Bộ GD&amp;ĐT khuyến khích sử dụng trong các cơ sở giáo dục</li>\n	<li>Bộ TT&amp;TT quy định ưu tiên sử dụng trong cơ quan nhà nước</li>\n</ul>', 'http://vinades.vn/vi/san-pham/nukeviet/', '_blank', 'cms.jpg', 1658830073, 0, 1),
(2, 1, 'Cổng thông tin doanh nghiệp', '<ul>\n	<li>Tích hợp bán hàng trực tuyến</li>\n	<li>Tích hợp các nghiệp vụ quản lý (quản lý khách hàng, quản lý nhân sự, quản lý tài liệu)</li>\n</ul>', 'http://vinades.vn/vi/san-pham/Cong-thong-tin-doanh-nghiep-NukeViet-portal/', '_blank', 'portal.jpg', 1658830073, 0, 1),
(3, 1, 'Cổng thông tin Phòng giáo dục, Sở giáo dục', '<ul>\n	<li>Tích hợp chung website hàng trăm trường</li>\n	<li>Tích hợp các ứng dụng trực tuyến (Tra điểm SMS, Tra cứu văn bằng, Học bạ điện tử ...)</li>\n</ul>', 'http://vinades.vn/vi/san-pham/Cong-thong-tin-giao-duc-NukeViet-Edugate/', '_blank', 'edugate.jpg', 1658830073, 0, 1),
(4, 1, 'Tòa soạn báo điện tử chuyên nghiệp', '<ul>\n	<li>Bảo mật đa tầng, phân quyền linh hoạt</li>\n	<li>Hệ thống bóc tin tự động, đăng bài tự động, cùng nhiều chức năng tiên tiến khác...</li>\n</ul>', 'http://vinades.vn/vi/san-pham/Toa-soan-bao-dien-tu/', '_blank', 'toa-soan-dien-tu.jpg', 1658830073, 0, 1),
(5, 1, 'Giải pháp bán hàng trực tuyến', '<ul><li>Tích hợp các tính năng cơ bản bán hàng trực tuyến</li><li>Tích hợp với các cổng thanh toán, ví điện tử trên toàn quốc</li></ul>', 'http://vinades.vn', '_blank', 'shop.jpg', 1658830073, 0, 1);

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `phung_vi_menu`
--

DROP TABLE IF EXISTS `phung_vi_menu`;
CREATE TABLE IF NOT EXISTS `phung_vi_menu` (
  `id` smallint(5) UNSIGNED NOT NULL AUTO_INCREMENT,
...
--
-- Đang đổ dữ liệu cho bảng `phung_vi_menu`
--

INSERT INTO `phung_vi_menu` (`id`, `title`) VALUES
(1, 'Top Menu');

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `phung_vi_menu_rows`
--

DROP TABLE IF EXISTS `phung_vi_menu_rows`;
CREATE TABLE IF NOT EXISTS `phung_vi_menu_rows` (
...
--
-- Đang đổ dữ liệu cho bảng `phung_vi_menu_rows`
--

INSERT INTO `phung_vi_menu_rows` (`id`, `parentid`, `mid`, `title`, `link`, `icon`, `image`, `note`, `weight`, `sort`, `lev`, `subitem`, `groups_view`, `module_name`, `op`, `target`, `css`, `active_type`, `status`) VALUES
(1, 0, 1, 'Giới thiệu', '/nukeviet-phung/index.php?language=vi&nv=about', '', '', '', 1, 1, 0, '8,9,10,11,12,13,14,15', '6', 'about', '', 1, '', 0, 1),
(2, 0, 1, 'Tin Tức', '/nukeviet-phung/index.php?language=vi&nv=news', '', '', '', 2, 10, 0, '16,17,18,19,20,21,22', '6', 'news', '', 1, '', 0, 1),
(3, 0, 1, 'Thành viên', '/nukeviet-phung/index.php?language=vi&nv=users', '', '', '', 3, 18, 0, '', '6', 'users', '', 1, '', 0, 1),
(4, 0, 1, 'Thống kê', '/nukeviet-phung/index.php?language=vi&nv=statistics', '', '', '', 4, 19, 0, '', '2', 'statistics', '', 1, '', 0, 1),
(5, 0, 1, 'Thăm dò ý kiến', '/nukeviet-phung/index.php?language=vi&nv=voting', '', '', '', 5, 20, 0, '', '6', 'voting', '', 1, '', 0, 1),
(6, 0, 1, 'Tìm kiếm', '/nukeviet-phung/index.php?language=vi&nv=seek', '', '', '', 6, 21, 0, '', '6', 'seek', '', 1, '', 0, 1),
(7, 0, 1, 'Liên hệ', '/nukeviet-phung/index.php?language=vi&nv=contact', '', '', '', 7, 22, 0, '', '6', 'contact', '', 1, '', 0, 1),
(8, 1, 1, 'Giới thiệu về NukeViet', '/nukeviet-phung/index.php?language=vi&nv=about&op=gioi-thieu-ve-nukeviet.html', '', '', '', 1, 2, 1, '', '6', 'about', 'gioi-thieu-ve-nukeviet', 1, '', 0, 1),
(9, 1, 1, 'Giới thiệu về NukeViet CMS', '/nukeviet-phung/index.php?language=vi&nv=about&op=gioi-thieu-ve-nukeviet-cms.html', '', '', '', 2, 3, 1, '', '6', 'about', 'gioi-thieu-ve-nukeviet-cms', 1, '', 0, 1),
(10, 1, 1, 'Logo và tên gọi NukeViet', '/nukeviet-phung/index.php?language=vi&nv=about&op=logo-va-ten-goi-nukeviet.html', '', '', '', 3, 4, 1, '', '6', 'about', 'logo-va-ten-goi-nukeviet', 1, '', 0, 1),
(11, 1, 1, 'Giấy phép sử dụng NukeViet', '/nukeviet-phung/index.php?language=vi&nv=about&op=giay-phep-su-dung-nukeviet.html', '', '', '', 4, 5, 1, '', '6,7', 'about', 'giay-phep-su-dung-nukeviet', 1, '', 0, 1),
(12, 1, 1, 'Những tính năng của NukeViet CMS 4.0', '/nukeviet-phung/index.php?language=vi&nv=about&op=nhung-tinh-nang-cua-nukeviet-cms-4-0.html', '', '', '', 5, 6, 1, '', '6', 'about', 'nhung-tinh-nang-cua-nukeviet-cms-4-0', 1, '', 0, 1),
(13, 1, 1, 'Yêu cầu sử dụng NukeViet 4', '/nukeviet-phung/index.php?language=vi&nv=about&op=Yeu-cau-su-dung-NukeViet-4.html', '', '', '', 6, 7, 1, '', '6', 'about', 'Yeu-cau-su-dung-NukeViet-4', 1, '', 0, 1),
(14, 1, 1, 'Giới thiệu về Công ty cổ phần phát triển nguồn mở Việt Nam', '/nukeviet-phung/index.php?language=vi&nv=about&op=gioi-thieu-ve-cong-ty-co-phan-phat-trien-nguon-mo-viet-nam.html', '', '', '', 7, 8, 1, '', '6', 'about', 'gioi-thieu-ve-cong-ty-co-phan-phat-trien-nguon-mo-viet-nam', 1, '', 0, 1),
(15, 1, 1, 'Ủng hộ, hỗ trợ và tham gia phát triển NukeViet', '/nukeviet-phung/index.php?language=vi&nv=about&op=ung-ho-ho-tro-va-tham-gia-phat-trien-nukeviet.html', '', '', '', 8, 9, 1, '', '6', 'about', 'ung-ho-ho-tro-va-tham-gia-phat-trien-nukeviet', 1, '', 0, 1),
(16, 2, 1, 'Đối tác', '/nukeviet-phung/index.php?language=vi&nv=news&op=Doi-tac', '', '', '', 1, 11, 1, '', '6', 'news', 'Doi-tac', 1, '', 0, 1),
(17, 2, 1, 'Tuyển dụng', '/nukeviet-phung/index.php?language=vi&nv=news&op=Tuyen-dung', '', '', '', 2, 12, 1, '', '6', 'news', 'Tuyen-dung', 1, '', 0, 1),
(18, 2, 1, 'Rss', '/nukeviet-phung/index.php?language=vi&nv=news&op=rss', '', '', '', 3, 13, 1, '', '6', 'news', 'rss', 1, '', 0, 1),
(19, 2, 1, 'Quản lý bài viết', '/nukeviet-phung/index.php?language=vi&nv=news&op=content', '', '', '', 4, 14, 1, '', '6', 'news', 'content', 1, '', 0, 1),
(20, 2, 1, 'Tìm kiếm', '/nukeviet-phung/index.php?language=vi&nv=news&op=search', '', '', '', 5, 15, 1, '', '6', 'news', 'search', 1, '', 0, 1),
(21, 2, 1, 'Tin tức', '/nukeviet-phung/index.php?language=vi&nv=news&op=Tin-tuc', '', '', '', 6, 16, 1, '', '6', 'news', 'Tin-tuc', 1, '', 0, 1),
(22, 2, 1, 'Sản phẩm', '/nukeviet-phung/index.php?language=vi&nv=news&op=San-pham', '', '', '', 7, 17, 1, '', '6', 'news', 'San-pham', 1, '', 0, 1);

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `phung_vi_modfuncs`
--

DROP TABLE IF EXISTS `phung_vi_modfuncs`;
CREATE TABLE IF NOT EXISTS `phung_vi_modfuncs` (
...
--
-- Đang đổ dữ liệu cho bảng `phung_vi_modfuncs`
--

INSERT INTO `phung_vi_modfuncs` (`func_id`, `func_name`, `alias`, `func_custom_name`, `func_site_title`, `in_module`, `show_func`, `in_submenu`, `subweight`, `setting`) VALUES
...
--
-- Cấu trúc bảng cho bảng `phung_vi_modthemes`
--

DROP TABLE IF EXISTS `phung_vi_modthemes`;
CREATE TABLE IF NOT EXISTS `phung_vi_modthemes` (
...
--
-- Đang đổ dữ liệu cho bảng `phung_vi_modthemes`
--

INSERT INTO `phung_vi_modthemes` (`func_id`, `layout`, `theme`) VALUES
...
--
-- Cấu trúc bảng cho bảng `phung_vi_modules`
--

DROP TABLE IF EXISTS `phung_vi_modules`;
CREATE TABLE IF NOT EXISTS `phung_vi_modules` (
  `title` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
...
--
-- Đang đổ dữ liệu cho bảng `phung_vi_modules`
--

INSERT INTO `phung_vi_modules` (`title`, `module_file`, `module_data`, `module_upload`, `module_theme`, `custom_title`, `site_title`, `admin_title`, `set_time`, `main_file`, `admin_file`, `theme`, `mobile`, `description`, `keywords`, `groups_view`, `weight`, `act`, `admins`, `rss`, `sitemap`) VALUES
('about', 'page', 'about', 'about', 'page', 'Giới thiệu', '', '', 1658830073, 1, 1, '', '', '', '', '6', 1, 1, '', 1, 1),
('news', 'news', 'news', 'news', 'news', 'Tin Tức', '', '', 1658830073, 1, 1, '', '', '', '', '6', 2, 1, '', 1, 1),
('users', 'users', 'users', 'users', 'users', 'Thành viên', '', 'Tài khoản', 1658830073, 1, 1, '', '', '', '', '6', 3, 1, '', 0, 1),
('contact', 'contact', 'contact', 'contact', 'contact', 'Liên hệ', '', '', 1658830073, 1, 1, '', '', '', '', '6', 4, 1, '', 0, 1),
('statistics', 'statistics', 'statistics', 'statistics', 'statistics', 'Thống kê', '', '', 1658830073, 1, 1, '', '', '', 'online, statistics', '6', 5, 1, '', 0, 1),
('voting', 'voting', 'voting', 'voting', 'voting', 'Thăm dò ý kiến', '', '', 1658830073, 1, 1, '', '', '', '', '6', 6, 1, '', 1, 1),
('banners', 'banners', 'banners', 'banners', 'banners', 'Quảng cáo', '', '', 1658830073, 1, 1, '', '', '', '', '6', 7, 1, '', 0, 1),
('seek', 'seek', 'seek', 'seek', 'seek', 'Tìm kiếm', '', '', 1658830073, 1, 0, '', '', '', '', '6', 8, 1, '', 0, 1),
('menu', 'menu', 'menu', 'menu', 'menu', 'Menu Site', '', '', 1658830073, 0, 1, '', '', '', '', '6', 9, 1, '', 0, 1),
('feeds', 'feeds', 'feeds', 'feeds', 'feeds', 'RSS-feeds', '', '', 1658830073, 1, 1, '', '', '', '', '6', 10, 1, '', 0, 1),
('page', 'page', 'page', 'page', 'page', 'Page', '', '', 1658830073, 1, 1, '', '', '', '', '6', 11, 1, '', 1, 0),
('comment', 'comment', 'comment', 'comment', 'comment', 'Bình luận', '', 'Quản lý bình luận', 1658830073, 0, 1, '', '', '', '', '6', 12, 1, '', 0, 1),
('siteterms', 'page', 'siteterms', 'siteterms', 'page', 'Điều khoản sử dụng', '', '', 1658830073, 1, 1, '', '', '', '', '6', 13, 1, '', 1, 1),
('freecontent', 'freecontent', 'freecontent', 'freecontent', 'freecontent', 'Giới thiệu sản phẩm', '', '', 1658830073, 0, 1, '', '', '', '', '6', 14, 1, '', 0, 1),
('two-step-verification', 'two-step-verification', 'two_step_verification', 'two_step_verification', 'two-step-verification', 'Xác thực hai bước', '', '', 1658830073, 1, 0, '', '', '', '', '6', 15, 1, '', 0, 1);

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `phung_vi_news_1`
--

DROP TABLE IF EXISTS `phung_vi_news_1`;
CREATE TABLE IF NOT EXISTS `phung_vi_news_1` (
  `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT,
...
--
-- Cấu trúc bảng cho bảng `phung_vi_news_2`
--

DROP TABLE IF EXISTS `phung_vi_news_2`;
CREATE TABLE IF NOT EXISTS `phung_vi_news_2` (
  `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT,
  `catid` smallint(5) UNSIGNED NOT NULL DEFAULT '0',
  `listcatid` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `topicid` smallint(5) UNSIGNED NOT NULL DEFAULT '0',
...
--
-- Đang đổ dữ liệu cho bảng `phung_vi_news_2`
--

INSERT INTO `phung_vi_news_2` (`id`, `catid`, `listcatid`, `topicid`, `admin_id`, `author`, `sourceid`, `addtime`, `edittime`, `status`, `weight`, `publtime`, `exptime`, `archive`, `title`, `alias`, `hometext`, `homeimgfile`, `homeimgalt`, `homeimgthumb`, `inhome`, `allowed_comm`, `allowed_rating`, `external_link`, `hitstotal`, `hitscm`, `total_rating`, `click_rating`, `instant_active`, `instant_template`, `instant_creatauto`) VALUES
...
--
-- Cấu trúc bảng cho bảng `phung_vi_news_3`
--

DROP TABLE IF EXISTS `phung_vi_news_3`;
CREATE TABLE IF NOT EXISTS `phung_vi_news_3` (
  `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT,
  `catid` smallint(5) UNSIGNED NOT NULL DEFAULT '0',
  `listcatid` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `topicid` smallint(5) UNSIGNED NOT NULL DEFAULT '0',
...
--
-- Đang đổ dữ liệu cho bảng `phung_vi_news_3`
--

INSERT INTO `phung_vi_news_3` (`id`, `catid`, `listcatid`, `topicid`, `admin_id`, `author`, `sourceid`, `addtime`, `edittime`, `status`, `weight`, `publtime`, `exptime`, `archive`, `title`, `alias`, `hometext`, `homeimgfile`, `homeimgalt`, `homeimgthumb`, `inhome`, `allowed_comm`, `allowed_rating`, `external_link`, `hitstotal`, `hitscm`, `total_rating`, `click_rating`, `instant_active`, `instant_template`, `instant_creatauto`) VALUES
(12, 1, '1,3', 0, 1, '', 0, 1445391217, 1445393997, 1, 10, 1445391180, 0, 2, 'Hỗ trợ tập huấn và triển khai NukeViet cho các Phòng, Sở GD&amp;ĐT', 'ho-tro-tap-huan-va-trien-khai-nukeviet-cho-cac-phong-so-gd-dt', 'Trên cơ sở Hướng dẫn thực hiện nhiệm vụ CNTT năm học 2015 - 2016 của Bộ Giáo dục và Đào tạo, Công ty cổ phần phát triển nguồn mở Việt Nam và các doanh nghiệp phát triển NukeViet trong cộng đồng NukeViet đang tích cực công tác hỗ trợ cho các phòng GD&ĐT, Sở GD&ĐT triển khai 2 nội dung chính: Hỗ trợ công tác đào tạo tập huấn hướng dẫn sử dụng NukeViet và Hỗ trợ triển khai NukeViet cho các trường, Phòng và Sở GD&ĐT', 'tap-huan-pgd-ha-dong-2015.jpg', 'Tập huấn triển khai NukeViet tại Phòng Giáo dục và Đào tạo Hà Đông - Hà Nội', 1, 1, '4', 1, 0, 1, 0, 0, 0, 0, '', 0);

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `phung_vi_news_4`
--

DROP TABLE IF EXISTS `phung_vi_news_4`;
CREATE TABLE IF NOT EXISTS `phung_vi_news_4` (
  `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT,
  `catid` smallint(5) UNSIGNED NOT NULL DEFAULT '0',
  `listcatid` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `topicid` smallint(5) UNSIGNED NOT NULL DEFAULT '0',
...
--
-- Đang đổ dữ liệu cho bảng `phung_vi_news_4`
--

INSERT INTO `phung_vi_news_4` (`id`, `catid`, `listcatid`, `topicid`, `admin_id`, `author`, `sourceid`, `addtime`, `edittime`, `status`, `weight`, `publtime`, `exptime`, `archive`, `title`, `alias`, `hometext`, `homeimgfile`, `homeimgalt`, `homeimgthumb`, `inhome`, `allowed_comm`, `allowed_rating`, `external_link`, `hitstotal`, `hitscm`, `total_rating`, `click_rating`, `instant_active`, `instant_template`, `instant_creatauto`) VALUES
...
--
-- Cấu trúc bảng cho bảng `phung_vi_news_5`
--

DROP TABLE IF EXISTS `phung_vi_news_5`;
CREATE TABLE IF NOT EXISTS `phung_vi_news_5` (
  `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT,
  `catid` smallint(5) UNSIGNED NOT NULL DEFAULT '0',
  `listcatid` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `topicid` smallint(5) UNSIGNED NOT NULL DEFAULT '0',
...
--
-- Đang đổ dữ liệu cho bảng `phung_vi_news_5`
--

INSERT INTO `phung_vi_news_5` (`id`, `catid`, `listcatid`, `topicid`, `admin_id`, `author`, `sourceid`, `addtime`, `edittime`, `status`, `weight`, `publtime`, `exptime`, `archive`, `title`, `alias`, `hometext`, `homeimgfile`, `homeimgalt`, `homeimgthumb`, `inhome`, `allowed_comm`, `allowed_rating`, `external_link`, `hitstotal`, `hitscm`, `total_rating`, `click_rating`, `instant_active`, `instant_template`, `instant_creatauto`) VALUES
(1, 1, '1,5,7', 0, 1, 'Quỳnh Nhi', 1, 1274989177, 1275318126, 1, 1, 1274989140, 0, 2, 'Ra mắt công ty mã nguồn mở đầu tiên tại Việt Nam', 'Ra-mat-cong-ty-ma-nguon-mo-dau-tien-tai-Viet-Nam', 'Mã nguồn mở NukeViet vốn đã quá quen thuộc với cộng đồng CNTT Việt Nam trong mấy năm qua. Tuy chưa hoạt động chính thức, nhưng chỉ trong khoảng 5 năm gần đây, mã nguồn mở NukeViet đã được dùng phổ biến ở Việt Nam, áp dụng ở hầu hết các lĩnh vực, từ tin tức đến thương mại điện tử, từ các website cá nhân cho tới những hệ thống website doanh nghiệp.', 'nangly.jpg', 'Thành lập VINADES.,JSC', 1, 1, '6', 1, 0, 2, 0, 0, 0, 0, '', 0);

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `phung_vi_news_6`
--

DROP TABLE IF EXISTS `phung_vi_news_6`;
CREATE TABLE IF NOT EXISTS `phung_vi_news_6` (
  `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT,
  `catid` smallint(5) UNSIGNED NOT NULL DEFAULT '0',
  `listcatid` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `topicid` smallint(5) UNSIGNED NOT NULL DEFAULT '0',
...
--
-- Đang đổ dữ liệu cho bảng `phung_vi_news_6`
--

INSERT INTO `phung_vi_news_6` (`id`, `catid`, `listcatid`, `topicid`, `admin_id`, `author`, `sourceid`, `addtime`, `edittime`, `status`, `weight`, `publtime`, `exptime`, `archive`, `title`, `alias`, `hometext`, `homeimgfile`, `homeimgalt`, `homeimgthumb`, `inhome`, `allowed_comm`, `allowed_rating`, `external_link`, `hitstotal`, `hitscm`, `total_rating`, `click_rating`, `instant_active`, `instant_template`, `instant_creatauto`) VALUES
(6, 1, '1,6', 0, 1, '', 3, 1322685920, 1322686042, 1, 2, 1322685920, 0, 2, 'Mã nguồn mở NukeViet giành giải ba Nhân tài đất Việt 2011', 'Ma-nguon-mo-NukeViet-gianh-giai-ba-Nhan-tai-dat-Viet-2011', 'Không có giải nhất và giải nhì, sản phẩm Mã nguồn mở NukeViet của VINADES.,JSC là một trong ba sản phẩm đã đoạt giải ba Nhân tài đất Việt 2011 - Lĩnh vực Công nghệ thông tin (Sản phẩm đã ứng dụng rộng rãi).', 'nukeviet-nhantaidatviet2011.jpg', 'Mã nguồn mở NukeViet giành giải ba Nhân tài đất Việt 2011', 1, 1, '6', 1, 0, 1, 0, 0, 0, 0, '', 0);

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `phung_vi_news_7`
--

DROP TABLE IF EXISTS `phung_vi_news_7`;
CREATE TABLE IF NOT EXISTS `phung_vi_news_7` (
  `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT,
  `catid` smallint(5) UNSIGNED NOT NULL DEFAULT '0',
  `listcatid` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `topicid` smallint(5) UNSIGNED NOT NULL DEFAULT '0',
...
--
-- Đang đổ dữ liệu cho bảng `phung_vi_news_7`
--

INSERT INTO `phung_vi_news_7` (`id`, `catid`, `listcatid`, `topicid`, `admin_id`, `author`, `sourceid`, `addtime`, `edittime`, `status`, `weight`, `publtime`, `exptime`, `archive`, `title`, `alias`, `hometext`, `homeimgfile`, `homeimgalt`, `homeimgthumb`, `inhome`, `allowed_comm`, `allowed_rating`, `external_link`, `hitstotal`, `hitscm`, `total_rating`, `click_rating`, `instant_active`, `instant_template`, `instant_creatauto`) VALUES
(1, 1, '1,5,7', 0, 1, 'Quỳnh Nhi', 1, 1274989177, 1275318126, 1, 1, 1274989140, 0, 2, 'Ra mắt công ty mã nguồn mở đầu tiên tại Việt Nam', 'Ra-mat-cong-ty-ma-nguon-mo-dau-tien-tai-Viet-Nam', 'Mã nguồn mở NukeViet vốn đã quá quen thuộc với cộng đồng CNTT Việt Nam trong mấy năm qua. Tuy chưa hoạt động chính thức, nhưng chỉ trong khoảng 5 năm gần đây, mã nguồn mở NukeViet đã được dùng phổ biến ở Việt Nam, áp dụng ở hầu hết các lĩnh vực, từ tin tức đến thương mại điện tử, từ các website cá nhân cho tới những hệ thống website doanh nghiệp.', 'nangly.jpg', 'Thành lập VINADES.,JSC', 1, 1, '6', 1, 0, 2, 0, 0, 0, 0, '', 0),
(2, 7, '1,7', 0, 1, 'Nguyễn Thế Hùng', 7, 1453192444, 1453192444, 1, 12, 1453192444, 0, 2, 'Hãy trở thành nhà cung cấp dịch vụ của NukeViet&#33;', 'hay-tro-thanh-nha-cung-cap-dich-vu-cua-nukeviet', 'Nếu bạn là công ty hosting, là công ty thiết kế web có sử dụng mã nguồn NukeViet, là cơ sở đào tạo NukeViet hay là công ty bất kỳ có kinh doanh dịch vụ liên quan đến NukeViet... hãy cho chúng tôi biết thông tin liên hệ của bạn để NukeViet hỗ trợ bạn trong công việc kinh doanh nhé!', 'hoptac.jpg', '', 1, 1, '6', 1, 0, 13, 0, 0, 0, 0, '', 0);
...
--
-- Cấu trúc bảng cho bảng `phung_vi_news_admins`
--

DROP TABLE IF EXISTS `phung_vi_news_admins`;
CREATE TABLE IF NOT EXISTS `phung_vi_news_admins` (
  `userid` mediumint(8) UNSIGNED NOT NULL DEFAULT '0',
...
--
-- Cấu trúc bảng cho bảng `phung_vi_news_author`
--

DROP TABLE IF EXISTS `phung_vi_news_author`;
CREATE TABLE IF NOT EXISTS `phung_vi_news_author` (
  `id` mediumint(8) UNSIGNED NOT NULL AUTO_INCREMENT,
...
--
-- Cấu trúc bảng cho bảng `phung_vi_news_authorlist`
--

DROP TABLE IF EXISTS `phung_vi_news_authorlist`;
CREATE TABLE IF NOT EXISTS `phung_vi_news_authorlist` (
  `id` int(11) NOT NULL,
...
--
-- Cấu trúc bảng cho bảng `phung_vi_news_block`
--

DROP TABLE IF EXISTS `phung_vi_news_block`;
CREATE TABLE IF NOT EXISTS `phung_vi_news_block` (
...
--
-- Đang đổ dữ liệu cho bảng `phung_vi_news_block`
--

INSERT INTO `phung_vi_news_block` (`bid`, `id`, `weight`) VALUES
(1, 1, 1),
(2, 12, 1),
(2, 11, 2),
(2, 10, 3),
...
--
-- Cấu trúc bảng cho bảng `phung_vi_news_block_cat`
--

DROP TABLE IF EXISTS `phung_vi_news_block_cat`;
CREATE TABLE IF NOT EXISTS `phung_vi_news_block_cat` (
...
--
-- Đang đổ dữ liệu cho bảng `phung_vi_news_block_cat`
--

INSERT INTO `phung_vi_news_block_cat` (`bid`, `adddefault`, `numbers`, `title`, `alias`, `image`, `description`, `weight`, `keywords`, `add_time`, `edit_time`) VALUES
...
--
-- Cấu trúc bảng cho bảng `phung_vi_news_cat`
--

DROP TABLE IF EXISTS `phung_vi_news_cat`;
CREATE TABLE IF NOT EXISTS `phung_vi_news_cat` (
...
--
-- Đang đổ dữ liệu cho bảng `phung_vi_news_cat`
--

INSERT INTO `phung_vi_news_cat` (`catid`, `parentid`, `title`, `titlesite`, `alias`, `description`, `descriptionhtml`, `image`, `viewdescription`, `weight`, `sort`, `lev`, `viewcat`, `numsubcat`, `subcatid`, `numlinks`, `newday`, `featured`, `ad_block_cat`, `keywords`, `admins`, `add_time`, `edit_time`, `groups_view`, `status`) VALUES
...
--
-- Cấu trúc bảng cho bảng `phung_vi_news_config_post`
--

DROP TABLE IF EXISTS `phung_vi_news_config_post`;
CREATE TABLE IF NOT EXISTS `phung_vi_news_config_post` (
...
--
-- Đang đổ dữ liệu cho bảng `phung_vi_news_config_post`
--

INSERT INTO `phung_vi_news_config_post` (`group_id`, `addcontent`, `postcontent`, `editcontent`, `delcontent`) VALUES
(4, 0, 0, 0, 0),
(7, 0, 0, 0, 0),
(5, 0, 0, 0, 0),
(10, 0, 0, 0, 0),
...
--
-- Cấu trúc bảng cho bảng `phung_vi_news_detail`
--

DROP TABLE IF EXISTS `phung_vi_news_detail`;
CREATE TABLE IF NOT EXISTS `phung_vi_news_detail` (
  `id` int(11) UNSIGNED NOT NULL,
...
--
-- Đang đổ dữ liệu cho bảng `phung_vi_news_detail`
--

INSERT INTO `phung_vi_news_detail` (`id`, `titlesite`, `description`, `bodyhtml`, `keywords`, `sourcetext`, `files`, `imgposition`, `layout_func`, `copyright`, `allowed_send`, `allowed_print`, `allowed_save`) VALUES
...
--
-- Cấu trúc bảng cho bảng `phung_vi_news_logs`
--

DROP TABLE IF EXISTS `phung_vi_news_logs`;
CREATE TABLE IF NOT EXISTS `phung_vi_news_logs` (
  `id` mediumint(8) UNSIGNED NOT NULL AUTO_INCREMENT,
...
--
-- Cấu trúc bảng cho bảng `phung_vi_news_rows`
--

DROP TABLE IF EXISTS `phung_vi_news_rows`;
CREATE TABLE IF NOT EXISTS `phung_vi_news_rows` (
  `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT,
  `catid` smallint(5) UNSIGNED NOT NULL DEFAULT '0',
  `listcatid` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `topicid` smallint(5) UNSIGNED NOT NULL DEFAULT '0',
...
--
-- Đang đổ dữ liệu cho bảng `phung_vi_news_rows`
--

INSERT INTO `phung_vi_news_rows` (`id`, `catid`, `listcatid`, `topicid`, `admin_id`, `author`, `sourceid`, `addtime`, `edittime`, `status`, `weight`, `publtime`, `exptime`, `archive`, `title`, `alias`, `hometext`, `homeimgfile`, `homeimgalt`, `homeimgthumb`, `inhome`, `allowed_comm`, `allowed_rating`, `external_link`, `hitstotal`, `hitscm`, `total_rating`, `click_rating`, `instant_active`, `instant_template`, `instant_creatauto`) VALUES
(1, 1, '1,5,7', 0, 1, 'Quỳnh Nhi', 1, 1274989177, 1275318126, 1, 1, 1274989140, 0, 2, 'Ra mắt công ty mã nguồn mở đầu tiên tại Việt Nam', 'Ra-mat-cong-ty-ma-nguon-mo-dau-tien-tai-Viet-Nam', 'Mã nguồn mở NukeViet vốn đã quá quen thuộc với cộng đồng CNTT Việt Nam trong mấy năm qua. Tuy chưa hoạt động chính thức, nhưng chỉ trong khoảng 5 năm gần đây, mã nguồn mở NukeViet đã được dùng phổ biến ở Việt Nam, áp dụng ở hầu hết các lĩnh vực, từ tin tức đến thương mại điện tử, từ các website cá nhân cho tới những hệ thống website doanh nghiệp.', 'nangly.jpg', 'Thành lập VINADES.,JSC', 1, 1, '6', 1, 0, 2, 0, 0, 0, 0, '', 0),
(2, 7, '1,7', 0, 1, 'Nguyễn Thế Hùng', 7, 1453192444, 1453192444, 1, 12, 1453192444, 0, 2, 'Hãy trở thành nhà cung cấp dịch vụ của NukeViet&#33;', 'hay-tro-thanh-nha-cung-cap-dich-vu-cua-nukeviet', 'Nếu bạn là công ty hosting, là công ty thiết kế web có sử dụng mã nguồn NukeViet, là cơ sở đào tạo NukeViet hay là công ty bất kỳ có kinh doanh dịch vụ liên quan đến NukeViet... hãy cho chúng tôi biết thông tin liên hệ của bạn để NukeViet hỗ trợ bạn trong công việc kinh doanh nhé!', 'hoptac.jpg', '', 1, 1, '6', 1, 0, 13, 0, 0, 0, 0, '', 0),
(3, 4, '4', 0, 1, 'Phạm Quốc Tiến', 2, 1453192400, 1453192400, 1, 11, 1453192400, 0, 2, 'Tuyển dụng lập trình viên PHP phát triển NukeViet', 'Tuyen-dung-lap-trinh-vien-PHP', 'Bạn đam mê nguồn mở? Bạn đang cần tìm một công việc phù hợp với thế mạnh của bạn về PHP và MySQL? Hãy gia nhập VINADES.,JSC để xây dựng mã nguồn mở hàng đầu cho Việt Nam.', 'tuyendung-kythuat.jpg', 'Tuyển dụng', 1, 1, '6', 1, 0, 0, 0, 0, 0, 0, '', 0),
(4, 4, '4', 0, 1, 'Phạm Quốc Tiến', 0, 1445391089, 1445394192, 1, 5, 1445391060, 0, 2, 'Tuyển dụng chuyên viên đồ hoạ phát triển NukeViet', 'Tuyen-dung-chuyen-vien-do-hoa', 'Bạn đam mê nguồn mở? Bạn là chuyên gia đồ họa? Chúng tôi sẽ giúp bạn hiện thực hóa ước mơ của mình với một mức lương đảm bảo. Hãy gia nhập VINADES.,JSC để xây dựng mã nguồn mở hàng đầu cho Việt Nam.', 'tuyendung-kythuat.jpg', 'Tuyển dụng', 1, 1, '6', 1, 0, 0, 0, 0, 0, 0, '', 0),
...
--
-- Cấu trúc bảng cho bảng `phung_vi_news_row_histories`
--

DROP TABLE IF EXISTS `phung_vi_news_row_histories`;
CREATE TABLE IF NOT EXISTS `phung_vi_news_row_histories` (
  `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT,
...
--
-- Cấu trúc bảng cho bảng `phung_vi_news_sources`
--

DROP TABLE IF EXISTS `phung_vi_news_sources`;
CREATE TABLE IF NOT EXISTS `phung_vi_news_sources` (
...
--
-- Đang đổ dữ liệu cho bảng `phung_vi_news_sources`
--

INSERT INTO `phung_vi_news_sources` (`sourceid`, `title`, `link`, `logo`, `weight`, `add_time`, `edit_time`) VALUES
...
--
-- Cấu trúc bảng cho bảng `phung_vi_news_tags`
--

DROP TABLE IF EXISTS `phung_vi_news_tags`;
CREATE TABLE IF NOT EXISTS `phung_vi_news_tags` (
...
--
-- Đang đổ dữ liệu cho bảng `phung_vi_news_tags`
--

INSERT INTO `phung_vi_news_tags` (`tid`, `numnews`, `title`, `alias`, `image`, `description`, `keywords`) VALUES
...
--
-- Cấu trúc bảng cho bảng `phung_vi_news_tags_id`
--

DROP TABLE IF EXISTS `phung_vi_news_tags_id`;
CREATE TABLE IF NOT EXISTS `phung_vi_news_tags_id` (
  `id` int(11) NOT NULL,
...
--
-- Đang đổ dữ liệu cho bảng `phung_vi_news_tags_id`
--

INSERT INTO `phung_vi_news_tags_id` (`id`, `tid`, `keyword`) VALUES
(1, 7, 'thương mại điện'),
(1, 9, 'nukeviet'),
(1, 41, 'module'),
(1, 16, 'mã nguồn mở'),
...
--
-- Cấu trúc bảng cho bảng `phung_vi_news_tmp`
--

DROP TABLE IF EXISTS `phung_vi_news_tmp`;
CREATE TABLE IF NOT EXISTS `phung_vi_news_tmp` (
...
--
-- Cấu trúc bảng cho bảng `phung_vi_news_topics`
--

DROP TABLE IF EXISTS `phung_vi_news_topics`;
CREATE TABLE IF NOT EXISTS `phung_vi_news_topics` (
...
--
-- Đang đổ dữ liệu cho bảng `phung_vi_news_topics`
--

INSERT INTO `phung_vi_news_topics` (`topicid`, `title`, `alias`, `image`, `description`, `weight`, `keywords`, `add_time`, `edit_time`) VALUES
(1, 'NukeViet 4', 'NukeViet-4', '', 'NukeViet 4', 1, 'NukeViet 4', 1445396011, 1445396011);

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `phung_vi_page`
--

DROP TABLE IF EXISTS `phung_vi_page`;
CREATE TABLE IF NOT EXISTS `phung_vi_page` (
  `id` mediumint(8) UNSIGNED NOT NULL AUTO_INCREMENT,
  `title` varchar(250) COLLATE utf8mb4_unicode_ci NOT NULL,
  `alias` varchar(250) COLLATE utf8mb4_unicode_ci NOT NULL,
  `image` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT '',
...
--
-- Cấu trúc bảng cho bảng `phung_vi_page_config`
--

DROP TABLE IF EXISTS `phung_vi_page_config`;
CREATE TABLE IF NOT EXISTS `phung_vi_page_config` (
  `config_name` varchar(30) COLLATE utf8mb4_unicode_ci NOT NULL,
  `config_value` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  UNIQUE KEY `config_name` (`config_name`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
--
-- Đang đổ dữ liệu cho bảng `phung_vi_page_config`
--

INSERT INTO `phung_vi_page_config` (`config_name`, `config_value`) VALUES
('viewtype', '0'),
('facebookapi', ''),
('per_page', '20'),
('news_first', '0'),
...
--
-- Cấu trúc bảng cho bảng `phung_vi_referer_stats`
--

DROP TABLE IF EXISTS `phung_vi_referer_stats`;
CREATE TABLE IF NOT EXISTS `phung_vi_referer_stats` (
...
--
-- Cấu trúc bảng cho bảng `phung_vi_searchkeys`
--

DROP TABLE IF EXISTS `phung_vi_searchkeys`;
CREATE TABLE IF NOT EXISTS `phung_vi_searchkeys` (
...
--
-- Cấu trúc bảng cho bảng `phung_vi_siteterms`
--

DROP TABLE IF EXISTS `phung_vi_siteterms`;
CREATE TABLE IF NOT EXISTS `phung_vi_siteterms` (
  `id` mediumint(8) UNSIGNED NOT NULL AUTO_INCREMENT,
  `title` varchar(250) COLLATE utf8mb4_unicode_ci NOT NULL,
  `alias` varchar(250) COLLATE utf8mb4_unicode_ci NOT NULL,
  `image` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT '',
...
--
-- Đang đổ dữ liệu cho bảng `phung_vi_siteterms_config`
--

INSERT INTO `phung_vi_siteterms_config` (`config_name`, `config_value`) VALUES
('viewtype', '0'),
('facebookapi', ''),
('per_page', '20'),
('news_first', '0'),
...
--
-- Cấu trúc bảng cho bảng `phung_vi_voting`
--

DROP TABLE IF EXISTS `phung_vi_voting`;
CREATE TABLE IF NOT EXISTS `phung_vi_voting` (
...
--
-- Đang đổ dữ liệu cho bảng `phung_vi_voting`
--

INSERT INTO `phung_vi_voting` (`vid`, `question`, `link`, `acceptcm`, `active_captcha`, `admin_id`, `groups_view`, `publ_time`, `exp_time`, `act`, `vote_one`) VALUES
(2, 'Bạn biết gì về NukeViet 4?', '', 1, 0, 1, '6', 1658830073, 0, 1, 0),
(3, 'Lợi ích của phần mềm nguồn mở là gì?', '', 1, 0, 1, '6', 1658830073, 0, 1, 0);

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `phung_vi_voting_rows`
--

DROP TABLE IF EXISTS `phung_vi_voting_rows`;
CREATE TABLE IF NOT EXISTS `phung_vi_voting_rows` (
  `id` mediumint(8) UNSIGNED NOT NULL AUTO_INCREMENT,
...
--
-- Đang đổ dữ liệu cho bảng `phung_vi_voting_rows`
--

INSERT INTO `phung_vi_voting_rows` (`id`, `vid`, `title`, `url`, `hitstotal`) VALUES
...
--
-- Cấu trúc bảng cho bảng `phung_vi_voting_voted`
--

DROP TABLE IF EXISTS `phung_vi_voting_voted`;
CREATE TABLE IF NOT EXISTS `phung_vi_voting_voted` (
  `vid` smallint(5) UNSIGNED NOT NULL,
