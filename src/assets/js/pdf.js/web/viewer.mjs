...
const defaultOptions = {
  ...
  standardFontDataUrl: {
    value: PDJS_DIR + "web/standard_fonts/",
    kind: OptionKind.API
  },
  useSystemFonts: {
    value: undefined,
  ...
  workerSrc: {
    value: PDJS_DIR + "build/pdf.worker.mjs",
    kind: OptionKind.WORKER
  }
};
{
  ...
  defaultOptions.sandboxBundleSrc = {
    value: PDJS_DIR + "build/pdf.sandbox.mjs",
    kind: OptionKind.VIEWER
  };
