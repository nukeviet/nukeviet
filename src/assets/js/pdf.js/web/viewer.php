...
-->
<html dir="<?= $nv_html_dir ?>" mozdisallowselectionprint>
  <head>
    <meta charset="<?= $global_config['site_charset'] ?>" />
    <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1" />
    <meta name="google" content="notranslate" />
    <title>PDF.js viewer</title>

<!-- This snippet is used in production (included from viewer.html) -->
<link rel="resource" type="application/l10n" href="<?= $pdf_js_dir ?>web/locale/locale.json" />
<script>
...
<script src="<?= $pdf_js_dir ?>build/pdf.mjs" type="module"></script>

    <link rel="stylesheet" href="<?= $pdf_js_dir ?>web/viewer.css" />

  <script src="<?= $pdf_js_dir ?>web/viewer.mjs" type="module"></script>
  </head>
