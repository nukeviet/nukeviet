...
if ($nv_Request->isset_request('checkss', 'post')) {
    ...
    $module = $row['module'] = $nv_Request->get_title('module_type', 'post', '', 55);
    $row['title'] = $nv_Request->get_title('title', 'post', '', 255);
    ...
    $row['template'] = $nv_Request->get_title('template', 'post', '', 55);
