...
// Document
$array_url_instruction['main'] = 'https://wiki.nukeviet.vn/nukeviet5:admin:themes';
$array_url_instruction['config'] = 'https://wiki.nukeviet.vn/nukeviet5:admin:themes:config';
$array_url_instruction['setuplayout'] = 'https://wiki.nukeviet.vn/nukeviet5:admin:themes:setuplayout';
$array_url_instruction['blocks'] = 'https://wiki.nukeviet.vn/nukeviet5:admin:themes:blocks';
