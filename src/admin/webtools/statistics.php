...
if ($nv_Request->isset_request('checkss', 'post')) {
    ...
    $statistics_timezone = nv_substr($nv_Request->get_title('statistics_timezone', 'post', ''), 0, 255);
    ...
    $array_config_global['googleAnalyticsID'] = nv_substr($nv_Request->get_title('googleAnalyticsID', 'post', ''), 0, 20);
    $array_config_global['googleAnalytics4ID'] = nv_substr($nv_Request->get_title('googleAnalytics4ID', 'post', ''), 0, 20);
    ...
    $array_config_global['google_tag_manager'] = nv_substr($nv_Request->get_title('google_tag_manager', 'post', ''), 0, 20);
