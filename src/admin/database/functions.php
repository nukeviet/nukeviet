...
// Document
$array_url_instruction['main'] = 'https://wiki.nukeviet.vn/nukeviet5:admin:database';
$array_url_instruction['file'] = 'https://wiki.nukeviet.vn/nukeviet5:admin:database:file';
$array_url_instruction['setting'] = 'https://wiki.nukeviet.vn/nukeviet5:admin:database:setting';
$array_url_instruction['sampledata'] = 'https://wiki.nukeviet.vn/nukeviet5:admin:database:sampledata';
