...
if ($nv_Request->isset_request('checkss', 'post')) {
    ...
    $array_config = [];
    $array_config['site_name'] = $nv_Request->get_title('site_name', 'post', '', 255);
    ...
    $array_config['site_description'] = $nv_Request->get_title('site_description', 'post', '', 255);
    ...
    $array_config['site_theme'] = $nv_Request->get_title('site_theme', 'post', '', 255);
    !in_array($array_config['site_theme'], $theme_array, true) && $array_config['site_theme'] = $global_config['site_theme'];
    $array_config['mobile_theme'] = $nv_Request->get_title('mobile_theme', 'post', '', 255);
    ...
    $array_config['site_keywords'] = $nv_Request->get_title('site_keywords', 'post', '', 255);
    ...
    $array_config['site_home_module'] = $nv_Request->get_title('site_home_module', 'post', '', 255);
