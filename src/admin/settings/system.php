...
if ($nv_Request->isset_request('checkss', 'post') and csrf_check($nv_Request->get_string('checkss', 'post'), $csrf_key)) {
    ...
    $site_email = $nv_Request->get_title('site_email', 'post', '', 255);
    ...
    if (defined('NV_IS_GODADMIN')) {
        ...
        $error_send_email = $nv_Request->get_title('error_send_email', 'post', '', 255);
        ...
        $array_config_global['cache_prefix'] = $nv_Request->get_title('cache_prefix', 'post', '', 50);
