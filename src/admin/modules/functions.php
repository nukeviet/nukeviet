...
// Document
$array_url_instruction['main'] = 'https://wiki.nukeviet.vn/nukeviet5:admin:modules:modules';
$array_url_instruction['setup'] = 'https://wiki.nukeviet.vn/nukeviet5:admin:modules:setup';
$array_url_instruction['vmodule'] = 'https://wiki.nukeviet.vn/nukeviet5:admin:modules:vmodule';
$array_url_instruction['edit'] = 'https://wiki.nukeviet.vn/nukeviet5:admin:modules:edit';
