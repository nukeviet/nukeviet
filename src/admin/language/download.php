...
if (csrf_check($nv_Request->get_string('checksess', 'get'), $admin_info['admin_id'] . '_' . $module_name . '_downloadallfile')) {
    ...
    throw new \NukeViet\Http\HttpException('error checksess', 403);
}
