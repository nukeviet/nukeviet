...
if ($numrows) {
    ...
    foreach ($adminrows as $row) {
        ...
        if (!empty($is_suspend)) {
            ...
            [$susp_admin_id, $susp_admin_name] = $db->query('SELECT userid,first_name,last_name FROM ' . NV_USERS_GLOBALTABLE . ' WHERE userid=' . (int) ($last_reason['start_admin']))->fetch(3) ?: [null, null];
