...
$sql_create_table[] = "INSERT INTO " . $db_config['prefix'] . "_plugin (pid, plugin_file, plugin_area, plugin_module_name, plugin_module_file, weight) VALUES
    ...
    (5, 'emf_author_delete.php', 'get_email_merge_fields', '', '', 3),
    (6, 'emf_author_suspend.php', 'get_email_merge_fields', '', '', 4),
    (7, 'emf_auto_error_report.php', 'get_email_merge_fields', '', '', 5),
    (8, 'emf_delete_user.php', 'get_email_merge_fields', 'users', 'Users', 6),
    (9, 'emf_new_2step_code.php', 'get_email_merge_fields', 'users', 'Users', 7),
