...
// FIXME ID 5, 6 dùng để dev giao diện admin_nv5, sau khi dev xong xóa đi
$sql_create_table[] = "INSERT INTO " . $db_config['prefix'] . "_plugin (pid, plugin_file, plugin_area, plugin_module_name, plugin_module_file, weight) VALUES
    ...
    (4, 'emf_reg_complete_uinfo.php', 'get_email_merge_fields', 'users', 'Users', 2),
    (5, 'get_global_admin_theme.php', 'get_global_admin_theme', '', '', 1),
    (6, 'get_module_admin_theme.php', 'get_module_admin_theme', '', '', 1)";
