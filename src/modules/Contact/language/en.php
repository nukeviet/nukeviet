...
$lang_module['content_config'] = 'Notice message';
...
$lang_module['notification_contact_new'] = 'mailing contact title <strong>%s</strong>';
...
$lang_module['departmentid'] = 'Select department';
