...
{
    global $module_info, $user_info, $module_name, $nv_Lang;
    ...
    if (empty($user_info['active2step'])) {
        ...
        $xtpl->assign('NUM_CODE', sprintf($nv_Lang->getModule('backupcode_2step'), $code_unused));
...
{
    global $module_info, $module_name, $op, $nv_Lang;
