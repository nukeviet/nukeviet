...
$lang_translator['createdate'] = '06/04/2026, 06:00';
...
$lang_module['not_found'] = 'Thật tiếc!!! Nội dung bạn tìm không tồn tại';
...
$lang_module['errorsave'] = 'Lỗi hệ thống không cập nhật được nội dung, bạn hãy kiểm tra lại';
...
$lang_module['socialbutton_zalo_note'] = 'Trước tiên cần khai báo Zalo Official Account ID';
$lang_module['activecomm'] = 'Cho phép thảo luận';
$lang_module['send'] = 'Gửi';
$lang_module['page_delete_unsuccess'] = 'Xóa bài viết không thành công';

// === CHUYÊN MỤC (CATEGORY) ===
$lang_module['cat'] = 'Chuyên mục';
$lang_module['cat_list'] = 'Danh sách chuyên mục';
$lang_module['cat_add'] = 'Thêm chuyên mục';
$lang_module['cat_edit'] = 'Sửa chuyên mục';
$lang_module['cat_save'] = 'Lưu chuyên mục';
$lang_module['cat_delete'] = 'Xóa chuyên mục';
$lang_module['cat_title'] = 'Tên chuyên mục';
$lang_module['cat_empty_title'] = 'Chuyên mục chưa có tên';
$lang_module['cat_delete_unsuccess'] = 'Xóa chuyên mục không thành công';
$lang_module['cat_has_content'] = 'Chuyên mục này có bài viết, không thể xóa';
$lang_module['cat_select'] = 'Chọn chuyên mục';
$lang_module['cat_unclassified'] = 'Không phân loại';
...
// === KHÁC ===
$lang_module['htmlcontent'] = 'Nhập nội dung cho block';
$lang_module['links'] = 'Các liên kết';
$lang_module['related'] = 'Bài viết liên quan';
