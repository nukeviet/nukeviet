...
if (empty($plans)) {
    nv_redirect_location(NV_BASE_ADMINURL . 'index.php?' . NV_LANG_VARIABLE . '=' . NV_LANG_DATA . '&' . NV_NAME_VARIABLE . '=' . $module_name . '&' . NV_OP_VARIABLE . '=add-plan');
}
...
$contents['upload'] = [
    $nv_Lang->getModule('re_upload', $contents['file_allowed_ext']),
    'banner',
