...
if ($nv_Request->isset_request('checkss', 'post')) {
    ...
    $_array_socialbutton = $nv_Request->get_typed_array('socialbutton', 'post', 'title', []);
    $_array_socialbutton = array_intersect($_array_socialbutton, $socialbuttons);

    $array_config['socialbutton'] = implode(',', $_array_socialbutton);
...
$tpl->assign('THEME_TYPES', $socialbuttons);
