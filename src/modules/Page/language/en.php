...
$lang_module['bodytext_length'] = 'Body length';
$lang_module['rowid'] = 'Show posts';
$lang_module['rowid_select'] = 'Select post';
$lang_module['rowid_note'] = 'If no article is selected, the system will randomly post the article in the list';
$lang_module['show_image'] = 'Show article image (if available)';
$lang_module['htmlcontent'] = 'Enter the content for the block';
$lang_module['numrow'] = 'Number of post displayed';
