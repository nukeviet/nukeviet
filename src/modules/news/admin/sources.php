...
[$sourceid, $title, $link, $logo, $error] = [0, '', 'http://', '', ''];
...
if ($sourceid > 0) {
    [$sourceid, $title, $link, $logo] = $db->query('SELECT sourceid, title, link, logo FROM ' . NV_PREFIXLANG . '_' . $module_data . '_sources where sourceid=' . $sourceid)->fetch(3) ?: [null, null, null, null];
