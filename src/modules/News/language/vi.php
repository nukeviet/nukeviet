...
$lang_module['save_temp_admin'] = 'Lưu bản nháp';
...
$lang_module['topic_sl_admin'] = 'Chọn nhóm tin liên quan hoặc tự điền';
...
$lang_module['tags_manager'] = 'Quản lý Tags';
...
$lang_module['notification_post_queue'] = 'gửi bài viết <strong>%s</strong> chờ duyệt';
...
$lang_module['catid'] = 'Chuyên mục cần hiển thị sub';
$lang_module['blockid'] = 'Nhóm tin liên quan';
$lang_module['numrow'] = 'Số bài hiển thị';
$lang_module['type'] = 'Cách thức hiển thị';
$lang_module['bl_showtooltip'] = 'Hiển thị tooltip';
$lang_module['bl_title_length'] = 'Số ký tự tiêu đề';
...
$lang_module['titlelength'] = 'Số ký tự cắt tiêu đề';
$lang_module['titlenote'] = 'Điền 0 nếu không cắt';
$lang_module['bl_numrow'] = 'Bản ghi hiển thị';
$lang_module['bl_catid'] = 'Chủ đề';
$lang_module['number_day'] = 'Số ngày gần nhất đăng bài';
...
$lang_module['length_title'] = 'Số ký tự tiêu đề chính';
