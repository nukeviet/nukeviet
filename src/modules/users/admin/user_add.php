...
$_user['view_mail'] = false;
$_user['in_groups'] = [];
$_user['is_official'] = true;
$_user['adduser_email'] = false;
...
foreach ($array_field_config as $row) {
    ...
    // Tính value từ dữ liệu initdata
...
$tpl->assign('ADMIN_ADD', $admin_add);
