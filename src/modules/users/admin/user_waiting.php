...
if ($nv_Request->isset_request('userid', 'get')) {
    ...
    if (csrf_check($nv_Request->get_string('checkss', 'post', ''), $csrf_key)) {
        $post = [
            ...
            'first_name' => nv_substr($nv_Request->get_title('first_name', 'post', ''), 0, 255),
            'last_name' => nv_substr($nv_Request->get_title('last_name', 'post', ''), 0, 255),
            ...
            'question' => nv_substr($nv_Request->get_title('question', 'post', ''), 0, 255),
            'answer' => nv_substr($nv_Request->get_title('answer', 'post', ''), 0, 255),
            'photo' => nv_substr($nv_Request->get_title('photo', 'post', ''), 0, 255),
