...
if ($nv_Request->isset_request('checkMail', 'post') and $checkss == $array_register['checkss']) {
    $email = nv_strtolower(nv_substr($nv_Request->get_title('email', 'post', ''), 0, 100));
...
if ($checkss == $array_register['checkss']) {
    $array_register['first_name'] = nv_substr($nv_Request->get_title('first_name', 'post', ''), 0, 255);
    $array_register['last_name'] = nv_substr($nv_Request->get_title('last_name', 'post', ''), 0, 255);
    ...
    $array_register['email'] = nv_strtolower(nv_substr($nv_Request->get_title('email', 'post', ''), 0, 100));
    $array_register['question'] = $nv_Request->get_title('question', 'post', '');
    $array_register['answer'] = nv_substr($nv_Request->get_title('answer', 'post', ''), 0, 255);
