...
// Clauses décrivant les contraintes d'un champ, voir fieldErrorMessages()
$lang_module['field_error_req_input'] = 'obligatoire';
$lang_module['field_error_req_choice'] = 'sélection obligatoire';
$lang_module['field_error_req_file'] = 'téléversement obligatoire';
$lang_module['field_error_len_range'] = 'de %1$s à %2$s caractères';
$lang_module['field_error_len_exact'] = 'exactement %s caractères';
$lang_module['field_error_len_min'] = 'au moins %s caractères';
$lang_module['field_error_len_max'] = 'au plus %s caractères';
$lang_module['field_error_val_range'] = 'valeur entre %1$s et %2$s';
$lang_module['field_error_date_range'] = 'date entre %1$s et %2$s';
$lang_module['field_error_rule_integer'] = 'nombres entiers uniquement';
$lang_module['field_error_rule_decimal'] = 'nombres uniquement';
$lang_module['field_error_rule_alphanumeric'] = 'lettres, chiffres et traits de soulignement uniquement';
$lang_module['field_error_rule_unicodename'] = 'lettres, espaces, apostrophes et traits d\'union uniquement';
$lang_module['field_error_rule_email'] = 'une adresse email valide';
$lang_module['field_error_rule_url'] = 'une URL valide';
$lang_module['field_error_rule_regex'] = 'conforme à la règle requise';
$lang_module['field_error_file_maxnum'] = 'jusqu\'à %s fichiers';
