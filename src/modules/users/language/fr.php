...
$lang_module['avatar_chosen'] = 'Glissez et déposez l\'image ici ou cliquez pour sélectionner une image';
$lang_module['avatar_chosen_release'] = 'Relâchez l\'image ici';
$lang_module['avatar_err_nofile'] = 'Aucune image trouvée';
$lang_module['avatar_err_too_many'] = 'Vous ne pouvez sélectionner qu\'une seule image';
$lang_module['avatar_err_empty'] = 'Taille d\'image invalide, le système reconnaît l\'image comme vide';
$lang_module['avatar_err_too_big'] = 'Taille de l\'image trop grande, l\'image que vous avez sélectionnée est de %s alors que le système ne permet que jusqu\'à %s';
$lang_module['avatar_err_heic'] = 'Les images HEIC provenant de l\'iPhone ne sont pas prises en charge. Allez dans Paramètres → Appareil photo → Formats → sélectionnez &quot;Le plus compatible&quot;, ou convertissez d\'abord l\'image en JPG';
$lang_module['avatar_err_bad_type'] = 'Ce format n\'est pas pris en charge. Utilisez PNG ou JPG';
$lang_module['avatar_drag_adjust'] = 'Faites glisser l\'image pour ajuster la position';
$lang_module['avatar_change_other'] = 'Changer pour une autre image';
$lang_module['avatar_reset'] = 'Réinitialiser';
...
$lang_module['avatar_ctl_zoomout'] = 'Réduire l\'image';
$lang_module['avatar_ctl_zoomin'] = 'Agrandir l\'image';
$lang_module['avatar_ctl_slidezoom'] = 'Faire glisser pour agrandir/réduire l\'image';
$lang_module['avatar_ctl_ccw'] = 'Faire pivoter dans le sens antihoraire';
$lang_module['avatar_ctl_cw'] = 'Faire pivoter dans le sens horaire';
...
$lang_module['lostpass_info2'] = 'Au cas où vous ne vous en souvenez pas, contactez l\'administrateur. Nous allons vous aider.';
...
$lang_module['account_active_mess'] = '<p class="h1">Votre compte a été créé et est en attente d\'activation</p><p>Nous avons envoyé les informations nécessaires à votre adresse e-mail. Veuillez vérifier votre boîte de réception et suivre les instructions pour activer votre compte.</p><p>Si vous ne voyez pas l\'e-mail, veuillez vérifier votre dossier <strong>Spam</strong> ou <strong>Courrier indésirable</strong>.</p>';
...
$lang_module['lostpass_page_title'] = 'Demande de récupération de mot de passe';
...
$lang_module['current_mode'] = 'Méthode de connexion';
...
$lang_module['field_error_req_input'] = 'est obligatoire';
$lang_module['field_error_req_choice'] = 'doit être sélectionné';
$lang_module['field_error_req_file'] = 'doit être téléversé';
$lang_module['field_error_len_range'] = 'doit contenir de %1$s à %2$s caractères';
$lang_module['field_error_len_exact'] = 'doit contenir exactement %s caractères';
$lang_module['field_error_len_min'] = 'doit contenir au moins %s caractères';
$lang_module['field_error_len_max'] = 'doit contenir au plus %s caractères';
$lang_module['field_error_val_range'] = 'doit avoir une valeur entre %1$s et %2$s';
$lang_module['field_error_date_range'] = 'doit être une date entre %1$s et %2$s';
$lang_module['field_error_rule_integer'] = 'doit être un nombre entier';
$lang_module['field_error_rule_decimal'] = 'doit être un nombre';
$lang_module['field_error_rule_alphanumeric'] = 'ne peut contenir que des lettres, chiffres et traits de soulignement';
$lang_module['field_error_rule_unicodename'] = 'ne peut contenir que des lettres, espaces, apostrophes et traits d\'union';
$lang_module['field_error_rule_email'] = 'doit être une adresse email valide';
$lang_module['field_error_rule_url'] = 'doit être une URL valide';
$lang_module['field_error_rule_regex'] = 'doit respecter la règle requise';
$lang_module['field_error_file_maxnum'] = 'accepte au plus %s fichiers';
$lang_module['field_error_rule_date'] = 'doit être une date valide';
$lang_module['field_error_rule_choice'] = 'doit être une valeur de la liste autorisée';
...
$lang_module['list_question'] = 'Liste des questions de sécurité';
...
$lang_module['field_match_type_callback_view'] = 'Cliquez ici pour voir la liste des fonctions acceptées';
$lang_module['field_match_type_callback_list'] = 'Liste des fonctions acceptées';
$lang_module['field_match_type_callback_list_empty'] = 'Aucune fonction acceptée';
...
$lang_module['field_error_start'] = 'Le nom du champ doit commencer par une lettre, suivie uniquement de lettres, chiffres ou traits de soulignement';
...
$lang_module['datadeletion_title'] = 'Demande de suppression des données liées';
$lang_module['datadeletion_text'] = 'Statut de traitement de votre demande de suppression des données de';
$lang_module['datadeletion_id'] = 'Code de demande';
$lang_module['datadeletion_success'] = 'La demande a été traitée';
$lang_module['datadeletion_success1'] = 'Nous avons traité votre demande de suppression des données';
$lang_module['datadeletion_data_info1'] = 'Données liées à votre compte';
$lang_module['datadeletion_data_info2'] = 'ont été marquées pour suppression de notre système conformément à la politique de confidentialité. Merci d\'utiliser nos services';
...
$lang_module['security_privacy'] = 'Sécurité et Confidentialité';
$lang_module['security_privacy_des'] = 'Gérer les sessions de connexion, renforcer la sécurité du compte et gérer la confidentialité';
$lang_module['login_session'] = 'Sessions actives';
$lang_module['login_session_none'] = 'Le système n\'a trouvé aucune session de connexion disponible';
$lang_module['login_session_explain'] = 'Voici la liste des appareils qui se sont connectés à votre compte. Déconnectez-vous de toute session que vous ne reconnaissez pas';
$lang_module['login_session_current'] = 'Session actuelle';
$lang_module['login_session_admin'] = 'Session d\'administration';
$lang_module['security_actions'] = 'Actions de sécurité';
$lang_module['security_actions_logout_all'] = 'Se déconnecter de toutes les autres sessions';
$lang_module['security_actions_logout_all1'] = 'Cette action vous déconnectera de tous les autres appareils sauf celui-ci';
$lang_module['security_actions_logout_all2'] = 'Tout déconnecter';
$lang_module['secacts_delaccount'] = 'Supprimer votre compte';
$lang_module['verify_password_title'] = 'Vérifier l\'identité';
$lang_module['verify_password_note'] = 'Pour continuer, veuillez d\'abord saisir votre mot de passe pour vérifier votre identité';
$lang_module['delaccount_noadmin'] = 'Vous êtes actuellement administrateur du site Web, vous ne pouvez donc pas supprimer votre compte vous-même';
$lang_module['delaccount_nosafemode'] = 'Vous avez activé le mode sans échec. Votre compte est protégé, si vous souhaitez toujours supprimer votre compte, vous devez d\'abord <a href="%s">cliquer ici</a> pour désactiver le mode sans échec';
$lang_module['delaccount_title'] = 'Supprimer le compte';
$lang_module['delaccount_note'] = 'Veuillez considérer attentivement avant de continuer';
$lang_module['delaccount_back'] = 'Retour à la page de sécurité';
$lang_module['delaccount_warn1'] = 'Avertissement important';
$lang_module['delaccount_warn2'] = 'Cette action supprimera définitivement votre compte et toutes vos données';
$lang_module['delaccount_explain1'] = 'Que va-t-il se passer ?';
$lang_module['delaccount_explain2'] = 'Après confirmation de votre demande, une période d\'attente de <strong>7 jours</strong> commencera';
$lang_module['delaccount_explain3'] = 'Pendant la période d\'attente de 7 jours';
$lang_module['delaccount_explain4'] = 'Vous pouvez vous reconnecter à tout moment pour annuler la demande de suppression et restaurer votre compte. La date et l\'heure exactes de suppression seront notifiées après votre confirmation';
$lang_module['delaccount_explain5'] = 'Après la fin de la période d\'attente';
$lang_module['delaccount_explain6'] = 'Le compte sera supprimé définitivement et';
$lang_module['delaccount_explain7'] = 'Tous les enregistrements, services et données associés seront supprimés du système';
$lang_module['delaccount_explain8'] = 'Les informations personnelles, l\'historique des activités et les fichiers téléchargés s\'il y en a seront supprimés de manière irrécupérable';
$lang_module['delaccount_explain9'] = 'Vous ne pourrez pas vous réinscrire avec le même nom de connexion pendant %s ans (pour garantir la sécurité et éviter l\'usurpation d\'identité)';
$lang_module['delaccount_explain10'] = 'Vous ne pourrez pas vous réinscrire avec le même nom de connexion pendant %s jours (pour garantir la sécurité et éviter l\'usurpation d\'identité)';
$lang_module['delaccount_explain11'] = 'Vous ne pourrez jamais vous réinscrire avec le même nom de connexion (pour garantir la sécurité et éviter l\'usurpation d\'identité)';
$lang_module['delaccount_explain12'] = 'Vous pouvez vous réinscrire avec l\'ancien nom de connexion si vous le souhaitez après que le compte ait été définitivement supprimé';
$lang_module['delaccount_confirm1'] = 'Je confirme';
$lang_module['delaccount_confirm2'] = 'J\'ai lu et compris les conséquences. Je veux supprimer mon compte';
$lang_module['delaccount_confirm3'] = 'Supprimer définitivement mon compte';
$lang_module['delaccount_veremail_title'] = 'Confirmer la suppression du compte';
$lang_module['delaccount_veremail_note'] = 'Ceci est la dernière étape pour assurer la sécurité de votre compte';
$lang_module['delaccount_veremail_checkmail'] = 'Vérifiez votre email';
$lang_module['delaccount_veremail_checkinfo'] = 'Nous avons envoyé un code de confirmation de 10 caractères à votre adresse <strong>%s</strong>. Veuillez saisir ce code ci-dessous pour continuer';
$lang_module['not_received_code'] = 'Code non reçu ?';
$lang_module['try_received_code'] = 'Réessayer plus tard';
$lang_module['send_received_code'] = 'Renvoyer le code';
$lang_module['send_success_code'] = 'Le code de confirmation a été renvoyé à votre email!';
$lang_module['session_expired'] = 'Votre session a expiré en raison d\'une inactivité trop longue. Veuillez recharger la page pour réessayer';
$lang_module['request_accepted'] = 'Demande acceptée';
$lang_module['delaccount_pending_info'] = 'Votre compte a été programmé pour suppression';
$lang_module['delaccount_pending_info1'] = 'Votre demande de suppression de compte a été confirmée. Votre compte sera définitivement supprimé vers';
$lang_module['delaccount_pending_info2'] = 'Après suppression, toutes les données et services associés ne pourront pas être récupérés';
$lang_module['delaccount_recover_info1'] = 'Comment restaurer le compte ?';
$lang_module['delaccount_recover_info2'] = 'Si vous changez d\'avis, vous pouvez annuler cette demande à tout moment avant l\'heure de suppression en vous reconnectant à votre compte';
$lang_module['delacc_pending_title'] = 'Compte en attente de suppression';
$lang_module['delacc_pending_info'] = 'Votre compte a été programmé pour suppression définitive';
$lang_module['delacc_pending_info1'] = 'Le processus de suppression aura lieu automatiquement vers';
$lang_module['delacc_pending_info2'] = 'Vous pouvez annuler cette demande à tout moment avant l\'expiration';
$lang_module['delacc_cancel'] = 'Annuler la demande de suppression';
$lang_module['delacc_cancel_adm'] = 'Annuler la demande de suppression du compte utilisateur';
$lang_module['delacc_continue'] = 'Continuer la suppression (Se déconnecter)';
$lang_module['delacc_cancel_success'] = 'Demande de suppression annulée';
$lang_module['delacc_cancel_success_info'] = 'Votre compte a été restauré et est en sécurité';
$lang_module['delacc_cancel_success_info1'] = 'Nous confirmons que votre demande de suppression de compte a été annulée avec succès';
$lang_module['delacc_cancel_success_info2'] = 'Votre compte a été entièrement restauré et aucune donnée n\'a été affectée. Vous pouvez continuer à utiliser tous nos services normalement';
$lang_module['delacc_cancel_success_after1'] = 'Protégez votre compte';
$lang_module['delacc_cancel_success_after2'] = 'Si vous n\'êtes pas celui qui a demandé la suppression, nous vous recommandons de <strong><a href="%s">changer votre mot de passe</a></strong> et de vérifier <strong><a href="%s">les sessions de connexion</a></strong> récentes';
$lang_module['delacc_cancel_success_back'] = 'Retour à la page d\'origine';
$lang_module['datadeletion_pedding_title'] = 'Statut de la demande de suppression de données';
$lang_module['datadeletion_pedding_sub'] = 'Statut de votre demande de suppression de données envoyée depuis';
$lang_module['datadeletion_pedding_body'] = 'Nous avons reçu votre demande de suppression de données et procédons à la planification du traitement';
$lang_module['datadeletion_pedding_time'] = 'Vos données sont prévues d\'être supprimées vers';
$lang_module['datadeletion_pedding_info'] = 'seront supprimées de notre système selon le calendrier. Vous recevrez une notification lorsque le processus sera terminé';
$lang_module['datadeletion_pedding_adm'] = 'Ce compte est programmé pour une suppression définitive. L\'heure prévue de suppression est %s';
