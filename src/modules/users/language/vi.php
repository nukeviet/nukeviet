...
$lang_module['passkey_error_challenge'] = 'Thử thách không hợp lệ hoặc đã hết hạn, vui lòng tải lại trang và thử lại';
$lang_module['passkey_error_challenge1'] = 'Thử thách không hợp lệ, vui lòng tải lại trang và thử lại';
$lang_module['passkey_error_credential'] = 'Chứng thực không hợp lệ, vui lòng tải lại trang và thử lại';
$lang_module['passkey_error_credential1'] = 'Chứng thực không thể giải mã, vui lòng tải lại trang và thử lại';
$lang_module['passkey_error_credential2'] = 'Chứng thực sai loại, vui lòng tải lại trang và thử lại';
$lang_module['passkey_error_validator'] = 'Xác thực chứng thực thất bại, vui lòng tải lại trang và thử lại';
...
$lang_module['passkey_cannot_login'] = 'Không thể đăng nhập với khóa đăng nhập này, hãy thử khóa khác hoặc đăng nhập bằng mật khẩu';
$lang_module['passkey_only_seckey'] = 'Khóa đăng nhập này chỉ dùng để xác thực hai bước, không thể đăng nhập. Hãy thử với khóa khác hoặc đăng nhập bằng mật khẩu';
