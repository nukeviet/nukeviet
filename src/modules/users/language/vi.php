...
$lang_module['passkey_login_create_body'] = 'Khóa đăng nhập là phương thức an toàn và hiện đại giúp bạn có thể đăng nhập vào tài khoản của mình mà chỉ cần sử dụng vân tay, khuôn mặt, khóa màn hình, PIN hoặc khóa bảo mật. Bạn cũng có thể sử dụng khóa đăng nhập làm phương thức xác thực hai bước sau khi đăng nhập bằng mật khẩu';
