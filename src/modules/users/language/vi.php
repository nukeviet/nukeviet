...
// Các mệnh đề mô tả ràng buộc của một trường dữ liệu, xem fieldErrorMessages()
...
$lang_module['field_error_len_range'] = 'từ %1$s đến %2$s ký tự';
$lang_module['field_error_len_exact'] = 'đúng %s ký tự';
$lang_module['field_error_len_min'] = 'tối thiểu %s ký tự';
$lang_module['field_error_len_max'] = 'tối đa %s ký tự';
$lang_module['field_error_val_range'] = 'giá trị từ %1$s đến %2$s';
$lang_module['field_error_date_range'] = 'ngày từ %1$s đến %2$s';
$lang_module['field_error_rule_integer'] = 'chỉ nhập số nguyên';
$lang_module['field_error_rule_decimal'] = 'chỉ nhập số';
$lang_module['field_error_rule_alphanumeric'] = 'chỉ gồm chữ cái không dấu, chữ số và dấu gạch dưới';
$lang_module['field_error_rule_unicodename'] = 'chỉ gồm chữ cái, dấu cách, dấu nháy đơn và dấu gạch nối';
$lang_module['field_error_rule_email'] = 'là địa chỉ email hợp lệ';
$lang_module['field_error_rule_url'] = 'là một URL hợp lệ';
$lang_module['field_error_rule_regex'] = 'đúng quy tắc đã quy định';
$lang_module['field_error_file_maxnum'] = 'tối đa %s tệp';
