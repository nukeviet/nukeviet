...
$lang_module['avatar_chosen'] = 'Kéo thả ảnh vào đây hoặc bấm để chọn ảnh';
$lang_module['avatar_chosen_release'] = 'Thả ảnh vào đây';
$lang_module['avatar_err_nofile'] = 'Không tìm thấy ảnh nào';
$lang_module['avatar_err_too_many'] = 'Bạn chỉ được chọn một ảnh';
$lang_module['avatar_err_empty'] = 'Kích thước ảnh không hợp lệ, hệ thống nhận diện ảnh đang trống';
$lang_module['avatar_err_too_big'] = 'Dung lượng ảnh quá lớn, ảnh bạn chọn là %s trong khi hệ thống chỉ cho phép tối đa %s';
$lang_module['avatar_err_heic'] = 'Ảnh HEIC từ iPhone chưa được hỗ trợ. Vào Cài đặt → Camera → Định dạng → chọn &quot;Tương thích nhất&quot;, hoặc chuyển ảnh sang JPG trước';
$lang_module['avatar_err_bad_type'] = 'Định dạng này không được hỗ trợ. Dùng PNG hoặc JPG';
$lang_module['avatar_drag_adjust'] = 'Kéo ảnh để điều chỉnh vị trí';
$lang_module['avatar_change_other'] = 'Đổi ảnh khác';
$lang_module['avatar_reset'] = 'Đặt lại';
...
$lang_module['avatar_ctl_zoomout'] = 'Thu nhỏ hình';
$lang_module['avatar_ctl_zoomin'] = 'Phóng to hình';
$lang_module['avatar_ctl_slidezoom'] = 'Trượt để phóng to/thu nhỏ hình';
$lang_module['avatar_ctl_ccw'] = 'Xoay ngược chiều kim đồng hồ';
$lang_module['avatar_ctl_cw'] = 'Xoay theo chiều kim đồng hồ';
...
$lang_module['account_active_mess'] = '<p class="h1">Tài khoản của bạn đã được tạo và đang đợi kích hoạt</p><p>Chúng tôi đã gửi đến email của bạn các thông tin cần thiết. Vui lòng kiểm tra email của bạn để làm theo hướng dẫn kích hoạt tài khoản.</p><p>Nếu không thấy thư, hãy kiểm tra trong mục <strong>Thư rác (Spam)</strong>.</p>';
...
$lang_module['lostpass_page_title'] = 'Yêu cầu khôi phục mật khẩu';
...
$lang_module['current_mode'] = 'Hình thức đăng nhập';
...
$lang_module['field_error_req_input'] = 'bắt buộc nhập';
$lang_module['field_error_req_choice'] = 'bắt buộc chọn';
$lang_module['field_error_req_file'] = 'bắt buộc tải lên';
$lang_module['field_error_len_range'] = 'phải từ %1$s đến %2$s ký tự';
$lang_module['field_error_len_exact'] = 'phải đúng %s ký tự';
$lang_module['field_error_len_min'] = 'phải có tối thiểu %s ký tự';
$lang_module['field_error_len_max'] = 'chỉ được tối đa %s ký tự';
$lang_module['field_error_val_range'] = 'phải có giá trị từ %1$s đến %2$s';
$lang_module['field_error_date_range'] = 'phải trong khoảng ngày %1$s đến ngày %2$s';
$lang_module['field_error_rule_integer'] = 'chỉ được nhập số nguyên';
$lang_module['field_error_rule_decimal'] = 'chỉ được nhập số';
$lang_module['field_error_rule_alphanumeric'] = 'chỉ được gồm chữ cái không dấu, chữ số và dấu gạch dưới';
$lang_module['field_error_rule_unicodename'] = 'chỉ được gồm chữ cái, dấu cách, dấu nháy đơn và dấu gạch nối';
$lang_module['field_error_rule_email'] = 'phải là địa chỉ email hợp lệ';
$lang_module['field_error_rule_url'] = 'phải là một URL hợp lệ';
$lang_module['field_error_rule_regex'] = 'phải đúng quy tắc đã quy định';
$lang_module['field_error_file_maxnum'] = 'chỉ được tối đa %s tệp';
$lang_module['field_error_rule_date'] = 'phải là ngày hợp lệ';
$lang_module['field_error_rule_choice'] = 'phải chọn giá trị có trong danh sách';
...
$lang_module['list_question'] = 'Danh sách câu hỏi bảo mật';
...
$lang_module['field_match_type_callback_view'] = 'Nhấp vào đây để xem danh sách các hàm được chấp nhận';
$lang_module['field_match_type_callback_list'] = 'Danh sách các hàm được chấp nhận';
$lang_module['field_match_type_callback_list_empty'] = 'Không có hàm nào được chấp nhận';
...
$lang_module['field_error_start'] = 'Trường dữ liệu phải bắt đầu bằng chữ cái, các ký tự sau chỉ gồm chữ cái, chữ số và dấu gạch dưới';
...
$lang_module['delaccount_noadmin'] = 'Bạn hiện đang là quản trị viên của website nên không thể tự xóa tài khoản được';
$lang_module['delaccount_nosafemode'] = 'Bạn đang bật chế độ an toàn. Tài khoản của bạn đang được bảo vệ, nếu vẫn muốn xóa tài khoản trước tiên bạn cần <a href="%s">nhấp vào đây</a> để tắt chế độ an toàn';
$lang_module['delaccount_title'] = 'Xóa tài khoản';
$lang_module['delaccount_note'] = 'Vui lòng xem xét cẩn thận trước khi tiếp tục';
$lang_module['delaccount_back'] = 'Quay lại trang bảo mật';
$lang_module['delaccount_warn1'] = 'Cảnh báo quan trọng';
$lang_module['delaccount_warn2'] = 'Hành động này sẽ xóa vĩnh viễn tài khoản và tất cả dữ liệu của bạn';
$lang_module['delaccount_explain1'] = 'Điều gì sẽ xảy ra?';
$lang_module['delaccount_explain2'] = 'Sau khi bạn xác nhận yêu cầu, một khoảng thời gian chờ <strong>7 ngày</strong> sẽ bắt đầu';
$lang_module['delaccount_explain3'] = 'Trong thời gian chờ 7 ngày';
$lang_module['delaccount_explain4'] = 'Bạn có thể đăng nhập lại bất kỳ lúc nào để huỷ yêu cầu xoá và khôi phục tài khoản. Ngày giờ xóa chính xác sẽ được thông báo sau khi bạn xác nhận';
$lang_module['delaccount_explain5'] = 'Sau khi thời gian chờ kết thúc';
$lang_module['delaccount_explain6'] = 'Tài khoản sẽ bị xoá vĩnh viễn và';
$lang_module['delaccount_explain7'] = 'Toàn bộ đăng ký, dịch vụ và dữ liệu liên quan sẽ bị xoá khỏi hệ thống';
$lang_module['delaccount_explain8'] = 'Thông tin cá nhân, lịch sử hoạt động và các tệp đã tải lên nếu có sẽ bị xoá không thể khôi phục';
$lang_module['delaccount_explain9'] = 'Bạn sẽ không thể đăng ký lại cùng tên đăng nhập trong %s năm (để đảm bảo an toàn và tránh giả mạo)';
$lang_module['delaccount_explain10'] = 'Bạn sẽ không thể đăng ký lại cùng tên đăng nhập trong %s ngày (để đảm bảo an toàn và tránh giả mạo)';
$lang_module['delaccount_explain11'] = 'Bạn sẽ không thể đăng ký lại cùng tên đăng nhập vĩnh viễn (để đảm bảo an toàn và tránh giả mạo)';
$lang_module['delaccount_explain12'] = 'Bạn có thể đăng ký lại với tên đăng nhập cũ nếu muốn sau khi tài khoản bị xoá vĩnh viễn';
...
$lang_module['request_accepted'] = 'Yêu cầu đã được tiếp nhận';
$lang_module['delaccount_pending_info'] = 'Tài khoản của bạn đã được lên lịch để xóa';
$lang_module['delaccount_pending_info1'] = 'Yêu cầu xóa tài khoản của bạn đã được xác nhận. Tài khoản của bạn sẽ bị xóa vĩnh viễn vào khoảng';
$lang_module['delaccount_pending_info2'] = 'Sau khi xóa, toàn bộ dữ liệu và dịch vụ liên quan sẽ không thể khôi phục lại được';
$lang_module['delaccount_recover_info1'] = 'Làm thế nào để khôi phục tài khoản?';
$lang_module['delaccount_recover_info2'] = 'Nếu bạn đổi ý, bạn có thể hủy yêu cầu này bất kỳ lúc nào trước thời gian xóa bằng cách đăng nhập lại vào tài khoản của mình';
$lang_module['delacc_pending_title'] = 'Tài khoản đang chờ xóa';
$lang_module['delacc_pending_info'] = 'Tài khoản của bạn đã được lên lịch để xóa vĩnh viễn';
...
$lang_module['delacc_cancel_success_info1'] = 'Chúng tôi xác nhận rằng yêu cầu xóa tài khoản của bạn đã được hủy thành công';
$lang_module['delacc_cancel_success_info2'] = 'Tài khoản của bạn đã được khôi phục hoàn toàn và không có dữ liệu nào bị ảnh hưởng. Bạn có thể tiếp tục sử dụng tất cả các dịch vụ của chúng tôi như bình thường';
