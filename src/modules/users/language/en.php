...
$lang_module['avatar_chosen'] = 'Drag and drop image here or click to select image';
$lang_module['avatar_chosen_release'] = 'Release image here';
$lang_module['avatar_err_nofile'] = 'No image found';
$lang_module['avatar_err_too_many'] = 'You can only select one image';
$lang_module['avatar_err_empty'] = 'Invalid image size, the system recognizes the image as empty';
$lang_module['avatar_err_too_big'] = 'Image size too large, the image you selected is %s while the system only allows up to %s';
$lang_module['avatar_err_heic'] = 'HEIC images from iPhone are not supported. Go to Settings → Camera → Formats → select &quot;Most Compatible&quot;, or convert the image to JPG first';
$lang_module['avatar_err_bad_type'] = 'This format is not supported. Use PNG or JPG';
$lang_module['avatar_drag_adjust'] = 'Drag the image to adjust the position';
$lang_module['avatar_change_other'] = 'Change to another image';
$lang_module['avatar_reset'] = 'Reset';
...
$lang_module['avatar_ctl_zoomout'] = 'Zoom out';
$lang_module['avatar_ctl_zoomin'] = 'Zoom in';
$lang_module['avatar_ctl_slidezoom'] = 'Slide to zoom in/out';
$lang_module['avatar_ctl_ccw'] = 'Rotate counterclockwise';
$lang_module['avatar_ctl_cw'] = 'Rotate clockwise';
...
$lang_module['current_mode'] = 'Login method';
...
$lang_module['field_error_req_input'] = 'is required';
$lang_module['field_error_req_choice'] = 'must be selected';
$lang_module['field_error_req_file'] = 'must be uploaded';
$lang_module['field_error_len_range'] = 'must be from %1$s to %2$s characters';
$lang_module['field_error_len_exact'] = 'must be exactly %s characters';
$lang_module['field_error_len_min'] = 'must be at least %s characters';
$lang_module['field_error_len_max'] = 'must be at most %s characters';
$lang_module['field_error_val_range'] = 'must be a value from %1$s to %2$s';
$lang_module['field_error_date_range'] = 'must be a date from %1$s to %2$s';
$lang_module['field_error_rule_integer'] = 'must be a whole number';
$lang_module['field_error_rule_decimal'] = 'must be a number';
$lang_module['field_error_rule_alphanumeric'] = 'may only contain letters, digits and underscores';
$lang_module['field_error_rule_unicodename'] = 'may only contain letters, spaces, apostrophes and hyphens';
$lang_module['field_error_rule_email'] = 'must be a valid email address';
$lang_module['field_error_rule_url'] = 'must be a valid URL';
$lang_module['field_error_rule_regex'] = 'must match the required rule';
$lang_module['field_error_file_maxnum'] = 'accepts up to %s files';
$lang_module['field_error_rule_date'] = 'must be a valid date';
$lang_module['field_error_rule_choice'] = 'must be a value from the allowed list';
...
$lang_module['list_question'] = 'Security question list';
...
$lang_module['field_match_type_callback_note'] = 'For security reasons, a function name is only accepted if it is declared in <code>$global_config[\'user_field_callbacks\']</code> in the <code>config.php</code> file. Example: <code>$global_config[\'user_field_callbacks\'] = [\'func_1\', \'func_2\'];</code>. The function must exist and return true/false';
$lang_module['field_match_type_callback_view'] = 'Click here to view the list of accepted functions';
$lang_module['field_match_type_callback_list'] = 'List of accepted functions';
$lang_module['field_match_type_callback_list_empty'] = 'No accepted functions';
...
$lang_module['field_error_start'] = 'Field name must start with a letter, followed by letters, digits or underscores only';
