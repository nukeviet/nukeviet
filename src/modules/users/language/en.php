...
// Clauses describing a field's constraints, see fieldErrorMessages()
$lang_module['field_error_req_input'] = 'required';
$lang_module['field_error_req_choice'] = 'selection required';
$lang_module['field_error_req_file'] = 'upload required';
$lang_module['field_error_len_range'] = '%1$s to %2$s characters';
$lang_module['field_error_len_exact'] = 'exactly %s characters';
$lang_module['field_error_len_min'] = 'at least %s characters';
$lang_module['field_error_len_max'] = 'at most %s characters';
$lang_module['field_error_val_range'] = 'value between %1$s and %2$s';
$lang_module['field_error_date_range'] = 'date between %1$s and %2$s';
$lang_module['field_error_rule_integer'] = 'whole numbers only';
$lang_module['field_error_rule_decimal'] = 'numbers only';
$lang_module['field_error_rule_alphanumeric'] = 'letters, digits and underscores only';
$lang_module['field_error_rule_unicodename'] = 'letters, spaces, apostrophes and hyphens only';
$lang_module['field_error_rule_email'] = 'a valid email address';
$lang_module['field_error_rule_url'] = 'a valid URL';
$lang_module['field_error_rule_regex'] = 'matching the required rule';
$lang_module['field_error_file_maxnum'] = 'up to %s files';
