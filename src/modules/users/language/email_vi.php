...
$module_emails[Emails::DELETE_ACCOUNT_COMPLETED] = [
    ...
    'c' => '<p>{$greeting_user}</p> <p>Như đã yêu cầu, tài khoản của bạn đã được <strong>xóa vĩnh viễn</strong> khỏi hệ thống của chúng tôi. Hành động này không thể được hoàn tác.</p> <p>Toàn bộ dữ liệu cá nhân, lịch sử hoạt động và các dịch vụ liên quan đến tài khoản này đã bị xóa không thể khôi phục.</p> <p>{$deadline}.</p> <p>Chúng tôi rất tiếc khi phải chia tay bạn và hy vọng sẽ có cơ hội phục vụ bạn trong tương lai.</p> <p style="margin-top: 30px; padding-top: 20px; border-top: 1px solid #e5e7eb; font-size: 14px; color: #6b7280; font-style: italic; margin-bottom: 0px;"> Đây là thông báo bắt buộc liên quan đến hoạt động trên tài khoản của bạn. Vui lòng không trả lời và hãy bỏ qua email nếu bạn không hiểu nội dung. </p>'
];
