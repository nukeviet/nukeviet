...
$lang_module['recovery_codes'] = 'Codes de récupération';
$lang_module['active_2tep_success'] = 'Activation de l\'authentification à deux étapes réussie avec le code de l\'application';
$lang_module['active_2tep_success1'] = 'Vous avez activé avec succès l\'authentification à deux étapes avec le code de l\'application. Désormais, après vous être connecté avec votre mot de passe, vous devrez entrer le code de vérification à deux étapes comme vous venez de le faire';
$lang_module['active_2tep_success2'] = 'En cas de perte ou de dommage de votre appareil, ce qui vous empêche d\'accéder à l\'application de vérification à deux étapes, les codes de récupération ci-dessous vous permettront de finaliser la connexion';
$lang_module['active_2tep_success3'] = 'Gardez vos codes de récupération en sécurité comme votre mot de passe. Nous vous recommandons de les stocker dans un gestionnaire de mots de passe tel que <a href="https://1password.com/" target="_blank">1Password</a>, <a href="https://1password.com/" target="_blank">Authy</a> ou <a href="https://1password.com/" target="_blank">Keeper</a>';
$lang_module['active_2tep_success'] = 'Activation de l\'authentification à deux étapes réussie avec le code de l\'application';
