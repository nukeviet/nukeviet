...
$lang_module['voting_total2'] = 'Number of votes from %s to the present';
...
$lang_module['voting_error_content'] = 'You need to enter the voting content';
$lang_module['voting_error_answer'] = 'You need to enter at least 2 response options';
