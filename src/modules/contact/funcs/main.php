...
[$departments, $departments_by_alias] = get_department_list();
...
if (defined('NV_IS_USER')) {
    ...
    $feedback['sender_phone'] = $user_info['phone'] ?? '';
    $feedback['sender_address'] = $user_info['address'] ?? '';
}
...
if ($nv_Request->isset_request('checkss', 'post')) {
    ...
    $feedback['title'] = nv_substr($nv_Request->get_title('ftitle', 'post', ''), 0, 255);
    ...
    if (!defined('NV_IS_USER')) {
        ...
        $feedback['sender_email'] = nv_substr($nv_Request->get_title('femail', 'post', ''), 0, 100);
    }
    ...
    $feedback['sender_phone'] = nv_substr($nv_Request->get_title('fphone', 'post', ''), 0, 100);
    ...
    $feedback['sender_address'] = nv_substr($nv_Request->get_title('faddress', 'post', ''), 0, 250);
