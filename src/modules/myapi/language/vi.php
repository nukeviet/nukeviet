...
$lang_module['api_role_credential_not_found'] = 'Không tìm thấy người sử dụng nào phù hợp với điều kiện tìm kiếm';
...
$lang_module['api_role_credential_username'] = 'Tên đăng nhập';
...
$lang_module['api_check_time'] = 'Thời gian lệch tối đa';
$lang_module['api_check_time_help'] = 'Thời gian sai lệch tối đa giữa Client và API Server';
...
$lang_module['search_adv'] = 'Tìm nâng cao';
