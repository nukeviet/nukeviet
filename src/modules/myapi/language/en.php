...
$lang_module['api_role_credential_not_found'] = 'No users found matching the search criteria';
...
$lang_module['api_check_time'] = 'Maximum time difference';
$lang_module['api_check_time_help'] = 'Maximum time difference between Client and API Server';
