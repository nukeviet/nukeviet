...
$lang_module['api_role_credential_not_found'] = 'Aucun utilisateur trouvé correspondant aux critères de recherche';
...
$lang_module['api_check_time'] = 'Temps de décalage maximal';
$lang_module['api_check_time_help'] = 'Temps de décalage maximal entre le Client et le Serveur API';
...
$lang_module['api_role_properties'] = 'Propriétés du rôle API';
$lang_module['apis_list'] = 'Liste des API';
$lang_module['search_adv'] = 'Recherche avancée';
$lang_module['from_date_short'] = 'de';
