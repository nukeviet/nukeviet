        ...
        <div class="card-body">
            ...
            <div class="mb-2">
                <div class="input-group">
                    ...
                    <input class="form-control" type="text" name="ftitle" value="" data-valid data-error-type="feedback" data-allowed-empty="1" minlength="3" maxlength="255" placeholder="{$LANG->getModule('title')}" aria-label="{$LANG->getModule('title')}">
            ...
            <div class="mb-2">
                <div class="input-group">
                    ...
                    <input class="form-control" type="text" name="fphone" value="{$CONTENT.fphone|default:''}" data-valid data-error-type="feedback" data-allowed-empty="1" minlength="3" maxlength="60" placeholder="{$LANG->getModule('phone')}" aria-label="{$LANG->getModule('phone')}">
                </div>
            ...
            <div class="mb-2">
                <div class="input-group">
                    ...
                    <input class="form-control" type="text" name="faddress" value="{$CONTENT.faddress|default:''}" data-valid data-error-type="feedback" data-allowed-empty="1" minlength="3" maxlength="60" placeholder="{$LANG->getModule('address')}" aria-label="{$LANG->getModule('address')}">
                </div>
            ...
            <div class="mb-3">
                <div class="input-group">
                    ...
                    <textarea class="form-control" name="fcon" data-valid="text" data-error-type="feedback" data-allowed-empty="1" minlength="3" maxlength="1000" placeholder="{$LANG->getModule('content')}" aria-label="{$LANG->getModule('content')}" style="height:130px"></textarea>
                    <span class="input-group-text text-danger">*</span>
                </div>
            ...
            <div class="form-check mb-3">
                <input class="form-check-input" type="checkbox" name="sendcopy" value="1" id="contact-sendcopy" checked="checked">
                <label class="form-check-label" for="contact-sendcopy">{$LANG->getModule('sendcopy')}</label>
            </div>
            {/if}
