...
<div style="height:100vh;padding:20px">
    <div class="alert alert-info">
        ...
        <form action="{OPENID_LOGIN}" method="post" role="form" class="form-horizontal margin-bottom-lg" <!-- BEGIN: captcha --> data-captcha="nv_seccode"
            <!-- END: captcha -->
            ...
            <div class="text-center margin-bottom-lg">
                <input name="checkss" value="{CHECKSS}" type="hidden" />
