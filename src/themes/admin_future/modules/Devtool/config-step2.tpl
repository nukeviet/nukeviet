<div class="card mb-3 shadow-sm border-0 bg-body-tertiary">
    <div class="card-header bg-body py-3 d-flex justify-content-between align-items-center">
        <h5 class="mb-0 text-primary fw-bold"><i class="fa-solid fa-code me-2"></i>Bước 2: Xem trước mã nguồn cho module [{$TARGET_MODULE}]</h5>
        <a href="{$smarty.const.NV_BASE_ADMINURL}index.php?{$smarty.const.NV_LANG_VARIABLE}={$smarty.const.NV_LANG_DATA}&amp;{$smarty.const.NV_NAME_VARIABLE}={$MODULE_NAME}&amp;{$smarty.const.NV_OP_VARIABLE}=config-step1&amp;target_module={$TARGET_MODULE}" class="btn btn-outline-secondary btn-sm">
...
<div class="row">
    <div class="col-md-6">
        <div class="card border-0 shadow-sm mb-4 h-100">
            <div class="card-header bg-dark text-white py-2 d-flex justify-content-between align-items-center">
                <span><i class="fa-brands fa-php me-2 text-info"></i>admin/config.php</span>
    ...
    <div class="col-md-6">
        <div class="card border-0 shadow-sm mb-4 h-100">
            <div class="card-header bg-dark text-white py-2 d-flex justify-content-between align-items-center">
                <span><i class="fa-solid fa-code me-2 text-warning"></i>config.tpl</span>
