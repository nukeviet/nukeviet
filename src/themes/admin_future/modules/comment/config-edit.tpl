    ...
    <div class="card border-0">
        <div class="card-body">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-8 col-lg-6 col-xxl-7">
                    <select name="auto_postcomm" class="form-select" id="auto_postcomm" style="max-width: 350px;">
                        {for $I = 0 to 2}
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-8 col-lg-6 col-xxl-7">
                    <select name="sortcomm" class="form-select" id="sortcomm" style="max-width: 350px;">
                        {for $I = 0 to 2}
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-8 col-lg-6 col-xxl-7">
                    <input type="text" name="perpagecomm" value="{$DATA.perpagecomm}" id="perpagecomm" class="form-control" style="max-width: 350px;">
                </div>
            </div>
            <div class="row mb-3">
                <label class="col-sm-3 col-xxl-4 col-form-label text-sm-end" for="timeoutcomm">{$LANG->getModule('timeoutcomm')}</label>
                <div class="col-sm-8 col-lg-6 col-xxl-7">
                    <input type="text" name="timeoutcomm" value="{$DATA.timeoutcomm}" id="timeoutcomm" class="form-control" style="max-width: 350px;">
