                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <input type="checkbox" name="activecheckbox" id="change_active_{$ROW.cid}" onclick="nv_change_active('{$ROW.cid}')" data-checkss="{$CHECKSS}" class="form-check-input m-0 align-middle"{if $ROW.status} checked="checked"{/if}>
                        </td>
                        <td class="text-right">
                            {if !empty($ROW.attach)}
                            ...
                            <a class="btn btn-danger btn-sm deleteone mt-1" href="{$smarty.const.NV_BASE_ADMINURL}index.php?{$smarty.const.NV_LANG_VARIABLE}={$smarty.const.NV_LANG_DATA}&amp;{$smarty.const.NV_NAME_VARIABLE}={$MODULE_NAME}&amp;{$smarty.const.NV_OP_VARIABLE}=del&amp;list={$ROW.cid}" data-checkss="{$CHECKSS}" title="{$LANG->getModule('delete')}"><i class="fa-solid fa-trash fa-fw" aria-hidden="true"></i><span class="d-none d-xl-inline">{$LANG->getModule('delete')}</span></a>
                        </td>
                    </tr>
                    {/foreach}
                </tbody>
        ...
        <div class="d-flex flex-wrap justify-content-between align-items-center">
            <div class="d-flex flex-wrap flex-sm-nowrap align-items-center">
                ...
                <div class="input-group me-1 my-1">
                    ...
                    <button class="btn btn-primary" type="button" id="element_action_btn" data-ctn="#list-cmt-items" data-checkss="{$CHECKSS}">{$LANG->getGlobal('submit')}</button>
                </div>
            </div>
