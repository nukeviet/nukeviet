...
<form method="get" action="{$smarty.const.NV_BASE_ADMINURL}index.php" class="row g-2 align-items-end mb-3">
    ...
    <div class="col-sm-auto">
        <div class="d-flex gap-2">
            ...
            {/if}
            <a href="{$smarty.const.NV_BASE_ADMINURL}index.php?{$smarty.const.NV_LANG_VARIABLE}={$smarty.const.NV_LANG_DATA}&amp;{$smarty.const.NV_NAME_VARIABLE}={$MODULE_NAME}&amp;{$smarty.const.NV_OP_VARIABLE}=add_banner" class="btn btn-success">
