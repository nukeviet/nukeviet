                    ...
                    <tr data-qid="{$row.qid}">
                        ...
                        <td>
                            ...
                            <div class="input-group input-group-sm">
                                ...
                                <button type="button" class="btn btn-primary" data-qid="{$row.qid}" data-action="save" data-checkss="{$CHECKSS}" aria-label="{$LANG->getGlobal('save')}">
                                    <i class="fa-solid fa-floppy-disk" data-icon="fa-floppy-disk"></i> {$LANG->getGlobal('save')}
                                </button>
                            </div>
                        </td>
                        <td class="text-center">
                            <button type="button" class="btn btn-sm btn-danger" data-qid="{$row.qid}" data-action="delete" data-checkss="{$CHECKSS}" aria-label="{$LANG->getGlobal('delete')}">
