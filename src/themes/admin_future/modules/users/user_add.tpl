{* Template: user_add.tpl
 * Giao diện admin_future cho khu vực Thêm tài khoản mới
...
<form class="ajax-submit" id="user_add_form"
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            {* Mật khẩu *}
            <div class="row mb-3">
                <label for="password1" class="col-sm-3 col-form-label text-sm-end">{$LANG->getModule('password')} <span class="text-danger">(*)</span></label>
                <div class="col-sm-8 col-lg-6 col-xxl-5">
                    <div class="input-group">
                        ...
                        <button class="btn btn-outline-secondary" type="button"
                            ...
                            data-field1="#password1"
                            data-field2="#password2"
                            aria-label="{$LANG->getModule('random_password')}">
            ...
            {* Nhập lại mật khẩu *}
            <div class="row mb-3">
                <label for="password2" class="col-sm-3 col-form-label text-sm-end">{$LANG->getModule('repassword')} <span class="text-danger">(*)</span></label>
                <div class="col-sm-8 col-lg-6 col-xxl-5">
                    <div class="input-group">
                        <input type="password"
                            class="form-control btn-eye-added"
            ...
            <div class="row mb-3">
                <div class="col-sm-8 col-lg-6 col-xxl-5 offset-sm-3">
                    <div class="form-check form-switch mt-1">
                        <input class="form-check-input" type="checkbox" id="is_official_field" name="is_official" value="1"{if $DATA.is_official} checked{/if}>
            ...
            <div class="row mb-3" id="ctn-list-groups">
                ...
                <div class="col-sm-8 col-lg-6 col-xxl-5">
                    ...
                    <div class="d-flex align-items-center gap-3 mb-1">
                        ...
                        <div class="form-check group_default" style="display: none;">
                    ...
                    {/foreach}
                    <div class="mt-1" id="cleargroupdefault" style="display: none;">
            ...
            {* Gửi email thông báo tới tài khoản *}
            <div class="row mb-3">
                <div class="col-sm-8 col-lg-6 col-xxl-5 offset-sm-3">
                    <div class="form-check form-switch mt-1">
                        <input class="form-check-input" type="checkbox" id="adduser_email_field" name="adduser_email" value="1"{if $DATA.adduser_email} checked{/if}>
                        <label class="form-check-label small" for="adduser_email_field">{$LANG->getModule('adduser_email1')}</label>
                    </div>
                    <div class="form-text">{$LANG->getModule('adduser_email1_note')}</div>
                </div>
            </div>
            ...
            <div class="row mb-3">
                <div class="col-sm-8 col-lg-6 col-xxl-5 offset-sm-3">
                    <div class="form-check form-switch mt-1">
                        <input class="form-check-input" type="checkbox" id="is_email_verified_field" name="is_email_verified" value="1"{if $DATA.is_email_verified} checked{/if}>
            ...
            <div class="row mb-3">
                ...
                <label for="cf_{$cf.field}" class="col-sm-3 col-form-label text-sm-end">
                    ...
                    {if $cf.for_admin}<div class="small text-muted">({$LANG->getModule('for_admin')})</div>{/if}
                </label>
                {else}
                <div class="col-sm-3 col-form-label text-sm-end">
                    {$cf.title}{if $cf.required} <span class="text-danger">(*)</span>{/if}
            ...
            <div class="row mb-3">
                <div class="col-sm-8 col-lg-6 offset-sm-3">
                    ...
                    <button class="btn btn-primary" type="submit">
                        <i class="fa-solid fa-user-plus"></i> {$LANG->getModule('member_add')}
                    </button>
                </div>
            </div>
