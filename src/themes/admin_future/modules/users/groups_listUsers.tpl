                ...
                <table class="table table-striped align-middle table-sticky mb-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            {if $row.show_tools}
                            <button class="btn btn-sm btn-success approved" data-id="{$row.userid}">
                                <i class="fa-solid fa-check" data-icon="fa-check"></i> {$LANG->getModule('approved')}
                            </button>
                            <button class="btn btn-sm btn-danger denied" data-id="{$row.userid}">
                                <i class="fa-solid fa-times" data-icon="fa-times"></i> {$LANG->getModule('denied')}
                            </button>
                            {/if}
                            </td>
                        </tr>
                ...
                <table class="table table-striped align-middle table-sticky mb-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center text-nowrap">
                            {if $row.show_tools}
                            <button class="btn btn-sm btn-warning demote" data-id="{$row.userid}">
                                <i class="fa-solid fa-star-half" data-icon="fa-star-half"></i> {$LANG->getModule('demote')}
                            </button>
                            <button class="btn btn-sm btn-danger deleteleader" data-id="{$row.userid}">
                                <i class="fa-solid fa-trash" data-icon="fa-trash"></i> {$LANG->getModule('exclude_user2')}
                            </button>
                            {/if}
                            </td>
                        </tr>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center text-nowrap">
                                ...
                                <button class="btn btn-sm btn-danger deletemember" data-id="{$row.userid}">
                                    <i class="fa-solid fa-trash" data-icon="fa-trash"></i> {$LANG->getModule('exclude_user2')}
                                </button>
                                {/if}
                            </td>
