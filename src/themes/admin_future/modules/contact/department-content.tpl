    ...
    <div class="row mb-3">
        ...
        <div class="col-sm-8 col-md-9">
            <div class="input-group">
                ...
                <button type="button" id="dpt-img-btn" data-toggle="selectfile" data-target="selectfile" data-path="{$MODULE_UPLOAD}" data-currentpath="{$MODULE_UPLOAD}/department" data-type="image" class="btn btn-info" title="{$LANG->getGlobal('browse_image')}" aria-label="{$LANG->getModule('select_image')}"><i class="fa-solid fa-folder-open"></i></button>
            </div>
        </div>
    </div>
