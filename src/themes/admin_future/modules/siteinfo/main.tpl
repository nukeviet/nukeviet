...
<div class="card text-bg-primary mb-4" id="notice-update-package">
    <div class="card-body text-center">
        ...
        <div class="row g-3 justify-content-center">
            ...
            <div class="col-auto">
                <a href="#" class="btn btn-secondary" data-toggle="deleteUpdPkg" data-checkss="{$CHECKSS_UPD}"><i class="fa-solid fa-trash text-danger" data-icon="fa-trash"></i> {$LANG->getModule('update_package_delete')}</a>
            </div>
        </div>
    </div>
</div>
