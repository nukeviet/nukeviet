...
<div class="card text-bg-primary mb-4" id="notice-update-package">
    <div class="card-body text-center">
        ...
        <div class="row g-3 justify-content-center">
            ...
            <div class="col-auto">
                <a href="#" class="btn btn-secondary" data-toggle="deleteUpdPkg" data-checkss="{$CHECKSS_WEBTOOLS}"><i class="fa-solid fa-trash text-danger" data-icon="fa-trash"></i> {$LANG->getModule('update_package_delete')}</a>
            </div>
        </div>
    </div>
</div>
...
{/if}
<div class="widget-containers" data-busy="0" data-checkss="{$CHECKSS}">
    <div class="row">
        {if $IS_EDIT}
