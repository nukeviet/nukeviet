<form id="news-setting-form" method="post" class="ajax-submit" novalidate action="{$smarty.const.NV_BASE_ADMINURL}index.php?{$smarty.const.NV_LANG_VARIABLE}={$smarty.const.NV_LANG_DATA}&amp;{$smarty.const.NV_NAME_VARIABLE}={$MODULE_NAME}&amp;{$smarty.const.NV_OP_VARIABLE}={$OP}">
    ...
    <div class="card mb-4">
        <div class="card-header">
            <h5 class="card-title mb-0">{$LANG->getModule('setting_insart_caption')}</h5>
        </div>
        <div class="card-body pt-4">
            <div class="row mb-3">
                <div class="col-sm-8 offset-sm-4 col-lg-6 col-xxl-5">
                    <div class="form-check form-switch">
                        <input class="form-check-input" type="checkbox" role="switch" id="instant_articles_active" name="instant_articles_active" value="1"{if $ITEM.instant_articles_active} checked{/if}>
                        <label class="form-check-label" for="instant_articles_active">{$LANG->getModule('setting_active_instant_articles')}</label>
                    </div>
                </div>
            </div>
            <div class="row mb-3">
                <div class="col-sm-8 offset-sm-4 col-lg-6 col-xxl-5">
                    <div class="form-check form-switch">
                        <input class="form-check-input" type="checkbox" role="switch" id="instant_articles_auto" name="instant_articles_auto" value="1"{if $ITEM.instant_articles_auto} checked{/if}>
                        <label class="form-check-label" for="instant_articles_auto">{$LANG->getModule('setting_instant_articles_auto')}</label>
                    </div>
                </div>
            </div>
            <div class="row mb-3">
                <label for="instant_articles_template" class="col-sm-4 col-form-label text-sm-end">{$LANG->getModule('setting_instant_articles_template')}</label>
                <div class="col-sm-8 col-lg-6 col-xxl-5">
                    <input type="text" value="{$ITEM.instant_articles_template}" id="instant_articles_template" name="instant_articles_template" class="form-control" autocomplete="off">
                </div>
            </div>
            <div class="row mb-3">
                <div class="col-sm-8 offset-sm-4 col-lg-6 col-xxl-5">
                    <div class="form-check form-switch">
                        <input class="form-check-input" type="checkbox" role="switch" id="instant_articles_httpauth" name="instant_articles_httpauth" value="1"{if $ITEM.instant_articles_httpauth} checked{/if}>
                        <label class="form-check-label" for="instant_articles_httpauth">{$LANG->getModule('setting_instant_articles_httpauth')}</label>
                    </div>
                </div>
            </div>
            <div class="row mb-3">
                <label for="instant_articles_username" class="col-sm-4 col-form-label text-sm-end">{$LANG->getModule('setting_instant_articles_username')}</label>
                <div class="col-sm-8 col-lg-6 col-xxl-5">
                    <input type="text" value="{$ITEM.instant_articles_username}" id="instant_articles_username" name="instant_articles_username" class="form-control" autocomplete="username">
                </div>
            </div>
            <div class="row mb-3">
                <label for="instant_articles_password" class="col-sm-4 col-form-label text-sm-end">{$LANG->getModule('setting_instant_articles_password')}</label>
                <div class="col-sm-8 col-lg-6 col-xxl-5">
                    <div class="input-group">
                        <input type="password" value="{$INSTANT_ARTICLES_PASSWORD}" id="instant_articles_password" name="instant_articles_password" class="form-control btn-eye-added" autocomplete="current-password">
                        <button class="btn btn-outline-secondary btn-eye" type="button" data-field="#instant_articles_password" aria-label="{$LANG->getModule('show_hide_pass')}"><i class="fa-solid fa-eye"></i></button>
                        <button class="btn btn-outline-secondary" type="button" data-toggle="setting-genpass" data-field="#instant_articles_password" aria-label="{$LANG->getModule('gen_rand_pass')}"><i class="fa-solid fa-rotate" data-icon="fa-rotate"></i></button>
                    </div>
                </div>
            </div>
            <div class="row mb-3">
                <label for="instant_articles_livetime" class="col-sm-4 col-form-label text-sm-end">{$LANG->getModule('setting_instant_articles_livetime')} <a href="#" data-bs-toggle="tooltip" data-bs-title="{$LANG->getModule('setting_instant_articles_livetime1')}" data-bs-trigger="focus hover" aria-label="{$LANG->getModule('setting_instant_articles_livetime1')}"><i class="fa-solid fa-circle-info"></i></a></label>
                <div class="col-sm-8 col-lg-3 col-xxl-2">
                    <input type="text" value="{$ITEM.instant_articles_livetime}" id="instant_articles_livetime" name="instant_articles_livetime" class="form-control" inputmode="numeric" autocomplete="off">
                </div>
            </div>
            <div class="row mb-3">
                <label for="instant_articles_gettime" class="col-sm-4 col-form-label text-sm-end">{$LANG->getModule('setting_instant_articles_gettime')} <a href="#" data-bs-toggle="tooltip" data-bs-title="{$LANG->getModule('setting_instant_articles_gettime1')}" data-bs-trigger="focus hover" aria-label="{$LANG->getModule('setting_instant_articles_gettime1')}"><i class="fa-solid fa-circle-info"></i></a></label>
                <div class="col-sm-8 col-lg-3 col-xxl-2">
                    <input type="text" value="{$ITEM.instant_articles_gettime}" id="instant_articles_gettime" name="instant_articles_gettime" class="form-control" inputmode="numeric" autocomplete="off">
                </div>
            </div>
            <div class="row mb-0">
                <label for="instant_articles_defaulturl" class="col-sm-4 col-form-label text-sm-end">{$LANG->getModule('setting_instant_articles_defaulturl')}</label>
                <div class="col-sm-8 col-lg-7 col-xxl-6">
                    <input type="text" class="form-control mb-2" id="instant_articles_defaulturl" value="{$INSTANT_ARTICLES_URL_DEFAULT}" data-toggle="selectall" autocomplete="off" readonly>
