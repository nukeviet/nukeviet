        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="text-center text-nowrap">
                    <a data-toggle="restoreHistory" data-checkss="{$row.checkss}" href="{$BASE_URL}&amp;loadhistory={$NEW_ID}" data-id="{$row.id}" data-msg="{$LANG->getModule('history_restore_confirm')}" class="btn btn-sm btn-info text-nowrap">
