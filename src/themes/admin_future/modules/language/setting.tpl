                    ...
                    <tr>
                        ...
                        <td class="text-nowrap">
                            <div class="d-flex flex-nowrap">
                                <button type="button" class="btn btn-secondary btn-sm me-1" data-toggle="ajLangInterface" data-url="{$smarty.const.NV_BASE_ADMINURL}index.php?{$smarty.const.NV_LANG_VARIABLE}={$smarty.const.NV_LANG_DATA}&amp;{$smarty.const.NV_NAME_VARIABLE}={$MODULE_NAME}&amp;{$smarty.const.NV_OP_VARIABLE}=read&amp;dirlang={$row.key}&amp;checkss={$row.checkss_read}"><i class="fa-solid fa-turn-up" data-icon="fa-turn-up"></i> {$LANG->getModule('nv_admin_read_all')}</button>
                                {if $row.allowed_write}
                                <button type="button" class="btn btn-secondary btn-sm me-1" data-toggle="ajLangInterface" data-url="{$smarty.const.NV_BASE_ADMINURL}index.php?{$smarty.const.NV_LANG_VARIABLE}={$smarty.const.NV_LANG_DATA}&amp;{$smarty.const.NV_NAME_VARIABLE}={$MODULE_NAME}&amp;{$smarty.const.NV_OP_VARIABLE}=write&amp;dirlang={$row.key}&amp;checkss={$row.checkss_write}"><i class="fa-solid fa-turn-down" data-icon="fa-turn-down"></i> {$LANG->getModule('nv_admin_write')}</button>
                                {/if}
                                {if $row.allowed_delete}
                                <button type="button" class="btn btn-secondary btn-sm me-1" data-toggle="ajLangInterface" data-url="{$smarty.const.NV_BASE_ADMINURL}index.php?{$smarty.const.NV_LANG_VARIABLE}={$smarty.const.NV_LANG_DATA}&amp;{$smarty.const.NV_NAME_VARIABLE}={$MODULE_NAME}&amp;{$smarty.const.NV_OP_VARIABLE}=delete&amp;type=db&amp;dirlang={$row.key}&amp;checkss={$row.checkss_delete}"><i class="fa-solid fa-eraser text-danger" data-icon="fa-eraser"></i> {$LANG->getModule('nv_admin_delete')}</button>
                                {/if}
                                {if $row.allowed_delete_files}
                                <button type="button" class="btn btn-secondary btn-sm me-1" data-toggle="ajLangInterface" data-url="{$smarty.const.NV_BASE_ADMINURL}index.php?{$smarty.const.NV_LANG_VARIABLE}={$smarty.const.NV_LANG_DATA}&amp;{$smarty.const.NV_NAME_VARIABLE}={$MODULE_NAME}&amp;{$smarty.const.NV_OP_VARIABLE}=delete&amp;type=files&amp;dirlang={$row.key}&amp;checkss={$row.checkss_delete}" data-confirm="1"><i class="fa-solid fa-folder-minus text-danger" data-icon="fa-folder-minus"></i> {$LANG->getModule('nv_admin_delete_files')}</button>
                                {/if}
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        {/if}
                                        <li><a class="dropdown-item" href="{$smarty.const.NV_BASE_ADMINURL}index.php?{$smarty.const.NV_LANG_VARIABLE}={$smarty.const.NV_LANG_DATA}&amp;{$smarty.const.NV_NAME_VARIABLE}={$MODULE_NAME}&amp;{$smarty.const.NV_OP_VARIABLE}=download&amp;dirlang={$row.key}&amp;checkss={$row.checkss_download}"><i class="fa-solid fa-download fa-fw text-center"></i> {$LANG->getModule('nv_admin_download')}</a></li>
                                    </ul>
                                </div>
                            </div>
                        </td>
