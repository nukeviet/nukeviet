        ...
        <tfoot>
            <tr>
                <td colspan="3">
                    ...
                    <input name="go_del" type="submit" value="{LANG.nv_admin_del}" class="btn btn-danger" />
                </td>
            </tr>
        </tfoot>
        <tbody>
            ...
            <tr>
                ...
                <td><input name="adminpass_iavim" type="password" autocomplete="off" value="{ADMIN_PASSWORD1}" maxlength="128" class="form-control w300" /></td>
            </tr>
            <tr>
                <td>{LANG.admin_del_reason}:</td>
                <td>&nbsp;</td>
                <td><input name="reason" type="text" value="{REASON}" maxlength="255" class="form-control w300" /></td>
            </tr>
            <tr>
