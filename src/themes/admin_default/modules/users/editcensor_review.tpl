...
<form method="post" action="{FORM_ACTION}" onsubmit="return user_editcensor_validForm(this);">
    ...
    <div class="text-center">
        ...
        <a href="javascript:void(0);" class="btn btn-danger" onclick="nv_editcensor_row_del({REVIEWUID}, '{CHECKSS}', '{LANG.editcensor_confirm_denied}');"><i class="fa fa-trash"></i> {LANG.denied}</a>
    </div>
</form>
<!-- END: main -->
