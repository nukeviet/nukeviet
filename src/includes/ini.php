...
$ini_server = in_array($server_name, $global_config['my_domains'], true) ? $server_name : $global_config['my_domains'][0];
...
if ($iniSaveTime + 86400 < NV_CURRENTTIME) {
    ...
    if (version_compare(PHP_VERSION, '5.6.0') < 0) {
        exit('You are running an unsupported PHP version. Please upgrade to PHP 5.5 or higher before trying to install Nukeviet Portal');
    }
