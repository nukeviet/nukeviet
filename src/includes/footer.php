...
// footer.php có thể được include từ trong function nên cần global các biến này
global $db, $nv_Request, $nv_plugin_area, $headers, $nv_Lang, $global_config, $sys_info;
