...
$lang_module['nv_lang_error_exit'] = '<strong>Thông báo</strong>: hiện tại chưa có ngôn ngữ nào được đọc vào Cơ sở dữ liệu. Hệ thống sẽ tự động chuyển sang phần đọc dữ liệu ngôn ngữ.';
...
$lang_module['nv_data_setup_ok'] = 'Cài đặt thành công! Hệ thống sẽ chuyển tới phần cấu hình site của ngôn ngữ mới để bạn bắt đầu thiết lập các cấu hình cho trang ngôn ngữ mới.';
