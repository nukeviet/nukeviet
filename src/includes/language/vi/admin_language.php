...
$lang_module['tab_dir'] = 'Chữ viết';
$lang_module['dir'] = 'Hướng chữ';
$lang_module['ltr'] = 'Trái sang phải';
$lang_module['rtl'] = 'Phải sang trái';
$lang_module['ltr_preview'] = 'Đây là ví dụ về hướng chữ trái sang phải';
$lang_module['rtl_preview'] = 'Đây là ví dụ về hướng chữ phải sang trái';
$lang_module['dir_note'] = 'Lưu ý: Hướng chữ từ phải sang trái có hiệu lực tùy thuộc vào việc giao diện của trang web có hỗ trợ hay không. Trong khu vực quản trị, mỗi quản trị viên có thể tùy chọn hướng chữ theo ý muốn';
