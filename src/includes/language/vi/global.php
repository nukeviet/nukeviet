...
$lang_global['unick_type_4'] = 'Tên đăng nhập chỉ được sử dụng chữ cái (có dấu hoặc không dấu), chữ số và khoảng trắng';
...
$lang_global['email_required_rule'] = 'Email cần khai báo đúng quy định';
...
$lang_global['search_keyword_rule'] = 'Vui lòng nhập từ khóa tìm kiếm từ %s đến %s ký tự';
...
$lang_global['browse_image'] = 'Chọn ảnh';
...
$lang_global['company_map'] = 'Bản đồ';
