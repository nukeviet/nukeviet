...
$lang_global['error_sendmail_subject'] = 'Cảnh báo từ website %s'; // FIXME
$lang_global['error_sendmail_content'] = 'Hệ thống đã nhận được một số thông báo. Bạn hãy mở file đính kèm để xem chi tiết';// FIXME
...
$lang_global['guests'] = 'Khách online';
