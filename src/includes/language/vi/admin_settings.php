...
$lang_module['smtp_test_note'] = 'Lưu ý: Nhấp thực hiện nếu có thay đổi ở form trên trước khi kiểm tra cấu hình';
...
$lang_module['lang_geo'] = 'Xác định ngôn ngữ theo quốc gia';
...
$lang_module['my_domains'] = 'Các domain chạy site';
$lang_module['my_domains_help'] = 'Nếu có nhiều domain thì mỗi domain cách nhau bởi dấu phảy';
$lang_module['searchEngineUniqueID'] = 'Google search Engine ID';
$lang_module['searchEngineUniqueID_help'] = 'Có dạng 000329275761967753447:sr7yxqgv294 , <a href="http://nukeviet.vn/vi/faq/Su-dung-Google-Custom-Search-tren-NukeViet/" target="_blank">xem chi tiết</a>';
...
$lang_module['notification_autodel'] = 'Tự động xóa thông báo sau';
