...
$lang_module['turnstile_sitekey'] = 'Site key của CloudFlare Turnstile';
$lang_module['turnstile_secretkey'] = 'Secret key của CloudFlare Turnstile';
...
$lang_module['captcha_type_turnstile_note'] = 'CloudFlare Turnstile sẽ bị thay bằng Captcha hình cho đến khi bạn khai báo Site key và Secret key của CloudFlare turnstile';
...
$lang_module['smtp_login'] = 'Tên đăng nhập';
$lang_module['smtp_login_error'] = 'Lỗi: bạn chưa khai báo tên đăng nhập';
...
$lang_module['admin_2step_warning'] = 'Khóa truy cập thường không khả dụng trên mọi thiết bị, việc chỉ chọn một phương thức khóa truy cập sẽ làm hạn chế phạm vi đăng nhập quản trị. Bạn nên lưu tâm vấn đề này';
$lang_module['admin_2step_error'] = 'Bạn đang bắt buộc xác thực hai bước trong quản trị nhưng không chọn phương thức nào được phép. Điều này khiến bạn không thể đăng nhập quản trị. Mời chọn ít nhất một phương thức';
...
$lang_module['trusted_proxy_cf_loaded'] = 'Đã bổ sung dải IP Cloudflare vào danh sách. Hãy nhấn Lưu thay đổi để áp dụng.';
...
$lang_module['trusted_proxy_warn_untrusted'] = 'Cảnh báo: tùy chọn tin cậy proxy đang bật, nhưng IP kết nối trực tiếp của request hiện tại (%s) không thuộc danh sách bên dưới, nên hệ thống vẫn bỏ qua header IP và ghi nhận chính IP này. Nguyên nhân thường gặp: dải IP Cloudflare trong danh sách đã cũ, hoặc còn thiếu dải IP của reverse proxy nội bộ. Hãy nhấn "Lấy dải IP Cloudflare" để cập nhật, hoặc bổ sung dải IP proxy còn thiếu rồi lưu lại. Chỉ thêm dải IP của proxy hoặc CDN do bạn kiểm soát; thêm dải IP lạ sẽ mở đường cho việc giả mạo IP.';
$lang_module['trusted_proxy_warn_disabled'] = 'Cảnh báo: request hiện tại có mang header IP của proxy nhưng tùy chọn tin cậy proxy đang <strong>tắt</strong>, nên hệ thống ghi nhận IP của bạn là %s, đây là IP của proxy, không phải IP thật. Nếu website thực sự đứng sau reverse proxy hoặc CDN, mọi khách sẽ dùng chung một IP: chặn đăng nhập sai mật khẩu sẽ lan sang toàn bộ người dùng, cấm IP mất tác dụng chọn lọc và nhật ký không còn giá trị truy vết. Hãy bật tùy chọn bên dưới và nhập đúng dải IP của proxy.';
