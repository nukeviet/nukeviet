...
$lang_module['nv_lang_error_exit'] = '<strong>Notification</strong>: aucune langue trouvée. Merci d\'importer la langue dans la Base de donnée';
...
$lang_module['nv_data_setup_ok'] = 'Installation réussie, le système vous transfèrera vers l\'installation de modules. Vous devez installer les modules nécessaires et activer ces modules';
