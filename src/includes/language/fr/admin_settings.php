...
$lang_module['turnstile_sitekey'] = 'Clé du site CloudFlare Turnstile';
$lang_module['turnstile_secretkey'] = 'Clé secrète CloudFlare Turnstile';
...
$lang_module['captcha_type_turnstile_note'] = 'CloudFlare Turnstile sera remplacé par Image-Captcha jusqu\'à ce que vous déclariez la Clé du site et la Clef secrète de CloudFlare Turnstile.';
...
$lang_module['admin_2step_warning'] = 'La clé d\'accès n\'est généralement pas disponible sur tous les appareils, le choix d\'une seule méthode de clé d\'accès limitera la portée de la connexion administrateur. Vous devez prêter attention à ce problème';
$lang_module['admin_2step_error'] = 'Vous forcez l\'authentification à deux facteurs dans l\'administration mais vous n\'avez sélectionné aucune méthode autorisée. Cela vous empêche de vous connecter à l\'administration. Veuillez sélectionner au moins une méthode';
$lang_module['cors'] = 'Configuration Cross-Site';
...
$lang_module['trusted_proxy_note_strip'] = 'Si le site est derrière un proxy interne ou un fournisseur autre que Cloudflare, configurez le proxy pour écraser ou supprimer tous les en-têtes d\'IP envoyés par le client ; sinon un attaquant peut toujours usurper l\'IP en envoyant des en-têtes falsifiés. Le système lit quatre en-têtes : CF-Connecting-IP, X-Forwarded-For, Forwarded et X-Real-IP. Exemple pour Nginx : proxy_set_header CF-Connecting-IP ""; proxy_set_header Forwarded ""; proxy_set_header X-Real-IP $remote_addr; et proxy_set_header X-Forwarded-For $proxy_add_x_forwarded_for;';
$lang_module['trusted_proxy_enable'] = 'Activer';
$lang_module['trusted_proxy_enable_des'] = 'Ne faire confiance aux en-têtes d\'IP du proxy que si cette option est activée. Lorsqu\'elle est désactivée, le système utilise toujours l\'IP de connexion directe (REMOTE_ADDR) et ignore tous les en-têtes d\'IP envoyés par le client';
...
$lang_module['trusted_proxy_warn_untrusted'] = 'Avertissement : la confiance aux proxys est activée, mais l\'IP de connexion directe de la requête actuelle (%s) ne figure pas dans la liste ci-dessous ; le système ignore donc toujours les en-têtes d\'IP et enregistre cette IP même. Causes fréquentes : les plages Cloudflare de la liste sont obsolètes, ou les plages du reverse proxy interne sont absentes. Cliquez sur « Récupérer les plages Cloudflare » pour les mettre à jour, ou ajoutez les plages de proxy manquantes puis enregistrez. N\'ajoutez que les plages d\'un proxy ou d\'un CDN que vous contrôlez ; ajouter des plages inconnues ouvre la porte à l\'usurpation d\'IP.';
$lang_module['trusted_proxy_warn_disabled'] = 'Avertissement : la requête actuelle contient des en-têtes d\'IP de proxy alors que la confiance aux proxys est <strong>désactivée</strong>, le système enregistre donc votre IP comme %s , il s\'agit de l\'IP du proxy, pas de la véritable. Si le site est réellement derrière un reverse proxy ou un CDN, tous les visiteurs partagent une seule IP : un blocage après échecs de connexion touchera l\'ensemble des utilisateurs, les bannissements d\'IP perdent leur sélectivité et les journaux deviennent inutiles pour la traçabilité. Activez l\'option ci-dessous et saisissez les plages de proxy correctes.';
