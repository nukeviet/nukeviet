...
$lang_global['hello_admin1'] = 'Votre dernière session était à %1$s';
$lang_global['hello_admin2'] = 'Votre session est ouverte depuis %1$s';
$lang_global['hello_admin3'] = 'C\'est votre première session d\'administration';
