...
$lang_module['save_error'] = 'Erreur: il est impossible de sauvegarder le fichier. Merci de vérifier les permissions du répertoire: %1$s, ce répertoire doit être obligatoirement modifiable.';
