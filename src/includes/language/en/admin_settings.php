...
$lang_module['smtp_test_note'] = 'Note: Click submit if there is a change in the above form before checking the configuration';
...
$lang_module['my_domains_help'] = 'If there are multiple domains then each domain is separated by commas';
$lang_module['searchEngineUniqueID'] = 'Google search Engine ID';
$lang_module['searchEngineUniqueID_help'] = 'Format 000329275761967753447:sr7yxqgv294 , <a href="http://nukeviet.vn/vi/faq/Su-dung-Google-Custom-Search-tren-NukeViet/" target="_blank">view details</a>';
...
$lang_module['banip_delete_confirm'] = 'Are you sure to remove this ip?';
...
$lang_module['banip_error_write_title'] = 'Error writing file';
...
$lang_module['login_number_tracking_label'] = 'Maximum error';
