...
$lang_module['nv_lang_error_exit'] = '<strong>Announcement</strong>: The current language does not have to be read into the database. System will automatically read data in a language';
