...
$lang_module['tab_dir'] = 'Text direction';
$lang_module['dir'] = 'Text direction';
$lang_module['ltr'] = 'Left to right';
$lang_module['rtl'] = 'Right to left';
$lang_module['ltr_preview'] = 'This is an example of left-to-right text direction';
$lang_module['rtl_preview'] = 'This is an example of right-to-left text direction';
$lang_module['dir_note'] = 'Note: The right-to-left text direction is effective depending on whether the website interface supports it. In the admin area, each administrator can choose the text direction as desired.';
