...
$lang_module['log_remote_addr'] = 'Connected from';
$lang_module['log_remote_addr_help'] = 'Address that connected directly to the server. It differs from the user IP because the request came through a trusted proxy';
