...
$lang_global['hello_admin1'] = 'Last login to administration at: %1$s';
$lang_global['hello_admin2'] = 'Your session was opened %1$s ago';
$lang_global['hello_admin3'] = 'This is the first time to login administration';
...
$lang_global['login_remember_admin'] = 'This option will allow administrators to log in multiple locations';
$lang_global['notification'] = 'Notification';
$lang_global['do_with_selected'] = 'With selected';
