...
<p><span class="smll">{TIME} | {DATE}</span></p>
<p>{TOPIC.hometext}</p>
<!-- BEGIN: adminlink -->
<p>{ADMINLINK}</p><!-- END: adminlink -->
<div class="hr"></div>
<!-- END: topic -->
<!-- BEGIN: other -->
<ul class="list">
	<!-- BEGIN: loop -->
	<li><a href="{TOPIC_OTHER.link}">{TOPIC_OTHER.title}</a><span class="smll">({TOPIC_OTHER.publtime})</span></li>
	<!-- END: loop -->
</ul><!-- END: other -->
<!-- END: main -->