...
<div class="banner_plan">
	...
	<div class="plan_content">
		<strong>{PLAN_LANG_TITLE}</strong>: {PLAN_LANG_NAME}, <strong>{PLAN_SIZE_TITLE}</strong>: {PLAN_SIZE_NAME}, <strong>{PLAN_FORM_TITLE}</strong>: {PLAN_FORM_NAME}
	</div>
	<div style="padding-left:5px">
		<strong>{PLAN_DESCRIPTION_TITLE}</strong>: {PLAN_DESCRIPTION_NAME}
	</div>
	<!-- END: banner_plan -->
</div>
<!-- END: if_banner_plan -->
