...
<div class="contact">
	...
	<form id="fcontact" method="post" action="{ACTION_FILE}" onsubmit="return sendcontact('{NV_GFX_NUM}');">
		<div class="content clearfix">
			...
			<div>
				<label for="fcon"> {LANG.content}: </label><textarea cols="8" rows="8" id="fcon" name="fcon" style="overflow: auto;" class="txttextArea" onkeyup="return nv_ismaxlength(this, 1000);">{CONTENT.fcon}</textarea>
			</div>
			<div class="capcha1">
