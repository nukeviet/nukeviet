...
<form id="uploadForm" name="uploadForm" action="{FORM_ACTION}" method="post" class="upload_form" enctype="multipart/form-data">
	<div class="upload_content">
		...
		<dl class="clearfix">
			...
			<dt class="fl"><textarea name="upload_linkdirect" id="upload_linkdirect_iavim">{UPLOAD.linkdirect}</textarea>
			</dt>
		</dl>
		<dl class="clearfix">
			<dd class="fl">
		...
		<dl class="clearfix">
			...
			<dt class="fl"><textarea name="upload_introtext" id="upload_introtext">{UPLOAD.introtext}</textarea>
			</dt>
		</dl>
		<dl class="clearfix">
			<dd class="fl">
			...
			<dt class="fl"><textarea name="upload_description" id="upload_description">{UPLOAD.description}</textarea>
			</dt>
		</dl>
		<br />
		<dl class="clearfix">
