<!-- BEGIN: main -->
<link rel="stylesheet" href="themes/de_nam_ngoai/css/owlcarousel2/owl.carousel.min.css">
<link rel="stylesheet" href="themes/de_nam_ngoai/css/owlcarousel2/owl.theme.default.min.css">
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta2/css/all.min.css">

<script src="themes/de_nam_ngoai/js/owlcarousel2/owl.carousel.min.js"></script>
<script>
	$(document).ready(function(){
		$('.owl-carousel').owlCarousel({
            margin: 10,
            nav: true,
            navText:["<i class='nav-btn prev-slide fas fa-caret-left'></i>","<i class='nav-btn next-slide fas fa-caret-right'></i>"],
            responsive: {
                0: {
                    items: 2
                },
