...
$(document).ready(function(){
   $('img#imageproduct').on('click',function(){
...
$(document).ready(function(){        
	$('.gallery img').on('click',function(){
		var src = $(this).attr('src');
		var img = '<img src="' + src + '" class="img-responsive"/>';
		var index = $(this).parent('.gallery').index();   
		var html = '';
		html += img;                
		html += '<div style="height:25px;clear:both;display:block;">';
		html += '<a class="controls next btn btn-primary pull-right" href="'+ (index+2) + '"><i class="fa fa-chevron-right"></i></a>';
		html += '<a class="controls previous btn btn-success pull-left" href="' + (index) + '"><i class="fa fa-chevron-left"></i></a>';
		html += '</div>';
		$('#GalleryModal').modal();
		$('#GalleryModal').on('shown.bs.modal', function(){
...
$(document).on('click', 'a.controls', function(){
	...
	var src = $('.gallery:nth-child('+ index +') img').attr('src');             
