...
<!-- BEGIN: company_email --><li><a href="mailto:{DATA.company_email}"><em class="fa fa-envelope"></em><span>{DATA.company_email}</span></a></li><!-- END: company_email -->
<!-- BEGIN: company_website --><li><a href="{DATA.company_website}" target="_blank"><em class="fa fa-globe"></em><span>{DATA.company_website}</span></a></li><!-- END: company_website -->
</ul>
<!-- END: main -->