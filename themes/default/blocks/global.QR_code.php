...
if( ! nv_function_exists( 'nv_block_qr_code' ) )
{
	...
	function nv_block_qr_code_config( $module, $data_block, $lang_block )
	{
		...
		$array_levels = array( 'L', 'M', 'Q', 'H' );
		
		$html = '<tr>';
		$html .= '	<td>' . ( empty( $lang_block['qr_level'] ) ? 'qr_level' : $lang_block['qr_level'] ) . '</td>';
		$html .= '	<td>';
		...
		$html .= '<tr>';
		$html .= '	<td>' . ( empty( $lang_block['qr_pixel_per_point'] ) ? 'qr_pixel_per_point' : $lang_block['qr_pixel_per_point'] ) . '</td>';
		$html .= '	<td>';
		...
		$html .= '<tr>';
		$html .= '	<td>' . ( empty( $lang_block['qr_outer_frame'] ) ? 'qr_outer_frame' : $lang_block['qr_outer_frame'] ) . '</td>';
		$html .= '	<td>';
