...
<div id="weblinks">
	...
	<!-- BEGIN: loop -->
	<div class="cat">
		<h2><a title="{SUB.title}" href="{SUB.link}">{SUB.title}</a><span style="font-weight:normal">[{SUB.count_link}]</span> &rsaquo; </h2>
	</div>
	<!-- BEGIN: clear -->
	<div class="clear"></div>
	<!-- END: clear -->
		...
		<div class="item clearfix" id="items-{ITEM.id}">
			...
			<div class="item-content fl">
				...
				<p>
					{ITEM.description}
					<br />
					<span style="float:left; color:#999">{ITEM.url}</span>
				</p>
			</div>
			<!-- BEGIN: img -->
