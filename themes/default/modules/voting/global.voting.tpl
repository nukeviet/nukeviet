...
<form action="">
	...
	<fieldset>
		...
		<div class="clearfix">
			...
			<a title="{VOTING.langresult}" href="javascript:void(0);" onclick="nv_sendvoting(this.form, '{VOTING.vid}', 0, '{VOTING.checkss}', '');"><button class="btn btn-link btn-sm">{VOTING.langresult}</button></a>
		</div>
	</fieldset>
</form>
<!-- END: main -->