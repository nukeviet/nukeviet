<form action="{USER_REGISTER}" method="post" onsubmit="return reg_validForm(this);" autocomplete="off" novalidate>
    ...
    <div class="form-detail">
        <div class="form-group">
            <div>
                <input type="text" class="form-control" placeholder="{LANG.last_name}" value="" name="last_name" maxlength="255">
            </div>
        </div>
        
        <div class="form-group">
            <div>
                <input type="text" class="form-control" placeholder="{LANG.first_name}" value="" name="first_name" maxlength="255">
            </div>
        </div>
