<form action="{USER_REGISTER}" method="post" onsubmit="return reg_validForm(this);" autocomplete="off" novalidate>
	<div class="nv-info margin-bottom" data-default="{LANG.info}">
		{LANG.info}
	</div>
	...
	<div class="form-detail">
		...
		<div class="form-group">
			<div>
				<input type="text" class="form-control {SYSTEM.required}" placeholder="{LANG_SYSTEM}" value="" name="{SYSTEM.field}" maxlength="255">
			</div>
		</div>
		<!-- END: loop -->
		<!-- END: show_system -->
		...
		<div class="form-group">
			<div>
				<input type="password" class="re-password required form-control" placeholder="{LANG.re_password}" value="" name="re_password" maxlength="{PASS_MAXLENGTH}" data-pattern="/^(.){{PASS_MINLENGTH},{PASS_MAXLENGTH}}$/" onkeypress="validErrorHidden(this);" data-mess="{GLANG.re_password_empty}">
			</div>
		</div>
		<!-- BEGIN: show_question -->
		<div class="form-group rel">
			<div class="input-group">
				<input type="text" class="{QUESTION_REQUIRED} form-control" placeholder="{LANG.question}" value="" name="your_question" maxlength="255" data-pattern="/^(.){3,}$/" onkeypress="validErrorHidden(this);" data-mess="{LANG.your_question_empty}">
		...
		<div class="form-group">
			<div>
				<input type="text" class="{ANSWER_REQUIRED} form-control" placeholder="{LANG.answer_your_question}" value="" name="answer" maxlength="255" data-pattern="/^(.){3,}$/" onkeypress="validErrorHidden(this);" data-mess="{LANG.answer_empty}">
			</div>
		</div>
		<!-- END: show_answer -->
		...
		<div>
			<div>
				<div class="form-group clearfix radio-box {RADIO_SYSTEM.required}" data-mess="">
