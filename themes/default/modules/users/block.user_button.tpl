...
<div id="guestBlock_{BLOCKID}" class="hidden">
    <div class="guestBlock">
        <h3>
            <a class="guest-sign pointer margin-right current">{GLANG.signin}</a>
            <!-- BEGIN: allowuserreg --><a href="{USER_REGISTER}" class="guest-reg pointer">{GLANG.register}</a><!-- END: allowuserreg -->
        </h3>
        <div class="log-area">
            {FILE "login_form.tpl"}
