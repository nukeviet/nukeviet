...
$(document).ready(function() {
	...
	$("#btn_upload").click(function() {
		nv_open_browse( nv_siteroot  + "index.php?" + nv_name_variable  + "=" + nv_module_name + "&" + nv_fc_variable  + "=avatar", "NVImg", 650, 500, "resizable=no,scrollbars=1,toolbar=no,location=no,status=no");
		return false;
	});
