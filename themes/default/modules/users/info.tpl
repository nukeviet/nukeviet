					...
					<form action="{EDITINFO_FORM}/basic" method="post" role="form" class="form-horizontal" onsubmit="return reg_validForm(this);" autocomplete="off" novalidate>
						...
						<div class="form-detail">
							...
							<div class="form-group">
								...
								<div class="col-md-12">
									<input type="text" class="form-control {LAST_NAME_REQUIRED}" placeholder="{LANG.last_name}" value="{DATA.last_name}" name="last_name" maxlength="255">
								</div>
							</div>
							<!-- END: show_last_name -->
							...
							<div class="form-group">
								...
								<div class="col-md-12">
									<input type="text" class="form-control {FIRST_NAME_REQUIRED}" placeholder="{LANG.first_name}" value="{DATA.first_name}" name="first_name" maxlength="255">
								</div>
							</div>
							<!-- END: show_first_name -->
							<!-- END: name_show_0 -->
							...
							<div class="form-group">
								...
								<div class="col-md-4">
									<input type="text" class="form-control calendar-icon datepicker {BIRTH_SYSTEM.required}" name="birthday" value="{DATA.birthday}" readonly="readonly" onfocus="datepickerShow(this);" data-mess="">
								</div>
							</div>
									...
									<div class="input-group">
										...
										<span class="input-group-btn" onclick="showQlist(this);">
											<button type="button" class="btn btn-default pointer">
												<em class="fa fa-caret-down fa-lg"></em>
											</button></span>
									</div>
