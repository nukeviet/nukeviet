			...
			<div class="row">
				...
				<div class="col-md-8">
					<ul class="related">
						<!-- BEGIN: loop -->
						<li class="{CLASS}">
							<a class="show" href="{OTHER.link}" data-content="{OTHER.hometext}" data-img="{OTHER.imghome}" data-rel="tooltip" data-position="{TOOLTIP_POSITION}" title="{OTHER.title}">{OTHER.title}</a>
						</li>
						<!-- END: loop -->
					</ul>
				</div>
