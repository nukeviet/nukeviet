...
<div class="col-sm-12 col-md-8">
	<div class="thumbnail">
		...
		<div class="caption text-center">
			<h4><a class="show" href="{CONTENT.link}" data-content="{CONTENT.hometext_clean}" data-img="{CONTENT.imghome}" data-rel="tooltip" data-position="{TOOLTIP_POSITION}" title="{CONTENT.title}">{CONTENT.title}</a></h4>
			<span>{ADMINLINK}</span>
		</div>
	</div>
</div>
