<!-- BEGIN: main -->
<link rel="stylesheet" href="{NV_BASE_SITEURL}/assets/css/sweetalert2.min.css">
<link rel="stylesheet" type="text/css" media="screen" href="{NV_BASE_SITEURL}themes/{BLOCK_THEME}/css/nghenhac.css" />
  ...
  <script src="{NV_BASE_SITEURL}/assets/js/sweetalert2.min.js"></script>
     <script src="{NV_BASE_SITEURL}themes/{BLOCK_THEME}/js/music.js"></script>
<!-- END:main -->