...
<div class="push-notification dropdown" id="push-notification" data-refresh-time="{REFRESH_TIME}" data-url="{PUSH_MODULE_URL}" data-userid="{USERID}" data-usergroups="{USERGROUPS}">
