...
<style type="text/css">
.style_nav{position:relative;background:url("{NV_BASE_SITEURL}themes/{BLOCK_THEME}/images/menu/nen.png") repeat-x;height:60px;line-height:32px;z-index:990}
</style>
...
<div class="style_nav">
	<ul id="sample-menu-4" class="sf-menu sf-navbar sf-js-enabled sf-shadow">
		<!-- BEGIN: loopcat1 -->
		<li{CAT1.class}><a title="{CAT1.note}" class="sf-with-ul" href="{CAT1.link}"{CAT1.target}><strong>{CAT1.title}</strong></a>		
			<!-- BEGIN: cat2 -->
			<ul>			
				{HTML_CONTENT}	
			</ul><!-- END: cat2 -->
