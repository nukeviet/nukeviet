...
<ul class="list-unstyled items" data-url="{PAGE_URL}">
    ...
    <li class="item hidden-{LOOP.is_hidden} shown-{LOOP.shown_time} viewed-{LOOP.is_viewed} favorite-{LOOP.is_favorite}" data-id="{LOOP.id}">
        ...
        <div class="foot">
            ...
            <div>
                <!-- BEGIN: set_viewed --><button type="button" class="btn btn-viewed" data-toggle="informNotifySetStatus" data-status="viewed" title="{LANG.mark_as_viewed}"><i class="fa fa-bell-o"></i></button><!-- END: set_viewed -->
                <!-- BEGIN: set_unviewed --><button type="button" class="btn btn-viewed" data-toggle="informNotifySetStatus" data-status="unviewed" title="{LANG.mark_as_unviewed}"><i class="fa fa-bell-o"></i></button><!-- END: set_unviewed -->
                <!-- BEGIN: set_favorite --><button type="button" class="btn btn-favorite" data-toggle="informNotifySetStatus" data-status="favorite" title="{LANG.mark_as_favorite}"><i class="fa fa-heart-o"></i></button><!-- END: set_favorite -->
                <!-- BEGIN: set_unfavorite --><button type="button" class="btn btn-favorite" data-toggle="informNotifySetStatus" data-status="unfavorite" title="{LANG.mark_as_unfavorite}"><i class="fa fa-heart-o"></i></button><!-- END: set_unfavorite -->
                <!-- BEGIN: set_hidden --><button type="button" class="btn" data-toggle="informNotifySetStatus" data-status="hidden" title="{LANG.hidden}"><i class="fa fa-trash-o"></i></button><!-- END: set_hidden -->
                <!-- BEGIN: set_unhidden --><button type="button" class="btn" data-toggle="informNotifySetStatus" data-status="unhidden" title="{LANG.show}"><i class="fa fa-eye"></i></button><!-- END: set_unhidden -->
            </div>
        </div>
    </li><!-- END: loop -->
</ul>
...
<link href="{NV_BASE_SITEURL}themes/{TEMPLATE}/css/inform-manager.css" rel="stylesheet" />
...
<script src="{NV_BASE_SITEURL}themes/{TEMPLATE}/js/inform-manager.js"></script>
<div id="notifications_manager" class="notifications_manager" data-url="{MANAGER_PAGE_URL}" data-csrf="{CHECKSS}">
    <div class="manager-heading">
        ...
        <button type="button" class="btn btn-primary margin-bottom" data-toggle="inform_action" data-type="add" data-title="{LANG.inform_add}">{LANG.inform_add}</button>
    </div>
        ...
        <tbody>
            ...
            <tr class="notification-item status-{ITEM.status}" data-id="{ITEM.id}">
                ...
                <td style="vertical-align:middle">
                    ...
                    <!-- BEGIN: link -->
                    <div class="inform-link"><a href="{ITEM.link}" target="_blank">{LANG.inform_link}</a></div>
                    <!-- END: link -->
                </td>
                <td class="text-center" style="width: 1%;vertical-align:middle">
                ...
                <td class="text-center text-nowrap" style="width: 1%;vertical-align:middle">
                    <button class="btn btn-default btn-sm" data-toggle="inform_action" data-type="edit" data-title="{LANG.inform_edit}" title="{LANG.inform_edit}"><i class="fa fa-pencil-square-o fa-fw"></i></button>
                    <button class="btn btn-default btn-sm" data-toggle="inform_del" title="{GLANG.delete}"><i class="fa fa-trash-o fa-fw"></i></button>
                </td>
            </tr>
            <!-- END: loop -->
        </tbody>
...
<form method="post" action="{MANAGER_PAGE_URL}" class="form-horizontal" id="notification_action_form">
    ...
    <div class="form-group">
        <label class="col-md-8 control-label">{LANG.inform_link}</label>
        <div class="col-md-16">
            <!-- BEGIN: link -->
            <div class="panel panel-default">
                <div class="panel-heading">
