<!-- BEGIN: main -->
<span class="visible-xs-inline-block"><!-- BEGIN: mainphone --><span class="hidden-ss-inline-block margin-right"><!-- BEGIN: href --><a href="tel:{MAINPHONE.href}"><!-- END: href --><em class="fa fa-phone"></em>&nbsp;{MAINPHONE.number}<!-- BEGIN: href2 --></a><!-- END: href2 --></span><!-- END: mainphone --><a title="{LANG.contactUs}" class="pointer button" data-toggle="tip" data-target="#contactList" data-click="y"><em class="fa fa-life-ring fa-lg"></em><span class="hidden">{LANG.contactUs}</span></a></span>
...
<!-- BEGIN: yahoo --><li><em class="fa fa-weixin"></em>&nbsp;<!-- BEGIN: item --><!-- BEGIN: comma -->&nbsp; <!-- END: comma --><a href="ymsgr:SendIM?{YAHOO}" title="Yahoo Chat">{YAHOO}</a><!-- END: item --></li><!-- END: yahoo -->
