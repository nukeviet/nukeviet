...
<table summary="{CTS.caption}" class="statistics">
	...
	<tbody class="second">
		<tr>
			<td colspan="24" style="text-align: right;"> {CTS.total.0}: <strong>{CTS.total.1}</strong></td>
		</tr>
	</tbody>
</table>
<br/>
...
<table summary="{CTS.caption}" class="statistics">
	...
	<tbody class="second">
		<tr>
			<td colspan="7" style="text-align: right;"> {CTS.total.0}: <strong>{CTS.total.1}</strong></td>
		</tr>
	</tbody>
</table>
<br/>
...
<table summary="{CTS.caption}" class="statistics">
	...
	<tbody class="second">
		<tr>
			<td colspan="{CTS.numrows}" style="text-align: right;"> {CTS.total.0}: <strong>{CTS.total.1}</strong></td>
		</tr>
	</tbody>
</table>
<br/>
...
<table summary="{CTS.caption}" class="statistics">
	...
	<tbody class="second">
		<tr>
			<td colspan="12" style="text-align: right;"> {CTS.total.0}: <strong>{CTS.total.1}</strong></td>
		</tr>
	</tbody>
</table>
<br/>
