...
<div class="table-responsive margin-bottom">
    <table summary="{LANG.statbybot}" class="table table-bordered">
        <tbody>
        ...
        <caption class="bg-primary padding-top padding-bottom padding-left padding-right"><i class="fa fa-line-chart fa-fw"></i> {LANG.statbybot}</caption>
    </table>
</div>
<!-- BEGIN: gp -->
