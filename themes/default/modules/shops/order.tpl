...
<div class="block clearfix">
	...
	<p class="error">{LANG.order_info}</p>
	<form action="" method="post" name="fpost" id="fpost">
		...
		<table class="rows2" style="margin-bottom: 2px">
			...
			<tr>
				...
				<td valign="top"><input name="order_address" value="{DATA.order_address}" style="width: 90%" /> <br />
		...
		<table class="rows3" style="margin-top: 2px">
			<tr>
				<td><input type="checkbox" name="check" value="1" id="check" /><span id="idselect">{LANG.order_true_info}</span> <br /> <span class="error">{ERROR.order_check}</span></td>
