...
<div class="profile">
	...
	<table class="rows" style="border: 1px solid #f4f4f4; padding-top: 2px">
		...
		<tr id="{id}"{bg}>
			...
			<!-- BEGIN: allow -->
			<a class="btn" title="{LANG.profile_edit_title}" href="{link_edit}">{LANG.profile_edit_title}</a> | <a class="btn0" title="{LANG.profile_del_title}" href="{link_del}">{LANG.profile_del_title}</a>
			<!-- END: allow -->
			<!-- BEGIN: not_allow -->
			<a class="btn" title="" href="#">-</a> | <a class="btn0" title="" href="#">-</a>
			<!-- END: not_allow -->
			</td>
		</tr>
		<!-- END: rows -->
