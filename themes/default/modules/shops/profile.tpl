...
<div class="profile">
	...
	<div class="profile_info">
		...
		<div class="allinfo" style="margin-top:2px">
			<strong>{LANG.profile_user_name} :</strong><span> {USER.full_name}</span>
			<br />
			<strong>{LANG.profile_company_address} : </strong><span> {USER.location}</span>
			<br />
			<strong>{LANG.profile_username} : </strong><span> {USER.username}</span> &nbsp; <strong>{LANG.profile_user_email} : </strong><span> {USER.email}</span>
			<br />
			<strong>{LANG.profile_user_last_online} : </strong><span> {USER.last_login}</span>
			<br />
