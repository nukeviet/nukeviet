...
<div class="panel-body">
	<div class="featured-products">
		...
		<div class="row clearfix">
			<!-- BEGIN: title_text --><div class="h3">{ROW.title}</div><!-- END: title_text -->
			<!-- BEGIN: title_link --><div class="h3"><a href="{ROW.link}" title="{ROW.title}"<!-- BEGIN: target --> target="{ROW.target}"<!-- END: target -->>{ROW.title}</a></div><!-- END: title_link -->
