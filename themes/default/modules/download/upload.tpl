...
<form id="uploadForm" name="uploadForm" action="{FORM_ACTION}" method="post" enctype="multipart/form-data" class="form-horizontal" role="form">
	<div class="form-group">
		<label class="col-sm-4 control-label">{LANG.file_title}</label>
		<div class="col-sm-20">
	...
	<div class="form-group">
		<label class="col-sm-4 control-label">{LANG.bycat2}</label>
		<div class="col-sm-20">
	...
	<div class="form-group">
		<label class="col-sm-4 control-label">{LANG.author_name}</label>
		<div class="col-sm-20">
	...
	<div class="form-group">
		<label class="col-sm-4 control-label">{LANG.author_email}</label>
		<div class="col-sm-20">
	...
	<div class="form-group">
		<label class="col-sm-4 control-label">{LANG.author_url}</label>
		<div class="col-sm-20">
	...
	<div class="form-group">
		<label class="col-sm-4 control-label">{LANG.upload_files}</label>
		<div class="col-lg-12">
	...
	<div class="form-group">
		<label class="col-sm-4 control-label">{LANG.file_linkdirect}</label>
		<div class="col-sm-20">
	...
	<div class="form-group">
		<label class="col-sm-4 control-label">{LANG.filesize} (byte)</label>
		<div class="col-sm-20">
	...
	<div class="form-group">
		<label class="col-sm-4 control-label">{LANG.file_version}</label>
		<div class="col-sm-20">
	...
	<div class="form-group">
		<label class="col-sm-4 control-label">{LANG.fileimage}</label>
		<div class="col-lg-12">
			<div class="input-group">
	...
	<div class="form-group">
		<label class="col-sm-4 control-label">{LANG.copyright}</label>
		<div class="col-sm-20">
	...
	<div class="form-group">
		<label class="col-sm-4 control-label">{LANG.file_introtext}</label>
		<div class="col-sm-20">
	...
	<div class="form-group">
		<label class="col-sm-4 control-label">{LANG.file_description}</label>
		<div class="col-sm-20">
	...
	<div class="form-group">
		<label class="col-sm-4 control-label">{LANG.file_username}</label>
		<div class="col-sm-20">
	...
	<div class="form-group">
		<label class="col-sm-4 control-label">{LANG.file_upload_captcha2}</label>
		<div class="col-sm-20">
