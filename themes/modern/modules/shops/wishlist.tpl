...
<div id="products" class="clearfix">
	...
	<!-- BEGIN: items -->
	<div class="items" id="item_{ID}" style="width:{pwidth}%">
		<div class="items_content">
			...
			<div class="clearfix">
				...
				<a href="javascript:void(0)" title="{LANG.wishlist_del_item}" onclick="wishlist_del_item({ID})" class="pro_order">{LANG.wishlist_del_item}</a>
			</div>
		</div>
	</div>
	<!-- BEGIN: break -->
