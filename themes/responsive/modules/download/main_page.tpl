	...
	<div class="panel-body">
			<!-- BEGIN: itemcat -->
				<div>
					...
					<small><span class="glyphicon glyphicon-user"></span> {LANG.author_name}: {itemcat.author_name} - <span class="glyphicon glyphicon-zoom-in"></span> {LANG.view_hits}: {itemcat.view_hits} - <span class="glyphicon glyphicon-download-alt"></span> {LANG.download_hits}: {itemcat.download_hits}</small>
				</div>
				<!-- BEGIN: image -->
