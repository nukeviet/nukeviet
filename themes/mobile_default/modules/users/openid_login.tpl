<!-- BEGIN: main -->
<div class="page" style="margin:0 20px !important">
    ...
    <div class="text-center">
        ...
        <div class="margin-bottom-lg">
            <select class="form-control" data-toggle="choose_action">
                <option value="login" selected>{LANG.openid_note5}</option>
                <option value="reg">{LANG.openid_note4}</option>
            </select>
        </div>
        <div id="regForm" class="panel panel-default hidden">
            <form action="{USER_LOGIN}" method="post" role="form" class="form-horizontal panel-body" autocomplete="off" novalidate>
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-16">
                        <input type="text" class="required form-control" value="{USER_EMAIL}" name="reg_email" id="reg_email" maxlength="100" data-mess="{GLANG.email_incorrect}"<!-- BEGIN: readonly --> readonly<!-- END: readonly -->/>
                    </div>
                </div>
                <!-- BEGIN: email_verify -->
                <div class="form-group">
    ...
    <div id="loginForm" class="panel panel-default">
        <form action="{USER_LOGIN}" method="post" role="form" class="form-horizontal panel-body"<!-- BEGIN: captcha --> data-captcha="nv_seccode"<!-- END: captcha --><!-- BEGIN: recaptcha --> data-recaptcha2="1"<!-- END: recaptcha --><!-- BEGIN: recaptcha3 --> data-recaptcha3="1"<!-- END: recaptcha3 --> autocomplete="off" novalidate>
            <div class="form-group">
