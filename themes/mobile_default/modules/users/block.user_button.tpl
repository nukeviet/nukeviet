<!-- BEGIN: main -->
<span class="pa"><a title="{GLANG.signin} - {GLANG.register}" class="pa pointer button" data-toggle="tip" data-target="#guestBlock_{BLOCKID}" data-click="y"><em class="fa fa-user fa-lg pointer mbt-lg"></em><span class="hidden">{GLANG.signin}</span></a></span>
<!-- START FORFOOTER -->
