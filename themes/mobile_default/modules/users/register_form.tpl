<form class="user-reg-form" action="{USER_REGISTER}" method="post" data-toggle="reg_validForm" autocomplete="off" novalidate<!-- BEGIN: reg_captcha --> data-captcha="nv_seccode"<!-- END: reg_captcha --><!-- BEGIN: reg_recaptcha --> data-recaptcha2="1"<!-- END: reg_recaptcha --><!-- BEGIN: reg_recaptcha3 --> data-recaptcha3="1"<!-- END: reg_recaptcha3 -->>
    ...
    <div class="form-detail">
        ...
        <div class="form-group">
            <div>
                <input type="password" autocomplete="off" class="password required form-control" placeholder="{LANG.password}" value="" name="password" maxlength="{PASS_MAXLENGTH}" data-pattern="/^(.){{PASS_MINLENGTH},{PASS_MAXLENGTH}}$/" data-toggle="validErrorHidden" data-event="keypress" data-mess="{PASSWORD_RULE}">
            </div>
        </div>

        <div class="form-group">
            <div>
                <input type="password" autocomplete="off" class="re-password required form-control" placeholder="{LANG.re_password}" value="" name="re_password" maxlength="{PASS_MAXLENGTH}" data-pattern="/^(.){{PASS_MINLENGTH},{PASS_MAXLENGTH}}$/" data-toggle="validErrorHidden" data-event="keypress" data-mess="{GLANG.re_password_empty}">
            </div>
        </div>
        ...
        <div class="form-group">
            <div class="filelist" data-field="{FIELD.field}" data-oclass="{FIELD.class}" data-maxnum="{FILEMAXNUM}">
                <div style="display:flex">
                    <label class="{FIELD.required}" style="font-weight:normal">{FIELD.title}</label>
