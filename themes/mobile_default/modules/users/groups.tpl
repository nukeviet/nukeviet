...
<table class="table table-bordered">
    <tr>
        <td rowspan="4" style="width:80px;border-top:0"><img title="{DATA.title}" src="{NV_STATIC_URL}{NV_ASSETS_DIR}/images/pix.svg" width="80" height="80" style="background-image:url({DATA.group_avatar});background-repeat:no-repeat;background-size:cover;" /></td>
