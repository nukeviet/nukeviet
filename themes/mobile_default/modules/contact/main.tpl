...
<div class="page">
    <!-- BEGIN: bodytext -->
    <div class="well margin-left-sm margin-right-sm">
        {CONTENT.bodytext}
    </div>
    <!-- END: bodytext -->
    <div class="row">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <p><em class="icon-viber fa-horizon margin-right"></em>{VIBER.name}:
                        <span><!-- BEGIN: item --><!-- BEGIN: comma -->&nbsp;<!-- END: comma --><a href="viber://pa?chatURI={VIBER.value}" class="black">{VIBER.value}</a><!-- END: item --></span>
                    </p>
                    <!-- END: viber -->
                    <!-- BEGIN: icq -->
                    ...
                    <p><em class="fa fa-whatsapp fa-horizon margin-right"></em>{WHATSAPP.name}:
                        <span><!-- BEGIN: item --><!-- BEGIN: comma -->&nbsp;<!-- END: comma --><a href="https://wa.me/{WHATSAPP.value}" class="black">{WHATSAPP.value}</a><!-- END: item --></span>
                    </p>
                    <!-- END: whatsapp -->
                    <!-- BEGIN: zalo -->
                    <p><em class="icon-zalo fa-horizon margin-right"></em>{ZALO.name}:
                        <span><!-- BEGIN: item --><!-- BEGIN: comma -->&nbsp;<!-- END: comma --><a href="https://zalo.me/{ZALO.value}" class="black">{ZALO.value}</a><!-- END: item --></span>
                    </p>
                    <!-- END: zalo -->
                    <!-- BEGIN: other -->
                    <p>
