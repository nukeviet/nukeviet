	...
	<table class="tab1">
		...
		<tbody>
			...
			<tr>
				...
				<td>&nbsp;</td>
				<td><label><input name="{CONTENTS.uploadtype.1}[]" type="checkbox" value="images" {CONTENTS.uploadtype.2}/>images</label>&nbsp; <label><input name="{CONTENTS.uploadtype.1}[]" type="checkbox" value="flash" {CONTENTS.uploadtype.3}/>flash</label></td>
			</tr>
			<tr>
				<td>{CONTENTS.pass.0}:</td>
				<td>&nbsp;</td>
				<td><input class="w300" name="{CONTENTS.pass.1}" id="{CONTENTS.pass.1}" type="password" autocomplete="off" value="{CONTENTS.pass.2}" maxlength="{CONTENTS.pass.3}" /></td>
			</tr>
			<tr>
				<td>{CONTENTS.re_pass.0}:</td>
				<td>&nbsp;</td>
				<td><input class="w300" name="{CONTENTS.re_pass.1}" id="{CONTENTS.re_pass.1}" type="password" autocomplete="off" value="{CONTENTS.re_pass.2}" maxlength="{CONTENTS.re_pass.3}" /></td>
			</tr>
		</tbody>
	</table>
</form>
