                ...
                <div class="row">
                    <div class="col-lg-6 col-md-4">
                        ...
                        {foreach $category as $categorys}
                        	{if $row.catid == $categorys.catid}
                            <a href="javascript:void(0)" class="ms-tag ms-tag-success">{$categorys.title}</a>
                            {/if}
                         {/foreach}
                        </div>
                    </div>
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-4">
                        ...
                        {foreach $category as $categorys}
                        	{if $row.catid == $categorys.catid}
                            <a href="javascript:void(0)" class="ms-tag ms-tag ms-tag-info">{$categorys.title}</a>
                            {/if}
                         {/foreach}
                        </div>
                    </div>
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-4">
                        ...
                        {foreach $category as $categorys}
                        	{if $row.catid == $categorys.catid}
                            <a href="javascript:void(0)" class="ms-tag ms-tag-royal">{$categorys.title}</a>
                            {/if}
                         {/foreach}
                        </div>
                    </div>
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-4">
                        ...
                        {foreach $category as $categorys}
                        	{if $row.catid == $categorys.catid}
                            <a href="javascript:void(0)" class="ms-tag ms-tag-danger">{$categorys.title}</a>
                            {/if}
                         {/foreach}
                        </div>
                    </div>
