...
if (!nv_function_exists('nv_block_banner_main')) {

    /**
     * nv_block_banner_main()
     *
    ...
    function nv_block_banner_main($block_config)
    {
        ...
        } elseif (file_exists(NV_ROOTDIR . '/themes/' . $global_config['site_theme'] . '/blocks/global.banner_main.tpl')) {
        ...
        return $tpl->fetch('global.banner_main.tpl');
    }
}

if (defined('NV_SYSTEM')) {
    $content = nv_block_banner_main($block_config);
}