		...
		<div id="container" class="clearfix">
			<div id="info_tab" class="clearfix">
				...
				<ul class="pull-right list-inline" style="margin: 0">
					...
					<li><a href="{NV_BASE_SITEURL}index.php?{NV_LANG_VARIABLE}={NV_LANG_DATA}&amp;{NV_NAME_VARIABLE}={MODULE_NAME}" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="{NV_GO_CLIENTMOD}"><em class="fa fa-book fa-lg">&nbsp;</em></a></li>
					<!-- END: url_instruction -->
					<!-- BEGIN: site_mods -->
					<li><a href="NV_URL_INSTRUCTION" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="{NV_INSTRUCTION}"><em class="fa fa-globe fa-lg">&nbsp;</em></a></li>
					<!-- END: site_mods -->
				</ul>
			</div>
			<div id="contentmod">
