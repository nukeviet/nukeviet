	...
	<table class="tab1" style="margin-bottom: 8px;">
		<tbody>
			...
			<tr>
				...
				<td><input type="text" name="per_page" value="{DATA.per_page}" style="width:50px"/></td>
			</tr>
			<tr>
			...
			<tr>
				<td colspan="2" class="center"><input type="submit" name="submit" value="{LANG.weblink_submit}"/></td>
			</tr>
		</tbody>
	</table>
</form>
