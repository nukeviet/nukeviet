		...
		<table class="tab1">
			...
			<tbody {ROW.class}>
				<tr>
					...
					<td align="center"><span class="edit_icon"><a href="{ROW.url_edit}">{LANG.weblink_method_edit}</a></span> &nbsp;-&nbsp;<a href="{ROW.url_delete}">{LANG.weblink_method_del}</a></span></td>
				</tr>
			</tbody>
			<!-- END: loop -->
			<tfoot>
				<tr>
					<td colspan="8"><input type="submit" value="{LANG.weblink_method_del}"></td>
				</tr>
			</tfoot>
		</table>
	</form>
