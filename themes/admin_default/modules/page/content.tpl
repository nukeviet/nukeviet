				...
				<table class="table table-striped table-bordered table-hover">
					...
					<tbody>
						...
						<tr>
							...
							<td><input class="w500 form-control pull-left" type="text" value="{DATA.alias}" name="alias" id="idalias" maxlength="255" />&nbsp;<i class="fa fa-refresh fa-lg icon-pointer" onclick="get_alias('{ID}');">&nbsp;</i></td>
						</tr>
						<tr>
