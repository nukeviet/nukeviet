	...
	$(function() {
		$("input[name=install_content_overwrite]").click(function() {
			if (confirm("{LANG.autoinstall_error_warning_overwrite}")) {
				$("#checkmessage").html('<div style="text-align:center"><strong>{LANG.autoinstall_package_processing}</strong><br /><br /><img src="{NV_BASE_SITEURL}{NV_FILES_DIR}/images/load_bar.gif" alt="" /></div>');
