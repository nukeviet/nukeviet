    ...
    <div class="table-responsive">
        <table class="table table-striped table-bordered table-hover">
            <tbody>
                ...
                <tr>
                    <td>{LANG.config_tshow}</td>
                    <td class="form-inline">
                        <select class="form-control" name="title_show_type">
                            <!-- BEGIN: title_show_type -->
                            <option value="{TITLE_SHOW_TYPE.key}"{TITLE_SHOW_TYPE.selected}>{TITLE_SHOW_TYPE.title}</option>
                            <!-- END: title_show_type -->
                        </select>
                    </td>
                </tr>
