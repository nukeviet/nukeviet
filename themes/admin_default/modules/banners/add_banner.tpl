	...
	<table summary="{CONTENTS.info}" class="tab1">
		...
		<tbody class="second">
			<tr>
				...
				<td></td>
				<td><input name="{CONTENTS.publ_date.1}" class="datepicker" type="text" value="{CONTENTS.publ_date.2}" style="width:100px" maxlength="{CONTENTS.publ_date.3}" readonly="readonly" />
				</td>
			</tr>
		</tbody>
		<tbody>
			<tr>
				...
				<td></td>
				<td><input name="{CONTENTS.exp_date.1}" class="datepicker" type="text" value="{CONTENTS.exp_date.2}" style="width:100px" maxlength="{CONTENTS.exp_date.3}" readonly="readonly" />
				</td>
			</tr>
		</tbody>
	</table>
