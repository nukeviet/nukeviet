	...
	<table summary="{CONTENTS.info}" class="tab1">
		...
		<tbody>
			<tr>
				...
				<td><sup class="required">&lowast;</sup></td>
				<td><input name="{CONTENTS.pass.1}" id="{CONTENTS.pass.1}" type="password" value="{CONTENTS.pass.2}" style="width:300px" maxlength="{CONTENTS.pass.3}" /></td>
			</tr>
		</tbody>
		<tbody class="second">
			<tr>
				...
				<td><sup class="required">&lowast;</sup></td>
				<td><input name="{CONTENTS.re_pass.1}" id="{CONTENTS.re_pass.1}" type="password" value="{CONTENTS.re_pass.2}" style="width:300px" maxlength="{CONTENTS.re_pass.3}" /></td>
			</tr>
		</tbody>
		<tbody>
			<tr>
