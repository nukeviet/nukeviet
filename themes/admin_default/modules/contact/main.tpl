		...
		<table class="table table-striped table-bordered table-hover">
			...
			<tfoot>
				<tr>
					...
					<td colspan="6"><em class="fa fa-trash-o fa-lg">&nbsp;</em> <a href="javascript:void(0);" onclick="nv_del_submit(document.myform, 'sends[]');">{LANG.bt_del_row_title}</a> &nbsp; <em class="fa fa-trash-o">&nbsp;</em> <a href="javascript:void(0)" onclick="nv_delall_submit();">{LANG.delall}</a></td>
				</tr>
			</tfoot>
			<tbody>
				<!-- BEGIN: row -->
