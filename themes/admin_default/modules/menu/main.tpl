...
<table class="tab1">
	<thead>
		<tr align="center">
			<td style="width:50px"><strong>{LANG.number}</strong></td>
	...
	<tbody {ROW.class}>
		<tr>
			...
			<td align="center"><span class="edit_icon"><a href="{ROW.edit_url}">{LANG.edit}</a></span>&nbsp;-&nbsp;<span class="delete_icon"><a href="javascript:void(0);" onclick="nv_menu_delete({ROW.id},{ROW.num});">{LANG.delete}</a></span></td>
		</tr>
	</tbody>
	<!-- END: loop1 -->
	<!-- BEGIN: generate_page -->
