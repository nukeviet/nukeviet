	...
	<table class="tab1">
		...
		<tbody>
			...
			<tr>
				...
				<td><input style="width: 600px" name="alias" id="idalias" type="text" value="{DATA.alias}" maxlength="255" /> &nbsp; <em class="icon-refresh icon-large" onclick="get_alias('topics', {DATA.topicid});">&nbsp;</em></td>
			</tr>
			<tr>
