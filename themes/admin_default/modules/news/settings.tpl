	...
	<table class="tab1">
		...
		<tbody>
			<tr class="second">
				...
				<td><input name="module_logo" id="module_logo" value="{MODULE_LOGO}" style="width:340px;" type="text"/><input style="width:100px;" value="{GLANG.browse_image}" name="selectimg" type="button" /></td>
			</tr>
		</tbody>
		<tbody class="second">
			<tr>
