...
<form class="form-inline m-bottom confirm-reload" action="{NV_BASE_ADMINURL}index.php?{NV_LANG_VARIABLE}={NV_LANG_DATA}&{NV_NAME_VARIABLE}={MODULE_NAME}&amp;{NV_OP_VARIABLE}={OP}" enctype="multipart/form-data" method="post">
        ...
        <div class="col-sm-24 col-md-18">
            <table class="table table-striped table-bordered">
                ...
                <tbody>
                    <tr>
                        ...
                        <td><input type="text" maxlength="250" value="{rowcontent.title}" id="idtitle" name="title" class="form-control" style="width: 350px" /><span class="text-middle"> {GLANG.length_characters}: <span id="titlelength" class="red">0</span>. {GLANG.title_suggest_max}
                        </span></td>
                    </tr>
                    <tr>
            ...
            <table class="table table-striped table-bordered table-hover">
                <tbody>
                    ...
                    <tr>
                        <td><select class="form-control w300" name="topicid" id="topicid">
                                <!-- BEGIN: rowstopic -->
            ...
            <table class="table table-striped table-bordered table-hover">
                <tbody>
                    ...
                    <tr>
                        <td>
                            <div style="padding: 2px; background: #CCCCCC; margin: 0; display: block; position: relative">{edit_bodytext}</div>
                        </td>
                    </tr>
                    <tr>
                            ...
                            <div class="message_body" style="height: 260px; overflow: auto">
                                <table class="table table-striped table-bordered table-hover">
                                    <tbody>
                                        <!-- BEGIN: catid -->
                                        <tr>
                                            <td><input style="margin-left: {CATS.space" type="checkbox" value="{CATS.catid}" name="catids[]" class="news_checkbox"{CATS.checked} {CATS.disabled}> {CATS.title}</td>
                                            <td><input id="catright_{CATS.catid}" style="" type="radio" name="catid" title="{LANG.content_checkcat}" value="{CATS.catid}" {CATS.catidchecked}/></td>
                                        </tr>
                                        <!-- END: catid -->
                                    </tbody>
                                </table>
                            ...
                            <div class="message_body" style="overflow: auto">
                                <div class="clearfix uiTokenizer uiInlineTokenizer">
                                    <div id="keywords" class="tokenarea">
                                        <!-- BEGIN: keywords -->
                                        <span class="uiToken removable" title="{KEYWORDS}" ondblclick="$(this).remove();"> {KEYWORDS} <input type="hidden" autocomplete="off" name="keywords[]" value="{KEYWORDS}" /> <a onclick="$(this).parent().remove();" class="remove uiCloseButton uiCloseButtonSmall" href="javascript:void(0);"></a>
                                        </span>
                                        <!-- END: keywords -->
                                    </div>
                    ...
                    <ul style="padding: 4px; margin: 0">
                        ...
                        <li>
                            ...
                            <div class="message_body">
                                ...
                                <div style="margin-bottom: 2px;">
                                    <input type="checkbox" value="1" name="copyright" {checkcop}/> <label> {LANG.content_copyright} </label>
                                </div>
                                <div style="margin-bottom: 2px;">
    ...
    <div class="clearfix">
        <h2>
            <i class="fa fa-angle-double-down" id="adv-form-arrow"></i><a data-toggle="collapse" href="#adv-form" aria-expanded="false">{LANG.content_advfeature}</a>
        </h2>
        <hr class="inline" />
                    ...
                    <table class="table table-striped table-bordered">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td><input type="text" maxlength="250" value="{rowcontent.titlesite}" id="idtitlesite" name="titlesite" class="form-control" style="width: 350px" /><span class="text-middle"> {GLANG.length_characters}: <span id="titlesitelength" class="red">0</span>. {GLANG.title_suggest_max}
                                </span></td>
                            </tr>
                            <tr>
                ...
                <div class="col-sm-24 col-md-6">
                    <ul style="padding-left: 4px; margin: 0">
                        <li>
                            ...
                            <div class="message_body">
                                <input class="form-control" name="publ_date" id="publ_date" value="{publ_date}" style="width: 90px;" maxlength="10" type="text" /> <select class="form-control" name="phour"> {phour}
                        ...
                        <li>
                            ...
                            <div class="message_body">
                                <input class="form-control" name="exp_date" id="exp_date" value="{exp_date}" style="width: 90px;" maxlength="10" type="text" /> <select class="form-control" name="ehour"> {ehour}
                        ...
                        <li>
                            ...
                            <div class="message_body">
                                ...
                                <div class="m-bottom">
                                    {LANG.content_instant_template}: <input type="text" placeholder="{LANG.content_instant_templatenote}" name="instant_template" value="{rowcontent.instant_template}" class="form-control" style="width: 100%" />
                                </div>
                                <p>
    ...
    <div class="text-center">
        <br /> <input type="hidden" value="1" name="save" /> <input type="hidden" value="{ISCOPY}" name="copy" /> <input type="hidden" value="{rowcontent.id}" name="id" /> <input type="hidden" value="{rowcontent.referer}" name="referer">
        <!-- BEGIN:status_save -->
