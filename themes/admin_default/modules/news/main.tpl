...
<form class="navbar-form" name="block_list" action="{NV_BASE_ADMINURL}index.php?{NV_LANG_VARIABLE}={NV_LANG_DATA}&{NV_NAME_VARIABLE}={MODULE_NAME}&amp;{NV_OP_VARIABLE}={OP}">
    <div class="table-responsive">
        ...
        <table class="table table-striped table-bordered table-hover">
            ...
            <thead>
                <tr>
                    <th class="text-center"><input name="check_all1[]" type="checkbox" value="yes" onclick="nv_checkAll(this.form, 'idcheck1[]', 'check_all1[]',this.checked);" /></th>
                    <th class="text-center"><a href="{base_url_name}">{LANG.name}</a></th>
                    <th class="text-center"><a href="{base_url_publtime}">{LANG.content_publ_date}</a></th>
                    <th>{LANG.content_admin}</th>
                    <th>{LANG.status}</th>
            ...
            <tbody>
                ...
                <tr class="{ROW.class}">
                    <td class="text-center">
                        <!-- BEGIN: checkrow -->
                        <input type="checkbox" onclick="nv_UncheckAll(this.form, 'idcheck1[]', 'check_all1[]', this.checked);" value="{ROW.id}" name="idcheck1[]" />
                        <!-- END: checkrow -->
                    </td>
                    <td class="text-left">
                        <!-- BEGIN: sort -->
        ...
        <!-- END: group_status_1 -->
        <!-- BEGIN: group_status_2 -->
        <table class="table table-striped table-bordered table-hover">
            <caption><i class="fa fa-file-text-o"></i> {LANG.table_group_status_2}</caption>
            <thead>
                <tr>
            ...
            <tbody>
                ...
                <tr class="{ROW.class}">
                    <td class="text-center">
                        <!-- BEGIN: checkrow -->
                        <input type="checkbox" onclick="nv_UncheckAll(this.form, 'idcheck2[]', 'check_all2[]', this.checked);" value="{ROW.id}" name="idcheck2[]" />
                        <!-- END: checkrow -->
                    </td>
                    <td class="text-left">
                        <!-- BEGIN: sort -->
        ...
        <!-- END: group_status_2 -->
        <!-- BEGIN: group_status_3 -->
        <table class="table table-striped table-bordered table-hover">
            <caption><i class="fa fa-file-text-o"></i> {LANG.table_group_status_3}</caption>
            <thead>
                <tr>
                    <th class="text-center"><input name="check_all3[]" type="checkbox" value="yes" onclick="nv_checkAll(this.form, 'idcheck3[]', 'check_all3[]',this.checked);" /></th>
                    <th class="text-center"><a href="{base_url_name}">{LANG.name}</a></th>
                    <th class="text-center"><a href="{base_url_publtime}">{LANG.content_publ_date}</a></th>
                    <th>{LANG.content_admin}</th>
                    <th>{LANG.status}</th>
            ...
            <tbody>
                ...
                <tr class="{ROW.class}">
                    <td class="text-center">
                        <!-- BEGIN: checkrow -->
                        <input type="checkbox" onclick="nv_UncheckAll(this.form, 'idcheck3[]', 'check_all3[]', this.checked);" value="{ROW.id}" name="idcheck3[]" />
                        <!-- END: checkrow -->
                    </td>
                    <td class="text-left">
                        <!-- BEGIN: sort -->
        ...
        <!-- END: group_status_3 -->
        <!-- BEGIN: group_status_4 -->
        <table class="table table-striped table-bordered table-hover">
            <caption><i class="fa fa-file-text-o"></i> {LANG.table_group_status_4}</caption>
            <thead>
                <tr>
                    <th class="text-center"><input name="check_all4[]" type="checkbox" value="yes" onclick="nv_checkAll(this.form, 'idcheck4[]', 'check_all4[]',this.checked);" /></th>
                    <th class="text-center"><a href="{base_url_name}">{LANG.name}</a></th>
                    <th class="text-center"><a href="{base_url_publtime}">{LANG.content_publ_date}</a></th>
                    <th>{LANG.content_admin}</th>
                    <th>{LANG.status}</th>
            ...
            <tbody>
                ...
                <tr class="{ROW.class}">
                    <td class="text-center">
                        <!-- BEGIN: checkrow -->
                        <input type="checkbox" onclick="nv_UncheckAll(this.form, 'idcheck4[]', 'check_all4[]', this.checked);" value="{ROW.id}" name="idcheck4[]" />
                        <!-- END: checkrow -->
                    </td>
                    <td class="text-left">
                        <!-- BEGIN: sort -->
