<!-- BEGIN: main -->
<script src="{NV_BASE_SITEURL}themes/admin_default/js/inform_action.js"></script>
<form method="post" action="{PAGE_URL}" class="role-{DATA.sender_role} receiver-grs-{DATA.is_receiver_grs} form-horizontal inform-action-form" id="inform-action-form">
    ...
    <div class="field time text-center">
        ...
        <button type="button" class="btn btn-default" data-toggle="inform_action_canceled">{GLANG.cancel}</button>
    </div>
</form>
<!-- END: main -->