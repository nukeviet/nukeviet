				...
				<td valign="top">
						...
						<tbody>
							...
							<tr>
								<td>
									...
									<input type="button" onclick="nv_add_otherimage();" value="{LANG.add_otherimage}">
								</td>
							</tr>
						</tbody>
						<tbody id="otherimage">
					...
					<table class="tab1">
						<tr>
							...
							<td>
								<!-- BEGIN: edit -->
								<strong>{rowcontent.product_number}</strong> +
								<input type="text" maxlength="50" value="0" name="product_number" style="width: 50px;" />
								<!-- END: edit -->
								<!-- BEGIN: add -->
							...
							<td>
								<input type="text" maxlength="50" value="{rowcontent.product_price}" name="product_price" style="width: 80px;" onkeyup="this.value=FormatNumber(this.value);" id="f_money"/>
