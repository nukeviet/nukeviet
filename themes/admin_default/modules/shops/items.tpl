            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center">
                        ...
                        <a href="{ROW.link_warehouse}" title="{LANG.warehouse}" class="btn btn-info btn-xs"><i class="fa fa-cubes"></i></a>
                        <!-- END: warehouse_icon -->
                        <a href="{ROW.link_copy}" title="{LANG.product_copy_note}" class="btn btn-success btn-xs"><i class="fa fa-copy"></i></a>
