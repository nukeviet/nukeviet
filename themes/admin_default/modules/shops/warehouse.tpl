			...
			<tbody>
				...
				<tr>
					...
					<div class="form-group">
						...
						<div class="col-sm-6">
							<input type="number" autocomplete="off" id="number_product" name="data[{DATA.id}][0][quantity]" class="form-control" placeholder="{LANG.warehouse_quantity}" required="required" oninvalid="setCustomValidity( nv_required )" oninput="setCustomValidity('')" />
						</div>
						<div class="col-sm-6">
					...
					</div><!-- END: product_number --><!-- BEGIN: group -->
					<div class="nv-listing">
						...
						<div class="listing-body">
							...
							<!-- END: loop -->
							<button class="btn btn-primary btn-xs btn-add" style="margin-top: 4px">
								<em class="fa fa-plus-circle">&nbsp;</em>{LANG.warehouse_add_group_propties}
							</button>
						</div>
					</div>
...
<script type="text/javascript">
	...
	$("#number_product").blur(function() {
		var c = $(this).val();
		if (c < 0) {
			alert("Số lượng nhập vào không được âm" + c);
			document.getElementById("number_product").value="0";
			//$(this).value="0";
		};
