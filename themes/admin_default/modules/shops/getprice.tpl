...
<!-- BEGIN: saleprice -->
<div class="form-group">
    <label class="col-md-4 control-label">{LANG.content_product_product_saleprice}</label>
    <div class="col-md-8">
        <input class="form-control f_money" type="text" maxlength="50" value="{rowcontent.saleprice}" name="saleprice" onkeyup="this.value=FormatNumber(this.value);" />
    </div>
</div>
<!-- END: saleprice -->
<!-- END:main -->