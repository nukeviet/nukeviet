...
<div class="table-responsive">
	<table class="table table-striped table-bordered table-hover">
		...
		<!-- BEGIN: loop -->
			<tr>
				<td><img alt="{OPTION_LEV}" src="{NV_BASE_SITEURL}themes/{NV_ADMIN_THEME}/images/admin{THREAD_LEV}.png" width="38" height="18" /><a href="{DATA.link}"><strong>{DATA.login}</strong></a></td>
				<td>{DATA.email}</td>
				<td>{DATA.lev}</td>
				<td>{DATA.position}</td>
