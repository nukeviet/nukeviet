    ...
    <div class="table-responsive">
        <table class="table table-striped table-bordered table-hover">
            ...
            <tbody>
                ...
                <tr>
                    <td align="right">{LANG.update_LDAP_config_lname}</td>
                    <td><input name="config_field[lastname]" size="30" value="{DATA.config_field.lastname}" type="text"></td>
                    <td> {LANG.update_field}&nbsp;
                ...
                <tr>
                    <td align="right">{LANG.question}</td>
                    <td><input name="config_field[question]" size="30" value="{DATA.config_field.question}" type="text"></td>
                    <td> {LANG.update_field}&nbsp;
                ...
                <tr>
                    <td align="right">{LANG.answer}</td>
                    <td><input name="config_field[answer]" size="30" value="{DATA.config_field.answer}" type="text"></td>
                    <td> {LANG.update_field}&nbsp;
                ...
                <tr>
                    <td align="right">{LANG.gender}</td>
                    <td><input name="config_field[gender]" size="30" value="{DATA.config_field.gender}" type="text"></td>
                    <td> {LANG.update_field}&nbsp;
                ...
                <tr>
                    ...
                    <td><input name="config_field[birthday]" size="30" value="{DATA.config_field.birthday}" type="text"></td>
                    <td> {LANG.update_field}&nbsp;
                ...
                <tr>
                    <td align="right">{LANG.show_email}</td>
                ...
                <tr>
                    <td align="right">{LANG.sig}</td>
                    <td><input name="config_field[sig]" size="30" value="{DATA.config_field.sig}" type="text"></td>
                    <td> {LANG.update_field}&nbsp;
