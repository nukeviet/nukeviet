...
<div id="message" style="display:none;text-align:center;color:red">
	<table class="tab1 fixtab">
		<tbody>
			<tr>
				<td class="center"><img src="{NV_BASE_SITEURL}images/load_bar.gif" alt="" />
				<br />
...
<div id="step1">
	<table class="tab1 fixtab">
		<tbody>
			<tr>
				<td class="center"><strong>{LANG.autoinstall_theme_checkfile_notice}</strong>
				<br />
				<input type="button" name="checkfile" value="{LANG.autoinstall_theme_checkfile}"/></td>
			</tr>
		</tbody>
	</table>
</div>
