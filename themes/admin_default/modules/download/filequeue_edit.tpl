...
<form action="{FORM_ACTION}" method="post">
	<table class="tab1">
		<tbody>
			<tr>
				<td style="width:250px"> {LANG.file_title} </td>
				<td style="white-space: nowrap"><input class="txt" value="{DATA.title}" name="title" id="title" style="width:300px" /></td>
			</tr>
		</tbody>
		<tbody class="second">
			<tr>
		...
		<tbody>
			<tr>
				...
				<td style="white-space: nowrap"><input class="txt" value="{DATA.author_name}" name="author_name" id="author_name" style="width:300px" maxlength="100" /></td>
			</tr>
		</tbody>
		<tbody class="second">
			<tr>
				<td> {LANG.file_author_email} </td>
				<td style="white-space: nowrap"><input class="txt" value="{DATA.author_email}" name="author_email" id="author_email" style="width:300px" maxlength="60" /></td>
			</tr>
		</tbody>
		<tbody>
			<tr>
				<td> {LANG.file_author_homepage} </td>
				<td style="white-space: nowrap"><input class="txt" value="{DATA.author_url}" name="author_url" id="author_url" style="width:300px" maxlength="255" /><input type="button" value="{LANG.file_checkUrl}" id="check_author_url" onclick="nv_checkfile('author_url',0, 'check_author_url');" /><input type="button" value="{LANG.file_gourl}" id="go_author_url" onclick="nv_gourl('author_url',0, 'go_author_url');" /></td>
			</tr>
		</tbody>
		<tbody class="second">
			<tr>
				...
				<td style="white-space: nowrap">
				<!-- BEGIN: fileupload -->
				<input class="txt" value="{FILEUPLOAD.value}" name="fileupload[]" id="fileupload{FILEUPLOAD.key}" style="width:300px" maxlength="255" disabled="disabled" /><input type="button" value="{LANG.file_checkUrl}" id= "check_fileupload{FILEUPLOAD.key}" onclick="nv_checkfile('fileupload{FILEUPLOAD.key}',1, 'check_fileupload{FILEUPLOAD.key}');" /><input type="button" value="{LANG.file_gourl}" id= "go_fileupload{FILEUPLOAD.key}" onclick="nv_gourl('fileupload{FILEUPLOAD.key}',1, 'go_fileupload{FILEUPLOAD.key}');" />
				<br />
				<!-- END: fileupload -->
				<div id="fileupload2_items">
					...
					<!-- END: if_fileupload -->
					<!-- BEGIN: fileupload2 -->
					<input readonly="readonly" class="txt" value="{FILEUPLOAD2.value}" name="fileupload2[]" id="fileupload2_{FILEUPLOAD2.key}" style="width:300px" maxlength="255" />&nbsp; <input type="button" value="{LANG.file_selectfile}" name="selectfile" onclick="nv_open_browse_file( '{NV_BASE_ADMINURL}index.php?{NV_NAME_VARIABLE}=upload&popup=1&area=fileupload2_{FILEUPLOAD2.key}&path={FILES_DIR}&type=file', 'NVImg', 850, 420, 'resizable=no,scrollbars=no,toolbar=no,location=no,status=no' );return false;" />&nbsp; <input type="button" value="{LANG.file_checkUrl}" id= "check_fileupload2_{FILEUPLOAD2.key}" onclick="nv_checkfile('fileupload2_{FILEUPLOAD2.key}',1, 'check_fileupload2_{FILEUPLOAD2.key}');" />&nbsp; <input type="button" value="{LANG.file_gourl}" id= "go_fileupload2_{FILEUPLOAD2.key}" onclick="nv_gourl('fileupload2_{FILEUPLOAD2.key}',1, 'go_fileupload2_{FILEUPLOAD2.key}');" />
					<br />
					<!-- END: fileupload2 -->
				</div>
		...
		<tbody class="second">
			<tr>
				...
				<td style="white-space: nowrap"><input class="txt" value="{DATA.filesize}" name="filesize" id="filesize" style="width:100px" maxlength="11" /> {LANG.config_maxfilebyte} </td>
			</tr>
		</tbody>
		<tbody>
			<tr>
				<td> {LANG.file_version} </td>
				<td style="white-space: nowrap"><input class="txt" value="{DATA.version}" name="version" id="version" style="width:300px" maxlength="20" /></td>
			</tr>
		</tbody>
		<tbody class="second">
			<tr>
				...
				<td style="white-space: nowrap">
				<!-- BEGIN: fileimage -->
				<input class="txt" value="{DATA.fileimage}" name="fileimage" id="fileimage" style="width:300px" maxlength="255" disabled="disabled" /><input type="button" value="{LANG.file_checkUrl}" id= "check_fileimage" onclick="nv_checkfile('fileimage',1, 'check_fileimage');" /><input type="button" value="{LANG.file_gourl}" id= "go_fileimage" onclick="nv_gourl('fileimage',1, 'go_fileimage');" />
				<br />
				<!-- BEGIN: if_fileimage -->
				<div style="padding-top:10px">
					{LANG.add_new_img}:
				...
				<!-- END: if_fileimage -->
				<!-- END: fileimage -->
				<input class="txt" value="{DATA.fileimage2}" name="fileimage2" id="fileimage2" style="width:300px" maxlength="255" /><input type="button" value="{LANG.file_selectfile}" name="selectimg" /><input type="button" value="{LANG.file_checkUrl}" id="check_fileimage2" onclick="nv_checkfile('fileimage2',1, 'check_fileimage2');" /><input type="button" value="{LANG.file_gourl}" id= "go_fileimage2" onclick="nv_gourl('fileimage2',1, 'go_fileimage2');" /></td>
			</tr>
		</tbody>
		<tbody>
			<tr>
				<td style="vertical-align: top"> {LANG.intro_title} </td>
				<td style="white-space: nowrap"><textarea name="introtext" style="width:300px;height:150px">{DATA.introtext}</textarea></td>
			</tr>
		</tbody>
		<tbody class="second">
			<tr>
				<td> {LANG.file_copyright} </td>
				<td style="white-space: nowrap"><input class="txt" value="{DATA.copyright}" name="copyright" id="copyright" style="width:300px" maxlength="20" /></td>
			</tr>
		</tbody>
		<tbody>
			<tr>
				<td> {LANG.file_allowcomment} </td>
				<td style="white-space: nowrap"><input name="comment_allow" value="1" type="checkbox"{DATA.comment_allow} /></td>
			</tr>
		</tbody>
		<tbody class="second">
			<tr>
