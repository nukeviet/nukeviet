	...
	<table class="tab1">
		<tbody>
			<tr>
				...
				<td style="white-space: nowrap"><input class="txt" type="text" value="{DATA.title}" name="title" id="title" style="width:300px" /></td>
			</tr>
		</tbody>
		<tbody class="second">
			<tr>
		...
		<tbody>
			<tr>
				...
				<td style="white-space: nowrap"><input class="txt" type="text" value="{DATA.author_name}" name="author_name" id="author_name" style="width:300px" maxlength="100" /></td>
			</tr>
		</tbody>
		<tbody class="second">
			<tr>
				<td> {LANG.file_author_email} </td>
				<td style="white-space: nowrap"><input class="txt" type="text" value="{DATA.author_email}" name="author_email" id="author_email" style="width:300px" maxlength="60" /></td>
			</tr>
		</tbody>
		<tbody>
			<tr>
				<td> {LANG.file_author_homepage} </td>
				<td style="white-space: nowrap"><input class="txt" type="text" value="{DATA.author_url}" name="author_url" id="author_url" style="width:300px" maxlength="255" /><input type="button" value="{LANG.file_checkUrl}" id="check_author_url" onclick="nv_checkfile('author_url',0, 'check_author_url');" /><input type="button" value="{LANG.file_gourl}" id="go_author_url" onclick="nv_gourl('author_url',0, 'go_author_url');" /></td>
			</tr>
		</tbody>
		<tbody class="second">
			<tr>
				...
				<div id="fileupload_items">
					<!-- BEGIN: fileupload -->
					<input readonly="readonly" class="txt" type="text" value="{FILEUPLOAD.value}" name="fileupload[]" id="fileupload{FILEUPLOAD.key}" style="width:300px" maxlength="255" />&nbsp; <input type="button" value="{LANG.file_selectfile}" name="selectfile" onclick="nv_open_browse_file( '{NV_BASE_ADMINURL}index.php?{NV_NAME_VARIABLE}=upload&popup=1&area=fileupload{FILEUPLOAD.key}&path={FILES_DIR}&type=file', 'NVImg', 850, 420, 'resizable=no,scrollbars=no,toolbar=no,location=no,status=no' );return false;" />&nbsp; <input type="button" value="{LANG.file_checkUrl}" id= "check_fileupload{FILEUPLOAD.key}" onclick="nv_checkfile('fileupload{FILEUPLOAD.key}',1, 'check_fileupload{FILEUPLOAD.key}');" />&nbsp; <input type="button" value="{LANG.file_gourl}" id= "go_fileupload{FILEUPLOAD.key}" onclick="nv_gourl('fileupload{FILEUPLOAD.key}', 1, 'go_fileupload{FILEUPLOAD.key}');" />
					<br />
					<!-- END: fileupload -->
				</div>
				...
				</script><input type="button" value="{LANG.add_file_items}" onclick="nv_file_additem();" /> ({LANG.add_file_items_note}) </td>
			</tr>
		</tbody>
		<tbody>
			<tr>
		...
		<tbody class="second">
			<tr>
				...
				<td style="white-space: nowrap"><input type="text" class="txt" value="{DATA.filesize}" name="filesize" id="filesize" style="width:100px" maxlength="11" /> {LANG.config_maxfilebyte} </td>
			</tr>
		</tbody>
		<tbody>
			<tr>
				<td> {LANG.file_version} </td>
				<td style="white-space: nowrap"><input class="txt" type="text" value="{DATA.version}" name="version" id="version" style="width:300px" maxlength="20" /></td>
			</tr>
		</tbody>
		<tbody class="second">
			<tr>
				<td> {LANG.file_image} </td>
				<td style="white-space: nowrap"><input class="txt" type="text" value="{DATA.fileimage}" name="fileimage" id="fileimage" style="width:300px" maxlength="255" /><input type="button" value="{LANG.file_selectfile}" name="selectimg" /><input type="button" value="{LANG.file_checkUrl}" id="check_fileimage" onclick="nv_checkfile('fileimage',1, 'check_fileimage');" /><input type="button" value="{LANG.file_gourl}" id= "go_fileimage" onclick="nv_gourl('fileimage',1, 'go_fileimage');" /></td>
			</tr>
		</tbody>
		<tbody>
			<tr>
		...
		<tbody class="second">
			<tr>
				...
				<td style="white-space: nowrap"><input class="txt" type="text" value="{DATA.copyright}" name="copyright" id="copyright" style="width:300px" maxlength="20" /></td>
			</tr>
		</tbody>
		<tbody>
			<tr>
...
<script type="text/javascript">
	$("input[name=selectimg]").click(function() {
		nv_open_browse_file("{NV_BASE_ADMINURL}index.php?{NV_NAME_VARIABLE}=upload&popup=1&area=fileimage&path={IMG_DIR}&type=image", "NVImg", 850, 420, "resizable=no,scrollbars=no,toolbar=no,location=no,status=no");
		return false;
	}); 
</script>
<!-- END: main -->