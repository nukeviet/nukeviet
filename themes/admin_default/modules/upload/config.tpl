	...
	<table class="tab1">
		...
		<tbody class="second">
			<tr>
				...
				<td><input type="text" style="width: 350px" value="{AUTOLOGOSIZE.upload_logo}" id="upload_logo" name="upload_logo"><input type="button" name="selectimg" value="{LANG.selectimg}" style="width:100px"></td>
			</tr>
		</tbody>
		<tbody>
			<tr>
