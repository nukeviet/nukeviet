...
<form name="install_module" enctype="multipart/form-data" action="{NV_BASE_ADMINURL}index.php?{NV_NAME_VARIABLE}={MODULE_NAME}" method="post">
	<table class="tab1">
		...
		<tr>
			<td colspan="2" align="center"><input name="continue" type="button" value="{LANG.autoinstall_continue}" /><input name="back" type="button" value="{LANG.autoinstall_back}" /></td>
		</tr>
	</table>
</form>
...
<table class="tab1">
	<tbody>
		<tr>
			<td align="center"> {LANG.autoinstall_module_uploadedfile} <strong style="color:red">{INFO.filename}</strong> - {LANG.autoinstall_module_uploadedfilesize} <strong style="color:red">{INFO.filesize}</strong></td>
		</tr>
	</tbody>
	<tbody class="second">
		<tr>
			<td align="center"> {LANG.autoinstall_module_uploaded_filenum} <strong style="color:red">{INFO.filenum}</strong></td>
		</tr>
	</tbody>
</table>
<table class="tab1">
	<tbody>
		<tr>
			<td align="center"><strong>{LANG.autoinstall_module_checkfile_notice}</strong>
			<br />
			<br />
