...
<table summary="{CONTENT.caption}" class="tab1">
	...
	<tbody {ROW.class}>
		<tr>
			...
			<td><input name="chang_func_in_submenu_{ROW.id}" id="chang_func_in_submenu_{ROW.id}" type="checkbox" value="1" onclick="{ROW.in_submenu_click}"{ROW.in_submenu_checked} {ROW.disabled} /></td>
			<td>{ROW.name.0}</td>
