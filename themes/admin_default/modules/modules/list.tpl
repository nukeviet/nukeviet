...
<table summary="{CAPTION.0}" class="tab1">
	...
	<tbody {ROW.class}>
		<tr>
			...
			<td><span class="edit_icon"><a href="{ROW.values.edit.0}">{ROW.values.edit.1}</a></span> &nbsp;-&nbsp; <span class="default_icon"><a href="javascript:void(0);" onclick="{ROW.values.recreate.0}">{ROW.values.recreate.1}</a></span>
			<!-- BEGIN: delete -->
			&nbsp;-&nbsp;<span class="delete_icon"><a href="javascript:void(0);" onclick="{ROW.values.del.0}">{ROW.values.del.1}</a></span>
			<!-- END: delete -->
			</td>
		</tr>
	</tbody>
