...
<div class="clearfix">
    <ul class="nav nav-tabs setting-tabnav" role="tablist" id="settingTabs">
        <li role="presentation" class="{TAB0_ACTIVE}"><a href="#settingCSP" aria-controls="settingCSP" aria-offsets="0" role="tab" data-toggle="tab">{LANG.csp}</a></li>
        <li role="presentation" class="{TAB1_ACTIVE}"><a href="#settingRP" aria-controls="settingRP" aria-offsets="1" role="tab" data-toggle="tab">{LANG.rp}</a></li>
        <li role="presentation" class="{TAB2_ACTIVE}"><a href="#settingPP" aria-controls="settingPP" aria-offsets="2" role="tab" data-toggle="tab">{LANG.pp}</a></li>
    </ul>
