...
function nv4_block_f4( $block_config )
{
	...
	$xtpl = new XTemplate( 'global.f4.tpl', NV_ROOTDIR . '/themes/' . $global_config['module_theme'] . '/blocks' );
...
{
	$content = nv4_block_f4( $block_config );
}
