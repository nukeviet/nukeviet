...
function nv4_block_f1( $block_config )
{
	...
	$xtpl = new XTemplate( 'global.f1.tpl', NV_ROOTDIR . '/themes/' . $global_config['module_theme'] . '/blocks' );
...
{
	$content = nv4_block_f1( $block_config );
}
